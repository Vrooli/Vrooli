...
const literalSelectors = {
  ...
  pages: {
    ...
    runwayFigure: "position-runway",
    runwayBasis: "position-runway-basis",
    completeness: "position-completeness",
    missingAdapter: "position-missing-adapter",
    goalList: "position-goal-list",
    sustainProgress: "goal-sustain-progress",
    positionDelta: "position-delta",
    emptyGuidance: "position-empty-guidance",
    positionError: "position-error",
    runwayBurnTrend: "runway-burn-trend",
    runwayBurnTable: "runway-burn-table",
    trendSourceBasis: "trend-source-basis",
    trendGap: "trend-gap",
    ...
    bookList: "book-list",
    bookLabel: "account-book-label",
    accountTable: "account-table",
    accountsEmptyGuidance: "accounts-empty-guidance",
    balanceBasis: "account-balance-basis",
    balanceGap: "account-balance-gap",
    transferPair: "account-transfer-pair",
    adapterList: "adapter-list",
    adapterAvailability: "adapter-availability",
    failureReason: "adapter-failure-reason",
    lastSuccessAge: "adapter-last-success-age",
    missingImpact: "adapter-missing-impact",
    credentialGap: "adapter-credential-gap",
    manualAdapterEntry: "adapter-row-manual",
    adaptersEmptyGuidance: "adapter-empty-guidance",
    operatorInputSurface: "operator-input-surface",
    operatorInputStatus: "operator-input-status",
    operatorInputReport: "operator-input-report",
    operatorInputDerivedRateRefusal: "operator-input-derived-rate-refusal",
    eventTable: "journal-table",
    eventBasis: "journal-event-basis",
    eventSource: "journal-event-source",
    reversalLink: "journal-reversal-link",
    reversalReason: "journal-reversal-reason",
    reverseAction: "journal-reverse",
    auditTrail: "journal-audit-trail",
    manualEntry: "journal-manual-entry",
    journalEmptyGuidance: "journal-empty-guidance",
    statementFigures: "statement-figures",
    coverageNote: "statement-coverage",
    periodSelector: "statement-period",
    categoryBreakdown: "statement-categories",
    uncategorisedCount: "statement-uncategorised-count",
    notTaxAdvice: "statement-not-tax-advice",
    exportAction: "statement-export",
    statementsEmptyGuidance: "statement-empty-guidance",
  },
  errorBoundary: {
