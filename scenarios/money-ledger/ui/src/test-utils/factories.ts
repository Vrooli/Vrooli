 ...
 * `packages/proto/gen/typescript/js/money-ledger/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/money-ledger/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/money-ledger/v1/shared/health_pb";
