 ...
 * @vrooliComponentAdoption 8be76bec-f5d9-4f71-8aa7-b447b2f79920
 * @vrooliComponentAppliedAt 2026-08-16T04:57:37Z
 * @vrooliComponentSourceSha256 98531169fdae8ab78d8c5237503a61a1fb07891dffebbe99b5b42bc72171b1a2
 * @vrooliComponentDriftHash 37135056011d4ce26cfd4b3553f549d507b7d0c295bdb7ee80601de5d16dda40
...
export const DirtyStateGuard = forwardRef<
  DirtyStateGuardHandle,
        ...
        (renderPrompt ? (
          ...
          >
            <div
              ref={dialogRef}
              data-rcl-dirty-guard-dialog
              data-testid="dirty-state-guard-dialog"
              role="alertdialog"
              aria-modal="true"
            ...
            >
              ...
              {note && <div data-rcl-dirty-guard-body><p data-rcl-dirty-guard-note>{note}</p></div>}
