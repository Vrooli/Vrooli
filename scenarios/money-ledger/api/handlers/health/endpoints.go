...
import "money-ledger/internal/module"
...
var Endpoints = []module.EndpointDescriptor{
	{
		...
		RESTException: &module.RESTException{
			...
			ProtoPayloads: &module.RESTProtoPayloads{
				...
				Response: module.RESTPayload{ProtoFullName: "vrooli.money_ledger.v1.shared.Response", Transport: "json", Conformance: "protojson"},
