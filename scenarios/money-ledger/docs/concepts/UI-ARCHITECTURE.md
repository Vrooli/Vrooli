...
react-component-library adoptions resolve-path <component-id> money-ledger
react-component-library adoptions apply <component-id> money-ledger <adopted-path>
```
...
Run `experience-manager spec validate money-ledger --json` after route or
selector changes. The generated notes page spec is example-domain content and
is removed by `template-manager detemplate money-ledger`.
