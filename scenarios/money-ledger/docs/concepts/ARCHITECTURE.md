...
| Contracts (`packages/proto/schemas/money-ledger/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/money-ledger/`.
...
packages/proto/schemas/money-ledger/v1/<domain>/<file>.proto
       ...
       make generate
       │
       ├──▶ packages/proto/gen/go/money-ledger/v1/...              (api, cli)
       ├──▶ packages/proto/gen/go/money-ledger/v1/...connect       (Connect-Go)
       ├──▶ packages/proto/gen/typescript/js/money-ledger/v1/...   (ui)
       └──▶ packages/proto/gen/python/money_ledger/v1/...    (future tools)
```
...
1. Add proto messages and service methods under
   `packages/proto/schemas/money-ledger/v1/<domain>/`.
