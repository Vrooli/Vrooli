...
func ledgerBindings(h *handlers) map[string]cliapp.PrimitiveHandler {
	return map[string]cliapp.PrimitiveHandler{
		...
		"BooksService.ArchiveBook":          cliapp.ProtoMutation(h.booksArchive, booksArchiveReport),
		...
		"PositionService.ArchiveGoal":       cliapp.ProtoMutation(h.goalsArchive, goalsArchiveReport),
		"PositionService.ReparentGoal":      cliapp.ProtoMutation(h.goalReparent, goalReparentReport),
		"IngestService.OperatorInputStatus": cliapp.ProtoList(h.operatorInputStatus, operatorInputStatusReport),
	}
}
