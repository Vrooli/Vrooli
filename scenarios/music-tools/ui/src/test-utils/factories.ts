 ...
 * (e.g. a feature-local mocks/factories.ts); only truly cross-domain
 ...
 * `packages/proto/gen/typescript/js/music-tools/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/music-tools/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/music-tools/v1/shared/health_pb";
