...
func TestLaunchAppAction_MissingPath(t *testing.T) {
	...
	assert.Error(t, err)
	assert.Contains(t, err.Error(), "app_path is required")
}
...
func TestScreenshotAction_Success(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, "ok", result.Status)
	assert.Contains(t, result.Data["url"], "/api/v1/sessions/test-session-1/files/screenshot-")
}
...
func TestControlEndpoint_UnknownAction(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost,
		fmt.Sprintf("/api/v1/sessions/%s/control", session.ID),
...
func TestControlEndpoint_SessionNotFound(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost,
		"/api/v1/sessions/fake-id/control",
		bytes.NewBufferString(body))
	req.Header.Set("Content-Type", "application/json")
	rr := httptest.NewRecorder()
...
func TestControlEndpoint_InvalidJSON(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost,
		"/api/v1/sessions/any-id/control",
...
func TestServeFile_PathTraversal(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet,
		"/api/v1/sessions/test-id/files/..%2F..%2Fetc%2Fpasswd", nil)
	rr := httptest.NewRecorder()
...
func TestServeFile_ValidFilename(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet,
		"/api/v1/sessions/test-session/files/screenshot.png", nil)
	rr := httptest.NewRecorder()
