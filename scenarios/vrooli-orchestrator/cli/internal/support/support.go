...
const CLIName = "vrooli-orchestrator"
...
// {success, data: {message}} envelope, else it tries to read a top-level
...
// ParseCSVList splits a comma-separated string into a trimmed, non-empty slice.
