# Runbook — React Component Library
...
| CLI talks to old API | `react-component-library status`, configured API base | Reinstall via `make setup` | Update CLI reference if command changed. |
