...
import (
	...
	notesconnect "github.com/vrooli/vrooli/packages/proto/gen/go/react-component-library/v1/notes/notes_v1connect"

	internalnotes "react-component-library/internal/notes"
)
...
var Endpoints = []module.EndpointDescriptor{
	{
		...
		Examples: []module.Example{
			{Name: "List notes", Curl: "curl http://localhost:${API_PORT}/vrooli.react_component_library.v1.notes.NotesService/ListNotes -H 'Content-Type: application/json' -d '{}'"},
		},
		CLIMapping: &module.CLIMapping{
			Command: "react-component-library notes list",
		},
	},
	{
		ID:          "notes_create",
		...
		Examples: []module.Example{
			{Name: "Create note", Curl: "curl http://localhost:${API_PORT}/vrooli.react_component_library.v1.notes.NotesService/CreateNote -H 'Content-Type: application/json' -d '{\"title\":\"first\",\"body\":\"hello\"}'"},
		},
		CLIMapping: &module.CLIMapping{
			Command: "react-component-library notes create",
	...
	},
	{
		...
		Examples: []module.Example{
			{Name: "Get note", Curl: "curl http://localhost:${API_PORT}/vrooli.react_component_library.v1.notes.NotesService/GetNote -H 'Content-Type: application/json' -d '{\"id\":\"abc123\"}'"},
		},
		CLIMapping: &module.CLIMapping{
			Command: "react-component-library notes get",
			Args:    []string{"<id>"},
		},
	},
	{
		...
		CLIMapping: &module.CLIMapping{
			Command: "react-component-library notes attach",
