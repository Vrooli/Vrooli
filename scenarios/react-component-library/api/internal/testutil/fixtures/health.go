...
// `packages/proto/gen/go/react-component-library/v1/health/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/react-component-library/v1/health/health.proto`
