...
--
-- builtin_themes carries the in-place-migrated canonical registry of themes
-- shipped with the library (light, dark, high-contrast). Scenario-derived themes are computed on demand and
