...
const literalSelectors = {
  ...
  components: {
    ...
    ingest: {
      details: "components-ingest-details",
      scenario: "components-ingest-scenario",
      sourceFile: "components-ingest-source-file",
      slug: "components-ingest-slug",
      tags: "components-ingest-tags",
      acceptLoss: "components-ingest-accept-loss",
      submit: "components-ingest-submit",
      error: "components-ingest-error",
    ...
    editor: {
      ...
      comparisonToolbar: "components-editor-comparison-toolbar",
      comparisonClear: "components-editor-comparison-clear",
      storySheetAll: "components-editor-story-sheet-all",
      galleryStatus: "components-editor-gallery-status",
      specimenError: "components-editor-specimen-error",
      specimenRetry: "components-editor-specimen-retry",
      propsPanel: "components-editor-props-panel",
      propsDraft: "components-editor-props-draft",
      ...
      previewEventsClear: "components-editor-preview-events-clear",
      previewEventItem: "components-editor-preview-event-item",
      previewEventsEmpty: "components-editor-preview-events-empty",
      previewDiagnostics: "components-editor-preview-diagnostics",
      previewDiagnosticsCopy: "components-editor-preview-diagnostics-copy",
      previewDiagnosticsCopied: "components-editor-preview-diagnostics-copied",
      ...
      workspaceAddPane: "components-editor-workspace-add-pane",
      workspacePane: "components-editor-workspace-pane",
      workspacePaneClose: "components-editor-workspace-pane-close",
      workspacePaneRestore: "components-editor-workspace-pane-restore",
      workspacePaneDragHandle: "components-editor-workspace-pane-drag-handle",
      workspacePaneDropIndicator: "components-editor-workspace-pane-drop-indicator",
      filesTreeTab: "components-editor-files-tree-tab",
      filesSourceTab: "components-editor-files-source-tab",
      filesDiffClose: "components-editor-files-diff-close",
      filesRevertButton: "components-editor-files-revert-button",
      filesWrapButton: "components-editor-files-wrap-button",
      filesFontDecrease: "components-editor-files-font-decrease",
      filesFontIncrease: "components-editor-files-font-increase",
      fileTree: "components-editor-file-tree",
      fileTreeNode: "components-editor-file-tree-node",
      fileTabs: "components-editor-file-tabs",
      templateSelect: "components-editor-template-select",
    },
    emulator: {
      root: "components-emulator",
      toolbar: "components-emulator-toolbar",
      viewportToggle: "components-emulator-viewport-toggle",
      viewportPanel: "components-emulator-viewport-panel",
      presetOption: "components-emulator-preset-option",
    ...
    themeSwitcher: {
      ...
      appearanceToggle: "components-theme-switcher-appearance-toggle",
      appearancePanel: "components-theme-switcher-appearance-panel",
      mode: "components-theme-switcher-mode",
      ...
      visionFilterSelect: "components-theme-switcher-vision-filter",
      blurSlider: "components-theme-switcher-blur-slider",
