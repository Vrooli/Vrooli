 ...
 * @vrooliComponentAdoption 20180c5a-9d88-4dd3-a4b2-4d24f1a28d78
 ...
 * @vrooliComponentDriftHash b33f068c457ed4c95c6c25e2c1506507c7ca1d225df0c7121e6f74d948ee2edf
 * @vrooliComponentTokenTranslation bg-app-primary->bg-app-primary,bg-app-surface->bg-app-surface,bg-app-surface-muted->bg-app-surface-muted,border-app-border->border-app-border,border-app-primary->border-app-primary,ring-app-primary/50->ring-app-primary/50,text-app-foreground->text-app-foreground,text-app-muted-foreground->text-app-muted-foreground,text-app-primary-foreground->text-app-primary-foreground
 *
