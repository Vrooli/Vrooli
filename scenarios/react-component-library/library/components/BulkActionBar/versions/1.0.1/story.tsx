  ...
  return (
    <section style={shell}>
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {resolveStrings("data-display.bulk-action-bar.selection-workflow", "Selection workflow")}
        </span>
...
export function Default() {
  return (
    <Showcase
      title={resolveStrings("data-display.bulk-action-bar.title", "Context follows selection")}
...
export function Success() {
  return (
    <Showcase
      title={resolveStrings("data-display.bulk-action-bar.title.completion-closes-the-loop", "Completion closes the loop")}
...
export function RequestError() {
  return (
    <Showcase
      title={resolveStrings("data-display.bulk-action-bar.title.transport-failure-preserves-intent", "Transport failure preserves intent")}
...
export function Interactive() {
  ...
  return (
    <Showcase
      title={resolveStrings("data-display.bulk-action-bar.title.a-real-bulk-action-lifecycle", "A real bulk action lifecycle")}
