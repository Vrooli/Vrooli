...
const common = {
  ...
  description:
    "This action can be undone from the activity stream for the next 30 days.",
  onClear: () => undefined,
};
...
export function Default() {
  return (
    <Showcase
      title="Context follows selection"
...
export function Submitting() {
  return (
    <Showcase
      title="Progress stays attached to the decision"
...
export function Success() {
  return (
    <Showcase
      title="Completion closes the loop"
...
export function Partial() {
  return (
    <Showcase
      title="Partial failure names the work left behind"
...
export function RequestError() {
  return (
    <Showcase
      title="Transport failure preserves intent"
...
export function Retry() {
  return (
    <Showcase
      title="Retry is a continuation, not a reset"
...
export function Interactive() {
  ...
  return (
    <Showcase
      title="A real bulk action lifecycle"
