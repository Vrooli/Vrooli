  ...
  return (
    <section style={shell}>
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {useStrings("data-display.bulk-action-bar.selection-workflow", "Selection workflow")}
        </span>
...
export function Default() {
  return (
    <Showcase
      title={useStrings("data-display.bulk-action-bar.title", "Context follows selection")}
