...
import { FilterBar, type FilterOption } from "@vrooli/react-component-library/FilterBar/1";
import { Toolbar, type ToolbarItem } from "@vrooli/react-component-library/Toolbar/1";
...
export const DataToolbar = withClassName(function DataToolbar({
  ...
  const toolbarItems: ToolbarItem[] = [
    ...(onRefresh
      ...
      : []),
    ...(onExport ? [{ id: "export", label: exportLabel, onSelect: onExport }] : []),
    ...(onColumns ? [{ id: "columns", label: columnsLabel, onSelect: onColumns }] : []),
    {
      id: "comfortable",
      label: "Comfortable",
      kind: "toggle",
