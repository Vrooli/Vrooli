 ...
 * changes is that a page with N inputs now has one sheet in the document head
 * instead of N duplicated style nodes interleaved through the body, and the sheet
