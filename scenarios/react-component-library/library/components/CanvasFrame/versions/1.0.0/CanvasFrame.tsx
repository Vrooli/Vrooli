...
export const CanvasFrame = withClassName(function CanvasFrame({
  ...
  return (
    <section data-testid="preview.canvas-frame" data-canvas-frame data-mode={mode} aria-label={title} style={{ minWidth: 0, minHeight: "18rem", overflow: "hidden", border: "var(--border-hairline) solid var(--color-border)", borderRadius: "var(--radius-panel)", background: "var(--color-surface-muted)" }}>
