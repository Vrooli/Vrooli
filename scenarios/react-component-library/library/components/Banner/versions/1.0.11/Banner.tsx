...
export const DEFAULT_DAMPING: Record<BannerTone, BannerDamping> = {
  danger: { enterAfterMs: 0, minVisibleMs: 2_000, exitAfterMs: 250, flapWindowMs: 10_000, flapThreshold: 2, flapBackoffFactor: 2, maxExitAfterMs: 5_000, primaryDwellMs: 1_500 },
  warning: { enterAfterMs: 250, minVisibleMs: 1_500, exitAfterMs: 500, flapWindowMs: 10_000, flapThreshold: 2, flapBackoffFactor: 2, maxExitAfterMs: 8_000, primaryDwellMs: 1_500 },
  info: { enterAfterMs: 450, minVisibleMs: 1_200, exitAfterMs: 700, flapWindowMs: 10_000, flapThreshold: 2, flapBackoffFactor: 2, maxExitAfterMs: 8_000, primaryDwellMs: 1_500 },
  success: { enterAfterMs: 250, minVisibleMs: 1_500, exitAfterMs: 500, flapWindowMs: 10_000, flapThreshold: 2, flapBackoffFactor: 2, maxExitAfterMs: 8_000, primaryDwellMs: 1_500 },
};
...
function parseColor(value: string): Rgba | null {
  ...
  if (srgb) {
    ...
    if (red === undefined || green === undefined || blue === undefined
      || [red, green, blue].some(Number.isNaN)) return null;
...
export const BannerRegion = withClassName(function BannerRegion({
  ...
  useLayoutEffect(() => { measure(); }, [measure, primary?.id]);
  useEffect(() => {
    if (measure()) return;
