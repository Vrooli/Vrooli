...
export const SidebarShell = forwardRef<HTMLDivElement, SidebarShellProps>(
  function SidebarShell(
    ...
    const panelClasses = isPersistent
      ? "relative z-auto flex h-screen w-auto shrink-0 flex-col border-r border-app-border bg-app-surface shadow-none"
      : isOverlay
        ...
        : "fixed inset-y-0 left-0 z-50 h-dvh w-full max-w-none shrink-0 flex-col border-r border-app-border bg-app-surface shadow-xl transition-transform duration-200 ease-out md:relative md:inset-auto md:z-auto md:flex md:h-screen md:w-auto md:translate-x-0 md:shadow-none";
