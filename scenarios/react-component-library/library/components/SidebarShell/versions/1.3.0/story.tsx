...
import { Icon } from "../../../../primitives/Icon/versions/1.1.0/Icon";
  ...
  return (
    <nav aria-label="Workspace sections" style={{ display: "grid", gap: "var(--space-2xs)" }}>
      ...
      <NavLink
        ...
        description="Manage connected resources"
      />
...
export function Persistent({ args }: StoryHarnessProps) {
  ...
  return (
    <SidebarShell
      mode="persistent"
      mobileOpen={false}
      mobileLabel="Workspace navigation"
      desktopLabel="Workspace"
...
export function OverlayOpen() {
  ...
  return (
    <SidebarShell
      ...
      mobileHeader={<strong>Northstar menu</strong>}
...
export function ResponsiveClosed() {
  return (
    <SidebarShell
      mode="responsive"
      mobileOpen={false}
      mobileLabel="Scenario navigation"
      desktopLabel="Scenario"
      closeLabel="Close menu"
      onMobileClose={() => undefined}
    >
      <NavigationSpecimen />
...
export function FixtureFailure() {
  return (
    <SidebarShell
      ...
      onMobileClose={() => undefined}
    >
      <div role="alert" style={{ padding: "var(--space-md)" }}>
        Navigation data is unavailable. Retry to restore workspace sections.
      </div>
    </SidebarShell>
  );
}
