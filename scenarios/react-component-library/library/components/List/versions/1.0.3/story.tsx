  ...
  return (
    ...
    >
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {useStrings("data-display.list.activity-stream", "Activity stream")}
        </span>
...
export function Default() {
  return (
    <Showcase
      title={useStrings("data-display.list.title", "A list with hierarchy, not just rows")}
      detail="Each item has a primary action cue, supporting context, and a time marker that remains readable on narrow screens."
    >
      <List
        title={useStrings("data-display.list.title.recent-activity", "Recent activity")}
        description={useStrings(
          "data-display.list.description",
          "Changes across the design workspace",
        )}
        items={activity}
        label={useStrings("data-display.list.label", "Recent activity")}
      />
    </Showcase>
  );
}
  ...
  return (
    ...
    >
      <List
        ...
        label={useStrings("data-display.list.label.review-activity", "Review activity")}
      />
    </Showcase>
  );
}
  ...
  return (
    ...
    >
      <List
        ...
        label={useStrings("data-display.list.label.recent-activity", "Recent activity")}
      />
    </Showcase>
  );
}
