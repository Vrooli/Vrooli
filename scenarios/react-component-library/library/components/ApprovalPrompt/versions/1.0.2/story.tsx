  ...
  return (
    <section style={shell}>
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {resolveStrings("ai.approval-prompt.human-in-the-loop", "Human in the loop")}
        </span>
...
export function Default() {
  return (
    <Showcase
      title={resolveStrings("ai.approval-prompt.title", "Consent should feel deliberate")}
...
export function Submitting() {
  return (
    <Showcase
      title={resolveStrings("ai.approval-prompt.title.the-decision-has-a-stable-pending-state", "The decision has a stable pending state")}
...
export function Success() {
  return (
    <Showcase
      title={resolveStrings("ai.approval-prompt.title.a-successful-decision-closes-the-loop", "A successful decision closes the loop")}
...
export function RequestError() {
  return (
    <Showcase
      title={resolveStrings("ai.approval-prompt.title.failures-preserve-the-decision-context", "Failures preserve the decision context")}
...
export function PermissionDenied() {
  return (
    <Showcase
      title={resolveStrings("ai.approval-prompt.title.permission-boundaries-stay-explainable", "Permission boundaries stay explainable")}
...
export function Retry() {
  return (
    <Showcase
      title={resolveStrings("ai.approval-prompt.title.retry-keeps-scope-stable", "Retry keeps scope stable")}
...
export function Interactive() {
  ...
  return (
    <Showcase
      title={resolveStrings("ai.approval-prompt.title.a-real-decision-not-a-decorative-card", "A real decision, not a decorative card")}
