...
const common = {
  ...
  description:
    "A human review is required before this external side effect can proceed.",
  consequences:
...
export function Default() {
  return (
    <Showcase
      title="Consent should feel deliberate"
...
export function Submitting() {
  return (
    <Showcase
      title="The decision has a stable pending state"
...
export function Success() {
  return (
    <Showcase
      title="A successful decision closes the loop"
...
export function RequestError() {
  return (
    <Showcase
      title="Failures preserve the decision context"
...
export function PermissionDenied() {
  return (
    <Showcase
      title="Permission boundaries stay explainable"
...
export function Retry() {
  return (
    <Showcase
      title="Retry keeps scope stable"
...
export function Interactive() {
  ...
  return (
    <Showcase
      title="A real decision, not a decorative card"
