  ...
  return (
    ...
    >
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {useStrings("controls.radio-group.choice-architecture", "Choice architecture")}
        </span>
        <strong style={{ font: "var(--text-title)" }}>
          {useStrings("controls.radio-group.appearance", "Appearance")}
        </strong>
        <span
          style={{
...
export function Default() {
  return (
    <Showcase>
      <RadioGroup
        label={useStrings("controls.radio-group.label", "Theme")}
        options={options}
        defaultValue="system"
      />
    </Showcase>
...
export function Interactive() {
  ...
  return (
    <Showcase>
      ...
      <div
        role="status"
        aria-label={useStrings("controls.radio-group.aria-label", "Selected theme")}
        style={{
          color: "var(--color-muted-foreground)",
