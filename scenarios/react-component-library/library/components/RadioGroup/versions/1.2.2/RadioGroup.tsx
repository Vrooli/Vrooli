 ...
 */
/** @vrooliComponentSource react-component-library:RadioGroup
 * @vrooliComponentSourceSlot controls.radio-group */
...
function RadioGroupStyles() {
  return (
    <StyleSheet libraryId="react-component-library:RadioGroup" version="1.2.1" css={styleSheet} />
  );
}
