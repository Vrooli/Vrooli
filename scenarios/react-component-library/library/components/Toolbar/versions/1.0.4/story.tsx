  ...
  return (
    ...
    >
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {useStrings("controls.toolbar.command-surface", "Command surface")}
        </span>
        <strong style={{ font: "var(--text-title)" }}>
          {useStrings("controls.toolbar.editor-toolbar", "Editor toolbar")}
        </strong>
        <span
          style={{
...
export function Default() {
  return (
    <Showcase>
      <Toolbar
        label={useStrings("controls.toolbar.label", "Editor toolbar")}
        items={items(() => {})}
      />
    </Showcase>
  );
...
export function Interactive() {
  ...
  return (
    <Showcase>
      ...
      <div
        role="status"
        aria-label={useStrings("controls.toolbar.aria-label", "Last toolbar action")}
        style={{
          color: "var(--color-muted-foreground)",
