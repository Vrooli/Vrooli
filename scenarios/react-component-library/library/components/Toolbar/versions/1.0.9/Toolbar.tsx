 ...
 */
/** @vrooliComponentSource react-component-library:Toolbar
 * @vrooliComponentSourceSlot controls.toolbar */
import { StyleSheet } from "@vrooli/react-component-library/StyleSheet/1";
import { withClassName } from "@vrooli/react-component-library/ClassMerge/1";

import { createRef, useRef, useState, type ReactNode, type RefObject } from "react";
import { ControlBase, type ControlVariant } from "@vrooli/react-component-library/ControlBase/1";
import { Toggle } from "@vrooli/react-component-library/Toggle/1";
...
function ToolbarStyles() {
  return (
    <StyleSheet libraryId="react-component-library:Toolbar" version="1.0.8" css={styleSheet} />
  );
}
...
export const Toolbar = withClassName(function Toolbar({
  ...
  const itemRefs = items.map((_, index) => {
    if (!refs.current[index]) refs.current[index] = createRef<HTMLButtonElement>();
