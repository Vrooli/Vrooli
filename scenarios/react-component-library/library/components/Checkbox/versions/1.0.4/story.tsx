  ...
  return (
    ...
    >
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {useStrings("controls.checkbox.preference-control", "Preference control")}
        </span>
        <strong style={{ font: "var(--text-title)" }}>
          {useStrings("controls.checkbox.account-preferences", "Account preferences")}
        </strong>
        <span
          style={{
...
export function Default() {
  return (
    <Showcase>
      <Checkbox
        label={useStrings("controls.checkbox.label", "Keep me signed in")}
...
export function Invalid() {
  return (
    <Showcase>
      <Checkbox
        label={useStrings("controls.checkbox.label.billing-alerts", "Billing alerts")}
        description={useStrings(
