...
export const InputGroup = forwardRef<HTMLDivElement, InputGroupProps>(function InputGroup(
  { children, className, disabled = false, grown, shape = "rounded", size = "md", style, testId, tone = "default", ...rest },
  ref,
) {
  useLibraryStyleSheet("input-group-1-2-0", inputGroupStyles);
  const context = useMemo<InputGroupContextValue>(() => ({ disabled, size, testId }), [disabled, size, testId]);
  return (
 ...
 */
export const InputGroupField = forwardRef<HTMLDivElement, InputGroupFieldProps>(function InputGroupField(
...
export const InputGroupAdornment = forwardRef<HTMLSpanElement, InputGroupAdornmentProps>(
  function InputGroupAdornment({ children, className, side = "leading", style, testId, ...rest }, ref) {
    const { testId: groupTestId } = useInputGroup();
    return (
      <span
        {...rest}
 ...
 */
export const InputGroupAction = forwardRef<HTMLDivElement, InputGroupActionProps>(function InputGroupAction(
...
export const InputGroupSegment = forwardRef<HTMLButtonElement, InputGroupSegmentProps>(
  function InputGroupSegment(
    { children, className, disabled, emphasis = "quiet", side = "trailing", style, testId, type = "button", ...rest },
    ref,
  ) {
