...
[data-rcl-input-group] {
  ...
  overflow: hidden;
  transition: border-color var(--dur-quick, 180ms) var(--ease-standard, ease), box-shadow var(--dur-quick, 180ms) var(--ease-standard, ease);
}
...
[data-rcl-input-group][data-disabled="true"] { opacity: var(--opacity-disabled, .4); pointer-events: none; }
...
[data-rcl-input-group] [data-rcl-textarea] {
  ...
  line-height: var(--text-body-line, 1.4);
}
...
[data-rcl-input-group-segment] {
  ...
  transition: background var(--dur-quick, 180ms) var(--ease-standard, ease), color var(--dur-quick, 180ms) var(--ease-standard, ease);
}
...
[data-rcl-input-group-segment]:disabled { cursor: not-allowed; opacity: var(--opacity-disabled, .4); }
