 ...
 * @displayName Ambient Display Shell
 * @description Full-bleed shell for ambient room displays
 * @version 0.1.2
 * @tags ["ambient","display","war-room"]
...
/** Stable ambient frame; controls and data fetching remain owned by the host. */
      ...
      >
        {beatCount > 0 ? (
          ...
          <span
            ...
            style={{ transform: `scaleX(${boundedProgress.toFixed(3)})` }}
          />
        )}
      </div>
