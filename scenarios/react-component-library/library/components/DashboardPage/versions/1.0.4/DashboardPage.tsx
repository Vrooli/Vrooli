  ...
  if (state === "refreshing")
    return (
      <div role="status" style={panel}>
        <strong>{translate("templates.dashboard-page.text.2", "Refreshing")}</strong>
        {children}
      </div>
    );
      ...
      <div style={{ display: "grid", gap: 16 }}>
        <header>
          <h1 style={{ margin: 0, fontSize: 24 }}>
            {translate("templates.dashboard-page.text.5", "Dashboard")}
          </h1>
          <p style={muted}>
            {translate("templates.dashboard-page.text.6", "A clear view of what needs attention.")}
          </p>
        </header>
        <section
