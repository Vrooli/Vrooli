...
[data-rcl-setup-task] h3 { margin: 0; color: var(--color-foreground-strong); font: var(--text-heading-sm); overflow-wrap: anywhere; }
...
[data-rcl-setup-task] [data-rcl-setup-task-meta] { display: flex; min-inline-size: 0; flex-wrap: wrap; gap: var(--space-xs) var(--space-lg); margin: 0; padding-block: var(--space-sm); border-block: var(--border-hairline) solid var(--color-border-muted); }
...
[data-rcl-setup-task] [data-rcl-setup-task-meta] dd { margin: var(--space-2xs) 0 0; color: var(--color-foreground-strong); font: var(--text-body-sm); overflow-wrap: anywhere; }
[data-rcl-setup-task] [data-rcl-setup-task-guidance] { display: grid; gap: var(--space-xs); padding: var(--space-sm) var(--space-md); border-inline-start: 3px solid var(--color-primary); border-radius: var(--radius-sm); background: var(--color-surface-muted); color: var(--color-foreground); font: var(--text-body-sm); }
    ...
    <article data-rcl-setup-task data-testid={testId} aria-label={title}>
      ...
      {target || account ? (
        <dl data-rcl-setup-task-meta>
          ...
          {account ? <div><dt>Account</dt><dd>{account}</dd></div> : null}
        </dl>
      ) : null}
