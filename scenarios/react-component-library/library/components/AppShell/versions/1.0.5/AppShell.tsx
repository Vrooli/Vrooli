  ...
  return (
    ...
    >
      <a data-testid="navigation.app-shell" href="/" aria-current="page">
        {useStrings("navigation.app-shell.workspace", "Workspace")}
      </a>
      <a data-testid="navigation.app-shell" href="/settings">
        {useStrings("navigation.app-shell.settings", "Settings")}
      </a>
    </nav>
  );
}
...
export const AppShell = withClassName(function AppShell({
  ...
  header,
  children,
  title = useStrings("navigation.app-shell.application-workspace", "Application workspace"),
