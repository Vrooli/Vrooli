...
[data-rcl-select-listbox] { box-sizing: border-box; display: grid; gap: var(--space-3xs); inline-size: var(--rcl-select-popover-width, 13rem); min-inline-size: var(--rcl-select-popover-width, 13rem); max-inline-size: calc(100vw - (var(--space-lg) * 2)); padding: var(--space-2xs); }
