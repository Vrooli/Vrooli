...
/** @vrooliComponentSource react-component-library:ValidationSummary
 * @vrooliComponentSourceSlot forms.validation-summary */
...
>({
  ...
  title =
    title ?? libraryStrings("forms.validation-summary.review-these-fields", "Review these fields");
