...
import { AspectRatio } from "@vrooli/react-component-library/AspectRatio/1.0.1";
    ...
    <div data-testid="data-display-version-row" className={className}>
      ...
      <div {...{ "data-rcl-version-row": "" }} data-selected={selected ? "true" : undefined}>
        ...
        <dl {...{ "data-rcl-version-row-details": "" }}>
          ...
          <div>
            <dt>Released</dt>
            <dd>{releasedAt ? <RelativeTime value={releasedAt} /> : "not released"}</dd>
          </div>
          <div>
            <dt>Source</dt>
              ...
              >
                ...
                {diffSummary ? (
                  <div data-testid={`version-diff-summary-${version}`}>
                    <span>
                      +{diffSummary.additions} additions · −{diffSummary.removals} removals
                    </span>
