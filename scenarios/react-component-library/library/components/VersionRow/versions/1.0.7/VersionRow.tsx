 ...
 * @description Selectable version history row with lifecycle, adoption, test health, and source identity details.
 * @version 1.0.7
 * @tags []
 * @warning Managed by React Component Library. Preserve this header when editing adopted copies.
 */
/** @vrooliComponentSource react-component-library:VersionRow
 * @vrooliComponentSourceSlot data-display.version-row */
