...
function Detail({
  ...
  return (
    <ResourceDetail
      title={resolveStrings("patterns.resource-detail.title", "Release brief")}
  ...
  return (
    <section style={frame}>
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {resolveStrings("patterns.resource-detail.resource-detail", "Resource detail")}
        </span>
...
export function Default() {
  return (
    <Showcase
      title={resolveStrings("patterns.resource-detail.title.the-record-stays-the-product-surface", "The record stays the product surface")}
...
export function Refreshing() {
  return (
    <Showcase
      title={resolveStrings("patterns.resource-detail.title.refresh-without-losing-context", "Refresh without losing context")}
...
export function Partial() {
  return (
    <Showcase
      title={resolveStrings("patterns.resource-detail.title.partial-data-is-named", "Partial data is named")}
...
export function Empty() {
  return (
    <Showcase
      title={resolveStrings("patterns.resource-detail.title.empty-is-a-real-state", "Empty is a real state")}
...
export function RequestError() {
  return (
    <Showcase
      title={resolveStrings("patterns.resource-detail.title.recovery-stays-local", "Recovery stays local")}
...
export function PermissionDenied() {
  return (
    <Showcase
      title={resolveStrings("patterns.resource-detail.title.permission-is-explained", "Permission is explained")}
