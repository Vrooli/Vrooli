...
[data-rcl-target-switcher-summary] { display: grid; min-inline-size: 0; gap: .35rem; border-block-end: 1px solid var(--color-border); padding: .6rem .8rem .65rem; }
...
[data-rcl-target-switcher-summary-description] { display: -webkit-box; overflow: hidden; color: var(--color-muted-foreground); font-size: .72rem; line-height: 1.35; -webkit-box-orient: vertical; -webkit-line-clamp: 2; }
