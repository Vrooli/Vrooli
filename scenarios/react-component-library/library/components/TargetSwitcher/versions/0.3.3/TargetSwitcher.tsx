...
[data-rcl-target-switcher-trigger] { display: inline-flex; min-block-size: var(--tap-target-min); max-inline-size: min(12rem, 100%); min-inline-size: 0; align-items: center; gap: .4rem; border: 1px solid var(--color-border); border-radius: var(--radius-control); background: var(--color-surface); color: var(--color-foreground); padding: .35rem .55rem; font: var(--text-label); cursor: pointer; transition: background-color var(--dur-quick) var(--ease-standard), border-color var(--dur-quick) var(--ease-standard), color var(--dur-quick) var(--ease-standard), box-shadow var(--dur-quick) var(--ease-standard); }
...
[data-rcl-popover-content][data-rcl-target-switcher-content] { inline-size: min(max(var(--rcl-target-switcher-width, 12rem), 20rem), calc(100vw - 1rem)); max-block-size: none; overflow: visible; }
[data-rcl-target-switcher-menu] { display: grid; box-sizing: border-box; inline-size: 100%; padding: 0; }
[data-rcl-target-switcher-summary] { display: grid; min-inline-size: 0; gap: .25rem; border-block-end: 1px solid var(--color-border); padding: .45rem .65rem .5rem; }
[data-rcl-target-switcher-eyebrow] { display: block; color: var(--color-muted-foreground); font-family: var(--font-mono); font-size: .63rem; letter-spacing: .14em; text-transform: uppercase; }
[data-rcl-target-switcher-summary-heading] { display: flex; min-inline-size: 0; align-items: center; justify-content: space-between; gap: .75rem; }
[data-rcl-target-switcher-summary-title] { min-inline-size: 0; overflow: hidden; color: var(--color-foreground-strong); font-size: var(--text-body-sm-size); font-weight: 700; text-overflow: ellipsis; white-space: nowrap; }
[data-rcl-target-switcher-summary-description] { display: -webkit-box; overflow: hidden; color: var(--color-muted-foreground); font-size: .7rem; line-height: 1.3; -webkit-box-orient: vertical; -webkit-line-clamp: 1; }
[data-rcl-target-switcher-status] { display: inline-flex; flex: 0 0 auto; align-items: center; gap: .3rem; color: var(--color-muted-foreground); font-size: .7rem; }
[data-rcl-target-switcher-status-value] { color: var(--color-foreground); font-weight: 650; }
[data-rcl-target-switcher-options] { display: grid; }
[data-rcl-target-switcher-options][data-scrollable="true"] { max-block-size: min(70vh, 32rem); overflow-y: auto; scrollbar-gutter: stable; }
[data-rcl-target-switcher-option] { display: flex; width: 100%; min-block-size: var(--tap-target-min); align-items: center; gap: .45rem; border: 0; border-radius: 0; background: transparent; color: var(--color-foreground); padding: .35rem .65rem; text-align: start; cursor: pointer; }
...
@media (max-width: 38rem) { [data-rcl-target-switcher-trigger] { max-inline-size: 9rem; } [data-rcl-popover-content][data-rcl-target-switcher-content] { inline-size: min(max(var(--rcl-target-switcher-width, 9rem), 16rem), calc(100vw - 1rem)); } }
`;
        ...
        >
          <div data-rcl-target-switcher-menu>
            <div data-rcl-target-switcher-summary>
              ...
              <div data-rcl-target-switcher-summary-heading>
                <span data-rcl-target-switcher-summary-title>{selected.label}</span>
                {(statusValue ?? selected.status) && (
                  <span data-rcl-target-switcher-status>
                    <span
                      data-rcl-target-switcher-dot
                    ...
                    <span>
                      {statusLabel}:{" "}
                      <span data-rcl-target-switcher-status-value>
                        {statusValue ?? selected.status}
                      </span>
                    </span>
                  </span>
              ...
              {(description ?? selected.description) && (
                <span data-rcl-target-switcher-summary-description>
                  {description ?? selected.description}
                </span>
              )}
            </div>
            <div
              ...
              data-scrollable={options.length > 16 ? "true" : "false"}
              role="listbox"
              aria-label={label}
              tabIndex={0}
