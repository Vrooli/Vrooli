...
[data-rcl-target-switcher-option-description] { display: -webkit-box; overflow: hidden; color: var(--color-muted-foreground); font-size: .68rem; line-height: 1.3; -webkit-box-orient: vertical; -webkit-line-clamp: 2; }
...
export function TargetSwitcher({
  ...
  useEffect(() => {
    ...
    const index = options[selectedIndex]?.disabled
      ? Math.max(
          0,
              ...
              {options.map((option, index) => (
                ...
                >
                  ...
                  <span data-rcl-target-switcher-option-body>
                    ...
                    {option.description && (
                      <span data-rcl-target-switcher-option-description>{option.description}</span>
                    )}
                  </span>
