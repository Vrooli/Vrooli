...
[data-rcl-target-switcher-trigger] { display: inline-flex; min-block-size: var(--tap-target-min); max-inline-size: min(14rem, 100%); min-inline-size: 0; align-items: center; gap: .5rem; border: 1px solid var(--color-border); border-radius: var(--radius-control); background: var(--color-surface); color: var(--color-foreground); padding: .45rem .65rem; font: var(--text-label); cursor: pointer; transition: background-color var(--dur-quick) var(--ease-standard), border-color var(--dur-quick) var(--ease-standard), color var(--dur-quick) var(--ease-standard), box-shadow var(--dur-quick) var(--ease-standard); }
...
[data-rcl-target-switcher-menu] { display: grid; box-sizing: border-box; inline-size: min(20rem, calc(100vw - 1rem)); padding: 0; }
...
[data-rcl-target-switcher-options] { display: grid; max-block-size: min(60vh, 22rem); overflow-y: auto; }
[data-rcl-target-switcher-option] { display: flex; width: 100%; min-block-size: var(--tap-target-min); align-items: center; gap: .6rem; border: 0; border-radius: 0; background: transparent; color: var(--color-foreground); padding: .6rem .8rem; text-align: start; cursor: pointer; }
...
[data-rcl-target-switcher-option-badge] { max-inline-size: 8rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; border: 1px solid var(--color-border-strong); border-radius: var(--radius-sm); color: var(--color-muted-foreground); padding: .1rem .4rem; font: var(--text-caption); }
...
@media (max-width: 38rem) { [data-rcl-target-switcher-trigger] { max-inline-size: 8rem; } [data-rcl-target-switcher-menu] { inline-size: min(20rem, calc(100vw - 1rem)); } }
`;
