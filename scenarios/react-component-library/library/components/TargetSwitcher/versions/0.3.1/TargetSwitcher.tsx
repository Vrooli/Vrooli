...
[data-rcl-popover-content][data-rcl-target-switcher-content] { inline-size: min(max(var(--rcl-target-switcher-width, 12rem), 15rem), calc(100vw - 1rem)); max-block-size: none; overflow: visible; }
...
@media (max-width: 38rem) { [data-rcl-target-switcher-trigger] { max-inline-size: 9rem; } [data-rcl-popover-content][data-rcl-target-switcher-content] { inline-size: min(max(var(--rcl-target-switcher-width, 9rem), 15rem), calc(100vw - 1rem)); } }
`;
        ...
        >
          <div data-rcl-target-switcher-menu>
            ...
            <div
              ...
              data-scrollable={options.length > 12 ? "true" : "false"}
              role="listbox"
              aria-label={label}
