...
export const CardHeader = withClassName(function CardHeader({ children, className, ...props }: CardHeaderProps) {
  return (
...
export const CardTitle = withClassName(function CardTitle({ children, className, ...props }: CardTitleProps) {
  return (
...
export const CardDescription = withClassName(function CardDescription({ children, className, ...props }: CardDescriptionProps) {
  return (
...
export const CardContent = withClassName(function CardContent({ children, className, ...props }: CardContentProps) {
  return (
