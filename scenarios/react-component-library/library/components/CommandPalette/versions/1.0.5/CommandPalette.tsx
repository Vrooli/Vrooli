...
export const CommandPalette = withClassName(function CommandPalette({
  ...
  onRetry,
  onExecuted,
  title = useStrings("overlays.command-palette.command-palette", "Command palette"),
  ...
  placeholder = useStrings("overlays.command-palette.search-commands", "Search commands…"),
  className,
  style,
}: CommandPaletteProps) {
