...
.rcl-full-page-drawer__panel h2 { margin: 0; font: var(--text-title); } .rcl-full-page-drawer__panel :is(button, input, select, textarea, [role="button"]) { min-inline-size: var(--tap-target-min); min-block-size: var(--tap-target-min); }
