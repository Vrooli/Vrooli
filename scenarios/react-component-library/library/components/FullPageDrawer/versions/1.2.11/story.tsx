...
export function LongBody() {
  return (
    <FullPageDrawer open dismissAffordance="grabber" title="Workspace" closeLabel="Close drawer">
...
export function DirectedInitialFocus() {
  ...
  return (
    ...
    >
      <input ref={target} aria-label="Draft value" defaultValue="Preserved value" />
    </FullPageDrawer>
  );
}
...
export function ComfortableContent() {
  return (
    <FullPageDrawer open contentPadding="comfortable" title="Share" closeLabel="Close sheet">
      <p>{paragraph}</p>
    </FullPageDrawer>
  );
}
