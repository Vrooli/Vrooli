...
/* The sheet owns the strip beneath it. An installed iOS 26 app paints nothing
   ...
   the sheet's surface and reads as the sheet continuing to the edge. */
@media not all and (min-width: 48rem) {
  html:has([data-rcl-full-page-drawer][data-state="open"]) { background-color: var(--color-surface-raised); }
}
