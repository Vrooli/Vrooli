...
/** @vrooliComponentSource react-component-library:Toast
 * @vrooliComponentSourceSlot feedback.toast */
...
export const Toast = withClassName(function Toast({ className, label, style }: ToastProps) {
  ...
  return (
    <>
      <StyleSheet libraryId="react-component-library:Toast" version="1.0.14" css={styles} />
      <div
        className={className}
        style={style}
