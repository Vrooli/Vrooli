...
export const MasterDetail = withClassName(function MasterDetail<T>({
  ...
  label = useStrings("navigation.master-detail.master-detail-workspace", "Master detail workspace"),
  ...
  const masterState =
    status === "loading" ? (
      ...
      <div
        ...
        role="list"
        aria-label={useStrings("navigation.master-detail.records", "Records")}
      >
        ...
        <div data-rcl-master-detail-detail-header>
          ...
          {compact && selected ? (
            <button
              ...
              onClick={back}
            >
              {useStrings("navigation.master-detail.back-to-list", "Back to list")}
            </button>
          ) : null}
        </div>
        {status === "partial" && (
  ...
  const collectionPanel = (
    <section
      data-rcl-master-detail-panel
      aria-label={useStrings("navigation.master-detail.record-collection", "Record collection")}
    >
      {masterState}
    </section>
  );
    ...
    <section data-rcl-master-detail className={className} style={style} aria-label={label}>
      ...
      <header data-rcl-master-detail-header>
        <span data-rcl-master-detail-kicker>
          {useStrings("navigation.master-detail.collection-workspace", "Collection workspace")}
        </span>
