 ...
 * @description The responsive collection workspace with explicit region composition and mobile navigation.
 * @version 1.7.1
 * @tags ["template","collection","workspace"]
...
[data-rcl-collection-workspace] { display: grid; gap: var(--space-md); min-inline-size: 0; align-items: start; }
[data-rcl-collection-primary], [data-rcl-collection-inspector] { display: grid; gap: var(--space-sm); min-inline-size: 0; }
...
function StateView({ state, children }: { state: State; children: ReactNode }) {
  ...
  if (state === "fatal-error")
    return (
      <div role="alert" style={{ ...panel, borderColor: "var(--color-danger)" }}>
...
export const CollectionPage = withClassName(function CollectionPage({
  ...
  return (
    <StateView state={state}>
      <StyleSheet
        libraryId="react-component-library:CollectionPage" version="1.7.1"
