...
import { MorphingIcon } from "@vrooli/react-component-library/MorphingIcon/3.1.0";
import type { IconMorphMode } from "@vrooli/react-component-library/useIconMorph/1.1.0";
    ...
    return (
      ...
      >
        <span data-rcl-icon-button-glyph="" style={{ inlineSize: GLYPH_SIZE[size], blockSize: GLYPH_SIZE[size] }}>
          <MorphingIcon morph={morph} iconKey={iconKey} swapIdentity={swapIdentity} size={MORPH_SIZE[size]}>
            {children}
          </MorphingIcon>
        </span>
        {pending ? (
