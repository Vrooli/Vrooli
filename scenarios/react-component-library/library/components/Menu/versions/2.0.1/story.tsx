...
export function Default() {
  return (
    <main data-rcl-story-background>
      <Menu defaultOpen>
        <MenuParts.Trigger aria-label="Open workspace actions">Workspace actions</MenuParts.Trigger>
        <MenuParts.Content aria-label="Workspace actions">
          ...
          <MenuParts.Separator />
          <MenuParts.CheckboxItem checked>Keep sidebar open</MenuParts.CheckboxItem>
        </MenuParts.Content>
      </Menu>
    </main>
  );
