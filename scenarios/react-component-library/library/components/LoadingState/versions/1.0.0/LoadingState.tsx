/** @vrooliComponentSource materialized.loadingstate */
...
export function LoadingState({ label = "Loading…" }: { label?: string }) { return <div role="status" aria-live="polite" style={{ ...panel, minHeight: 120, display: "grid", placeItems: "center", ...muted }}>{label}</div>; }
