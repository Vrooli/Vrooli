...
function Harness({ swipe = false }: HarnessProps) {
  ...
  if (!overlay.present) {
    return <output data-testid="runtime.use-overlay-surface.dismissed">dismissed</output>;
  }
  return (
    <div data-testid="runtime.use-overlay-surface">
      ...
      />
      <section {...overlay.surfaceProps} role="dialog" aria-modal="true" aria-label="Surface">
        {swipe ? (
          <button
