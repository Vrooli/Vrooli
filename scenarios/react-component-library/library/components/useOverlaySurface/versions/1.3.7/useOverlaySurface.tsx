...
import { useSwipe, type SwipeDirection } from "@vrooli/react-component-library/useSwipe/2.0.3";
import { useViewportEnvironmentStyle } from "@vrooli/react-component-library/useViewportEnvironment/1.0.2";
...
export function useOverlaySurface({
  ...
  const cancelSwipeRef = useRef(swipe.cancel);
    ...
    grabberProps: swipeEnabled
      ? {
          ...
          onPointerMove: (event: ReactPointerEvent) => {
            ...
            const pixels = travelled(resolvedDirection, dragOrigin.current, event);
