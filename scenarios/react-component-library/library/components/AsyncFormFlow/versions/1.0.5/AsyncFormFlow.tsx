...
>({
  ...
  destination,
  offline = false,
  title = useStrings("patterns.async-form-flow.create-or-edit", "Create or edit"),
  description = useStrings(
        ...
        <header data-rcl-async-form-header>
          <div>
            <div data-rcl-async-form-kicker>
              {useStrings("patterns.async-form-flow.async-workflow", "ASYNC WORKFLOW")}
            </div>
            ...
            {showEmpty ? (
              <div data-rcl-async-form-empty>
                <strong data-rcl-async-form-empty-title>
                  {useStrings("patterns.async-form-flow.no-saved-draft-yet", "No saved draft yet")}
                </strong>
                ...
                >
                  {useStrings("patterns.async-form-flow.start-fresh", "Start fresh")}
                </button>
              </div>
            ) : (
              <Form store={store} title={undefined} description={undefined} onSubmit={submit}>
                ...
                {phase === "success" && (
                  <div data-rcl-async-form-submit-status data-phase="success" role="status">
                    ...
                    <span data-rcl-async-form-submit-copy>
                      <strong data-rcl-async-form-submit-title>
                        {useStrings("patterns.async-form-flow.all-set", "All set")}
                      </strong>
                      ...
                      {onNavigate && (
                        ...
                        >
                          {useStrings("patterns.async-form-flow.continue", "Continue")}
                        </button>
                      )}
                    </span>
                  </div>
                ...
                <FormActions store={store} submitLabel={submitLabel} pendingLabel="Saving…">
                  <button
                    ...
                    disabled={!submitting}
                  >
                    {useStrings("patterns.async-form-flow.cancel-request", "Cancel request")}
                  </button>
                  <button
                    data-testid="patterns.async-form-flow"
                    type="reset"
                    ...
                    disabled={submitting}
                  >
                    {useStrings("patterns.async-form-flow.reset", "Reset")}
                  </button>
                  <button
                    data-testid="patterns.async-form-flow"
                    type="submit"
