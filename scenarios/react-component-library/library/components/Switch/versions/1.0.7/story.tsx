...
export function Bare() {
  const libraryStrings = useStrings();
  const label = libraryStrings("controls.switch.label.adaptive-chrome", "Adaptive chrome");
  return (
    <Showcase>
      <div
        style={{
      ...
      >
        <span id="host-owned-switch-label" style={{ font: "var(--text-body)", fontWeight: 650 }}>
          {label}
        </span>
...
export function TrailingLabel() {
  ...
  return (
    <Showcase>
      <Switch
        labelPlacement="end"
        label={libraryStrings("controls.switch.label.adaptive-chrome", "Adaptive chrome")}
        description={libraryStrings(
