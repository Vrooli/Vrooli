  ...
  return (
    ...
    >
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {libraryStrings("controls.switch.immediate-setting", "Immediate setting")}
        </span>
        <strong style={{ font: "var(--text-title)" }}>
          {libraryStrings("controls.switch.notification-preferences", "Notification preferences")}
        </strong>
        <span
          style={{
...
export function Enabled() {
  ...
  return (
    <Showcase>
      <Switch
        label={libraryStrings("controls.switch.label.automatic-updates", "Automatic updates")}
        description={libraryStrings(
