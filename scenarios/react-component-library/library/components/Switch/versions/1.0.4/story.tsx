  ...
  return (
    ...
    >
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {useStrings("controls.switch.immediate-setting", "Immediate setting")}
        </span>
        <strong style={{ font: "var(--text-title)" }}>
          {useStrings("controls.switch.notification-preferences", "Notification preferences")}
        </strong>
        <span
          style={{
...
export function Default() {
  return (
    <Showcase>
      <Switch
        label={useStrings("controls.switch.label", "Quiet hours")}
...
export function Enabled() {
  return (
    <Showcase>
      <Switch
        label={useStrings("controls.switch.label.automatic-updates", "Automatic updates")}
        description={useStrings(
