...
import { useOverlaySurface } from "@vrooli/react-component-library/useOverlaySurface/1.3.4";
...
export function ResponsiveDialog({
  ...
  useLibraryStyleSheet("responsive-dialog-1.1.5", responsiveDialogStyles);
