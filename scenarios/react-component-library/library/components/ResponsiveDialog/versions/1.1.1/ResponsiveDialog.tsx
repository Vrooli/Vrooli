...
import { useOverlaySurface } from "@vrooli/react-component-library/useOverlaySurface/1.3.2";
...
export function ResponsiveDialog({
  ...
  useLibraryStyleSheet("responsive-dialog-1.1.0", responsiveDialogStyles);
