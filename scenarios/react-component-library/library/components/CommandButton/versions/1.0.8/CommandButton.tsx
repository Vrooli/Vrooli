 ...
 * @description The async-aware action progressing through idle, pending, progress, success, failure, retry, and cancellation without the consumer writing any glue, while holding stable dimensions throughout.
 * @version 1.0.8
 * @tags []
 * @warning Managed by React Component Library. Preserve this header when editing adopted copies.
 */
/** @vrooliComponentSource react-component-library:CommandButton
 * @vrooliComponentSourceSlot controls.command-button */
import { StyleSheet } from "@vrooli/react-component-library/StyleSheet/1";
import { forwardRef, type CSSProperties, type ReactNode } from "react";
import { Button, type ButtonProps } from "@vrooli/react-component-library/Button/2";
import { useAsyncAction, type AsyncAction } from "@vrooli/react-component-library/useAsyncAction/1";
  ...
  function CommandButton(
    ...
    return (
      <>
        ...
        <span
          className="rcl-visually-hidden"
          data-rcl-command-button-status
          role="status"
          aria-live="polite"
          aria-atomic="true"
        >
