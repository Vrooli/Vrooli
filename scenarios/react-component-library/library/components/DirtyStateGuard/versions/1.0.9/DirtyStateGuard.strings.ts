...
export const DirtyStateGuardStrings = defineStrings("react-component-library:DirtyStateGuard", {
  ...
  "forms.dirty-state-guard.you-have-unsaved-changes": "You have unsaved changes",
});
