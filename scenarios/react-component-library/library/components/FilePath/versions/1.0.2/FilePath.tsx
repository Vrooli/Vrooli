...
[data-rcl-file-path] > div { flex: 1 1 auto; min-inline-size: 0; max-inline-size: 100%; }
[data-rcl-file-path] > div > [data-rcl-popover] { inline-size: 100%; min-inline-size: 0; max-inline-size: 100%; }
[data-rcl-file-path-trigger] { display: inline-flex; inline-size: 100%; min-inline-size: 0; max-inline-size: 100%; flex: 1 1 auto; align-items: center; gap: var(--space-2xs); overflow: hidden; border: 0; background: transparent; color: inherit; cursor: pointer; font: var(--text-caption); text-align: start; }
