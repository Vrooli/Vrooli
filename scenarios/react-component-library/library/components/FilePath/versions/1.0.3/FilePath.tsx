...
[data-rcl-file-path-trigger] > svg { flex: 0 0 auto; inline-size: var(--icon-size-md); block-size: var(--icon-size-md); }
[data-rcl-file-path-trigger] > span { flex: 1 1 auto; min-inline-size: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
