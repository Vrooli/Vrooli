 ...
 * @description A six-point series beside a figure; authored series are stamped illustrative and drawn dashed with hollow points.
 * @version 0.1.1
 * @tags []
 * @warning Managed by React Component Library. Preserve this header when editing adopted copies.
 */
/** @vrooliComponentSource react-component-library:SampleSeries */
...
const styles = `
  ...
  [data-rcl-sample-series="illustrative"] { color: color-mix(in srgb, var(--color-foreground, #e8ecf3) 55%, var(--provenance-sample, #b7a6ff)); }
`;
...
export const SampleSeries = withClassName(function SampleSeries({
  series,
  illustrative,
  className,
}: SampleSeriesProps) {
    ...
    <>
      ...
      >
        <path
          ...
          stroke="currentColor"
          strokeWidth="1.4"
          strokeDasharray={illustrative ? "3 4" : undefined}
          strokeLinecap="round"
        />
        {points.map(([x, y], i) => (
          <circle
            ...
            cy={y}
            r="2"
            fill={illustrative ? "none" : "currentColor"}
            stroke="currentColor"
            strokeWidth="1"
          />
        ))}
