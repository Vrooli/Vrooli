...
/** @vrooliComponentSource react-component-library:Message
 * @vrooliComponentSourceSlot ai.message */
...
export interface MessageProps {
  /** Transcript rows share their surrounding surface; standalone cards retain a frame. */
