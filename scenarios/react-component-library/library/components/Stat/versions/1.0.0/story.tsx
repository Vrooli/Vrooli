...
export function Default() {
  return (
    <Showcase
      title="Metrics with a point of view"
...
export function Negative() {
  return (
    <Showcase
      title="A downturn should be legible, not alarming"
