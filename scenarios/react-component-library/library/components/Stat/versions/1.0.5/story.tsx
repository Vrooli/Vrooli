  ...
  return (
    ...
    >
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {libraryStrings("data-display.stat.signal-at-a-glance", "Signal at a glance")}
        </span>
...
export function Default() {
  ...
  return (
    <Showcase
      title={libraryStrings("data-display.stat.title", "Metrics with a point of view")}
    ...
    >
      ...
      >
        <Stat
          label={libraryStrings("data-display.stat.label", "Active workspaces")}
          value="42"
          trend="+12.4%"
          trendTone="positive"
        ...
        />
        <Stat
          label={libraryStrings("data-display.stat.label.tasks-completed", "Tasks completed")}
          value="186"
          trend="+8.1%"
          trendTone="positive"
          caption="this week"
...
export function Negative() {
  ...
  return (
    ...
    >
      <Stat
        label={libraryStrings("data-display.stat.label.support-response", "Support response")}
        value="2h 14m"
        trend="-4.8%"
        trendTone="negative"
...
export function Loading() {
  ...
  return (
    ...
    >
      <Stat
        label={libraryStrings("data-display.stat.label.pipeline-value", "Pipeline value")}
        value="$—"
        loading
      />
    </Showcase>
