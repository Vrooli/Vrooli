...
export const DataTable = withClassName(function DataTable<Row>({
  ...
  useLibraryStyleSheet("data-table", styles);
      ...
      <div data-rcl-data-table-summary aria-live="polite">
        ...
        {!hideDensityControl ? (
          <div
            ...
            aria-label={libraryStrings("data-display.data-table.row-density", "Row density")}
          >
            <button
              data-testid="data-display.data-table"
              type="button"
    ...
    >
      {status === "permission-denied" ? (
        <div data-rcl-data-table-permission role="status">
          <strong>
            {libraryStrings("data-display.data-table.access-is-limited", "Access is limited")}
          </strong>
          ...
          {pageSize && totalPages > 1 ? (
            <div data-rcl-data-table-page>
              ...
              <div data-rcl-data-table-page-controls>
                ...
                >
                  {libraryStrings("data-display.data-table.previous", "Previous")}
                </button>
