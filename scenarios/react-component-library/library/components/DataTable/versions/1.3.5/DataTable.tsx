...
export const DataTable = withClassName(function DataTable<Row>({
        ...
        <div data-rcl-data-table-query-row>
          ...
          {filters.length > 0 ? (
            ...
            >
              ...
              >
                {useStrings("data-display.data-table.all", "All")}
              </button>
              {filters.map((filter) => (
                <button
                  data-testid="data-display.data-table"
      ...
      <div data-rcl-data-table-summary aria-live="polite">
        ...
        {!hideDensityControl ? (
          <div
            ...
            aria-label={useStrings("data-display.data-table.row-density", "Row density")}
          >
            <button
              data-testid="data-display.data-table"
              type="button"
            ...
            >
              {useStrings("data-display.data-table.roomy", "Roomy")}
            </button>
            <button
              data-testid="data-display.data-table"
              type="button"
            ...
            >
              {useStrings("data-display.data-table.dense", "Dense")}
            </button>
          </div>
        ) : null}
      </div>
  ...
  const tableContent = (
    <div
      ...
      role="region"
      aria-label={useStrings("data-display.data-table.data-table-content", "Data table content")}
    >
      {status === "permission-denied" ? (
        <div data-rcl-data-table-permission role="status">
          <strong>
            {useStrings("data-display.data-table.access-is-limited", "Access is limited")}
          </strong>
          ...
          {pageSize && totalPages > 1 ? (
            <div data-rcl-data-table-page>
              ...
              <div data-rcl-data-table-page-controls>
                ...
                >
                  {useStrings("data-display.data-table.previous", "Previous")}
                </button>
                ...
                <button
                  ...
                  onClick={() => changePage(currentPage + 1)}
                >
                  {useStrings("data-display.data-table.next", "Next")}
                </button>
              </div>
            </div>
          ) : null}
