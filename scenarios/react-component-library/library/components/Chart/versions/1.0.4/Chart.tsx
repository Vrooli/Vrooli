 ...
 * @displayName Chart
 * @description A responsive, accessible chart surface with pluggable presentation, resilient data states, and keyboard-readable values.
 * @version 1.0.4
...
export const Chart = withClassName(function Chart({
  ...
  return (
    <div data-rcl-chart className={className} style={style}>
      <StyleSheet name="chart-1-0-4-1" css={styles} />
      <AsyncBoundary
