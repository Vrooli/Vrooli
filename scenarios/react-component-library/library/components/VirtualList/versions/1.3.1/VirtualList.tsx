...
/** @vrooliComponentSource react-component-library:VirtualList
 * @vrooliComponentSourceSlot data-display.virtual-list */
...
export interface VirtualListHandle {
  /** Reveal a stable key using measured row offsets; returns false for missing keys. */
  ...
  useImperativeHandle(
    ...
    () => ({
      scrollToKey(key) {
        ...
        if (!viewport || index === undefined) return false;
        ...
        const next =
          top < viewport.scrollTop
            ...
            : bottom > viewport.scrollTop + viewport.clientHeight
              ? Math.max(top, bottom - viewport.clientHeight)
              : viewport.scrollTop;
