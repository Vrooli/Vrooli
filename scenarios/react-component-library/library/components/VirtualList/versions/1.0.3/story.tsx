...
function Rows({ dense = false }: { dense?: boolean }) {
  return (
    <VirtualList
      ...
      label={useStrings("data-display.virtual-list.label", "Activity history")}
  ...
  return (
    <div style={shell}>
      <VirtualList
        items={[]}
        renderItem={() => null}
        title={useStrings("data-display.virtual-list.title", "Recent activity")}
  ...
  return (
    <div style={shell}>
      <VirtualList
        ...
        stickyIndices={[0]}
        title={useStrings("data-display.virtual-list.title.restored-timeline", "Restored timeline")}
        description={useStrings(
        ...
        label={useStrings("data-display.virtual-list.label.restored-activity", "Restored activity")}
        getItemKey={(item) => item.id}
        renderItem={(item, index) => (
          <div style={rowStyle}>
