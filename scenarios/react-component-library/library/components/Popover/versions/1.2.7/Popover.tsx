...
const styles = `
[data-rcl-popover-content] { --rcl-popover-top: 0px; --rcl-popover-left: 0px; --rcl-popover-arrow-left: 50%; position: fixed; inset-block-start: var(--rcl-popover-top); inset-inline-start: var(--rcl-popover-left); z-index: var(--layer-popover); inline-size: min(calc(100vw - (var(--space-lg) * 2)), 24rem); max-block-size: min(32rem, calc(100vh - (var(--space-lg) * 2))); overflow: auto; overscroll-behavior: contain; transform-origin: var(--rcl-popover-arrow-left) top; background: linear-gradient(var(--color-surface-raised), var(--color-surface-raised)), var(--color-background); border: 1px solid var(--color-border); border-radius: var(--radius-panel); box-shadow: var(--elev-floating); color: var(--color-foreground); pointer-events: auto; }
