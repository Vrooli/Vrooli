...
export const AlertDialogStrings = defineStrings("react-component-library:AlertDialog", {
  ...
  "overlays.alert-dialog.no-partial-publish-was-created": "No partial publish was created.",
