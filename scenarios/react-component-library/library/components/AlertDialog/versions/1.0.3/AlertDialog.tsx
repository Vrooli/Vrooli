 ...
 * @description A focused confirmation surface for consequential decisions with explicit destructive recovery and resilient focus behavior.
 * @version 1.0.3
...
export const AlertDialog = withClassName(function AlertDialog({
  ...
  useEffect(() => {
    ...
    dialogRef.current?.querySelector<HTMLElement>("[data-rcl-alert-dialog-cancel]")?.focus();
  ...
  return (
    <div data-rcl-alert-dialog-layer style={style} aria-label={closeLabel}>
      <StyleSheet name="alertdialog-1-0-3-1" css={styles} />
      <div
        ref={dialogRef}
      ...
      >
        ...
        <div data-rcl-alert-dialog-actions>
          <button
            data-testid="overlays.alert-dialog"
            type="button"
