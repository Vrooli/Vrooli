...
import type { DataTableColumn, DataTableFilter } from "@vrooli/react-component-library/DataTable/1";
...
function Example({
  ...
  return (
    <div style={frame}>
      <ResourceCollection
        title={libraryStrings("patterns.resource-collection.title", "Resources")}
