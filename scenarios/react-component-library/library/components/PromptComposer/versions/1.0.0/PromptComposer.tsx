...
[data-rcl-composer-surface] { display: grid; min-inline-size: 0; border: var(--border-hairline) solid var(--color-border); border-radius: var(--radius-surface); background: var(--color-surface-raised); box-shadow: var(--shadow-sm); transition: border-color var(--dur-quick) var(--ease-standard), box-shadow var(--dur-quick) var(--ease-standard); }
...
[data-rcl-composer-surface] textarea[data-rcl-textarea] { border: 0; border-radius: var(--radius-surface); background: transparent; padding: var(--space-sm); min-block-size: 5rem; max-block-size: 15rem; resize: none; box-shadow: none; outline-offset: calc(var(--space-3xs) * -1); line-height: var(--text-body-line); }
