...
.rcl-bottom-sheet__header h2 { margin: 0; font: var(--text-title); } .rcl-bottom-sheet__header button { min-inline-size: var(--tap-target-min); min-block-size: var(--tap-target-min); }
