 ...
 * @description The mobile-first drawer with snap points, drag handle, keyboard avoidance, scroll handoff between sheet and content, velocity-aware settling, and accessible non-gesture controls.
 * @version 1.3.3
 * @tags []
...
/* The sheet owns the strip beneath it. An installed iOS 26 app paints nothing
   ...
   it, so both are coloured: <html> alone is hidden by any opaque body (1.3.1). */
@media not all and (min-width: 48rem) {
  html:has([data-rcl-bottom-sheet][data-state="open"]),
  html:has([data-rcl-bottom-sheet][data-state="open"]) body { background-color: var(--color-surface-raised); }
}
...
export function BottomSheet({
  ...
  useLibraryStyleSheet("react-component-library:BottomSheet", "1.3.3", bottomSheetStyles);
