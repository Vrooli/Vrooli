    ...
    <Card style={{ inlineSize: "100%", maxInlineSize: "35rem", minInlineSize: 0 }}>
      <Stack gap="lg" inset="xl">
        <Stack gap="2xs">
          ...
          <Heading level={2} textStyle="title" balance style={{ minInlineSize: 0 }}>
            {title}
          </Heading>
          <Text tone="muted" balance style={{ minInlineSize: 0, overflowWrap: "anywhere" }}>
            {detail}
          </Text>
        </Stack>
        {children}
...
export function IdentityDetails({ args }: StoryHarnessProps<AvatarStoryArgs>) {
  ...
  return (
    <Showcase
      title="Details without a nested-control trap"
