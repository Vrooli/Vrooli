  ...
  return (
    ...
    >
      ...
      >
        City
        <input
          aria-label={useStrings("forms.object-field.aria-label", "City")}
      ...
      >
        Country
        <input
          aria-label={useStrings("forms.object-field.aria-label.country", "Country")}
...
export function Default() {
  ...
  return (
    <Showcase
      ...
      title={useStrings("forms.object-field.title", "Group related details without losing focus")}
      detail="The group carries its own hierarchy and disclosure while child controls remain ordinary, addressable inputs."
    >
      <ObjectField
        store={store}
        field="address"
        title={useStrings("forms.object-field.title.mailing-address", "Mailing address")}
