  ...
  return (
    ...
    >
      ...
      >
        Country
        <input
          aria-label={resolveStrings("forms.object-field.aria-label.country", "Country")}
...
export function Default() {
  ...
  return (
    <Showcase
      ...
      title={resolveStrings("forms.object-field.title", "Group related details without losing focus")}
      detail="The group carries its own hierarchy and disclosure while child controls remain ordinary, addressable inputs."
    >
      <ObjectField
        store={store}
        field="address"
        title={resolveStrings("forms.object-field.title.mailing-address", "Mailing address")}
...
export function Validation() {
  ...
  return (
    <Showcase
      ...
      title={resolveStrings("forms.object-field.title.errors-stay-with-the-group", "Errors stay with the group")}
