...
export function Default() {
  return <ContextMenu open title="Actions" closeLabel="Close actions" items={basicItems} />;
}
  ...
  return (
    <ContextMenu
      ...
      items={[
        ...
        { id: "select-all", label: "Select all", separatorBefore: true, onSelect() {} },
      ]}
    />
  );
}
...
export function WithCheckableItem() {
  return (
    <ContextMenu
      ...
      closeLabel="Close actions"
      items={[
        { id: "mouse-mode", label: "Mouse reporting", pressed: true, onSelect() {} },
        { id: "rename", label: "Rename", onSelect() {} },
      ]}
    />
  );
