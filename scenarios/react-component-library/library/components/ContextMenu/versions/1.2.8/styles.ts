...
@media (min-width: 48rem) {
  .rcl-context-menu__surface { position: absolute; inset: auto; inline-size: auto; min-inline-size: 14rem; max-inline-size: 24rem; max-block-size: calc(100% - (var(--space-lg) * 2)); padding-block-end: var(--space-2xs); border-block-end: var(--border-hairline) solid var(--color-border); border-radius: var(--radius-panel); box-shadow: var(--elev-overlay); transform: translateX(var(--overlay-menu-align, 0)); animation-name: rcl-context-menu-enter-menu; }
