...
const styles = `
  ...
  [data-rcl-freshness] > span { display: block; height: 100%; background: var(--color-primary, #33d6ff); box-shadow: 0 0 8px var(--glow-primary, rgba(51,214,255,.5)); transform-origin: left; transition: transform 1s linear; }
