...
/**
 * 1.0.1 — `value` is the text to copy, not the native button's form value.
 *
 * 1.0.0 extended IconButton's props without dropping the inherited `value`
 * (`string | number | readonly string[]`), so widening it to accept a function
 * failed the type check of every build that compiled this release.
 */
export interface CopyIconButtonProps
  extends Omit<IconButtonProps, "children" | "aria-label" | "selected" | "iconKey" | "value"> {
