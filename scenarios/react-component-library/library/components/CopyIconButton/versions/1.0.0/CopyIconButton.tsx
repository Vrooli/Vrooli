...
import { forwardRef, useEffect, useRef, useState, type MouseEvent as ReactMouseEvent } from "react";
...
export const CopyIconButton = forwardRef<HTMLButtonElement, CopyIconButtonProps>(
