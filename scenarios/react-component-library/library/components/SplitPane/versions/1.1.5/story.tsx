  ...
  return (
    <div style={frame}>
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {libraryStrings("manipulation.split-pane.operational-workspace", "Operational workspace")}
        </span>
        <h1 style={{ margin: 0, font: "var(--text-heading)" }}>
          {libraryStrings(
            "manipulation.split-pane.keep-both-decisions-in-view",
      ...
      <SplitPane
        primary={
          <Pane
            ...
            title={libraryStrings("manipulation.split-pane.title", "Needs review")}
        ...
        secondary={
          <Pane
            ...
            title={libraryStrings("manipulation.split-pane.title.ready-to-ship", "Ready to ship")}
