  ...
  return (
    <div style={frame}>
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {useStrings("manipulation.split-pane.operational-workspace", "Operational workspace")}
        </span>
      ...
      <SplitPane
        primary={
          <Pane
            ...
            title={useStrings("manipulation.split-pane.title", "Needs review")}
        ...
        secondary={
          <Pane
            ...
            title={useStrings("manipulation.split-pane.title.ready-to-ship", "Ready to ship")}
