...
export function TypographyShowcase({ args }: { args?: { textStyle?: TextStyle } }) {
  ...
  return (
    <section aria-label="Typography specimen" data-rcl-typography-showcase style={showcaseStyle}>
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        <Text tone="muted" balance>
          Eight bundled styles keep hierarchy, rhythm, and tone coherent across every surface.
        </Text>
      </div>
      <div
        style={{
...
export function TextAnatomy() {
  return (
    <section aria-label="Text anatomy" data-rcl-text-anatomy style={showcaseStyle}>
      ...
      <div data-rcl-text-block-frame>
        <Text as="h2" textStyle="heading">
          Block heading frame
        </Text>
        <Text as="p" tone="muted">
          A semantic heading is followed by a paragraph in its own block flow.
        </Text>
      </div>
...
export function TextBoundaries() {
  return (
    <section aria-label="Text boundary states" data-rcl-text-boundaries style={showcaseStyle}>
      ...
      <Text truncate>
        Truncated content remains legible when a single line must fit inside a constrained surface.
      </Text>
