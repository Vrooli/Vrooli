...
export function HeadingShowcase({
  ...
  return (
    <section aria-label="Heading specimen" data-rcl-heading-showcase style={showcaseStyle}>
      ...
      <Text tone="muted" balance>
        Change the document level without losing the typography that makes the page feel
        intentional.
      </Text>
...
export function HeadingAnatomy(props: Parameters<typeof HeadingShowcase>[0]) {
  return <HeadingShowcase {...props} />;
}
export function HeadingScaleMatrix(props: Parameters<typeof HeadingShowcase>[0]) {
  return <HeadingShowcase {...props} />;
}
export function HeadingBoundary(props: Parameters<typeof HeadingShowcase>[0]) {
  return <HeadingShowcase {...props} />;
}
