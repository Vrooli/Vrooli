 ...
 * @description Accessible compact trend visualization with a text alternative for version history and adoption signals.
 * @version 1.0.2
 * @tags []
 * @warning Managed by React Component Library. Preserve this header when editing adopted copies.
 */
/** @vrooliComponentSource react-component-library:TrendSpark
 * @vrooliComponentSourceSlot data-display.trend-spark */
