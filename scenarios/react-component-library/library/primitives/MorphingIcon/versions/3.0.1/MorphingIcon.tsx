...
import {
  useIconMorph,
  type IconMorphMode,
} from "@vrooli/react-component-library/useIconMorph/1.0.0";
import { ICON_REGISTRY, type IconName } from "@vrooli/react-component-library/IconRegistry/1.0.0";
...
export const MorphingIcon = withClassName(function MorphingIcon({
  ...
  const { technique, progress, active, geometry, previousKey, currentRef, previousRef } =
    useIconMorph({ iconKey: key, mode, duration });
