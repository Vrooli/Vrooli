      ...
      >
        ...
        <div
          style={{
            ...
            color: sent ? "var(--color-success, #15803d)" : "var(--color-accent, #315efb)",
  ...
  return (
    <Surface elevation="raised" style={stageStyle}>
      ...
      >
        ...
        <IconButton aria-label={copied ? "Copied" : "Copy value"} onClick={() => setCopied(true)}>
          <MorphingIcon
            ...
            duration={420}
            style={{
              color: copied ? "var(--color-success, #15803d)" : "var(--color-foreground, #142033)",
