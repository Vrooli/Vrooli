...
[data-rcl-selection-row][data-kind="switch"] [data-rcl-selection-indicator] {
  ...
  /* Vertical panning stays with the page; horizontal is ours. Without this a
     switch inside a scroll container never receives a drag. */
  touch-action: pan-y;
}
...
function SelectionStyles() {
  return <StyleSheet name="selectioncontrol-1-0-2-1" css={styleSheet} />;
}
