  ...
  return (
    ...
    >
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        <strong style={{ font: "var(--text-title)" }}>Workspace preferences</strong>
        <span
          style={{
        ...
        >
          Native semantics, calm state changes, and enough context to make a decision confidently.
        </span>
      </div>
...
export function Bare() {
  return (
    <Showcase>
      <SelectionControl kind="switch" aria-label="Adaptive chrome" defaultChecked />
    </Showcase>
  );
}
...
/** The host row renders the label; the control must adopt it, not discard it. */
export function HostLabelled() {
  return (
    <Showcase>
      <div
        style={{
      ...
      >
        <span id="host-owned-label" style={{ font: "var(--text-body)", fontWeight: 650 }}>
          Adaptive chrome
        </span>
        <SelectionControl kind="switch" aria-labelledby="host-owned-label" defaultChecked />
      </div>
    </Showcase>
  );
}
