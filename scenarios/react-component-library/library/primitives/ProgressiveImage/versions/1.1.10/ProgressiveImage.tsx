 ...
 * @description The image component reserving layout ahead of load, resolving responsive sources, degrading legibly on error, and avoiding visual popping on arrival.
 * @version 1.1.10
 * @tags []
...
/** @vrooliComponentSource react-component-library:ProgressiveImage
 * @vrooliComponentSourceSlot primitives.progressive-image */
import {
  useEffect,
  useState,
  type CSSProperties,
      ...
      >
        ...
        >
          <div data-rcl-progressive-image-error-content>
            ...
            {errorFallback ?? (
              <span>
                {strings("primitives.progressive-image.image-unavailable", "Image unavailable.")}
              </span>
            )}
          </div>
        </div>
