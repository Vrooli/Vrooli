  ...
  return (
    ...
    >
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {libraryStrings("primitives.progressive-image.media-primitive", "Media primitive")}
        </span>
...
export function Default({ args }: StoryHarnessProps<Args>) {
  ...
  return (
    <Showcase
      title={libraryStrings("primitives.progressive-image.title", "Arrival without the pop")}
