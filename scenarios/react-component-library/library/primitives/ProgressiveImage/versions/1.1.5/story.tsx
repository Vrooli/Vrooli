  ...
  return (
    ...
    >
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {resolveStrings("primitives.progressive-image.media-primitive", "Media primitive")}
        </span>
...
export function Default({ args }: StoryHarnessProps<Args>) {
  return (
    <Showcase
      title={resolveStrings("primitives.progressive-image.title", "Arrival without the pop")}
...
export function Loading({ args }: StoryHarnessProps<Args>) {
  return (
    <Showcase
      title={resolveStrings("primitives.progressive-image.title.inspect-the-reserved-frame", "Inspect the reserved frame")}
    ...
    >
      <ProgressiveImage
        ...
        alt={resolveStrings("primitives.progressive-image.alt.abstract-loading-workspace-preview", "Abstract loading workspace preview")}
        ratio="16 / 9"
      />
    </Showcase>
  );
...
export function ResponsiveSources({ args }: StoryHarnessProps<Args>) {
  return (
    <Showcase
      title={resolveStrings("primitives.progressive-image.title.responsive-by-intent", "Responsive by intent")}
...
export function ErrorState({ args }: StoryHarnessProps<Args>) {
  return (
    <Showcase
      title={resolveStrings("primitives.progressive-image.title.a-useful-failure", "A useful failure")}
    ...
    >
      <ProgressiveImage
        ...
        alt={resolveStrings("primitives.progressive-image.alt.unavailable-workspace-preview", "Unavailable workspace preview")}
        ratio="16 / 9"
      />
    </Showcase>
  );
