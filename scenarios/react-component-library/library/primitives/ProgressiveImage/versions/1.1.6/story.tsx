  ...
  return (
    ...
    >
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {useStrings("primitives.progressive-image.media-primitive", "Media primitive")}
        </span>
...
export function Default({ args }: StoryHarnessProps<Args>) {
  return (
    <Showcase
      title={useStrings("primitives.progressive-image.title", "Arrival without the pop")}
...
export function ErrorState({ args }: StoryHarnessProps<Args>) {
  return (
    <Showcase
      title={useStrings("primitives.progressive-image.title.a-useful-failure", "A useful failure")}
