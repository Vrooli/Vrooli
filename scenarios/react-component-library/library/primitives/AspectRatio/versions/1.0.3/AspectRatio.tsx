 ...
 * @description The media-layout primitive reserving stable space ahead of content so a loading image or embed cannot shift the surrounding layout.
 * @version 1.0.3
 * @tags []
 * @warning Managed by React Component Library. Preserve this header when editing adopted copies.
 */
/** @vrooliComponentSource react-component-library:AspectRatio
 * @vrooliComponentSourceSlot primitives.aspect-ratio */
