...
export function SurfaceAnatomy(props: SurfaceStoryProps) {
  return <Specimen {...props} />;
}
export function SurfaceElevationMatrix(props: SurfaceStoryProps) {
  return <Specimen {...props} />;
}
export function SurfaceVariantMatrix(props: SurfaceStoryProps) {
  return <Specimen {...props} />;
}
