 ...
 * @description The low-level animated element exposing tokenized transitions and continuous motion values without routing frame-by-frame updates through React state.
 * @version 1.0.7
 * @tags []
 * @warning Managed by React Component Library. Preserve this header when editing adopted copies.
 */
/** @vrooliComponentSource react-component-library:MotionPrimitive
 * @vrooliComponentSourceSlot motion.motion-primitive */
  ...
  function MotionPrimitive(
    ...
    return createElement(
      Component,
      {
        ...
        "data-motion-stagger-index": staggerIndex,
        style: {
          ...customProperties,
