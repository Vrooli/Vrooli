...
export function Default() {
  ...
  return (
    <Transition
      present
      kind="scale"
      aria-label={libraryStrings("motion.transition.aria-label", "Transition example")}
    >
      <div
        role="status"
        style={{
      ...
      >
        ...
        >
          {libraryStrings("motion.transition.shared-transition", "Shared transition")}
        </span>
        <strong style={{ font: "var(--text-title)" }}>
          {libraryStrings("motion.transition.a-single-motion-grammar", "A single motion grammar")}
        </strong>
        <span
          style={{
      ...
      >
        ...
        >
          <strong style={{ font: "var(--text-subtitle)" }}>
            {libraryStrings("motion.transition.interruptible-by-design", "Interruptible by design")}
          </strong>
          <span
            style={{
              color: "var(--color-muted-foreground)",
