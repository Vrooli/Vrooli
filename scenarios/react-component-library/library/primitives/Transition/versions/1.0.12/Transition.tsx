 ...
 * @description The compact family of tokenized fade, scale, slide, blur, and crossfade transitions sharing one presence lifecycle and one reduced-motion policy.
 * @version 1.0.12
 * @tags []
 * @warning Managed by React Component Library. Preserve this header when editing adopted copies.
 */
/** @vrooliComponentSource react-component-library:Transition
 * @vrooliComponentSourceSlot motion.transition */
import { withClassName } from "@vrooli/react-component-library/ClassMerge/1";

import type { ReactNode } from "react";
import { Presence, type PresenceDuration } from "@vrooli/react-component-library/Presence/1";
import {
  MotionPrimitive,
  type MotionDuration,
...
export interface TransitionProps
  extends Omit<MotionPrimitiveProps, "active" | "children" | "variant" | "duration"> {
  children: ReactNode;
  present?: boolean;
  initial?: boolean;
  keepMounted?: boolean;
