 ...
 * @displayName Icon
 * @description The normalized icon renderer applying optical sizing, stroke policy, direction-aware flipping, and accessibility treatment for decorative versus meaningful icons.
 * @version 1.1.6
 * @tags []
 * @warning Managed by React Component Library. Preserve this header when editing adopted copies.
 */
/** @vrooliComponentSource react-component-library:Icon
 * @vrooliComponentSourceSlot primitives.icon */
...
import {
  ...
  iconSize,
  type IconName,
} from "@vrooli/react-component-library/IconRegistry/1";
