 ...
 * @displayName Use Handedness
 * @description Provides reach-side and writing-direction context for logical gesture behavior.
 * @version 1.1.4
 * @tags []
 * @warning Managed by React Component Library. Preserve this header when editing adopted copies.
 */
/** @vrooliComponentSource react-component-library:useHandedness
 * @vrooliComponentSourceSlot hooks.use-handedness */
import {
  createContext,
  createElement,
  useContext,
