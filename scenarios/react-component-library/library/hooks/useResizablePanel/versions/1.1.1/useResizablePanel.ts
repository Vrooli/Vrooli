/**
 * @libraryId react-component-library:useResizablePanel
 * @displayName useResizablePanel
 * @description Pointer, keyboard and persistence behavior for one resizable panel: logical axis and edge, bounded clamping against the adjacent region, snap points, a collapse threshold, and an injectable storage adapter.
 * @version 1.1.1
 * @tags []
 * @warning Managed by React Component Library. Preserve this header when editing adopted copies.
 */
/** @vrooliComponentSource react-component-library:useResizablePanel
 * @vrooliComponentSourceSlot hooks.use-resizable-panel */
import {
  useCallback,
  useEffect,
  useId,
...
export function useResizablePanel(options: UseResizablePanelOptions): UseResizablePanelResult {
  ...
  const growsTowardEnd =
    axis === "inline" ? (edge === "end") !== (direction === "rtl") : edge === "end";
