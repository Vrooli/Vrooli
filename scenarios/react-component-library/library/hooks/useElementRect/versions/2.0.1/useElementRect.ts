/**
 * @libraryId react-component-library:useElementRect
 * @displayName useElementRect
 * @description A measured-layout primitive that batches reads and exposes a stable element rectangle without forcing layout on every render.
 * @version 2.0.1
 * @tags []
 * @warning Managed by React Component Library. Preserve this header when editing adopted copies.
 */
/** @vrooliComponentSource react-component-library:useElementRect
 * @vrooliComponentSourceSlot hooks.use-element-rect */
...
function sameRect(a: DOMRectReadOnly | null, b: DOMRectReadOnly): boolean {
  return a !== null && a.width === b.width && a.height === b.height && a.x === b.x && a.y === b.y;
}
