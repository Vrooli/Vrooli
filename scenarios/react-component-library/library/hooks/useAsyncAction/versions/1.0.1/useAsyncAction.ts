/**
 * @libraryId react-component-library:useAsyncAction
 * @displayName useAsyncAction
 * @description The standardized async-operation controller covering pending, progress, success, failure, cancellation, retry, optimistic update, rollback, and stale-result protection behind one contract.
 * @version 1.0.1
 * @tags []
 * @warning Managed by React Component Library. Preserve this header when editing adopted copies.
 */
/** @vrooliComponentSource react-component-library:useAsyncAction
 * @vrooliComponentSourceSlot hooks.use-async-action */
import { useCallback, useEffect, useRef, useState } from "react";

export type AsyncActionStatus = "idle" | "pending" | "success" | "error" | "cancelled";
