/**
 * @libraryId react-component-library:useResizeObserver
 * @displayName useResizeObserver
 * @description A shared-observer primitive reporting element size changes without creating one native observer per component instance.
 * @version 1.0.2
 * @tags []
 * @warning Managed by React Component Library. Preserve this header when editing adopted copies.
 */
/** @vrooliComponentSource react-component-library:useResizeObserver
 * @vrooliComponentSourceSlot hooks.use-resize-observer */
