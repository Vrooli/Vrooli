/**
 * @libraryId react-component-library:Contracts
 * @displayName Contracts
 * @description The framework-light type layer defining shared change events, async actions, collection shapes, overlay descriptors, and telemetry events, so every other asset speaks one vocabulary at its boundaries.
 * @version 1.0.1
 * @tags []
 * @warning Managed by React Component Library. Preserve this header when editing adopted copies.
 */
/** @vrooliComponentSource react-component-library:Contracts
 * @vrooliComponentSourceSlot foundations.contracts */
...
export type SurfaceContextKey = "elevation" | "density" | "tone" | "columns" | "disabled";
...
export const SurfaceContext =
  ...
  (surfaceContextRuntime.__vrooliSurfaceContext = createContext<SurfaceContextValue>({}));
