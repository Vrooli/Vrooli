...
const styles = `
[data-rcl-alert-dialog-layer] { position: fixed; inset: 0; z-index: var(--layer-alert, 700); display: grid; place-items: center; box-sizing: border-box; padding: var(--space-lg, 24px); background: var(--color-scrim, rgb(15 23 42 / .52)); animation: rcl-alert-dialog-in var(--dur-moderate, 180ms) var(--ease-standard, cubic-bezier(.2,.8,.2,1)) both; }
