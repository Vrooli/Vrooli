...
const styles = `
[data-rcl-file-preview] { display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: center; gap: var(--space-sm, 12px); width: 100%; box-sizing: border-box; padding: var(--space-sm, 12px); border: 1px solid var(--color-border, #cbd5e1); border-radius: var(--radius-panel, .75rem); background: var(--color-surface, #fff); color: var(--color-foreground, #0f172a); box-shadow: var(--elev-flat, 0 1px 2px rgb(15 23 42 / .06)); }
[data-rcl-file-preview][data-status="error"] { border-color: var(--color-danger-border, #e7a8a8); }
[data-rcl-file-preview-thumb] { display: grid; place-items: center; inline-size: 3.25rem; block-size: 3.25rem; overflow: hidden; border-radius: var(--radius-control, .5rem); background: var(--color-surface-muted, #f1f5f9); color: var(--color-primary, #2563eb); }
...
[data-rcl-file-preview][data-status="success"] [data-rcl-file-preview-status] { color: var(--color-success-foreground, #19704a); }
[data-rcl-file-preview][data-status="error"] [data-rcl-file-preview-status] { color: var(--color-danger-foreground, #b42318); }
