...
import {
  useSwipe,
  type SwipeDirection,
} from "@vrooli/react-component-library/useSwipe/2.0.2";
import { baseStyles } from "@vrooli/react-component-library/BaseStyles/1.1.1";
...
export function useOverlaySurface({
  ...
  // The sheet key names the stylesheet revision, not the asset version: 1.1.0
  // and 1.1.1 publish byte-identical CSS, so they must share one head node.
