 ...
 * @version 2.0.0
 * @tags ["layout","interaction","token-bound","accessibility"]
 ...
 *
 * 1.0.3 was a placeholder: a flexbox with a gap that resized nothing. This is
 * the first implementation of the asset, hence a major rather than a patch.
 */
