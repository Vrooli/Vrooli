...
import { useSwipe, type SwipeDirection } from "@vrooli/react-component-library/useSwipe/2";
    ...
    grabberProps: swipeEnabled
      ? {
          ...
          onPointerMove: (event: ReactPointerEvent) => {
            ...
            writeOffset(travelled(resolvedDirection, dragOrigin.current, event));
          },
        }
      : {
          type: "button" as const,
