  ...
  return (
    ...
    >
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        <strong style={{ font: "var(--text-title)" }}>Editor toolbar</strong>
        <span
          style={{
        ...
        >
          Actions stay grouped, keyboardable, and usable when the available
          width gets smaller.
        </span>
      </div>
      {children}
...
export function Default() {
  return (
    <Showcase>
      <Toolbar label="Editor toolbar" items={items(() => {})} />
    </Showcase>
  );
}
...
export function Interactive() {
  ...
  return (
    <Showcase>
      <Toolbar label="Editor toolbar" items={items(setStatus)} />
      <div
        role="status"
