...
const SECTIONS = ["Sessions", "Workspace", "Input", "Output", "Shortcuts", "Defaults", "Links"];

/** The default rendered anatomy: a short strip that fits its container. */
export function Default() {
  return <Tabs ariaLabel="Sections" items={["Sessions", "Workspace", "Input"]} />;
}
...
export function ControlledWithPanels() {
  ...
  return (
    <Tabs
      ...
      panels={{ sessions: <p>Session settings</p>, workspace: <p>Workspace settings</p> }}
    />
  );
}
