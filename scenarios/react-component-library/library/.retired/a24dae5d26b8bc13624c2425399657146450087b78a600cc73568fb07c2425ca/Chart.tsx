          ...
          <div data-rcl-chart-surface data-presentation={presentation}>
            <div data-rcl-chart-header>
              <div data-rcl-chart-heading>
                <span data-rcl-chart-kicker>
                  {strings(
                    "visualization.chart.performance-overview",
            ...
            {data.length > 0 && (
              <div
                ...
                aria-label={strings(
                  "visualization.chart.chart-values",
                  "Chart values",
                )}
              >
                {data.map((point) => (
            ...
            <table data-rcl-chart-table>
              ...
              <thead>
                <tr>
                  <th scope="col">
                    {strings("visualization.chart.period", "Period")}
                  </th>
                  <th scope="col">
                    {strings("visualization.chart.value", "Value")}
                  </th>
                </tr>
              </thead>
              <tbody>
