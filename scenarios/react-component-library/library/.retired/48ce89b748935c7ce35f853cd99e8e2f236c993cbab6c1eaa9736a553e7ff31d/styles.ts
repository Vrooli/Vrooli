...
[data-rcl-banner] {
  --rcl-banner-accent: var(--color-info, #0ea5e9);
  --rcl-banner-surface: color-mix(in srgb, var(--rcl-banner-accent) 18%, var(--color-surface, #0f172a));
  --rcl-banner-border: color-mix(in srgb, var(--rcl-banner-accent) 35%, transparent);
  --rcl-banner-title: var(--color-foreground, #e2e8f0);
  --rcl-banner-detail: var(--color-muted-foreground, #94a3b8);
  ...
  padding-inline-start: max(var(--space-sm, 12px), var(--rcl-safe-left, 0px));
  padding-inline-end: max(var(--space-sm, 12px), var(--rcl-safe-right, 0px));
...
[data-rcl-banner][data-tone="warning"] { --rcl-banner-accent: var(--color-warning, #b45309); }
[data-rcl-banner][data-tone="success"] { --rcl-banner-accent: var(--color-success, #15803d); }

[data-rcl-banner][data-compact="true"] { padding-block: var(--space-3xs, 6px); background: color-mix(in srgb, var(--rcl-banner-accent) 10%, transparent); }
...
[data-rcl-banner-actions] { display: flex; flex-wrap: wrap; gap: var(--space-3xs, 6px); }
...
[data-rcl-banner-dismiss] {
  ...
  border: 0; border-radius: var(--radius-control, 4px);
  background: transparent; color: var(--rcl-banner-detail); cursor: pointer;
  transition: background-color var(--dur-quick, 120ms) ease, color var(--dur-quick, 120ms) ease;
}
...
[data-rcl-banner-overflow-toggle] {
  ...
  padding-inline: max(var(--space-sm, 12px), var(--rcl-safe-left, 0px)) max(var(--space-sm, 12px), var(--rcl-safe-right, 0px));
  border: 0; border-block-end: var(--border-hairline, 1px) solid var(--color-border, rgb(255 255 255 / 0.1));
  background: color-mix(in srgb, var(--color-foreground, #000) 8%, transparent);
  color: var(--color-muted-foreground, #94a3b8);
  font: var(--text-caption, inherit); cursor: pointer;
}
[data-rcl-banner-overflow-toggle]:hover { color: var(--color-foreground, #e2e8f0); }
...
[data-rcl-banner-overflow-toggle]:focus-visible { outline: var(--focus-ring-width, 2px) solid var(--color-focus-ring, #22d3ee); outline-offset: 1px; }
