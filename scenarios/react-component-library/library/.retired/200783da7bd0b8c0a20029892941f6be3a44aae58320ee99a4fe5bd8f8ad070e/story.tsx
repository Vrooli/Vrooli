...
import { createFormStore } from "@vrooli/react-component-library/FormStore/1";
...
function CurrencyInput({
  ...
  store: ReturnType<typeof createFormStore<{ subtotal: number; taxRate: number }>>;
...
export function Default() {
  ...
  return (
    ...
    >
      <CurrencyInput store={store} field="subtotal" label="Subtotal" value={240} />
      <CurrencyInput store={store} field="taxRate" label="Tax rate" value={0.2} />
      <ComputedField
        store={store}
        field="subtotal"
