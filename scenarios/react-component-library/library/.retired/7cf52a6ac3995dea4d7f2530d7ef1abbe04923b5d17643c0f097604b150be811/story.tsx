...
function MotionCard({ active }: { active: boolean }) {
  return (
    ...
    >
      ...
      >
        Shared duration, easing, and reduced-motion policy without layout
        animation.
      </span>
    </MotionPrimitive>
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          The offset writes to the DOM style subscription without React frame
          updates.
        </span>
      </MotionPrimitive>
    </section>
