 ...
 * @description A section-backed nested object field that keeps child values, optionality, collapse, and nested errors together.
 * @version 1.0.2
...
>({
  ...
  return (
    ...
    >
      <StyleSheet name="objectfield-1-0-2-1" css={styles} />
      <FormSection
        title={title}
        ...
        summary={
          <span data-rcl-object-meta>
            ...
            {optional && (
              <span>
                {resolveStrings(
                  "forms.object-field.optional-group",
                  "Optional group",
                )}
              </span>
            )}
