 ...
 * @description Protects meaningful unsaved work with an accessible recovery prompt and an SSR-safe unload guard.
 * @version 1.0.4
...
>(function DirtyStateGuard(
  ...
  return (
    ...
    >
      <StyleSheet name="dirtystateguard-1-0-4-1" css={styles} />
      {children}
      {isOpen &&
        (renderPrompt ? (
