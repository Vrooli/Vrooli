...
[data-rcl-bottom-nav-active-indicator] { position: absolute; inset-block-start: 0; inset-inline-start: 0; block-size: var(--space-3xs); border-radius: var(--radius-pill); background: var(--color-primary); pointer-events: none; transition: transform var(--dur-moderate) var(--ease-standard), inline-size var(--dur-moderate) var(--ease-standard); }
