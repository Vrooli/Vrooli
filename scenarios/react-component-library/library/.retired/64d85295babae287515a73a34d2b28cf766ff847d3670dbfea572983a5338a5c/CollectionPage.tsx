  ...
  if (state === "refreshing")
    return (
      <div role="status" style={panel}>
        <strong>
          {strings("templates.collection-page.refreshing", "Refreshing")}
        </strong>
        {children}
      </div>
    );
    ...
    return (
      <div style={{ display: "grid", gap: 12 }}>
        <span style={{ color: "var(--color-primary, #2563eb)" }}>
          {strings(
            "templates.collection-page.showing-stale-data",
            "Showing stale data",
          )}
        </span>
        {children}
      ...
      <div style={{ display: "grid", gap: 16, minWidth: 0, width: "100%" }}>
        ...
        >
          <input
            ...
            aria-label={strings(
              "templates.collection-page.filter-query",
              "Filter query",
            )}
            placeholder={strings(
          ...
          >
            {strings(
              "templates.collection-page.apply-filters",
              "Apply filters",
            )}
          </button>
        </form>
