  ...
  return (
    ...
    >
      <div style={{ display: "grid", gap: "var(--space-2xs)" }}>
        ...
        >
          {libraryStrings(
            "data-display.list.activity-stream",
            "Activity stream",
          )}
        </span>
...
const activity: ListItem[] = [
  ...
  },
  {
    id: "review",
    title:
      "A descriptive activity with a longer label that still needs to wrap gracefully",
    ...
    >
      <List
        ...
        label={libraryStrings(
          "data-display.list.label.review-activity",
          "Review activity",
        )}
      />
    </Showcase>
