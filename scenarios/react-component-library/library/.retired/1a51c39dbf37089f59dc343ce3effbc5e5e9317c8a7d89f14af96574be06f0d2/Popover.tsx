...
[data-rcl-popover-content] :is(button, a[href], input, select, textarea, [role="button"]) { min-block-size: var(--tap-target-min, 2.75rem); min-inline-size: var(--tap-target-min, 2.75rem); }
