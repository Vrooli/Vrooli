 ...
 * @description A six-point series beside a figure. Authored series are stamped illustrative and drawn dashed with hollow points so nothing downstream mistakes them for a trend.
 * @version 0.1.0
 * @tags ["ambient-display","provenance","visualization"]
