 ...
 * @description A contextual selection surface that makes scope, progress, partial failure, and recovery explicit.
 * @version 1.0.2
...
export const BulkActionBar = withClassName(function BulkActionBar({
  ...
  return (
    <section
      ...
      style={style}
    >
      <StyleSheet name="bulkactionbar-1-0-2-1" css={styles} />
      ...
      {description ? (
        <p data-rcl-bulk-action-bar-message>{description}</p>
      ) : null}
      ...
      <ButtonGroup
        label={strings(
          "data-display.bulk-action-bar.selection-actions",
          "Selection actions",
        )}
