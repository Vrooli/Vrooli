  ...
  return (
    <SplitPane
      ...
      primary={
        <Pane
          title="Needs review"
          body="Three items are waiting for an owner."
        />
      }
      secondary={
        <Pane
          title="Ready to ship"
          body="The next handoff is prepared for release."
        />
      }
    />
  );
  ...
  return (
    <SplitPane
      ...
      primary={
        <Pane
          title="Editor"
          body="Stacked panes share one splitter implementation."
        />
      }
      secondary={
        <Pane title="Console" body="The splitter is horizontal here." />
      }
    />
  );
}
