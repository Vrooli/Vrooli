...
export function Default() {
  return (
    <Showcase
      title="A list with hierarchy, not just rows"
    ...
    >
      <List
        ...
        description="Changes across the design workspace"
        items={activity}
...
export function LongContent() {
  return (
    <Showcase
      title="Long labels are part of the product"
    ...
    >
      <List items={activity.slice(1)} label="Review activity" />
    </Showcase>
  );
}
...
export function Empty() {
  return (
    <Showcase
      title="An empty list still explains itself"
