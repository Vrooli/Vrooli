...
3. Validation evidence lives on each requirement entry and points at existing files, tests, command contracts, or manual notes that can prove the requirement.
