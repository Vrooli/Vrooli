...
| 2026-07-12 | codex | done | Completed Template Manager reliability hardening: delegated Test Genie assessments without a portable presentation now retain their authoritative findings under explicit compatibility warning, while malformed presentations remain contract failures. React-vite 1.6.5 deep validation passed through the real generated-scenario path and the registry is active. The scheduler now excludes quarantined/retired scenario templates, preventing unrelated known-invalid templates from turning the active-template monitor red. Production monitor run `validation-f8ed2ee5-6ff1-4d39-8b7d-e3190737952b` passed with scheduler attribution and green streak 4. |
