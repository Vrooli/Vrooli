...
| Contracts (`packages/proto/schemas/template-manager/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/template-manager/`.
...
1. Add proto messages and service methods under
   `packages/proto/schemas/template-manager/v1/<domain>/`.
...
|---|---|---|---|
| 2026-07-09 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
