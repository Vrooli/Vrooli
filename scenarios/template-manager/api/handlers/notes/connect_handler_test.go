...
import (
	...
	"template-manager/handlers/notes"
	...
	notesv1 "github.com/vrooli/vrooli/packages/proto/gen/go/template-manager/v1/notes"
	notesconnect "github.com/vrooli/vrooli/packages/proto/gen/go/template-manager/v1/notes/notes_v1connect"

	measuresv1 "github.com/vrooli/vrooli/packages/proto/gen/go/measures/v1"

	internalnotes "template-manager/internal/notes"
	mocks "template-manager/internal/notes/mocks"
	clockmocks "template-manager/internal/testutil/mocks"
)
