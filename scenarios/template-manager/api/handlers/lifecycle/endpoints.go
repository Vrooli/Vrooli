...
var Endpoints = []module.EndpointDescriptor{
	...
	{ID: "lifecycle_destroy_scenario", Path: lifecycleconnect.TemplateLifecycleServiceDestroyScenarioProcedure, Method: "POST", Summary: "Destroy scenario", Description: "Removes a generated scenario and its full packages/proto codegen footprint.", Category: "lifecycle"},
