...
func Module(logger *log.Logger, engine *templateengine.Engine, validation *validationrunner.Service) module.Module {
	if engine == nil {
		var err error
	...
	handler := NewConnectHandler(engine, validation)
