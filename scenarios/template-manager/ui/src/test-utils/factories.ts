 ...
 * `packages/proto/gen/typescript/js/template-manager/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/template-manager/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/template-manager/v1/shared/health_pb";
