 ...
 * `packages/proto/gen/typescript/js/ai-gateway/v1/notes/...`.
...
} from "@vrooli/proto-types/ai-gateway/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/ai-gateway/v1/notes/attachments_pb";
