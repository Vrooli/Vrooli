 ...
 * (e.g. `features/routing/mocks/factories.ts`); only truly cross-domain
 ...
 * `packages/proto/gen/typescript/js/ai-gateway/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/ai-gateway/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/ai-gateway/v1/shared/health_pb";
