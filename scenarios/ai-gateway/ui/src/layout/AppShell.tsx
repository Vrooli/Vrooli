import { LayoutDashboard, Route, Server, Settings, ShieldCheck } from "lucide-react";
...
const NAV_ICONS = {
  ...
  providers: <Server aria-hidden className="h-5 w-5" />,
  routePreview: <Route aria-hidden className="h-5 w-5" />,
  conformance: <ShieldCheck aria-hidden className="h-5 w-5" />,
  settings: <Settings aria-hidden className="h-5 w-5" />,
} as const;

/** Library-owned shell adapter for the AI Gateway navigated console. */
export function AppShell() {
  ...
  return (
    <LibraryAppShell
      ...
      sidebarStorageKey="ai-gateway.sidebar-width"
