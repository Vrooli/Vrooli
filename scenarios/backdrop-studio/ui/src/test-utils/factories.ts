 ...
 * `packages/proto/gen/typescript/js/backdrop-studio/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/backdrop-studio/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/backdrop-studio/v1/shared/health_pb";
