 ...
 * `packages/proto/gen/typescript/js/backdrop-studio/v1/notes/...`.
...
} from "@vrooli/proto-types/backdrop-studio/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/backdrop-studio/v1/notes/attachments_pb";
