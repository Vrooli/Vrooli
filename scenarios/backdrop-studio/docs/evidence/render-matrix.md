...
| Field | Value |
|---|---|
| API build | `cfa2bbf37fa3` |
| Catalog seed version | 2 applied of 2 shipped |
...
| Result | **14 rendered, 0 failed, 2 skipped** of 16 |
...
| `op-art-interior` | procedural-treated | pass | 1440x720 | procedural → treatment |
