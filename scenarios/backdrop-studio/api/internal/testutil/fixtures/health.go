...
// `packages/proto/gen/go/backdrop-studio/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/backdrop-studio/v1/shared/health.proto`
