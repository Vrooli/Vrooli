...
func (s *Server) registerRunningProcess(issueID, agentID, runID, startTime string, targets []Target, cancel context.CancelFunc) {
	...
	s.processor.RegisterRunningProcess(issueID, agentID, runID, startTime, targets, cancel)
