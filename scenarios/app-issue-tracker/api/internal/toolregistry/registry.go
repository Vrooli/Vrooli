// Package toolregistry provides the tool discovery service for app-issue-tracker.
//
// This package implements the Tool Discovery Protocol, enabling external consumers
// (like agent-inbox) to discover what issue tracking tools this scenario provides.
//
// ARCHITECTURE:
// - Registry: Central coordinator that manages tool providers
// - ToolProvider: Interface for components that contribute tools
// - Categories: issue_discovery, issue_management, investigation, agent_automation, reporting
//
// TESTING SEAMS:
