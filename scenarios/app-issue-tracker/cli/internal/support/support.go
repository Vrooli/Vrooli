...
const CLIName = "app-issue-tracker"
...
// EnvelopeMessage returns the "message" string from a {success, message, data}
// envelope, else empty. The message lives at the top level of the envelope.
