...
var Endpoints = []module.EndpointDescriptor{
	...
	endpoint("authoring_discover_skill_pack", authoringconnect.AuthoringServiceDiscoverSkillPackProcedure, "Discover skill pack", "Runs prompt-manager skill discovery for decomposed concepts and auto-upserts the returned skill pack into global relevant context, or into one phase's relevant context when phase_id is set."),
