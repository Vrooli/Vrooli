...
func PlanToProto(p planmodel.Plan) *sharedv1.Plan {
	return &sharedv1.Plan{
		...
		CompletionPolicy:        &sharedv1.CompletionPolicy{Mode: p.CompletionPolicy.Mode, Reason: p.CompletionPolicy.Reason},
...
func PlanFromProto(p *sharedv1.Plan) planmodel.Plan {
	...
	return planmodel.Plan{
		...
		CompletionPolicy:        planmodel.CompletionPolicy{Mode: p.GetCompletionPolicy().GetMode(), Reason: p.GetCompletionPolicy().GetReason()},
