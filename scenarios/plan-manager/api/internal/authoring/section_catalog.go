...
// guided wizard renders. The mandatory sections gate Finalize; optional sections
// may be left empty. References and the change boundary are mandatory but have
// typed escape hatches (NO_CODE_REFS / OPERATOR_ONLY) enforced by validation.
var defaultSkeleton = []sectionSpec{
	...
	},
	{
		...
		Instructions:   []string{"Decompose the work into 2-5 search concepts.", "Run context-discover to generate candidate setup commands.", "Accept useful candidates globally or for a phase; reject noisy candidates with a reason.", "For plan-wide setup, include a relevant skill item or record NO_SKILL_CONTEXT with the reason.", "Do not add generic feedback reminders here; the rendered plan includes the default plan-manager log capture workflow."},
		RequiredInputs: []string{"context concepts", "global skill context or explicit NO_SKILL_CONTEXT reason", "or explicit NO_CONTEXT reason"},
