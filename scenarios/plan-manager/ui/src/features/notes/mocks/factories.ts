 ...
 * `packages/proto/gen/typescript/js/plan-manager/v1/notes/...`.
...
} from "@vrooli/proto-types/plan-manager/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/plan-manager/v1/notes/attachments_pb";
