...
const literalSelectors = {
  ...
  authoring: {
    ...
    contextCandidates: "authoring-context-candidates",
    contextCandidateAcceptButton: "authoring-context-candidate-accept-button",
    contextCandidateRejectButton: "authoring-context-candidate-reject-button",
    contextRejectReasonInput: "authoring-context-reject-reason-input",
    referenceSuggestButton: "authoring-reference-suggest-button",
    referenceCandidates: "authoring-reference-candidates",
    referenceCandidateAcceptButton: "authoring-reference-candidate-accept-button",
    referenceCandidateRejectButton: "authoring-reference-candidate-reject-button",
    referenceRejectReasonInput: "authoring-reference-reject-reason-input",
