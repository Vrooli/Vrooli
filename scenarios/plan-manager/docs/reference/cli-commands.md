...
```bash
plan-manager notes list
plan-manager notes list --json
```

#### `plan-manager notes create --title <title> [--body <body>]`
...
```bash
plan-manager notes create --title "First note" --body "Hello world"
```
...
```bash
plan-manager notes attach abc123 --file ./example.png
```
