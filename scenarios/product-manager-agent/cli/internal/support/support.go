...
const CLIName = "product-manager-agent"
...
// ReadJSONBody loads a JSON file and returns the parsed RawMessage for use as a
// POST/PUT body. An empty path returns nil unless required is true.
...
// JoinNonEmpty joins only non-empty strings with sep.
