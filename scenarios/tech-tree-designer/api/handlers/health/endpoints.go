...
import "tech-tree-designer/internal/module"
		...
		RESTException: &module.RESTException{
			...
			ProtoPayloads: &module.RESTProtoPayloads{
				...
				Response: module.RESTPayload{
					ProtoFullName: "vrooli.tech_tree_designer.v1.health.Response",
					Transport:     "json",
					Conformance:   "protojson",
				},
				Error: module.RESTPayload{
					ProtoFullName: "vrooli.tech_tree_designer.v1.errors.ErrorEnvelope",
					Transport:     "json",
					Conformance:   "protojson",
				},
			},
