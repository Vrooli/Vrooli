...
// `packages/proto/gen/go/tech-tree-designer/v1/health/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/tech-tree-designer/v1/health/health.proto`
// — never duplicate them in this file.
package fixtures

import (
	healthv1 "github.com/vrooli/vrooli/packages/proto/gen/go/tech-tree-designer/v1/health"
)
