...
import (
	...
	notesv1 "github.com/vrooli/vrooli/packages/proto/gen/go/scenario-to-android/v1/notes" // EXAMPLE-DOMAIN:notes
)
...
func AllProtoFiles() []ProtoFileEntry {
	return []ProtoFileEntry{
		{Module: "notes", File: notesv1.File_scenario_to_android_v1_notes_notes_proto}, // EXAMPLE-DOMAIN:notes
	}
}
