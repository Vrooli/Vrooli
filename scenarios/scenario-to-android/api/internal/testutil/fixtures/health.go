...
// `packages/proto/gen/go/scenario-to-android/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/scenario-to-android/v1/shared/health.proto`
