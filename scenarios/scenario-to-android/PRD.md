...
- [x] OT-P0-012 | hello-mobile fixture proves the ramp end to end | The `hello-mobile` fixture scenario is generated, built, installed, driven, and recorded on the local emulator, producing a complete conformance journey with useful decoded video and verified redaction. This is the proof that the ramp works without depending on any product scenario's correctness.
