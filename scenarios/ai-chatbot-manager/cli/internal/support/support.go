...
const CLIName = "ai-chatbot-manager"
...
// EnvelopeMessage returns the "message" string from the response, unwrapping a
// {success, data: {message}} envelope if present. Returns empty string if not found.
