import { FileCode2, LayoutDashboard, Settings } from "lucide-react";
...
const NAV_ICONS = {
  ...
  facts: <FileCode2 aria-hidden className="h-5 w-5" />,
  settings: <Settings aria-hidden className="h-5 w-5" />,
} as const;

/** Library-owned shell adapter for the Code Facts navigated console. */
export function AppShell() {
  ...
  return (
    <LibraryAppShell
      ...
      sidebarStorageKey="code-facts.sidebar-width"
