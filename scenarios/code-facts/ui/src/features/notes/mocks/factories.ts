 ...
 * `packages/proto/gen/typescript/js/code-facts/v1/notes/...`.
...
} from "@vrooli/proto-types/code-facts/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/code-facts/v1/notes/attachments_pb";
