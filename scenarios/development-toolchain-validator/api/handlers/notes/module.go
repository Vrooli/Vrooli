...
import (
	...
	notesconnect "github.com/vrooli/vrooli/packages/proto/gen/go/development-toolchain-validator/v1/notes/notes_v1connect"

	internalnotes "development-toolchain-validator/internal/notes"
)
...
var Endpoints = []module.EndpointDescriptor{
	{
		...
		Examples: []module.Example{
			{Name: "List notes", Curl: "curl http://localhost:${API_PORT}/vrooli.development_toolchain_validator.v1.notes.NotesService/ListNotes -H 'Content-Type: application/json' -d '{}'"},
		},
		CLIMapping: &module.CLIMapping{
			Command: "development-toolchain-validator notes list",
		},
	},
	{
		ID:          "notes_create",
		...
		Examples: []module.Example{
			{Name: "Create note", Curl: "curl http://localhost:${API_PORT}/vrooli.development_toolchain_validator.v1.notes.NotesService/CreateNote -H 'Content-Type: application/json' -d '{\"title\":\"first\",\"body\":\"hello\"}'"},
		},
		CLIMapping: &module.CLIMapping{
			Command: "development-toolchain-validator notes create",
	...
	},
	{
		...
		Examples: []module.Example{
			{Name: "Get note", Curl: "curl http://localhost:${API_PORT}/vrooli.development_toolchain_validator.v1.notes.NotesService/GetNote -H 'Content-Type: application/json' -d '{\"id\":\"abc123\"}'"},
		},
		CLIMapping: &module.CLIMapping{
			Command: "development-toolchain-validator notes get",
			Args:    []string{"<id>"},
		},
	},
	{
		...
		CLIMapping: &module.CLIMapping{
			Command: "development-toolchain-validator notes attach",
