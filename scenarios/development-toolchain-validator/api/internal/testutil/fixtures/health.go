...
// `packages/proto/gen/go/development-toolchain-validator/v1/health/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/development-toolchain-validator/v1/health/health.proto`
// — never duplicate them in this file.
package fixtures

import (
	healthv1 "github.com/vrooli/vrooli/packages/proto/gen/go/development-toolchain-validator/v1/health"
)
