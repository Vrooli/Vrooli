...
`vrooli scenario orient development-toolchain-validator`, which reads the temporary
`.vrooli/orientation.json` manifest generated by the template. After
all required gates pass, run `vrooli scenario orient development-toolchain-validator
...
```bash
prd-control-tower prd generate development-toolchain-validator \
...
```bash
prd-control-tower prd validate development-toolchain-validator --json
```
...
```bash
prd-control-tower requirements generate development-toolchain-validator \
...
```bash
prd-control-tower requirements validate development-toolchain-validator --json
```
