# Runbook — Development Toolchain Validator
...
| CLI talks to old API | `development-toolchain-validator status`, configured API base | Reinstall via `make setup` | Update CLI reference if command changed. |
