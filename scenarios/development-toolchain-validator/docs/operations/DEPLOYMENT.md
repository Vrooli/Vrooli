# Deployment — Development Toolchain Validator
...
| Proto | Schemas live under `packages/proto/schemas/development-toolchain-validator/`; generated clients are shared artifacts. |
