 ...
 * `packages/proto/gen/typescript/js/development-toolchain-validator/v1/health/...`.
...
import type { Response as HealthResponse } from "@vrooli/proto-types/development-toolchain-validator/v1/health/health_pb";
