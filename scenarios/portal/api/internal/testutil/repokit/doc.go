...
//
//	type FakeRepository = repokit.SliceRepo[chat.Chat]
//
//	func NewFakeRepository() *FakeRepository {
//	    return &FakeRepository{
//	        GetID:    func(c chat.Chat) string { return c.ID },
//	        SetID:    func(c *chat.Chat, id string) { c.ID = id },
//	        NotFound: func(id string) error { return chat.ErrChatNotFound{ID: id} },
//	    }
//	}
//
...
// → []T" shape. Other domain-specific repository shapes
