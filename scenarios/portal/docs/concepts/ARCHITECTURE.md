...
| Contracts (`packages/proto/schemas/portal/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
1. Add proto messages and service methods under
   `packages/proto/schemas/portal/v1/<domain>/`.
...
|---|---|---|---|
| 2026-07-05 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
