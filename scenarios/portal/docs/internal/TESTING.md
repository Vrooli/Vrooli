...
- **API**: `api/handlers/health/handler_test.go` — table-driven, real
  ...
  in `packages/proto/schemas/portal/v1/shared/health.proto`;
...
5. **Generated proto types** — every endpoint's wire shape lives in
   `packages/proto/schemas/portal/v1/<domain>/<file>.proto`.
   Tests import the generated Go type directly
   (`healthv1 "github.com/vrooli/vrooli/packages/proto/gen/go/portal/v1/shared"`)
...
import (
    ...
    "portal/internal/testutil/assertx"
    "portal/internal/testutil/httpx"
...
The proto schema in `packages/proto/schemas/portal/v1/shared/health.proto`
...
dynamically from `go.mod`, so it works after `portal`
substitution.
