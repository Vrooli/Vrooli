...
import { ResponseSchema } from "@vrooli/proto-types/portal/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/portal/v1/shared/health_pb";
