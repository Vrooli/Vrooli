...
import (
	...
	errorsv1 "github.com/vrooli/vrooli/packages/proto/gen/go/search-hub/v1/errors"
)
...
// vocabulary stays consistent. Translation from typed domain sentinels
// to (status, code, message) tuples is the handler's responsibility —
// this writer just emits.
//
