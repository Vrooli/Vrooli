...
//
// Adding a column lands as `ALTER TABLE <table> ADD COLUMN ...` appended to
// schema.sql. Drops/renames need the brownfield migration path (deferred until
// the first scenario hits it).
