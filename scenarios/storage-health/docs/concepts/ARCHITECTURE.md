...
| Contracts (`packages/proto/schemas/storage-health/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/storage-health/`.
...
packages/proto/schemas/storage-health/v1/<domain>/<file>.proto
       ...
       make generate
       │
       ├──▶ packages/proto/gen/go/storage-health/v1/...              (api, cli)
       ├──▶ packages/proto/gen/go/storage-health/v1/...connect       (Connect-Go)
       ├──▶ packages/proto/gen/typescript/js/storage-health/v1/...   (ui)
       └──▶ packages/proto/gen/python/storage_health/v1/...    (future tools)
```
