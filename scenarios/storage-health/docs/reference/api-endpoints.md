...
envelope (`packages/proto/schemas/storage-health/v1/shared/errors.proto`):
...
| **CLI** | `storage-health status` |

```bash
curl "http://localhost:${API_PORT}/health"
```

The proto type lives at `packages/proto/schemas/storage-health/v1/shared/health.proto`
...
`POST /vrooli.storage_health.v1.<domain>.<Domain>Service/<Method>`
