...
// `packages/proto/gen/go/storage-health/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/storage-health/v1/shared/health.proto`
