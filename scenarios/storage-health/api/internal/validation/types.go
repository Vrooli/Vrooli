// Package validation is storage-health's storage-judgment engine. It detects
...
// Severity is storage-health's internal severity ladder. It is mapped to the
...
type Finding struct {
	...
	Remediation string
	// AutofixAvailable marks that a registered storage-health autofix can
...
// Engine enumerates the storage engines storage-health classifies.
type Engine string
