...
Owns all storage judgment: schema layout, migration hygiene, persistence-seam adoption, and test-isolation safety.
...
`test-genie execute storage-health --preset comprehensive` directly for
