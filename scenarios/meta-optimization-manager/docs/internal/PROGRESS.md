...
| 2026-08-18 | codex | validated | Condition instrumentation now carries separate typed local_invocation_ledger and fleet_receipt_aggregate summaries. Live condition status reported 726/1326 ledger-instrumented and 1/1326 receipt-instrumented; focus next condition entries explicitly include exercise_basis=fleet_receipt_aggregate. Full API and CLI Go suites pass. |
## Entry Template
