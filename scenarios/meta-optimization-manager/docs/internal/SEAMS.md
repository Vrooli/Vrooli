# Seams — Meta-Optimization Manager
...
`packages/proto/schemas/meta-optimization-manager/v1/<domain>/<file>.proto` —
...
The `health` proto in `packages/proto/schemas/meta-optimization-manager/v1/shared/`
