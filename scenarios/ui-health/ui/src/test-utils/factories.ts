 ...
 * only truly cross-domain shapes (HealthResponse, error envelopes) live
 * here. Deleting a feature folder takes its factories with it — no
 * central residue.
 *
 ...
 * `packages/proto/gen/typescript/js/ui-health/v1/health/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/ui-health/v1/health/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/ui-health/v1/health/health_pb";
