...
| Contracts (`packages/proto/schemas/ui-health/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/ui-health/`.
...
packages/proto/schemas/ui-health/v1/<domain>/<file>.proto
       ...
       make generate
       │
       ├──▶ packages/proto/gen/go/ui-health/v1/...              (api, cli)
       ├──▶ packages/proto/gen/go/ui-health/v1/...connect       (Connect-Go)
       ├──▶ packages/proto/gen/typescript/js/ui-health/v1/...   (ui)
       └──▶ packages/proto/gen/python/ui_health/v1/...    (future tools)
```
...
|---|---|---|---|
| 2026-05-20 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
