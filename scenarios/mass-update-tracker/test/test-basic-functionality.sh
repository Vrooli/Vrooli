...
# Basic functionality test for Mass Update Tracker
...
TEST_DIR="/tmp/mass-update-tracker-test"
CLI_PATH="./cli/mass-update-tracker"
...
echo -e "${BLUE}🧪 Testing Mass Update Tracker Basic Functionality${NC}"
...
CAMPAIGN_OUTPUT=$("$CLI_PATH" create "test-campaign" "src/**/*.js" "*.md" \
    ...
    --scenario "mass-update-tracker-test" \
...
echo -e "${GREEN}🎉 All tests passed! Mass Update Tracker is working correctly${NC}"
echo
echo "Next steps:"
echo "  1. Run 'vrooli scenario run mass-update-tracker' to start the full scenario"
echo "  2. Visit the dashboard at http://localhost:3251"
echo "  3. Use 'mass-update-tracker --help' for CLI usage"