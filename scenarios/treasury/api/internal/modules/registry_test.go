...
// their own domains, so pinning the count would
...
//
// Kept at the registry boundary so the safety net applies automatically
// to every Connect-mounted domain registered in
