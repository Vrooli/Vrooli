...
// (health, authorization, settlement, …) returns a Module from its handlers package, and main.go
...
//
//   - Name is for diagnostics ("health", "authorization", "settlement"). Free-form;
