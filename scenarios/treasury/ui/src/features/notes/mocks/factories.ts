 ...
 * `packages/proto/gen/typescript/js/treasury/v1/notes/...`.
...
} from "@vrooli/proto-types/treasury/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/treasury/v1/notes/attachments_pb";
