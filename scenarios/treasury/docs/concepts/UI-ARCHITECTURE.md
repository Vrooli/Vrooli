...
react-component-library adoptions resolve-path <component-id> treasury
react-component-library adoptions apply <component-id> treasury <adopted-path>
```
...
Run `experience-manager spec validate treasury --json` after route or
selector changes. The generated notes page spec is example-domain content and
is removed by `template-manager detemplate treasury`.
