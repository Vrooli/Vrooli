...
import { buildTimelineEntries, buildToolGroupSummary, filterTimelineEntries, createDefaultTimelineFilterState, groupTimelineEntries, } from "../../src/lib/runTimeline.js";
...
function makeToolCall(id, seq, toolName, callId) {
    return makeEvent({
        id,
        sequence: seq,
...
function makeToolResult(id, seq, toolName, callId, success = true) {
    return makeEvent({
        id,
        sequence: seq,
...
function makeMessage(id, seq, content) {
    return makeEvent({
        id,
        sequence: seq,
