// Package toolexecution implements the Tool Execution Protocol for agent-manager.
//
// This package provides the server-side implementation of the Tool Execution Protocol,
// allowing external systems (like agent-inbox) to execute agent-manager tools via
// a standardized HTTP API.
//
// Protocol Contract:
//
//	Request:  POST /api/v1/tools/execute
//	          { "tool_name": "spawn_coding_agent", "arguments": {...} }
//
