...
func TestFeatureFlags_IsZero(t *testing.T) {
	tests := []struct {
		name  string
		flags FeatureFlags
		want  bool
		...
		{
			name:  "EnableBrowser false is zero",
			flags: FeatureFlags{EnableBrowser: false},
			want:  true,
		},
		{
			name:  "EnableBrowser true is not zero",
			flags: FeatureFlags{EnableBrowser: true},
			want:  false,
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.flags.IsZero(); got != tt.want {
...
// =============================================================================
// EXTRA FLAGS STRUCTURAL VALIDATION TESTS
// =============================================================================
