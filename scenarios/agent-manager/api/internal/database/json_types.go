...
// -----------------------------------------------------------------------------
// Investigation-specific JSON types
// -----------------------------------------------------------------------------

// AnalysisTypeJSON wraps domain.AnalysisType for JSONB scanning.
type AnalysisTypeJSON struct {
	V domain.AnalysisType
}

// Scan implements sql.Scanner for AnalysisTypeJSON.
func (a *AnalysisTypeJSON) Scan(src interface{}) error {
	if src == nil {
		a.V = domain.AnalysisType{}
		return nil
	}
	...
	case string:
		data = []byte(v)
	default:
		return scanTypeError("AnalysisTypeJSON", src)
	}

	return wrapScanError("AnalysisTypeJSON", json.Unmarshal(data, &a.V))
}

// Value implements driver.Valuer for AnalysisTypeJSON.
func (a AnalysisTypeJSON) Value() (driver.Value, error) {
	return json.Marshal(a.V)
}

// ReportSectionsJSON wraps domain.ReportSections for JSONB scanning.
type ReportSectionsJSON struct {
	V domain.ReportSections
}

// Scan implements sql.Scanner for ReportSectionsJSON.
func (r *ReportSectionsJSON) Scan(src interface{}) error {
	if src == nil {
		r.V = domain.ReportSections{}
		return nil
	}
	...
	case string:
		data = []byte(v)
	default:
		return scanTypeError("ReportSectionsJSON", src)
	}

	return wrapScanError("ReportSectionsJSON", json.Unmarshal(data, &r.V))
}

// Value implements driver.Valuer for ReportSectionsJSON.
func (r ReportSectionsJSON) Value() (driver.Value, error) {
	return json.Marshal(r.V)
}

// NullableInvestigationReport wraps *domain.InvestigationReport for JSONB scanning.
type NullableInvestigationReport struct {
	V *domain.InvestigationReport
}

// Scan implements sql.Scanner for NullableInvestigationReport.
func (n *NullableInvestigationReport) Scan(src interface{}) error {
	if src == nil {
		n.V = nil
		return nil
	}
	...
	case string:
		data = []byte(v)
	default:
		return scanTypeError("NullableInvestigationReport", src)
	}

	n.V = &domain.InvestigationReport{}
	return wrapScanError("NullableInvestigationReport", json.Unmarshal(data, n.V))
}

// Value implements driver.Valuer for NullableInvestigationReport.
func (n NullableInvestigationReport) Value() (driver.Value, error) {
	if n.V == nil {
		return nil, nil
	}
	return json.Marshal(n.V)
...
// NullableMetricsData wraps *domain.MetricsData for JSONB scanning.
type NullableMetricsData struct {
	V *domain.MetricsData
}

// Scan implements sql.Scanner for NullableMetricsData.
func (n *NullableMetricsData) Scan(src interface{}) error {
	if src == nil {
		n.V = nil
		return nil
	}
	...
	case string:
		data = []byte(v)
	default:
		return scanTypeError("NullableMetricsData", src)
	}

	n.V = &domain.MetricsData{}
	return wrapScanError("NullableMetricsData", json.Unmarshal(data, n.V))
}

// Value implements driver.Valuer for NullableMetricsData.
func (n NullableMetricsData) Value() (driver.Value, error) {
	if n.V == nil {
		return nil, nil
	}
	return json.Marshal(n.V)
