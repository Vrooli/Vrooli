...
func (db *DB) initSchema() error {
	...
	if err := db.migrateColumns(ctx, "workflow_executions", []columnMigration{{column: "parent_attempt_id", ddl: "ALTER TABLE workflow_executions ADD COLUMN parent_attempt_id TEXT"}, {column: "depth", ddl: "ALTER TABLE workflow_executions ADD COLUMN depth INTEGER NOT NULL DEFAULT 0"}, {column: "engagement_grant_json", ddl: "ALTER TABLE workflow_executions ADD COLUMN engagement_grant_json TEXT"}, {column: "approval_digest", ddl: "ALTER TABLE workflow_executions ADD COLUMN approval_digest TEXT NOT NULL DEFAULT ''"}, {column: "grant_digest", ddl: "ALTER TABLE workflow_executions ADD COLUMN grant_digest TEXT NOT NULL DEFAULT ''"}, {column: "execution_preferences_json", ddl: "ALTER TABLE workflow_executions ADD COLUMN execution_preferences_json TEXT NOT NULL DEFAULT ''"}}); err != nil {
		return err
	}
...
var runColumnMigrations = []columnMigration{
	...
	{column: "cancel_requested_at", ddl: "ALTER TABLE runs ADD COLUMN cancel_requested_at TEXT"},
	{column: "goal_delivery", ddl: "ALTER TABLE runs ADD COLUMN goal_delivery TEXT DEFAULT ''"},
	{column: "terminal_class", ddl: "ALTER TABLE runs ADD COLUMN terminal_class TEXT DEFAULT ''"},
	{column: "stop_reason", ddl: "ALTER TABLE runs ADD COLUMN stop_reason TEXT DEFAULT ''"},
	{column: "last_handoff", ddl: "ALTER TABLE runs ADD COLUMN last_handoff TEXT DEFAULT ''"},
