...
type Finding struct {
	...
	CitesResolvedCommands bool      `db:"cites_resolved_commands" json:"citesResolvedCommands"`
	CitesRealOutcome      bool      `db:"cites_real_outcome" json:"citesRealOutcome"`
	CitesAttributedOwner  bool      `db:"cites_attributed_owner" json:"citesAttributedOwner"`
	QualitySignal         string    `db:"quality_signal" json:"qualitySignal"`
}
