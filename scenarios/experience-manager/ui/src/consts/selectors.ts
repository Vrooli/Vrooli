...
const literalSelectors = {
  ...
  pages: {
    fleet: "page-fleet",
    explorer: "page-scenario-explorer",
  ...
  experience: {
    fleet: {
      debtTable: "fleet-debt-table",
      depthSummary: "fleet-depth-summary",
      coverageMeter: "fleet-coverage-meter",
      scenarioLink: "fleet-scenario-link",
      refreshAction: "fleet-refresh",
    },
    explorer: {
      depthGrid: "explorer-depth-grid",
      gapPanel: "explorer-gap-panel",
      claimList: "explorer-claim-list",
      tierLabel: "explorer-tier-label",
      evidenceLink: "explorer-evidence-link",
      studioAction: "explorer-open-studio",
    },
    evidence: {
      captureImage: "evidence-capture",
      treePanel: "evidence-tree",
      verdictList: "evidence-verdicts",
      evidenceLink: "evidence-link",
      recaptureAction: "evidence-recapture",
    },
    studio: {
      specForm: "studio-spec-form",
      wireframePreview: "studio-wireframe",
      variantRail: "studio-variant-rail",
      saveAction: "studio-save",
      promoteAction: "studio-promote",
      validationSummary: "studio-validation-summary",
    },
    findings: {
      findingsList: "findings-list",
      severityLabel: "findings-severity",
      evidenceLink: "findings-evidence-link",
      previewAction: "findings-preview-fix",
      applyAction: "findings-apply-fix",
    },
  },
  errorBoundary: {
