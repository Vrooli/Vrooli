...
// `packages/proto/gen/go/experience-manager/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/experience-manager/v1/shared/health.proto`
