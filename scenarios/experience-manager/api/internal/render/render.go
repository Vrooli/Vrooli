...
func css() string {
	return `:root{font-family: Inter,Arial,sans-serif;color: #172026;background: #f7f7f4}body{margin: 0}.wireframe{max-width: 1180px;margin: 0 auto;padding: 32px}.hero{border-bottom: 2px solid #172026;padding-bottom: 20px}.eyebrow{font-size: 12px;text-transform: uppercase;letter-spacing: 0;color: #6b6f59}h1{font-size: 32px;line-height: 1.1;margin: 0 0 12px}nav{display: flex;gap: 8px;flex-wrap: wrap}nav span,.role{border: 1px solid #909482;padding: 3px 7px;background: #fff}.priorities{display: grid;grid-template-columns: repeat(auto-fit,minmax(220px,1fr));gap: 12px;margin: 20px 0}.priorities article,.region,.claim{background: #fff;border: 2px solid #2f3a40;border-radius: 6px;padding: 14px}.grid{display: grid;grid-template-columns: repeat(auto-fit,minmax(260px,1fr));gap: 16px}.element{border: 1px dashed #687078;padding: 12px;margin: 10px 0;background: #fafafa}.element strong{display: block;margin-top: 8px}.element code{display: inline-block;margin-top: 8px;color: #7b3f00}.claims{display: grid;grid-template-columns: repeat(auto-fit,minmax(240px,1fr));gap: 12px;margin-top: 20px}.claim header{display: flex;justify-content: space-between;gap: 12px}.claim.machine{border-color: #1f6f54}.claim.manual{border-color: #8a5a00}.claim.aspirational{border-color: #6b5fb5}`
}

func variantCSS() string {
	return `.variant-compare{max-width: 1440px;margin: 0 auto;padding: 32px}.variant-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(420px,1fr));gap:16px;margin-top:20px}.variant{background:#fff;border:2px solid #2f3a40;border-radius:6px;padding:14px}.variant h2{font-size:18px;margin:0 0 12px}.variant iframe{width:100%;height:720px;border:1px solid #909482;background:#f7f7f4}`
}
