...
```bash
export SQLITE_PATH=/tmp/experience-manager.db
make start
```
...
```bash
fuser "$(echo "${SQLITE_PATH:-${SCENARIO_DATA_DIR}/experience-manager.db}")"
```
...
`packages/proto/gen/typescript/js/experience-manager/v1/`, and Python under
