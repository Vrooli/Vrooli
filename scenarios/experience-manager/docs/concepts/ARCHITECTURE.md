# Architecture — Experience Manager
...
| Contracts (`packages/proto/schemas/experience-manager/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/experience-manager/`.
...
```
packages/proto/schemas/experience-manager/v1/<domain>/<file>.proto
       │
       ▼
       make generate
       │
       ├──▶ packages/proto/gen/go/experience-manager/v1/...              (api, cli)
       ├──▶ packages/proto/gen/go/experience-manager/v1/...connect       (Connect-Go)
       ├──▶ packages/proto/gen/typescript/js/experience-manager/v1/...   (ui)
       └──▶ packages/proto/gen/python/experience_manager/v1/...    (future tools)
```
...
1. Add proto messages and service methods under
   `packages/proto/schemas/experience-manager/v1/<domain>/`.
