...
// `packages/proto/gen/go/vrooli-memory/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/vrooli-memory/v1/shared/health.proto`
