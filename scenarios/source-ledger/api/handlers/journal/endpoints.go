...
var Endpoints = []module.EndpointDescriptor{
	...
	{ID: "journal_count_entries", Path: journalconnect.JournalServiceCountEntriesProcedure, Method: "POST", Summary: "Count journal entries in a time window", Category: "measures", Request: &module.Schema{Type: "CountEntriesRequest"}, Response: &module.Schema{Type: "CountEntriesResponse"}},
}
