...
SCRIPT_DIR="${APP_ROOT}/scenarios/secure-document-processing"
...
# Main test function
test_secure_document_processing_workflow() {
    print_custom_info "Testing secure document processing business workflow"
...
# Export functions
export -f test_secure_document_processing_workflow
