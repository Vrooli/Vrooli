...
### Impact
No test failures, but noisy errors during test runs and potential confusion when re-applying schema.

### Fix (2026-01-26)
Updated schema to use `CREATE INDEX IF NOT EXISTS` and `DROP TRIGGER IF EXISTS` before re-creating triggers.
...
- Add `🎨 UX & Branding`
- Move progress history items (Sessions 1-19) to docs/internal/PROGRESS.md
...
- Move Session 1-19 progress entries from PRD to docs/internal/PROGRESS.md
