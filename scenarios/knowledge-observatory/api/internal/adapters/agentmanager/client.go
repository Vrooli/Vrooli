...
// ReconcileScenarioProfiles activates the target scenario's declared,
// repository-owned profile sources. Agent Manager remains the only profile
// writer; consumers never supply inline profile defaults.
