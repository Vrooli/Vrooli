...
- [ ] OT-P0-002 | Knowledge quality metrics | Coherence, freshness, redundancy, and coverage metrics per collection
- [ ] OT-P0-003 | Knowledge graph access | API-powered graph endpoint for semantic relationships
