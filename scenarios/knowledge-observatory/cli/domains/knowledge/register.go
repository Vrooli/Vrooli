...
func Register(deps support.Dependencies) cliapp.CommandGroup {
	return cliapp.CommandGroup{
		...
		Commands: []cliapp.Command{
			...
			{Name: "ingest-health", NeedsAPI: false, Description: "Inspect ingest queue and runner health", Run: func(args []string) error { return ingestHealth(deps, args) }},
			...
			{Name: "document-delete", NeedsAPI: false, Description: "Delete all chunks for a document (dry-run by default)", Run: func(args []string) error { return documentDelete(deps, args) }},
