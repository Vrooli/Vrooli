...
import { _resetMicOwnershipForTesting, acquireMicStream, getActiveMicLeases, installMicLifecycleCleanup, registerMicStream, releaseAllMicLeases, releaseMicLease, subscribeMicLeases, } from "./micOwnership";
function fakeTrack() {
    const listeners = {};
    const t = {
        readyState: "live",
