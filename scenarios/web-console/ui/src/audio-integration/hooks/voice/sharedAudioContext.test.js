...
import { armIdleSuspend, closeSharedAudioContext, ensureRunningSharedAudioContext, keepAudioContextAwake, suspendSharedAudioContext, } from "./sharedAudioContext";
...
class FakeAudioContext {
    constructor(initial = "suspended") {
        this.resume = vi.fn(async () => { if (this.resumeRecovers)
            this.state = "running"; });
        this.close = vi.fn(async () => { this.state = "closed"; });
        this.resumeRecovers = true;
        this.state = initial;
