// Multipart file uploads for session attachments (images, video, audio, PDF,
// archives, text/code). Stays on plain HTTP because Connect-RPC binary payloads
// are not yet wired for this path.
