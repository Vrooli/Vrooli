...
export const ESC_KEY = { label: "Esc", input: "\x1b", width: "normal" };
export const TAB_KEY = { label: "Tab", input: "\t", width: "normal" };
export const ENTER_KEY = { label: "Enter", input: "\r", width: "normal" };
export const ARROW_UP = { label: "\u2191", input: "\x1b[A", width: "narrow" };
export const ARROW_DOWN = { label: "\u2193", input: "\x1b[B", width: "narrow" };
export const ARROW_LEFT = { label: "\u2190", input: "\x1b[D", width: "narrow" };
export const ARROW_RIGHT = { label: "\u2192", input: "\x1b[C", width: "narrow" };
/** Standard terminal keys for mobile usage (compact layout). */
export const TOOLBAR_KEYS = [ESC_KEY, TAB_KEY, ARROW_UP, ARROW_DOWN, ARROW_LEFT, ARROW_RIGHT];
/**
 ...
 */
export function applyModifiers(input, mods) {
