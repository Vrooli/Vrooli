...
function renderConfirm(props = {}) {
    ...
    const result = render(_jsx(ConfirmDialog, { open: true, title: "Delete thing?", body: "This cannot be undone.", cancelLabel: "Keep it", confirmLabel: "Delete", onCancel: onCancel, onConfirm: onConfirm, testIdPrefix: "test-confirm", ...props }));
