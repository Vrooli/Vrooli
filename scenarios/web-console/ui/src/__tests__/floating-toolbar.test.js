...
vi.mock("../hooks/useLongPress", () => ({
    useLongPress: ({ onPress, onLongPress }) => ({
        onPointerDown: vi.fn(),
        onPointerUp: () => onPress(),
        onPointerCancel: vi.fn(),
        onContextMenu: (event) => {
...
describe("FloatingToolbar", () => {
    ...
    function renderToolbar(isCreating = false) {
        return render(_jsx(FloatingToolbar, { onOpenSettings: onOpenSettings, onOpenAi: onOpenAi, onNewTerminal: onNewTerminal, onOpenLauncher: onOpenLauncher, onExpandComposer: onExpandComposer, isCreating: isCreating }));
    }
