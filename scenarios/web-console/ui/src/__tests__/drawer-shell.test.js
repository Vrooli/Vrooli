...
function renderDrawer(props = {}) {
    const onClose = vi.fn();
    const result = render(_jsx(DrawerShell, { open: true, onClose: onClose, closeAriaLabel: "Close drawer", title: "Test Drawer", panelTestId: "test-drawer-panel", ...props, children: _jsxs("div", { children: [_jsx("button", { "data-testid": "inner-first", children: "First" }), _jsx("button", { "data-testid": "inner-last", children: "Last" })] }) }));
...
describe("DrawerShell", () => {
    ...
    it("renders headerActions and headerExtra in the header", () => {
        renderDrawer({
            headerActions: _jsx("button", { "data-testid": "hdr-action", children: "A" }),
            headerExtra: _jsx("div", { "data-testid": "hdr-extra", children: "extra" }),
        });
