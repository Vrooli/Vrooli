...
describe("matchProseFilePaths", () => {
    const paths = (text) => matchProseFilePaths(text).map((m) => m.path);
    ...
    it("matches deep absolute paths with dot-dirs, hyphens, and underscores", () => {
        const text = "Looks like it’s matching the negatives /home/matthalloran8/.vrooli/cache/vrooli/web-console/uploads/e802040e-8e0a-4fed-a776-34d1eed75bb1/IMG_9951.png";
