...
export function relativeLuminanceRgb(rgb) {
    const channel = (c) => {
        const s = c / 255;
 ...
 */
export function parsePaneColor(value) {
 ...
 */
export function serializePaneColor(colors) {
    const valid = colors
 ...
 */
export function nextGroupColor(existingColors) {
 ...
 */
export function paneAccentStyle(headerColor, groupColor, variant) {
    return (paneColorStyle(headerColor, variant)
 ...
 */
export function paneColorStyle(value, variant) {
