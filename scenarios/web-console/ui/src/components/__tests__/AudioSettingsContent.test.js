...
function renderContent(overrides) {
    return render(_jsx(AudioSettingsContent, { testIdPrefix: "x", volume: 0.8, isMuted: false, playbackRate: 1, isSummarized: false, capabilities: fullCapabilities, onVolumeChange: vi.fn(), onSetMuted: vi.fn(), onSetPlaybackRate: vi.fn(), ...overrides }));
}
