...
function renderSidebar(bucketNav) {
    return render(_jsx(SessionSidebar, { buckets: bucketNav, containerRef: createRef(), isMobile: false, mobileOpen: false, onCloseMobile: vi.fn(), onActivatePane: vi.fn(), onClosePane: vi.fn(), onNewTerminal: vi.fn(), onOpenLauncher: vi.fn(), onNewSessionInGroup: vi.fn(), onOpenSettings: vi.fn() }));
}
