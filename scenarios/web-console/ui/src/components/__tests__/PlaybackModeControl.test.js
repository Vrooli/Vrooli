...
function renderCtl(overrides) {
    return render(_jsx(PlaybackModeControl, { testIdPrefix: "x", isSummarized: false, hasOriginalVersion: false, canSummarize: true, isSummarizing: false, currentLevel: "moderate", onToggleSummarized: vi.fn(), onChangeLevel: vi.fn(), ...overrides }));
}
