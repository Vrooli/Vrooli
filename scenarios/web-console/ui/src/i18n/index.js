...
const isSupported = (lng) => Boolean(lng && SUPPORTED_LOCALES.includes(lng));
...
export const setLocale = (lng) => i18n.changeLanguage(lng).then(() => undefined);
export const getLocaleConfig = (lng) => LOCALE_CONFIG[lng];
/**
 ...
 */
export const getCurrentLocale = () => isSupported(i18n.language) ? i18n.language : "en";
