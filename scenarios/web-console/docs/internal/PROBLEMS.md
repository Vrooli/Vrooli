...
- Rung: W1
- Evidence: `business-health validate scenario web-console` reports `business_status_unearned` for eight requirements declared complete while no requirements-sync snapshot exists.
