...
| 2026-09-18 | Codex | Documentation-first remote desktop baseline | Documented the Web Console desktop pane as a presentation client over Bridge and Device Control, including security and reconnect behavior. |
