...
func (fakeMetricsService) Snapshot(context.Context) Snapshot {
	return Snapshot{Sessions: SessionMetrics{Created: 1, Deleted: 2, Active: 3, Resizes: 4}, Connections: ConnectionMetrics{Total: 5, Active: 6}, Messages: MessageMetrics{Sent: 7, Received: 8}, Reattach: ReattachMetrics{Attempts: 9, Successes: 10, Failures: 11}, Recovery: RecoveryMetrics{Recovered: 12, OrphanedMeta: 13, OrphanedTmux: 14, AttachRetries: 15, PreservedForNow: 16}, AIGenerations: 17, AISuggestions: 18, VoiceSkipVerificationTotal: 19, Continuity: ContinuityMetrics{Receipts: 20, Failures: 21, Orphans: 22}, Uptime: "up"}
}
...
func TestConnectHandlerMetricsProjectsSnapshot(t *testing.T) {
	...
	if err != nil || resp.Msg.Sessions.Created != 1 || resp.Msg.Recovery.PreservedForFutureRecovery != 16 || resp.Msg.AiSuggestions != 18 || resp.Msg.Continuity.Orphans != 22 {
