...
| `Extract` returns `ErrWorkspaceUnsupported` | Look for `pnpm-workspace.yaml` in ancestors | Point at a specific project inside the workspace. Workspace support is P2 (OT-P2-005). | Promote OT-P2-005 if a real consumer needs workspace mode. |
