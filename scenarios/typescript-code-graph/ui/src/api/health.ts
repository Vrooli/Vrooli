...
import { ResponseSchema } from "@vrooli/proto-types/typescript-code-graph/v1/health/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/typescript-code-graph/v1/health/health_pb";
