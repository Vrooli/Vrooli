...
import {
  ...
  ImportRewriteSchema,
  OperationStatus,
} from "@vrooli/proto-types/typescript-code-graph/v1/rewrite/rewrite_pb";
import type {
  Operation,
  OperationResult,
} from "@vrooli/proto-types/typescript-code-graph/v1/rewrite/rewrite_pb";
...
// Re-export the shared TypeScriptCodeGraphService client so rewrite controllers
// do not reach across to ./graph for the transport. Same client, narrower
// import site.
export { tsCodeGraphClient } from "./graph";
