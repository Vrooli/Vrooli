 ...
 * `packages/proto/gen/typescript/js/typescript-code-graph/v1/notes/...`.
...
} from "@vrooli/proto-types/typescript-code-graph/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/typescript-code-graph/v1/notes/attachments_pb";
