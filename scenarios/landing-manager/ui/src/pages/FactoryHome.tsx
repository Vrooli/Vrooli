      ...
      <div className="max-w-6xl mx-auto px-6 py-16 space-y-12">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 space-y-3">
            ...
            <p className="text-sm text-slate-300">
              ...
              Generate, start, and view at <code className="px-1 py-0.5 rounded bg-slate-900">http://localhost:&lt;UI_PORT&gt;</code> and{' '}
              <code className="px-1 py-0.5 rounded bg-slate-900">http://localhost:&lt;UI_PORT&gt;/admin</code> after start.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 space-y-3">
            ...
            <div className="space-y-1 text-xs text-slate-200">
              <code className="block rounded-lg bg-slate-900 px-3 py-2 border border-white/10">
                landing-manager generate saas-landing-page --name "demo" --slug "demo" --dry-run
              </code>
              <code className="block rounded-lg bg-slate-900 px-3 py-2 border border-white/10">
                landing-manager generate saas-landing-page --name "demo" --slug "demo"
              </code>
            </div>
          </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6 space-y-4">
          ...
          <ol className="list-decimal list-inside space-y-2 text-slate-200 text-sm">
            <li>Dry-run first (plan only), then generate a new landing scenario via the CLI.</li>
            <li>Move <code className="px-1 py-0.5 rounded bg-slate-900">generated/&lt;slug&gt;</code> into <code className="px-1 py-0.5 rounded bg-slate-900">/scenarios/&lt;slug&gt;</code> and start it with <code className="px-1 py-0.5 rounded bg-slate-900">vrooli scenario start &lt;slug&gt;</code>.</li>
            <li>Preview landing at <code className="px-1 py-0.5 rounded bg-slate-900">http://localhost:&lt;UI_PORT&gt;/</code> and admin at <code className="px-1 py-0.5 rounded bg-slate-900">/admin</code> from the generated scenario.</li>
