...
import { getVariant, createVariant, updateVariant, getSections, type Variant, type ContentSection } from '../lib/api';
...
export function VariantEditor() {
  ...
  const fetchVariant = async () => {
    ...
    try {
      ...
      // Fetch sections
      const sectionsData = await getSections(variantData.id);
