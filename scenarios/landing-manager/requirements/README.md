...
- Template-owned features (admin portal, A/B testing, metrics, Stripe, customization UX) live in the template at `templates/scenarios/landing-page-react-vite` and are validated in generated scenarios, not here.
