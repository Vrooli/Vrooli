...
export const strings = {
  ...
  health: {
    ...
    providerMaturity: "health.providerMaturity",
    providerLoading: "health.providerLoading",
    providerUnavailable: "health.providerUnavailable",
    providerHistorical: "health.providerHistorical",
    providerContract: "health.providerContract",
    providerNorthStar: "health.providerNorthStar",
    providerNextAction: "health.providerNextAction",
    providerCapabilities: "health.providerCapabilities",
    providerDocumentation: "health.providerDocumentation",
  },
  notifications: {
