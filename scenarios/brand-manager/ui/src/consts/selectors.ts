...
const literalSelectors = {
  ...
  logo: {
    brandSelect: "logo-brand-select",
    loading: "logo-loading",
    empty: "logo-empty",
    error: "logo-error",
    gallery: "logo-gallery",
    card: "logo-candidate-card",
    cardThumb: "logo-candidate-thumb",
    cardStatus: "logo-candidate-status",
    cardConcept: "logo-candidate-concept",
    cardPick: "logo-candidate-pick",
    cardReject: "logo-candidate-reject",
    cardRestore: "logo-candidate-restore",
    cardCompare: "logo-candidate-compare",
    compare: "logo-compare",
    compareItem: "logo-compare-item",
    exploreForm: "logo-explore-form",
    ...
    refineSubmit: "logo-refine-submit",
    vectorizeSubmit: "logo-vectorize-submit",
    maskBrush: "logo-mask-brush",
    maskSubmit: "logo-mask-submit",
    preview: "logo-target-preview",
    previewTile: "logo-preview-tile",
    previewMaskable: "logo-preview-maskable",
  },
  apply: {
    card: "apply-card",
