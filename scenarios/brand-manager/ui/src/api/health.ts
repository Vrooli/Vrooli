...
import { ResponseSchema } from "@vrooli/proto-types/brand-manager/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/brand-manager/v1/shared/health_pb";
