...
const NAV_ICONS = {
  ...
  brands: <Aperture aria-hidden className="h-5 w-5" />,
...
/** Library-owned shell adapter for the Brand Manager navigated console. */
export function AppShell() {
  ...
  return (
    <LibraryAppShell
      ...
      sidebarStorageKey="brand-manager.sidebar-width"
