...
| Contracts (`packages/proto/schemas/brand-manager/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/brand-manager/`.
...
|---|---|---|---|
| 2026-06-27 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
