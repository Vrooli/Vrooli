...
// `packages/proto/gen/go/brand-manager/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/brand-manager/v1/shared/health.proto`
