...
var Endpoints = []module.EndpointDescriptor{
	...
	},
	{
		...
		Request: &module.Schema{Type: "object", Properties: map[string]string{
			...
			"allow_byok":      "bool (permit metered BYOK cloud fallback unless fallback_policy=local_only)",
			"quality_policy":  "string (quality | balanced | fast; default quality)",
			"fallback_policy": "string (any | cloud_allowed | local_only; default any)",
			"priority":        "string (service | interactive | batch; default service)",
			"allow_reclaim":   "optional bool (permit cold-idle local resource reclaim; default true)",
