...
# Main test function
test_campaign_content_studio_workflow() {
    print_custom_info "Testing campaign content studio business workflow"
...
# Export functions
export -f test_campaign_content_studio_workflow
