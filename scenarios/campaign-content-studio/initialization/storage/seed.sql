-- Campaign Content Studio Seed Data
-- Campaign-based content management demo data

-- Insert application metadata
INSERT INTO campaign_content_studio.app_metadata (
...
INSERT INTO campaign_content_studio.campaigns (
...
INSERT INTO campaign_content_studio.app_config (config_key, config_value, config_type, description) VALUES 
    -- Feature flags
    ...
    ('app_name', '"Campaign Content Studio"'::jsonb, 'setting', 'Application display name'),
    ...
    ('ui_brand_name', '"Campaign Content Studio"'::jsonb, 'setting', 'Brand name displayed in UI'),
...
INSERT INTO campaign_content_studio.campaign_documents (
...
INSERT INTO campaign_content_studio.user_sessions (
...
INSERT INTO campaign_content_studio.generated_content (
    ...
    (
        ...
        (SELECT id FROM campaign_content_studio.user_sessions WHERE session_id = 'demo-session-002'),
        'agency-user',
        1150
    );

-- Insert sample activity log entries
INSERT INTO campaign_content_studio.activity_log (
...
INSERT INTO campaign_content_studio.resource_metrics (
...
SELECT 'Application metadata:' as info, COUNT(*) as count FROM campaign_content_studio.app_metadata
UNION ALL
SELECT 'Campaigns:', COUNT(*) FROM campaign_content_studio.campaigns
UNION ALL
SELECT 'Documents:', COUNT(*) FROM campaign_content_studio.campaign_documents
UNION ALL
SELECT 'Generated content:', COUNT(*) FROM campaign_content_studio.generated_content
UNION ALL
SELECT 'Configuration entries:', COUNT(*) FROM campaign_content_studio.app_config
UNION ALL
SELECT 'User sessions:', COUNT(*) FROM campaign_content_studio.user_sessions
UNION ALL
SELECT 'Activity log entries:', COUNT(*) FROM campaign_content_studio.activity_log
UNION ALL
SELECT 'Resource metrics:', COUNT(*) FROM campaign_content_studio.resource_metrics;

-- Display sample campaign summary
SELECT * FROM campaign_content_studio.campaign_summary;
