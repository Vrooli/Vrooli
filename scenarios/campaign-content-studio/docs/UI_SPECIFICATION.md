# Campaign Content Studio - UI Design Specification

> **Note**: This document contains detailed UI/UX specifications extracted from the original PRD.
> The canonical PRD has been restructured to follow Vrooli standards; refer to PRD.md for operational targets and product overview.
