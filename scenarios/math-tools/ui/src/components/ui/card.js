...
const Card = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { ref: ref, className: cn('rounded-xl border border-slate-800 bg-card text-card-foreground shadow-lg shadow-black/20', className), ...props })));
