...
// test to write.
//
// REST-exception-only domains are simply not listed here; the global
// test never inspects them, and the gen-endpoints validateTransport
// pass enforces their RESTException tags at codegen time.
