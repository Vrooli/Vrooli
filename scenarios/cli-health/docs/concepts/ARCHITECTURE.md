...
| Contracts (`packages/proto/schemas/cli-health/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/cli-health/`.
...
```
packages/proto/schemas/cli-health/v1/<domain>/<file>.proto
       │
       ▼
       make generate
       │
       ├──▶ packages/proto/gen/go/cli-health/v1/...              (api, cli)
       ├──▶ packages/proto/gen/go/cli-health/v1/...connect       (Connect-Go)
       ├──▶ packages/proto/gen/typescript/js/cli-health/v1/...   (ui)
       └──▶ packages/proto/gen/python/cli_health/v1/...    (future tools)
```
...
1. Add proto messages and service methods under
   `packages/proto/schemas/cli-health/v1/<domain>/`.
...
|---|---|---|---|
| 2026-05-19 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
