...
var Endpoints = []module.EndpointDescriptor{
	...
	{
		ID:          "validation_assign_fixed_port",
		Path:        validationconnect.ValidationServiceAssignFixedPortProcedure,
		Method:      "POST",
		Summary:     "Assign a free in-band fixed port to a scenario",
		Description: "Switches a scenario's port (default \"ui\") from a canonical range to a free, conflict-free fixed port inside the canonical band so it can be exposed as a scenario route. Format-preserving and idempotent; apply=false previews.",
		Category:    "validation",
		Request:     &module.Schema{Type: "object", Properties: map[string]string{"scenario": "string", "path": "string", "port_name": "string", "apply": "bool"}},
		Response:    &module.Schema{Type: "object", Properties: map[string]string{"scenario": "string", "port_name": "string", "previous_port": "int32", "assigned_port": "int32", "changed": "bool", "applied": "bool", "before": "string", "after": "string", "message": "string"}},
		Errors:      []module.ErrorDesc{{Status: 400, Code: "invalid_argument", Description: "Scenario/path missing/unresolvable, no canonical band, or no free port"}},
	},
	{
		ID:          "validation_release_fixed_port",
		Path:        validationconnect.ValidationServiceReleaseFixedPortProcedure,
		Method:      "POST",
		Summary:     "Release a scenario's fixed port back to its range",
		Description: "Reverts a scenario's port back to the canonical range. Format-preserving and idempotent; apply=false previews.",
		Category:    "validation",
		Request:     &module.Schema{Type: "object", Properties: map[string]string{"scenario": "string", "path": "string", "port_name": "string", "apply": "bool"}},
		Response:    &module.Schema{Type: "object", Properties: map[string]string{"scenario": "string", "port_name": "string", "previous_port": "int32", "assigned_port": "int32", "changed": "bool", "applied": "bool", "before": "string", "after": "string", "message": "string"}},
		Errors:      []module.ErrorDesc{{Status: 400, Code: "invalid_argument", Description: "Scenario/path missing/unresolvable or no canonical band"}},
	},
	{
	...
	},
	{
		...
		Method:      "POST",
		Summary:     "Preview deterministic structure fixes through the shared provider contract",
		Description: "Returns the format-preserving service.json edits and skeleton files structure-health could apply for the requested rules, in the shared scenario-validation FixResponse shape, without writing anything.",
		Category:    "validation",
	...
	},
	{
		...
		Method:      "POST",
		Summary:     "Apply deterministic structure fixes through the shared provider contract",
		Description: "Applies the format-preserving service.json edits and skeleton files for the requested rules and reports what changed, in the shared scenario-validation FixResponse shape.",
		Category:    "validation",
		Request:     &module.Schema{Type: "object", Properties: map[string]string{"scenario": "string", "path": "string", "rule_ids": "array<string>"}},
		Response:    &module.Schema{Type: "object", Properties: map[string]string{"scenario": "string", "applied": "bool", "candidates": "array<scenario_validation.v1.FixCandidate>", "messages": "array<string>"}},
		Errors:      []module.ErrorDesc{{Status: 400, Code: "invalid_argument", Description: "Scenario/path is missing or cannot be resolved"}},
