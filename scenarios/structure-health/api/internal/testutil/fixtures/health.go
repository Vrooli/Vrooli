...
// `packages/proto/gen/go/structure-health/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/structure-health/v1/shared/health.proto`
