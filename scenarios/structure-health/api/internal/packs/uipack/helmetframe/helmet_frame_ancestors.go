...
func CheckHelmetFrameAncestors(content []byte, filePath string) []auditrules.Violation {
...
func newHelmetViolation(filePath string, line int, message string) auditrules.Violation {
	if line <= 0 {
		line = 1
	}
