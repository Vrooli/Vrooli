 ...
 * `packages/proto/gen/typescript/js/structure-health/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/structure-health/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/structure-health/v1/shared/health_pb";
