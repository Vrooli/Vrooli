...
| Contracts (`packages/proto/schemas/structure-health/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/structure-health/`.
...
1. Add proto messages and service methods under
   `packages/proto/schemas/structure-health/v1/<domain>/`.
...
|---|---|---|---|
| 2026-06-20 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
