...
- Blocker: minimouse loses its entire scenario workload on reboot (Colima plus scenario autostart); pending an operator decision on whether that workload should return automatically.
- Measured: 2026-09-15
