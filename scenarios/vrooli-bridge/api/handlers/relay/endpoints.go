...
var Endpoints = []module.EndpointDescriptor{
	{
		...
		Response:    &module.Schema{Type: "object", Properties: map[string]string{"correlation_id": "string", "outcome": "RelayCallOutcome", "data": "bytes", "reason": "string", "exit_code": "int32", "total_bytes": "uint64", "route": "string", "route_cost_units": "uint64", "route_latency_ms": "uint64"}},
	...
	{
		ID: "relay_reconcile", Path: relayconnect.RelayServiceReconcileProcedure, Method: "POST",
		Summary:     "Reconcile a possibly delivered relay command",
		Description: "Owner-gated read of the durable command journal; callers must resolve submitted or unknown commands before fallback.",
		Category:    "relay",
		Request:     &module.Schema{Type: "object", Properties: map[string]string{"node_id": "string", "command_id": "string"}},
		Response:    &module.Schema{Type: "object", Properties: map[string]string{"command_id": "string", "state": "RelayReconcileState", "response": "RelayCallResponse", "reason": "string"}},
		Errors: []module.ErrorDesc{
			{Status: 400, Code: "invalid_argument", Description: "Node and command identity are required"},
			{Status: 401, Code: "unauthenticated", Description: "Owner authentication required"},
			{Status: 404, Code: "not_found", Description: "Command receipt was not found"},
		},
	},
}
