...
var Endpoints = []module.EndpointDescriptor{
	{
		...
		RESTException: &module.RESTException{
			...
			ProtoPayloads: &module.RESTProtoPayloads{
				...
				Response: module.RESTPayload{ProtoFullName: "vrooli.vrooli_bridge.v1.health.Response", Transport: "json", Conformance: "protojson"},
				Error:    module.RESTPayload{ProtoFullName: "vrooli.vrooli_bridge.v1.errors.ErrorEnvelope", Transport: "json", Conformance: "protojson"},
			},
		},
	},
}
