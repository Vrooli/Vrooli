...
func Module(svc *internalpairing.Service, controlPlanePublicKey string, defaultScopes []string, presets []internalpairing.PermissionPreset, verifier *nodeauth.Verifier, logger *log.Logger) module.Module {
