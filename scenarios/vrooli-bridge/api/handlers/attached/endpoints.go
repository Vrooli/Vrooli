...
var Endpoints = []module.EndpointDescriptor{
	...
	{ID: "attached_get", Path: "/vrooli.vrooli_bridge.v1.attached_devices.AttachedDeviceService/GetAttachedDevice", Method: "POST", Summary: "Read attached-device trust state", Category: "attached-devices"},
