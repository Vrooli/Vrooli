...
func newDMHarness(t *testing.T) *dmHarness {
	...
	repo.Seed(registry.Node{ID: "ubuntu-1", Name: "ci-linux", OS: "linux", Arch: "amd64", Scopes: []string{"vrooli-bridge:write", "vrooli:write"}})
	repo.Seed(registry.Node{ID: "mac-1", Name: "ci-darwin", OS: "darwin", Arch: "arm64", Scopes: []string{"vrooli-bridge:write", "vrooli:write"}})
	repo.Seed(registry.Node{ID: "win-1", Name: "ci-windows", OS: "windows", Arch: "amd64", Scopes: []string{"vrooli-bridge:write", "vrooli:write"}})
