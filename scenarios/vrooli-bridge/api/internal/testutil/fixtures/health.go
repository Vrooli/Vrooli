...
// `packages/proto/gen/go/vrooli-bridge/v1/health/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/vrooli-bridge/v1/health/health.proto`
