...
import (
	...
	notesv1 "github.com/vrooli/vrooli/packages/proto/gen/go/vrooli-bridge/v1/notes"
...
// the template itself does not build because of vrooli-bridge placeholders.
func TestNotesManifestCoversNotesService(t *testing.T) {
	manifest := readNotesManifest(t)
	cliapp.RequireProtoServiceCoverage(t, manifest, notesv1.File_vrooli_bridge_v1_notes_notes_proto, "NotesService")
}
