 ...
 * `packages/proto/gen/typescript/js/vrooli-bridge/v1/notes/...`.
...
} from "@vrooli/proto-types/vrooli-bridge/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/vrooli-bridge/v1/notes/attachments_pb";
