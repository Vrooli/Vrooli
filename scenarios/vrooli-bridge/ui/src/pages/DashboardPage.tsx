 ...
 * the API health card, the pairing form, the fleet panel (presence + OS/arch/
 * version/health + live per-node job status + revoke), and the run-history feed
 * so the full operator flow — pair a node, watch dispatch land, follow a run to
 * completion — is reachable without leaving the page.
 */
