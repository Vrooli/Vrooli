 ...
 * `packages/proto/gen/typescript/js/vrooli-bridge/v1/health/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/vrooli-bridge/v1/health/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/vrooli-bridge/v1/health/health_pb";
