...
Local-first image toolbox: deterministic editing, on-demand AI generation/enhancement, and image analysis via CLI, UI, and API.
...
`test-genie execute image-tools --preset comprehensive` directly for
