...
import (
	...
	notesconnect "github.com/vrooli/vrooli/packages/proto/gen/go/image-tools/v1/notes/notes_v1connect"

	measuresv1 "github.com/vrooli/vrooli/packages/proto/gen/go/measures/v1"

	internalnotes "image-tools/internal/notes"
	mocks "image-tools/internal/notes/mocks"
	clockmocks "image-tools/internal/testutil/mocks"
)
