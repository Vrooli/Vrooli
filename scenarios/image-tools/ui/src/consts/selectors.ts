...
const literalSelectors = {
  ...
  editor: {
    ...
    stack: {
      card: "editor-stack-card",
      fileInput: "editor-stack-file-input",
      operationSelect: "editor-stack-operation-select",
      applyButton: "editor-stack-apply-button",
      undoButton: "editor-stack-undo-button",
      redoButton: "editor-stack-redo-button",
      resetButton: "editor-stack-reset-button",
      list: "editor-stack-list",
      empty: "editor-stack-empty",
      error: "editor-stack-error",
      preview: "editor-stack-preview",
    },
    compare: {
      root: "editor-compare-root",
