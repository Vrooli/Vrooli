...
//
// Domain-specific factories (Job, ListJobsResponse, etc.) are NOT
// re-exported here — they live next to the feature they double for
// (e.g. `features/jobs/mocks/factories.ts`) so deleting a feature
...
// (e.g. `makeJobsMocks`) live with their feature.
