 ...
 * (e.g. `features/jobs/mocks/factories.ts`); only truly cross-domain
 ...
 * `packages/proto/gen/typescript/js/image-tools/v1/health/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/image-tools/v1/health/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/image-tools/v1/health/health_pb";
