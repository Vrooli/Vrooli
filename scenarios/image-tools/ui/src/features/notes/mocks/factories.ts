 ...
 * `packages/proto/gen/typescript/js/image-tools/v1/notes/...`.
...
} from "@vrooli/proto-types/image-tools/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/image-tools/v1/notes/attachments_pb";
