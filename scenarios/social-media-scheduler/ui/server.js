...
// Expose shared iframe bridge assets for the static UI
app.use(
  '/vendor/@vrooli/iframe-bridge',
  express.static(path.join(__dirname, 'node_modules', '@vrooli', 'iframe-bridge', 'dist'))
);
