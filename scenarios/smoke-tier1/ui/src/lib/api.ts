...
import type { Response as HealthResponse } from "@vrooli/proto-types/smoke-tier1/v1/health/health_pb";
 ...
 *
 * The wire shape lives in `packages/proto/schemas/smoke-tier1/v1/health/health.proto`
