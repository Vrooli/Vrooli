...
// `packages/proto/gen/go/security-health/v1/health/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/security-health/v1/health/health.proto`
