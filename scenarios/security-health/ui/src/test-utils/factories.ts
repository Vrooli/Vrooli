 ...
 * `packages/proto/gen/typescript/js/security-health/v1/health/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/security-health/v1/health/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/security-health/v1/health/health_pb";
