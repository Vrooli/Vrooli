...
| Contracts (`packages/proto/schemas/security-health/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/security-health/`.
...
packages/proto/schemas/security-health/v1/<domain>/<file>.proto
       ...
       make generate
       │
       ├──▶ packages/proto/gen/go/security-health/v1/...              (api, cli)
       ├──▶ packages/proto/gen/go/security-health/v1/...connect       (Connect-Go)
       ├──▶ packages/proto/gen/typescript/js/security-health/v1/...   (ui)
       └──▶ packages/proto/gen/python/security_health/v1/...    (future tools)
```
...
1. Add proto messages and service methods under
   `packages/proto/schemas/security-health/v1/<domain>/`.
...
|---|---|---|---|
| 2026-06-01 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
