...
func (a *App) registerCommands() []cliapp.CommandGroup {
	...
	health := cliapp.CommandGroup{
		Title: "Health",
		Commands: []cliapp.Command{
			{Name: "stats", NeedsAPI: true, Description: "Show event store statistics", Run: a.cmdStats},
	...
	return []cliapp.CommandGroup{events, health, config}
}
