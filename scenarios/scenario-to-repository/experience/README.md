...
Use `experience-manager spec validate scenario-to-repository --json` after edits.
...
`template-manager detemplate scenario-to-repository` removes its page spec and registry
