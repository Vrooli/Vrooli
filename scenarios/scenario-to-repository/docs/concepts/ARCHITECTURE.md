...
| Contracts (`packages/proto/schemas/scenario-to-repository/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/scenario-to-repository/`.
...
packages/proto/schemas/scenario-to-repository/v1/<domain>/<file>.proto
       ...
       make generate
       │
       ├──▶ packages/proto/gen/go/scenario-to-repository/v1/...              (api, cli)
       ├──▶ packages/proto/gen/go/scenario-to-repository/v1/...connect       (Connect-Go)
       ├──▶ packages/proto/gen/typescript/scenario-to-repository/v1/...   (ui)
       └──▶ packages/proto/gen/python/scenario_to_repository/v1/...    (future tools)
```
...
|---|---|---|---|
| 2026-09-06 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
