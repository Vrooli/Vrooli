...
```bash
react-component-library adoptions eject navigation.app-shell scenario-to-repository --reason "..."
```
...
react-component-library adoptions preflight <component-id> scenario-to-repository
...
```bash
react-component-library components ingest scenario-to-repository ui/src/features/<name>/<Component>.tsx <Component>
```
