...
require (
	...
	github.com/vrooli/vrooli/scenarios/scenario-dependency-analyzer/api v0.0.0
...
replace github.com/vrooli/vrooli/scenarios/scenario-dependency-analyzer/api => ../../scenario-dependency-analyzer/api
