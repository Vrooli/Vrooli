...
import (
	...
	capsH "scenario-to-repository/handlers/capabilities"

	apidb "github.com/vrooli/api-core/database"
	"google.golang.org/protobuf/reflect/protoreflect"

	healthH "scenario-to-repository/handlers/health"
	sourceH "scenario-to-repository/handlers/source"
	localdb "scenario-to-repository/internal/database"
	sourceDomain "scenario-to-repository/internal/source"
...
func AllEndpoints() []module.EndpointDescriptor {
	...
	out = append(out, sourceH.Endpoints...)
	return out
}
...
func AllProtoFiles() []ProtoFileEntry {
	return []ProtoFileEntry{
		{Module: "source", File: sourcev1.File_scenario_to_repository_v1_source_source_proto},
	}
}
...
func AllSchemas() []apidb.SchemaProvider {
	return []apidb.SchemaProvider{
		...
		apidb.SchemaProviderFunc(sourceDomain.Schema),
	}
}
