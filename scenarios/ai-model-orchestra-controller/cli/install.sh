...
# AI Model Orchestra Controller CLI Installation Script

set -e

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CLI_NAME="ai-orchestra"
...
echo "  ${CLI_NAME} select completion --priority high"
echo "  ${CLI_NAME} route reasoning 'Explain quantum physics'"
echo "  ${CLI_NAME} models --include-metrics"
