// Package toolregistry provides the tool discovery service for app-monitor.
//
// This package implements the Tool Discovery Protocol, enabling external consumers
// (like agent-inbox) to discover what monitoring and management tools this scenario provides.
//
// ARCHITECTURE:
// - Registry: Central coordinator that manages tool providers
// - ToolProvider: Interface for components that contribute tools
// - Categories: app_discovery, app_lifecycle, diagnostics, logs_metrics, issues, docs, resources
//
// TESTING SEAMS:
