// Package toolexecution implements the Tool Execution Protocol for app-monitor.
//
// This package provides the server-side implementation of the Tool Execution Protocol,
// allowing external systems (like agent-inbox) to execute app-monitor tools via
// a standardized HTTP API.
//
// Protocol Contract:
//
//	Request:  POST /api/v1/tools/execute
//	          { "tool_name": "list_apps", "arguments": {...} }
//
