...
CREATE INDEX IF NOT EXISTS idx_app_health_status_app_id ON app_health_status(app_id);
CREATE INDEX IF NOT EXISTS idx_app_health_alerts_app_id ON app_health_alerts(app_id);
CREATE INDEX IF NOT EXISTS idx_app_health_alerts_severity ON app_health_alerts(severity);
CREATE INDEX IF NOT EXISTS idx_app_performance_app_id ON app_performance_analysis(app_id);
CREATE INDEX IF NOT EXISTS idx_app_performance_timestamp ON app_performance_analysis(analyzed_at);
CREATE INDEX IF NOT EXISTS idx_app_view_stats_last_viewed ON app_view_stats(last_viewed_at DESC);
CREATE INDEX IF NOT EXISTS idx_app_view_stats_view_count ON app_view_stats(view_count DESC);
