...
DROP TRIGGER IF EXISTS update_chart_styles_updated_at ON chart_styles;
CREATE TRIGGER update_chart_styles_updated_at 
    BEFORE UPDATE ON chart_styles
    FOR EACH ROW 
    EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_chart_templates_updated_at ON chart_templates;
...
DROP TRIGGER IF EXISTS create_history_on_chart_creation ON chart_instances;
