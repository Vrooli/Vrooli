...
// `packages/proto/gen/go/channel-manager/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/channel-manager/v1/shared/health.proto`
