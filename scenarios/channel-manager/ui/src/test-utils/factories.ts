 ...
 * `packages/proto/gen/typescript/js/channel-manager/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/channel-manager/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/channel-manager/v1/shared/health_pb";
