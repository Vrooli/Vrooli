...
describe("errorMessage", () => {
  ...
  it("maps Connect errors to Connect code i18n keys", () => {
	...
	it("maps an unrecognized REST error code to the safe unknown message", () => {
		const err = makeApiError("upstream_shape_changed", "unexpected response", 502);
	...
	it("renders non-Error failures without suppressing their value", () => {
