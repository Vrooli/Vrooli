...
- [ ] OT-P0-002 | Credential isolation | The system shall store only a credential-authority reference for an identity and shall reject any write carrying a credential value.
