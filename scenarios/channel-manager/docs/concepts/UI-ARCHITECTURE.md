...
react-component-library adoptions resolve-path <component-id> channel-manager
react-component-library adoptions apply <component-id> channel-manager <adopted-path>
```
...
Run `experience-manager spec validate channel-manager --json` after route or
selector changes. The generated notes page spec is example-domain content and
is removed by `template-manager detemplate channel-manager`.
