# Architecture — Trustworthy Testing Reference
...
```
                       ...
                       │   trustworthy-testing-reference/v1/...    │
                       └──────────────┬──────────────┘
...
| Contracts (`packages/proto/schemas/trustworthy-testing-reference/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/trustworthy-testing-reference/`.
...
```
packages/proto/schemas/trustworthy-testing-reference/v1/<domain>/<file>.proto
       │
       ▼
       make generate
       │
       ├──▶ packages/proto/gen/go/trustworthy-testing-reference/v1/...              (api, cli)
       ├──▶ packages/proto/gen/go/trustworthy-testing-reference/v1/...connect       (Connect-Go)
       ├──▶ packages/proto/gen/typescript/trustworthy-testing-reference/v1/...   (ui)
       └──▶ packages/proto/gen/python/trustworthy_testing_reference/v1/...    (future tools)
```
...
1. Add proto messages and service methods under
   `packages/proto/schemas/trustworthy-testing-reference/v1/<domain>/`.
...
|---|---|---|---|
| 2026-09-07 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
