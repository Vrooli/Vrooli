...
Record what Trustworthy Testing Reference needed from `react-component-library`
...
eject <component-id> trustworthy-testing-reference --reason "..."`. One row per ejection.
