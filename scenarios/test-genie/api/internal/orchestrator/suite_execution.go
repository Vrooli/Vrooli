...
var (
	...
	defaultExecutionPresets = map[string][]string{
		"quick":         {"structure", "docs", "unit"},
		"smoke":         {"structure", "lint", "docs", "integration"},
		"comprehensive": {"structure", "dependencies", "lint", "docs", "unit", "integration", "playbooks", "business", "performance"},
	}
