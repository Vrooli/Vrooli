...
func stubSmokeRunForPhase(t *testing.T, fn func(ctx context.Context, scenarioName, scenarioDir, uiURL, runID, captureProfile string, logWriter io.Writer) (*smoke.PhaseResult, error)) {
	t.Helper()
...
func TestRunSmokePhasePassesExplicitUIURL(t *testing.T) {
	...
	var gotUIURL string
	stubSmokeRunForPhase(t, func(ctx context.Context, scenarioName, scenarioDir, uiURL, runID, captureProfile string, logWriter io.Writer) (*smoke.PhaseResult, error) {
		gotUIURL = uiURL
