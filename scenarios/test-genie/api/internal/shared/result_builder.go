...
// ResultBuilder provides a fluent interface for building Result objects.
...
// WithCount sets the items checked count.
func (b *ResultBuilder) WithCount(count int) *ResultBuilder {
	b.result.ItemsChecked = count
	return b
}
