...
func TestServer_handleCreateSuiteRequest(t *testing.T) {
	t.Run("[REQ:TESTGENIE-SUITE-P0] API persists suite request payloads", func(t *testing.T) {
...
func TestServer_handleListSuiteRequests(t *testing.T) {
	t.Run("[REQ:TESTGENIE-SUITE-P0] API lists suite queue with estimates", func(t *testing.T) {
		db, mock, err := sqlmock.New()
		if err != nil {
			t.Fatalf("failed to create sqlmock: %v", err)
		}
...
func TestServer_handleCreateSuiteRequestInvalidPayload(t *testing.T) {
	t.Run("[REQ:TESTGENIE-SUITE-P0] API validates create payloads", func(t *testing.T) {
