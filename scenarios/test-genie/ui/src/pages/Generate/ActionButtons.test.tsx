...
describe("ActionButtons", () => {
  ...
  it("renders copy prompt button", () => {
    render(<ActionButtons prompt="test prompt" disabled={false} />);
  ...
  it("copies prompt to clipboard when clicked", async () => {
    render(<ActionButtons prompt="test prompt content" disabled={false} />);
