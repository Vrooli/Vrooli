...
| 12 | [Playbooks](playbooks/README.md) | 15m | No | Yes | native | Executes Vrooli Ascension workflows declared under bas/ to validate end-to-end UI flows. |
| 13 | [Business](business/README.md) | 15m | No | No | native | Audits requirements modules to guarantee operational targets stay mapped. |
