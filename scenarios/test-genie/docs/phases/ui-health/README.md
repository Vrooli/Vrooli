...
- **Runtime-render findings** → fix the live render: repair the iframe handshake, clear console/network/page errors, and resolve visual defects (blank pixels, broken assets, viewport overflow, unsafe edge tap zones).
