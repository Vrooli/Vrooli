...
```bash
# Automatically happens after comprehensive test run via test-genie
test-genie execute my-scenario --preset comprehensive
# Requirements synced automatically after successful run
```
...
- [UI Testability](ui-testability.md) - Design UIs for automation
