...
func SubcommandGroups(core *cliapp.ScenarioApp, manifest []byte) ([]cliapp.SubcommandGroup, error) {
	_ = manifest
	return []cliapp.SubcommandGroup{control.DesktopGroup(), control.Group(core), control.AuthGroup(core), control.StrategyGroup(core), control.SessionGroup(core), control.FlowGroup(core), control.AuditGroup(core), control.AgentGroup(core), control.ConformanceGroup(core)}, nil
}
