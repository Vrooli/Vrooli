...
import (
	...
	notesv1 "github.com/vrooli/vrooli/packages/proto/gen/go/device-control/v1/notes"
...
// the template itself does not build because of device-control placeholders.
func TestNotesManifestCoversNotesService(t *testing.T) {
	manifest := readNotesManifest(t)
	cliapp.RequireProtoServiceCoverage(t, manifest, notesv1.File_device_control_v1_notes_notes_proto, "NotesService")
}
