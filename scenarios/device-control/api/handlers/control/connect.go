...
func (c *deviceConnect) ConnectDevice(_ context.Context, req *connect.Request[devicesv1.ConnectDeviceRequest]) (*connect.Response[devicesv1.ConnectDeviceResponse], error) {
	rungs := c.h.service.Onboarding(req.Msg.Kind)
...
func deviceProto(d internal.Device) *devicesv1.Device {
	...
	return &devicesv1.Device{Id: d.ID, Name: d.Name, Kind: d.Kind, StrategyId: d.StrategyID, Status: d.Status, HealthReason: d.HealthReason, HostNodeId: d.HostNodeID, Capabilities: caps, ObservedAt: timestamppb.New(d.ObservedAt)}
}
...
func (c *sessionConnect) ListSessions(_ context.Context, _ *connect.Request[sessionsv1.ListSessionsRequest]) (*connect.Response[sessionsv1.ListSessionsResponse], error) {
	...
	for _, s := range c.h.service.ListSessions() {
...
func (c *flowConnect) RunFlow(ctx context.Context, req *connect.Request[flowsv1.RunFlowRequest]) (*connect.Response[flowsv1.RunResult], error) {
	result, err := c.h.service.Run(ctx, flowFromProto(req.Msg.Flow), req.Msg.DeviceId, req.Msg.Actor)
	if err != nil {
...
func (c *evidenceConnect) ListAudit(_ context.Context, _ *connect.Request[evidencev1.ListAuditRequest]) (*connect.Response[evidencev1.ListAuditResponse], error) {
	...
	for _, a := range c.h.service.Audit() {
		out = append(out, &evidencev1.AuditRecord{Id: a.ID, Actor: a.Actor, DeviceId: a.DeviceID, LeaseId: a.LeaseID, Verb: a.Verb, Outcome: a.Outcome, CreatedAt: timestamppb.New(a.CreatedAt), RedactionVerified: a.RedactionVerified})
	}
