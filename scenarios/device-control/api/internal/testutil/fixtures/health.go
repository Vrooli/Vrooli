...
// `packages/proto/gen/go/device-control/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/device-control/v1/shared/health.proto`
