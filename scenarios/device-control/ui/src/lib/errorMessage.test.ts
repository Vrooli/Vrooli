...
describe("errorMessage", () => {
  ...
  it("maps unknown API codes and primitive failures to stable text", () => {
    expect(errorMessage(makeApiError("future_code", "server detail", 500), i18n.t)).toBe("An unknown error occurred.");
