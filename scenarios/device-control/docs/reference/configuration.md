...
|---|---|---|
| `SQLITE_PATH` | `${SCENARIO_DATA_DIR}/device-control.db` | Override SQLite file location. The default routes through `api-core/storage` and resolves to a writable per-scenario data directory. |
