...
var Endpoints = []module.EndpointDescriptor{
	{
		...
		CLIMapping: &module.CLIMapping{Command: "data-backup-manager runs trigger", Args: []string{"--plan", "<plan_id>"}},
	},
	{
		ID:          "runs_get",
		...
		CLIMapping:  &module.CLIMapping{Command: "data-backup-manager runs get", Args: []string{"<id>"}},
	},
	{
		ID:          "runs_list",
		...
		CLIMapping:  &module.CLIMapping{Command: "data-backup-manager runs list", Args: []string{"--plan", "<plan_id>"}},
	},
	{
		...
		CLIMapping:  &module.CLIMapping{Command: "data-backup-manager runs status"},
	},
	{
