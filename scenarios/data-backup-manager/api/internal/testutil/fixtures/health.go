...
// `packages/proto/gen/go/data-backup-manager/v1/health/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/data-backup-manager/v1/health/health.proto`
