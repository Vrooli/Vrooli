...
The proto schema in `packages/proto/schemas/data-backup-manager/v1/health/health.proto`
...
dynamically from `go.mod`, so it works after `data-backup-manager`
substitution.
...
import (
    ...
    clitest "data-backup-manager/cli/internal/testutil"
)
...
2. **Regenerate.** From the repo root:
   ...
   `packages/proto/gen/typescript/js/data-backup-manager/v1/<domain>/`, and
