 ...
 * `packages/proto/gen/typescript/js/data-backup-manager/v1/notes/...`.
...
} from "@vrooli/proto-types/data-backup-manager/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/data-backup-manager/v1/notes/attachments_pb";
