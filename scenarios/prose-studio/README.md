...
Governed natural-language generation: a query plus a named writing style becomes a measured set of candidate outputs, converged to one committed document
...
`test-genie execute prose-studio --preset comprehensive` directly for
