...
| Contracts (`packages/proto/schemas/prose-studio/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/prose-studio/`.
...
1. Add proto messages and service methods under
   `packages/proto/schemas/prose-studio/v1/<domain>/`.
...
|---|---|---|---|
| 2026-08-16 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
