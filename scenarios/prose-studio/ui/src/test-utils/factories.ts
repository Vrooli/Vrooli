 ...
 * `packages/proto/gen/typescript/js/prose-studio/v1/shared/...`.
...
import type { Response as HealthResponse } from "@vrooli/proto-types/prose-studio/v1/shared/health_pb";
