...
export function StepIntegrationsDeferred() {
  return <div data-testid="step-integrations-deferred">
    ...
    <div data-testid="step-integrations-deferred" className="mt-6 rounded-xl border border-amber-400/30 bg-amber-400/10 p-5" role="status">
