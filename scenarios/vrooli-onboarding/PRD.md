...
- [ ] OT-P0-010 | Actionable readiness report | The readiness report shall probe declared credentials, host tools, host safeguards, and resource reachability, and shall name a remediation for every item that is not ready.
- [ ] OT-P0-011 | Re-enterable setup | When an operator re-opens the wizard on a configured install, it shall load committed state, resume at the first unsatisfied step, and allow revision of any decision that is not deferred.
...
- [ ] OT-P0-013 | Accessible, themed operator experience | The wizard shall meet WCAG 2.1 AA, shall be operable by keyboard alone, and shall render correctly in light and dark themes.
