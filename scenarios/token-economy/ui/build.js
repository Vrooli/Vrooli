...
const IGNORE_FILES = new Set(['build.js', 'server.js', 'package.json', 'package-lock.json', 'pnpm-lock.yaml', 'package.json.backup', '.DS_Store']);
...
function ensureDist() {
  ...
  console.log(`Token Economy UI assets built to ${DIST_DIR}`);
}
