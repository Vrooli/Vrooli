 ...
 * `packages/proto/gen/typescript/js/token-economy/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/token-economy/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/token-economy/v1/shared/health_pb";
