...
| Contracts (`packages/proto/schemas/token-economy/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
1. Add proto messages and service methods under
   `packages/proto/schemas/token-economy/v1/<domain>/`.
