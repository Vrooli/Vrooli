...
// `packages/proto/gen/go/token-economy/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/token-economy/v1/shared/health.proto`
