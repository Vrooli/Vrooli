...
#### Visual Validation
- [ ] OT-P2-027 | Screen-Recorded Smoke Tests | Record desktop smoke tests via FFmpeg screen capture for human review before publishing
- [ ] OT-P2-028 | Video Review UI | HTML5 video player with approve/reject workflow for visual validation
- [ ] OT-P2-029 | Validation CLI | CLI commands for running, reviewing, and managing visual validations
