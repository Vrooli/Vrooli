...
// ExternalServiceConfig holds configuration for external service dependencies.
type ExternalServiceConfig struct {
	// AnalyzerURL is the base URL for the scenario-dependency-analyzer service.
	AnalyzerURL string
	// SecretsManagerURL is the base URL for the secrets-manager service.
	SecretsManagerURL string
	// TelemetryDir is the directory path for storing telemetry files.
	TelemetryDir string
}
