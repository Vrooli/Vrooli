...
import "deployment-manager/fitness"

// Defaults defines the default values applied to newly created profiles.
...
// DefaultDefaults returns the standard defaults for new profiles.
//
// Decision rationale:
...
func DefaultDefaults() Defaults {
	return Defaults{
		Tiers:    []int{fitness.TierDesktop}, // Default to desktop tier
		Swaps:    map[string]interface{}{},
		Secrets:  map[string]interface{}{},
		Settings: map[string]interface{}{},
	}
...
// ApplyDefaults fills in missing fields on a profile with default values.
// Only nil fields are replaced; explicit empty values are preserved.
func ApplyDefaults(profile *Profile) {
