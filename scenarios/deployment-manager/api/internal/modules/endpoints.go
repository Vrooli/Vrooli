...
func AllEndpoints() []module.EndpointDescriptor {
	return []module.EndpointDescriptor{
		...
		connectEndpoint("get_release_operation", releasesconnect.ReleasesServiceGetOperationProcedure, "Get release operation standing", "releases"),
		connectEndpoint("get_release_dossier", releasesconnect.ReleasesServiceDossierProcedure, "Get release dossier", "releases"),
		connectEndpoint("reverify_release", releasesconnect.ReleasesServiceReverifyProcedure, "Reverify a release", "releases"),
		connectEndpoint("reconcile_release", releasesconnect.ReleasesServiceReconcileProcedure, "Reconcile release standing", "releases"),
		connectEndpoint("recover_release", releasesconnect.ReleasesServiceRecoverProcedure, "Recover a release through its owner", "releases"),
		connectEndpoint("start_release", releasesconnect.ReleasesServiceStartProcedure, "Start a release", "releases"),
		connectEndpoint("register_release_candidate", releasesconnect.ReleasesServiceRegisterCandidateProcedure, "Register a release candidate", "releases"),
		connectEndpoint("register_destination_revision", releasesconnect.ReleasesServiceRegisterDestinationRevisionProcedure, "Register a destination revision", "releases"),
		connectEndpoint("record_client_update_receipt", releasesconnect.ReleasesServiceRecordClientUpdateReceiptProcedure, "Record an owner client update receipt", "releases"),
