#!/bin/bash
# Shared phased test orchestrator for saas-landing-manager
set -euo pipefail
...
# Initialise runner (enable runtime management for phases that require the app)
testing::runner::init \
  --scenario-name "saas-landing-manager" \
