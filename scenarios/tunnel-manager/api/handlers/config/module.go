...
var Endpoints = []module.EndpointDescriptor{
	...
	{
		ID:          "config_dns_update",
		Path:        configconnect.ConfigServiceUpdateDNSRecordProcedure,
		Method:      "POST",
		Summary:     "Update an explicitly owned DNS record in place",
		Description: "Replaces one existing TXT, MX, A, AAAA, or CNAME record without a delete-create gap.",
		Category:    "config",
		Request:     &module.Schema{Type: "object", Properties: map[string]string{"provider_profile": "string", "hostname": "string", "type": "string", "content": "string", "ttl": "int", "priority": "int", "owner": "string", "dry_run": "bool"}},
		Response:    &module.Schema{Type: "object", Properties: map[string]string{"record_id": "string", "changed": "bool", "dry_run": "bool", "owner": "string"}},
	},
	{
		ID:          "config_dns_spf",
		Path:        configconnect.ConfigServiceEnsureSPFRecordProcedure,
		Method:      "POST",
		Summary:     "Merge one provider mechanism into SPF",
		Description: "Computes and optionally applies a single-record SPF merge, refusing duplicate records and lookup cost above ten.",
		Category:    "config",
		Request:     &module.Schema{Type: "object", Properties: map[string]string{"provider_profile": "string", "hostname": "string", "mechanism": "string", "ttl": "int", "owner": "string", "dry_run": "bool"}},
		Response:    &module.Schema{Type: "object", Properties: map[string]string{"merged_value": "string", "record_id": "string", "lookup_cost": "int", "changed": "bool", "dry_run": "bool", "owner": "string"}},
	},
	{
