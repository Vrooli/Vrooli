...
import "tunnel-manager/internal/module"
...
var Endpoints = []module.EndpointDescriptor{
	{
		...
		RESTException: &module.RESTException{
			...
			ProtoPayloads: &module.RESTProtoPayloads{
				...
				Response: module.RESTPayload{ProtoFullName: "vrooli.tunnel_manager.v1.health.Response", Transport: "json", Conformance: "protojson"},
