...
func (s unavailableCredentialStore) Status(context.Context) (CredentialStatus, error) {
	return CredentialStatus{}, s.err
}

func (s unavailableCredentialStore) Resolve(context.Context) (CFConfig, error) {
	return CFConfig{}, s.err
}

func (s unavailableCredentialStore) Save(context.Context, CredentialUpdate) (CredentialStatus, error) {
	return CredentialStatus{}, s.err
}

func (s unavailableCredentialStore) Delete(context.Context, []string) (CredentialStatus, error) {
	return CredentialStatus{}, s.err
}
