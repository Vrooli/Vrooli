...
// `packages/proto/gen/go/tunnel-manager/v1/health/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/tunnel-manager/v1/health/health.proto`
