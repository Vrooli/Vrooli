...
func WithLocalConfigCmdRunner(fn adapter.CmdRunner) LocalConfigOption {
...
func (m *LocalConfigManager) Parse() (*domain.CloudflaredConfig, error) {
...
func (m *LocalConfigManager) GenerateFromRoutes(routes []domain.Route, existing *domain.CloudflaredConfig) *domain.CloudflaredConfig {
...
func (m *LocalConfigManager) WriteWithBackup(cfg *domain.CloudflaredConfig, maxBackups int) error {
	if maxBackups <= 0 {
		maxBackups = 5
	}
