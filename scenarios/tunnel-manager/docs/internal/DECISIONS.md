...
| 2026-06-18 | **`domain` is a manifest field** (default `example.invalid`), not a hardcoded constant. | Old code hardcoded `.vrooli.com`; real domain is `.example.invalid`. | Fixes a latent bug; enables multi-domain (P2). | n/a. |
