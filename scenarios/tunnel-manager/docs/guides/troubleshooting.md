...
make stop
vrooli scenario start tunnel-manager --clean-stale
```
...
```bash
fuser "${SCENARIO_DATA_DIR}/tunnel-manager.db"
```
...
`packages/proto/gen/typescript/tunnel-manager/v1/`, and Python under
