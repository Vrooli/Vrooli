...
// FormatTimePtr renders a *time.Time; nil/zero values render as "unknown".
...
// FormatConfidence renders an optional confidence score as a percentage, or "N/A".
