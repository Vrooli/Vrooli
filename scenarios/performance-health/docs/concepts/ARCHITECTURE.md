# Architecture — Performance Health
...
| Contracts (`packages/proto/schemas/performance-health/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/performance-health/`.
...
1. Add proto messages and service methods under
   `packages/proto/schemas/performance-health/v1/<domain>/`.
...
|---|---|---|---|
| 2026-06-21 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
