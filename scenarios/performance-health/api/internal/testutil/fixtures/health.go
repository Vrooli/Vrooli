...
// `packages/proto/gen/go/performance-health/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/performance-health/v1/shared/health.proto`
