...
// ReadJSONFile loads a JSON file (or stdin when path is "-") and returns the
// parsed RawMessage. An empty path returns nil unless required is true.
