...
react-component-library adoptions resolve-path <component-id> switchboard
react-component-library adoptions apply <component-id> switchboard <adopted-path>
```
...
Run `experience-manager spec validate switchboard --json` after route or
selector changes. The generated notes page spec is example-domain content and
is removed by `template-manager detemplate switchboard`.
