 ...
 * `packages/proto/gen/typescript/js/switchboard/v1/notes/...`.
...
} from "@vrooli/proto-types/switchboard/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/switchboard/v1/notes/attachments_pb";
