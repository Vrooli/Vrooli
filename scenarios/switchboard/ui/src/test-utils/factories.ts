 ...
 * `packages/proto/gen/typescript/js/switchboard/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/switchboard/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/switchboard/v1/shared/health_pb";
