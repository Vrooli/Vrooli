...
import (
	...
	errorsv1 "github.com/vrooli/vrooli/packages/proto/gen/go/network-manager/v1/shared"
)
...
func setBaselineSecurityHeaders(w http.ResponseWriter) {
