    ...
    >
      <div className="min-w-0">
        ...
        <h1
          ...
          className="truncate text-lg font-semibold text-app-foreground"
        >
          {t(strings.app.title)}
        </h1>
        <p data-testid={selectors.app.description} className="hidden max-w-2xl truncate text-xs text-app-muted-foreground lg:block">
