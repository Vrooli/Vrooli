    ...
    <LibraryAppShell
      ...
      items={NAV_ITEMS.map((item) => {
        ...
        return {
          id: item.key,
          href: item.path,
          label: item.labelKey ? t(item.labelKey) : item.label ?? item.key,
      ...
      utility={<span className="font-mono text-xs uppercase tracking-[0.18em] text-app-subtle-foreground">{t(strings.app.eyebrow)}</span>}
      ...
      sidebarStorageKey="infrastructure-manager.sidebar-width"
