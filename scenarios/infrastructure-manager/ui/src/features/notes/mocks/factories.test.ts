...
import {
  ...
  NoteSchema,
} from "@vrooli/proto-types/infrastructure-manager/v1/notes/notes_pb";
import { AttachmentSchema } from "@vrooli/proto-types/infrastructure-manager/v1/notes/attachments_pb";
