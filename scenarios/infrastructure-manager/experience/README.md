...
Use `experience-manager spec validate infrastructure-manager --json` after edits.
...
`template-manager detemplate infrastructure-manager` removes its page spec and registry
