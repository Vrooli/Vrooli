...
react-component-library adoptions resolve-path <component-id> infrastructure-manager
react-component-library adoptions apply <component-id> infrastructure-manager <adopted-path>
```
...
Run `experience-manager spec validate infrastructure-manager --json` after route or
selector changes. The generated notes page spec is example-domain content and
is removed by `template-manager detemplate infrastructure-manager`.
