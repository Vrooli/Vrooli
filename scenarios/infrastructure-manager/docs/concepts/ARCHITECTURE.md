...
- **Holding a roster.** Every set is a derivation query executed at read time. This
  is what clears the retired instrumentation roadmap's Gap 11 objection to a central
