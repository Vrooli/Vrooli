...
// `packages/proto/gen/go/infrastructure-manager/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/infrastructure-manager/v1/shared/health.proto`
