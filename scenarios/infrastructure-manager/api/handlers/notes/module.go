...
func defaultBlobStore() (blobstore.BlobStore, error) {
	...
	path, err := resolver.Path(
		storage.Options{ScenarioID: "infrastructure-manager"},
		storage.ClassData,
		"attachments",
	)
	if err != nil {
...
var Endpoints = []module.EndpointDescriptor{
	{
		...
		Examples: []module.Example{
			{Name: "List notes", Curl: "curl http://localhost:${API_PORT}/vrooli.infrastructure_manager.v1.notes.NotesService/ListNotes -H 'Content-Type: application/json' -d '{}'"},
		},
	},
	{
		ID:          "notes_create",
		...
		Examples: []module.Example{
			{Name: "Create note", Curl: "curl http://localhost:${API_PORT}/vrooli.infrastructure_manager.v1.notes.NotesService/CreateNote -H 'Content-Type: application/json' -d '{\"title\":\"first\",\"body\":\"hello\"}'"},
		},
	},
	{
		ID:          "notes_get",
		...
		Examples: []module.Example{
			{Name: "Get note", Curl: "curl http://localhost:${API_PORT}/vrooli.infrastructure_manager.v1.notes.NotesService/GetNote -H 'Content-Type: application/json' -d '{\"id\":\"abc123\"}'"},
		},
	},
	{
		ID:          "notes_count",
		...
		Examples: []module.Example{
			{Name: "Count this week", Curl: "curl http://localhost:${API_PORT}/vrooli.infrastructure_manager.v1.notes.NotesService/CountNotes -H 'Content-Type: application/json' -d '{\"window\":{\"token\":\"TIME_WINDOW_TOKEN_THIS_WEEK\"}}'"},
		},
	},
	{
		ID:          "notes_attach",
		...
		RESTException: &module.RESTException{
			...
			ProtoPayloads: &module.RESTProtoPayloads{
				...
				Response: module.RESTPayload{ProtoFullName: "vrooli.infrastructure_manager.v1.notes.UploadAttachmentResponse", Transport: "json", Conformance: "protojson"},
