# RCL Generated Suite Positive

Temporary Test Genie fixture for the RCL adoption contract
...
`test-genie execute rcl-fixture-positive-1787641498371379912 --preset comprehensive` directly for
