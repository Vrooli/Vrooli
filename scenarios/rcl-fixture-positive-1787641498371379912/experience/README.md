...
Use `experience-manager spec validate rcl-fixture-positive-1787641498371379912 --json` after edits.
...
`template-manager detemplate rcl-fixture-positive-1787641498371379912` removes its page spec and registry
