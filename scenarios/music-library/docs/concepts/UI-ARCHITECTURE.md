...
react-component-library adoptions resolve-path <component-id> music-library
react-component-library adoptions apply <component-id> music-library <adopted-path>
```
...
Run `experience-manager spec validate music-library --json` after route or
selector changes. The generated notes page spec is example-domain content and
is removed by `template-manager detemplate music-library`.
