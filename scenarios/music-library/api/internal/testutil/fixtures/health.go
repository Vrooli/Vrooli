...
// `packages/proto/gen/go/music-library/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/music-library/v1/shared/health.proto`
