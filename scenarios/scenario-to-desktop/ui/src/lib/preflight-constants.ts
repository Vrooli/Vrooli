...
export const PREFLIGHT_ISSUE_GUIDANCE: Record<string, PreflightIssueGuidance> =
  {
    manifest_invalid: {
      ...
      meaning:
        "The manifest structure does not pass schema or platform validation.",
      remediation: [
    ...
    binary_not_defined: {
      ...
      meaning:
        "The service has no binary entry for this platform in bundle.json.",
      remediation: [
    ...
    binary_missing: {
      ...
      meaning:
        "The manifest references a binary path that doesn't exist in the bundle root.",
      remediation: [
    ...
    binary_is_directory: {
      ...
      meaning:
        "The manifest points at a directory, but an executable file is required.",
      remediation: [
    ...
    asset_missing: {
      ...
      meaning:
        "The manifest references an asset path that doesn't exist in the bundle root.",
      remediation: [
    ...
    asset_checksum_mismatch: {
      ...
      meaning:
        "The file exists but its checksum differs from the manifest entry.",
      remediation: [
    ...
    asset_size_suspicious: {
      ...
      meaning:
        "The asset is much smaller than expected, which often indicates a failed build.",
      remediation: [
 ...
 */
export const PREFLIGHT_CHECK_STYLES: Record<PreflightCheckStatus, string> = {
 ...
 */
export const PREFLIGHT_CHECK_LABELS: Record<PreflightCheckStatus, string> = {
  pass: "PASS",
  fail: "FAIL",
  warning: "WARN",
  skipped: "SKIP",
