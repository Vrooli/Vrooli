/**
 * Preflight section - orchestrates and displays preflight validation.
 * Consolidated from BundledPreflightSection to reduce duplication.
 *
...
interface PreflightSectionProps {
  scenarioName: string;
  /** Bundle manifest path (required to run preflight) */
  bundleManifestPath?: string;
  /** Parsed bundle manifest for display */
  bundleManifest?: unknown;
  /** Whether the deployment mode uses bundled runtime */
  isBundled?: boolean;
}
    ...
    if (!isBundled) {
      return (
        <SectionCard
          ...
          sectionId="preflight"
          title="Preflight"
          subtitle="Validate environment readiness"
          variant="pipeline"
          collapsible={true}
        >
          <StagePlaceholder
