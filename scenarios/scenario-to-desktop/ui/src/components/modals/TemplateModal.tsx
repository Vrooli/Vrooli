        ...
        <CardHeader className="flex flex-row items-start justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-sm text-slate-400">
              Pick the wrapper that matches today&apos;s needs. You can change
              this anytime.
            </p>
          </div>
          <Button
          ...
          <div className="flex items-start gap-3 rounded-lg border border-slate-800/80 bg-slate-950/60 p-3 text-sm text-slate-200">
            ...
            <div className="space-y-1">
              <p className="font-semibold text-slate-100">
                All templates share the same Electron base.
              </p>
              <p className="text-slate-300">
                Switching templates only changes the wrapper. Your scenario
                logic stays intact.
              </p>
            </div>
          </div>
