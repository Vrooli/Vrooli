...
describe("FrameworkModal", () => {
  ...
  it("explains and selects the supported Electron framework", () => {
    ...
    expect(
      screen.getByText("Mature tooling · Full Node access · Largest community"),
    ).toBeInTheDocument();
  ...
  it("closes from its accessible control and backdrop", () => {
    ...
    fireEvent.click(
      screen.getByRole("button", { name: "Close framework chooser" }),
    );
    const backdrop = screen
      .getByText("Choose a framework")
      .closest("div.fixed");
