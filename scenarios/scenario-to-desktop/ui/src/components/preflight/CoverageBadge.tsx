...
export function CoverageBadge({ label, active }: CoverageBadgeProps) {
  return (
    <div
      className={`rounded-md border px-2 py-1 text-[10px] ${active ? "border-sky-800/70 bg-sky-950/40 text-sky-200" : "border-slate-800/70 bg-slate-950/60 text-slate-400"}`}
    >
