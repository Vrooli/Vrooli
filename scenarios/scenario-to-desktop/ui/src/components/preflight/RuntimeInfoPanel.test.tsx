...
describe("RuntimeInfoPanel", () => {
  it("presents complete runtime identity without hiding paths or version provenance", () => {
    renderWithProviders(<RuntimeInfoPanel runtimeInfo={{ instance_id: "instance-123456789", started_at: "2026-07-27T12:00:00Z", dry_run: true, manifest_hash: "abcdef123456789", app_name: "Canvas", app_version: "1.2.3", ipc_host: "127.0.0.1", ipc_port: 8123, runtime_version: "2.0.0", build_version: "build-7", bundle_root: "/bundle/canvas", app_data_dir: "/data/canvas" }} />);
    expect(screen.getByText("instance-123")).toHaveAttribute("title", "instance-123456789");
    expect(screen.getByText("abcdef123456")).toHaveAttribute("title", "abcdef123456789");
