...
describe("PreflightCheckList", () => {
  ...
  it("presents all check states and an inspectable listening URL", () => {
    renderWithProviders(<PreflightCheckList checks={[{ id: "api", name: "API health", status: "pass", detail: "listening on 19925" }, { id: "cache", name: "Cache", status: "warning", detail: "slow start" }, { id: "bundle", name: "Bundle", status: "fail" }, { id: "legacy", name: "Legacy", status: "skipped" }] as never} />);
