...
export type { ExposedFormState, ValidationState } from "./types";
    ...
    <div className="space-y-4">
      ...
      >
        {selectionSource === "inventory" && scenarioName && (
          <div className="rounded-md border border-blue-800/60 bg-blue-950/30 px-2.5 py-1.5 text-xs md:text-sm text-blue-100">
            ...
            <span className="text-blue-100/90">
              Settings below regenerate the desktop wrapper&mdash;scenario code
              stays the same.
            </span>
          </div>
        )}
        <ScenarioSelector
          ...
          onOpenScenarioModal={() => {
            state.openModal("scenario");
          }}
          onLoadSaved={
            state.selectedScenario?.connection_config
              ? () => {
                  state.applySavedConnection(
                    state.selectedScenario?.connection_config,
                  );
                }
              : undefined
        ...
        <FrameworkTemplateSection
          ...
          onOpenFrameworkModal={() => {
            state.openModal("framework");
          }}
          selectedTemplate={selectedTemplate}
          onOpenTemplateModal={() => {
            state.openModal("template");
          }}
        />
        ...
        <PlatformSelector
          ...
          onPlatformChange={state.handlePlatformChange}
        />
