// Package toolregistry provides the tool discovery service for scenario-to-desktop.
//
// This package implements the Tool Discovery Protocol, enabling external consumers
// (like agent-inbox) to discover what desktop packaging tools this scenario provides.
//
// ARCHITECTURE:
