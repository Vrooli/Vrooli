...
// SyncIcons copies the best-available scenario icon into the Electron assets directory.
func (s *DefaultIconSyncer) SyncIcons(scenario, outputDir string, logf func(string, map[string]interface{})) error {
	...
	paths := []string{
		...
		filepath.Join(s.vrooliRoot, "scenarios", scenario, "ui", "dist", "apple-icon-180.png"),
		filepath.Join(s.vrooliRoot, "scenarios", scenario, "ui", "dist", "favicon-196.png"),
	}
