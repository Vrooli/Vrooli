...
| Contracts (`packages/proto/schemas/workflow-health/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/workflow-health/`.
...
1. Add proto messages and service methods under
   `packages/proto/schemas/workflow-health/v1/<domain>/`.
...
|---|---|---|---|
| 2026-07-02 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
