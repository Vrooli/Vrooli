 ...
 * `packages/proto/gen/typescript/js/workflow-health/v1/notes/...`.
...
} from "@vrooli/proto-types/workflow-health/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/workflow-health/v1/notes/attachments_pb";
