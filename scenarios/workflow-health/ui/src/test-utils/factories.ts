 ...
 *
 * Domain-specific factories live next to the feature they double for; only
 * truly cross-domain shapes (HealthResponse, error envelopes) live here.
 * Deleting a feature folder takes its factories with it — no central residue.
 *
 ...
 * `packages/proto/gen/typescript/js/workflow-health/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/workflow-health/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/workflow-health/v1/shared/health_pb";
