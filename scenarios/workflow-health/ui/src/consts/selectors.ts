...
const literalSelectors = {
  ...
  workflow: {
    ...
    scenarioSelect: "workflow-scenario-select",
    assetTable: "workflow-asset-table",
    searchInput: "workflow-search-input",
    searchTypeFilter: "workflow-search-type-filter",
    runTimeline: "workflow-run-timeline",
    fixPreview: "workflow-fix-preview",
  },
  notifications: {
