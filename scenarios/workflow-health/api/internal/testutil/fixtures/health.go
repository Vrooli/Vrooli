...
// `packages/proto/gen/go/workflow-health/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/workflow-health/v1/shared/health.proto`
