...
// added to the contract. measures-health ships no deterministic autofixer, so both
...
var errNoDeterministicFixer = errors.New("measures-health has no deterministic fixer")
