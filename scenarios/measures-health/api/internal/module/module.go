...
// (validation, search, health, …) returns a Module from its handlers package, and main.go
...
//
//   - Name is for diagnostics ("validation", "search", "health"). Free-form;
...
const (
	...
	// A file-upload endpoint is the canonical worked example.
...
// (e.g. "string", "array<MeasureSummary>"); this is documentation, not JSON Schema.
...
// it. Command uses measures-health as the binary name placeholder, e.g.
// "measures-health validate scenario". Args lists positional/flag tokens for
