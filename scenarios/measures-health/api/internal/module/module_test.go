...
func TestEndpointDescriptorJSONShape(t *testing.T) {
	descriptor := module.EndpointDescriptor{
		...
		Path:        "/api/v1/validation/validate",
		Method:      http.MethodPost,
		Summary:     "Validate scenario",
		Description: "Grades a scenario's measure coverage",
		Category:    "validation",
		...
		Examples: []module.Example{{
			Name: "Validate",
			Curl: "curl http://localhost:${API_PORT}/api/v1/validation/validate",
		}},
	...
	require.Equal(t, "/api/v1/validation/validate", got["path"])
