...
import (
	...
	"measures-health/internal/testutil/httpx"
...
// middleware).
//
// Per-module route coverage (e.g. validate scenario returns 200,
// unknown id returns 404) lives in each handler's module_test.go where
