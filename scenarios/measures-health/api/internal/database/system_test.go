...
import (
	...
	"measures-health/internal/testutil/db"
...
// own *_test.go files (see handlers/health for the schema provider).
//
// This test deliberately does NOT import any per-domain package. Domain
// deletion must leave this package's tests passing — coupling to a
// specific domain here would break the deletability invariant Pass-3
// establishes.
