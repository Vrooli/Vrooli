...
//
// Per-domain wiring (in a future internal/<domain>/mocks/repository.go)
// is a 5–15 line type alias + extractor plumbing, e.g. for a hypothetical
// `widget` domain:
//
//	type FakeRepository = repokit.SliceRepo[widget.Widget]
//
//	func NewFakeRepository() *FakeRepository {
//	    return &FakeRepository{
//	        GetID:    func(w widget.Widget) string { return w.ID },
//	        SetID:    func(w *widget.Widget, id string) { w.ID = id },
//	        NotFound: func(id string) error { return widget.ErrWidgetNotFound{ID: id} },
//	    }
//	}
//
...
// → []T" shape. Other domain-specific shapes (e.g. an attachments
// repository with its own CreateAttachment / ListAttachmentKeys methods)
// stay hand-written for now; lift to repokit only when a second consumer surfaces.
//
