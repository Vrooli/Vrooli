...
| Contracts (`packages/proto/schemas/measures-health/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/measures-health/`.
...
1. Add proto messages and service methods under
   `packages/proto/schemas/measures-health/v1/<domain>/`.
...
|---|---|---|---|
| 2026-06-08 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
