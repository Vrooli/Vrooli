 ...
 * (e.g. `features/<domain>/mocks/factories.ts`); only truly cross-domain
 ...
 * `packages/proto/gen/typescript/js/measures-health/v1/health/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/measures-health/v1/health/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/measures-health/v1/health/health_pb";
