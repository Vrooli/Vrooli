...
describe('ViewModeToggle', () => {
  it('renders three view mode buttons', () => {
    render(<ViewModeToggle viewMode="tree" onViewModeChange={() => {}} />)
  ...
  it('marks the active mode as checked', () => {
    render(<ViewModeToggle viewMode="list" onViewModeChange={() => {}} />)
  ...
  it('calls onViewModeChange when a mode is clicked', () => {
    ...
    render(<ViewModeToggle viewMode="tree" onViewModeChange={onChange} />)
