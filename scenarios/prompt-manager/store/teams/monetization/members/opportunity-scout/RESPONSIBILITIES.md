...
(Inbox draining mechanics, destinations, and dispatch are generated into the heartbeat's `# Inbox Flow` section from `topics.json` + `docs/monetization/OPPORTUNITY_TAXONOMY.md`. Do not duplicate them here.)
