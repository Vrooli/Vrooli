...
- Handed off to debt-curator: 0
- Inbox overflow this heartbeat: no
...
### Triage snapshot
- friction-triage-record/2026-05-21 updated as `knw-1779364824920426420`
...
- Snapshot write succeeded without legacy `--by`.