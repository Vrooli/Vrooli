...
6. Check whether research evidence should feed artifact requests, canon decisions, hook promotions, post-type proposals, channel strategy, or capability gaps.
7. Check supersession on owned pending decisions.
8. Author decisions only when warranted by the taxonomy's evidence rules.
