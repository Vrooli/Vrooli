...
- Latest accessible publisher snapshot remains `coverage-snapshot/2026-05-18`: releases=0, fresh=0, stale=0, missing=2.
...
- Latest subscription-adjacent evidence from 2026-05-18 supports future “managed gateway / operational proof surfaces / predictable operating cost” framing, but does not open the draft gate.
...
- `knw-1779301894284534525` on `subscription-ad-run/2026-05-20`.
