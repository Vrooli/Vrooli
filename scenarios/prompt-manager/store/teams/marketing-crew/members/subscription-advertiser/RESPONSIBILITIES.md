...
## Primary Duties
- Operate the subscription lane of the shared advertiser pipeline.
- Consume subscription artifact requests, marketing evidence, canon, publish logs, and coverage state before drafting.
