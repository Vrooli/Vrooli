...
- Maintain resolution state for each open challenge; see `docs/agent-system/CONTRARIAN_REVIEW.md`. This state moves to the `content-desk` `review` domain once that scenario is real.
