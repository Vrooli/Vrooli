...
5. Take the smallest useful action from the taxonomy's `actionSelection` set: `drop`, `observe`, `file-backlog`, `file-work`, `route-to-another-topic`, `capability work item`.
