...
1. Read your responsibilities and heartbeat instructions first.
2. Complete the work that fits your lane without waiting for a coordinator.
3. Persist only the information that future runs will need.
4. Leave a clean handoff so the next run can continue efficiently.
