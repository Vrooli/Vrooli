...
Separate declared product/infrastructure delivery from unexpected dependency-repair diversion. Normal planned implementation and qualification consume the main allowance; a diversion fraction does not cap every infrastructure feature in the accepted mandate. Repeated unsuccessful interventions still consume the cumulative repair policy, including inside a planned infrastructure task. Preserve prior charges and stable failure identities; renaming repair as planned work cannot reopen a circuit.
