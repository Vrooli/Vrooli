---
name: "polish"
description: "Final touches - consistency, edge cases, error messages"
license: "CC-BY-4.0"
metadata:
  kind: "skill"
  schemaVersion: 1
  ...
  icon: "sparkles"
  status: "active"
  targetDimensions: ["visual","tidiness","standards"]
  revision: 46
  createdAt: "2025-01-15T00:00:00Z"
  updatedAt: "2026-02-05T01:01:57Z"
  requires:
...
Use the `visited-tracker-tools` skill for tracking visited files, with LOCATION set to `scenarios/{{TARGET}}` and TAG set to `polish`.
