...
web-search notes create --title "First note" --body "Hello"
```
...
curl -s -X POST "http://localhost:${API_PORT}/vrooli.web_search.v1.notes.NotesService/ListNotes" \
