 ...
 * `packages/proto/gen/typescript/js/web-search/v1/health/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/web-search/v1/health/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/web-search/v1/health/health_pb";
