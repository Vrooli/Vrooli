...
- [x] OT-P1-001 | L2 Fetch, Read, and Synthesize | Fetch top-N result pages via the browserless resource, extract readable text, and produce a single-pass cited synthesis, exposed as discrete API endpoints and agent tools.
