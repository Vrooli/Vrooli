...
**DO:** Test frequently; keep changes focused; document as you go; handle errors gracefully; follow patterns
**DON'T:** Break working code; skip testing; hardcode values; ignore warnings; copy blindly

## Common Pitfalls
- **Over-engineering**: Use simplest working solution
- **Under-testing**: Test multiple scenarios, not just happy path
- **Poor errors**: Provide clear messages with recovery hints
- **Ignoring standards**: Follow established conventions
