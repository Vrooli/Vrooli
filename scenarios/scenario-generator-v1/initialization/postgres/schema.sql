...
('E-commerce Assistant', 'AI-powered e-commerce management tool', 'e-commerce', 'Create an AI assistant for e-commerce businesses that can manage inventory, process orders, handle customer inquiries, and generate product descriptions automatically.', ARRAY['postgres', 'ollama', 'claude-code'], 'advanced', 30000, 50000),
...
('Customer Support Bot', 'Intelligent customer service automation', 'customer-service', 'Create an AI-powered customer support system with ticket management, automated responses, knowledge base integration, and escalation workflows.', ARRAY['postgres', 'ollama', 'claude-code'], 'intermediate', 18000, 32000);
