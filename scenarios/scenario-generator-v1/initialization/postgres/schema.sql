...
('Simple SaaS Dashboard', 'A basic business dashboard for managing data and metrics', 'business-tool', 'Create a SaaS dashboard application that allows users to view and manage business metrics. Include user authentication, data visualization, and basic CRUD operations. Target audience: small business owners.', ARRAY['postgres', 'claude-code'], 'simple', 10000, 20000),
('AI Document Processor', 'Intelligent document processing pipeline', 'ai-automation', 'Build an AI-powered document processing system that can extract data from PDFs, process it with AI, and provide structured output. Include file upload, processing status tracking, and results export.', ARRAY['postgres', 'unstructured-io', 'claude-code'], 'intermediate', 20000, 35000),
('E-commerce Assistant', 'AI-powered e-commerce management tool', 'e-commerce', 'Create an AI assistant for e-commerce businesses that can manage inventory, process orders, handle customer inquiries, and generate product descriptions automatically.', ARRAY['postgres', 'claude-code'], 'advanced', 30000, 50000),
('Content Generation Platform', 'Automated content creation system', 'content-marketing', 'Build a platform that generates blog posts, social media content, and marketing materials using AI. Include content templates, scheduling, and multi-platform publishing.', ARRAY['postgres', 'claude-code', 'comfyui'], 'intermediate', 15000, 30000),
('Customer Support Bot', 'Intelligent customer service automation', 'customer-service', 'Create an AI-powered customer support system with ticket management, automated responses, knowledge base integration, and escalation workflows.', ARRAY['postgres', 'claude-code'], 'intermediate', 18000, 32000);
