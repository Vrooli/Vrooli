 ...
 * `packages/proto/gen/typescript/js/nutrition-planner/v1/notes/...`.
...
} from "@vrooli/proto-types/nutrition-planner/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/nutrition-planner/v1/notes/attachments_pb";
