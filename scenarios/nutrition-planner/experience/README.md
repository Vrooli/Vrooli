...
Use `experience-manager spec validate nutrition-planner --json` after edits.
...
`template-manager detemplate nutrition-planner` removes its page spec and registry
