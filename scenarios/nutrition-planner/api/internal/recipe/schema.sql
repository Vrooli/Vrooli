...
CREATE TABLE IF NOT EXISTS recipe_revisions (
  ...
  status TEXT NOT NULL, methods_json TEXT NOT NULL DEFAULT '[]', groups_json TEXT NOT NULL DEFAULT '[]', required_appliances_json TEXT NOT NULL DEFAULT '[]', allergen_evidence_json TEXT NOT NULL DEFAULT '{}', canonical_yield TEXT NOT NULL DEFAULT '', serving_unit TEXT NOT NULL DEFAULT 'serving', ingredients_json TEXT NOT NULL DEFAULT '[]', created_at TEXT NOT NULL,
