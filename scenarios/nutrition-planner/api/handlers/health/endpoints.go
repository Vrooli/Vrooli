...
var Endpoints = []module.EndpointDescriptor{
	{
		...
		RESTException: &module.RESTException{
			...
			ProtoPayloads: &module.RESTProtoPayloads{
				...
				Response: module.RESTPayload{ProtoFullName: "vrooli.nutrition_planner.v1.shared.Response", Transport: "json", Conformance: "protojson"},
				Error:    module.RESTPayload{ProtoFullName: "vrooli.nutrition_planner.v1.shared.ErrorEnvelope", Transport: "json", Conformance: "protojson"},
			},
		},
	},
}
