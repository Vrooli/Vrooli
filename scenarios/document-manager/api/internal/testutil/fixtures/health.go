...
// `packages/proto/gen/go/document-manager/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/document-manager/v1/shared/health.proto`
// — never duplicate them in this file.
package fixtures

import (
	healthv1 "github.com/vrooli/vrooli/packages/proto/gen/go/document-manager/v1/shared"
)
