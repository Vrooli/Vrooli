...
react-component-library adoptions resolve-path <component-id> document-manager
react-component-library adoptions apply <component-id> document-manager <adopted-path>
```
...
Run `experience-manager spec validate document-manager --json` after route or
selector changes. The generated notes page spec is example-domain content and
is removed by `template-manager detemplate document-manager`.
