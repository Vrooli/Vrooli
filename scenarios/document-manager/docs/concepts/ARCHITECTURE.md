...
| Contracts (`packages/proto/schemas/document-manager/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/document-manager/`.
...
packages/proto/schemas/document-manager/v1/<domain>/<file>.proto
       ...
       make generate
       │
       ├──▶ packages/proto/gen/go/document-manager/v1/...              (api, cli)
       ├──▶ packages/proto/gen/go/document-manager/v1/...connect       (Connect-Go)
       ├──▶ packages/proto/gen/typescript/js/document-manager/v1/...   (ui)
       └──▶ packages/proto/gen/python/document_manager/v1/...    (future tools)
```
...
1. Add proto messages and service methods under
   `packages/proto/schemas/document-manager/v1/<domain>/`.
