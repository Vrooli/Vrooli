import { BookOpen, Files, Home, ReceiptText, Settings } from "lucide-react";
...
function iconForItem(item: NavItem) {
  ...
  switch (item.key) {
    case "corpus":
      return <Files aria-hidden className={iconClass} />;
    case "reader":
      return <BookOpen aria-hidden className={iconClass} />;
    case "receipt":
      return <ReceiptText aria-hidden className={iconClass} />;
    case "settings":
