 ...
 * feature-local mock factories); only truly cross-domain
 ...
 * `packages/proto/gen/typescript/js/document-manager/v1/shared/...`.
...
import type { Response as HealthResponse } from "@vrooli/proto-types/document-manager/v1/shared/health_pb";
