...
import (
	...
	notesv1 "github.com/vrooli/vrooli/packages/proto/gen/go/document-manager/v1/notes"
...
// the template itself does not build because of document-manager placeholders.
func TestNotesManifestCoversNotesService(t *testing.T) {
	manifest := readNotesManifest(t)
	cliapp.RequireProtoServiceCoverage(t, manifest, notesv1.File_document_manager_v1_notes_notes_proto, "NotesService")
}
