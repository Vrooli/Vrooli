...
export function UnsavedChangesDialog({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      <div className="absolute inset-0 bg-black/60" onClick={onKeepEditing} />
      <div className="relative bg-slate-900 border border-white/10 rounded-xl p-6 max-w-sm mx-4 shadow-xl">
        ...
        <div className="flex justify-end gap-3">
          <button onClick={onKeepEditing} className="px-4 py-2 text-sm text-slate-400 hover:text-white transition-colors">
            Keep Editing
          </button>
          <button
            onClick={onDiscard}
