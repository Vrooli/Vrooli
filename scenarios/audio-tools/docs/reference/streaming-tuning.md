...
| `PreRollMs` | 800 | 0–800 | Audio carried from the trailing edge of segment N into the leading edge of segment N+1. The long-form default uses the maximum supported acoustic context so boundary omissions remain recoverable. |
