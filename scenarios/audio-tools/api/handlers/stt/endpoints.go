...
var Endpoints = []modulekit.EndpointDescriptor{
	...
	{ID: "stt.get_stream_config", Path: "/vrooli.audio_tools.v1.stt.STTAdminService/GetStreamConfig", Method: "POST", Category: "stt"},
	{ID: "stt.update_stream_config", Path: "/vrooli.audio_tools.v1.stt.STTAdminService/UpdateStreamConfig", Method: "POST", Category: "stt"},
	...
	{ID: "stt.update_speaker_config", Path: "/vrooli.audio_tools.v1.stt.STTAdminService/UpdateSpeakerConfig", Method: "POST", Category: "stt"},
	{ID: "stt.get_speaker_status", Path: "/vrooli.audio_tools.v1.stt.STTAdminService/GetSpeakerStatus", Method: "POST", Category: "stt"},
	{ID: "stt.list_speaker_profiles", Path: "/vrooli.audio_tools.v1.stt.STTAdminService/ListSpeakerProfiles", Method: "POST", Category: "stt"},
	{ID: "stt.enroll_speaker_profile", Path: "/vrooli.audio_tools.v1.stt.STTAdminService/EnrollSpeakerProfile", Method: "POST", Category: "stt"},
