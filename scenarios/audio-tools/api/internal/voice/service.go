...
// Backend (in this package) so the Adapter can call into it without
// knowing about file paths, the speaker resource client, or the Whisper
// pipeline.
//
// seam: Backend — the Adapter's storage/state seam; Service is the production
...
// Compile-time assertion: *Service implements Backend.
