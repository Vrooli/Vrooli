...
import { type ProviderHealth, ProviderState } from "@vrooli/proto-types/audio-tools/v1/shared/shared_pb";
...
function stateLabel(t: TFn, s: ProviderState): string {
  switch (s) {
...
function stateVariant(s: ProviderState): "success" | "danger" | "warning" | "neutral" {
  switch (s) {
    case ProviderState.AVAILABLE:
      return "success";
    case ProviderState.UNAVAILABLE:
