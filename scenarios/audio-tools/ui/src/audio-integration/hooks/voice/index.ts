...
export { playRecordingStartCue, playRecordingStopCue, playRecordingFaultCue } from "./audioCues";
...
// HOST DIFFERENCE: audio-tools exports scenario-local transport adapters.
