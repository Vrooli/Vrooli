...
- [x] OT-P0-025 | Stripe credential config | Each landing page resolves Stripe secret and webhook credentials through the Vrooli credential authority; the publishable key may be exposed to the browser through the public runtime configuration
