...
- `registerLandingRoutes`: `LandingConfigService.GetLandingConfig`, `/api/v1/plans`, `VariantSpaceService`, `/api/v1/customize`
...
## Notes
- Root-level endpoints are intentionally reserved for infra/SEO (`/health`, `/sitemap.xml`, `/robots.txt`).
