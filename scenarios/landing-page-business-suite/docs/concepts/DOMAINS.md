...
| commerce | Pricing, Stripe billing, subscriptions, credits, entitlements, coupons, and payment anomaly policy. | Sell subscriptions and credits while preserving correct entitlement decisions. | Plans, prices, subscriptions, credit balances, coupons, payment settings, anomaly-dispatch records. | Temporal workflow | integration / client, policy / rules | stripe, billing, subscription, credits, entitlement, coupon, payment | `api/account_service.go`, `api/account_service_entitlements_test.go`, `api/billing_handlers.go`, `api/coupon_connect.go`, `api/handlers/account/` (generated `AccountService` transport), `api/handlers/coupons/`, `api/plan_catalog.go` (composition adapter), `api/stripe_handlers.go`, `api/stripe_service.go`, `api/stripe_service_test.go`, `api/payment_anomaly_service.go` (server adapter), `api/internal/commerce/plan_{store,service,pricing}.go`, `api/internal/commerce/payment_anomaly_service.go`, `api/internal/commerce/anomaly_dispatcher.go`, `api/internal/commerce/catalog.go`, `api/internal/commerce/stripe_price.go`, `api/internal/commerce/stripe_repository.go`, `api/internal/commerce/` |
