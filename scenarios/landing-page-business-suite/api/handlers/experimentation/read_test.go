...
func TestNewReadDependenciesMapsSnapshotsWithinTheDomainBoundary(t *testing.T) {
	store := readStoreStub{snapshots: []*domain.VariantSnapshot{{Variant: domain.VariantSnapshotMeta{
		Slug: "spring", Name: "Spring", Description: "Launch", Weight: 25, Status: "active", Axes: map[string]string{"audience": "founders"},
	}}}}
	logged := ""
...
type readStoreStub struct{ snapshots []*domain.VariantSnapshot }

func (s readStoreStub) GetVariant(slug string) (*domain.VariantSnapshot, error) {
...
func (s readStoreStub) ListVariants() []*domain.VariantSnapshot { return s.snapshots }
func (readStoreStub) GetBranding() *domain.SiteBranding         { return nil }
func (readStoreStub) VariantCount() int                         { return 0 }
func (readStoreStub) GetVariantsDir() string                    { return "" }
