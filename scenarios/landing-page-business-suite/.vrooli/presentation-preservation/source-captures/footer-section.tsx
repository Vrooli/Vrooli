    ...
    <footer className="border-t border-white/10 bg-bg-base">
      <div className="container mx-auto px-6 py-16">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
          <div className="space-y-4 lg:col-span-2">
            <h3 className="text-2xl font-semibold text-white">
              {content.company_name || 'Aquila · Vrooli Business Suite'}
            </h3>
            <p className="text-slate-400">
              {content.tagline || 'A calm command center for your tools and agents.'}
            </p>
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-white/10 pt-6 text-sm text-slate-500 md:flex-row md:items-center md:justify-between">
          <p>{content.copyright || `© ${String(new Date().getFullYear())} Aquila by Vrooli. All rights reserved.`}</p>
