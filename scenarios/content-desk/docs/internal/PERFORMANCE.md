...
No budgets yet; the corpus is small by construction — one operator's editorial
history. The one path with real cost is the scheduled claim re-verification
sweep, which executes stored commands and grows with the claim library rather
than with drafts. Budget it when it exists.
...
|---|---|---|---|
| None captured yet. | n/a | n/a | 2026-07-28 |
