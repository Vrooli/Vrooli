...
**This scenario has no go-to-market motion because it is not sold.** See
[`MONETIZATION.md`](MONETIZATION.md) for why that is a decision rather than a
deferral.

Worth stating plainly to avoid confusion later: this scenario *supports* the
go-to-market work for everything else Vrooli ships — it is where those campaigns
are drafted, verified, and recorded — but it is not itself a thing anyone is
marketed. Its "adoption" question is internal: whether the marketing team
actually routes work through it rather than back to flat files.
