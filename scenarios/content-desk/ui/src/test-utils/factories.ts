 ...
 * `packages/proto/gen/typescript/js/content-desk/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/content-desk/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/content-desk/v1/shared/health_pb";
