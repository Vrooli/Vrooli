 ...
 * `packages/proto/gen/typescript/js/content-desk/v1/notes/...`.
...
} from "@vrooli/proto-types/content-desk/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/content-desk/v1/notes/attachments_pb";
