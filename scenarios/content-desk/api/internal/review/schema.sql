CREATE TABLE IF NOT EXISTS review_runs (id TEXT PRIMARY KEY, draft_id TEXT NOT NULL, outcome TEXT NOT NULL, created_at TEXT NOT NULL, invalidated_at TEXT NOT NULL DEFAULT '');
