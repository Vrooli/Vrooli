...
import (
	...
	errorsv1 "github.com/vrooli/vrooli/packages/proto/gen/go/content-desk/v1/shared"
)
...
// vocabulary stays consistent. Translation from domain-specific typed sentinels
// to (status, code,
