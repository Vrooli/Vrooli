...
//
// Per-domain wiring (see internal/artifacts/mocks/repository.go for the
// canonical example) is a 5–15 line type alias + extractor plumbing:
//
//	type FakeRepository = repokit.SliceRepo[artifacts.Artifact]
//
//	func NewFakeRepository() *FakeRepository {
//	    return &FakeRepository{
//	        GetID:    func(a artifacts.Artifact) string { return a.ID },
//	        SetID:    func(a *artifacts.Artifact, id string) { a.ID = id },
//	        NotFound: func(id string) error { return artifacts.ErrNotFound{ID: id} },
//	    }
//	}
//
...
// → []T" shape. Other domain-specific shapes (e.g. artifacts.AssetRepository
