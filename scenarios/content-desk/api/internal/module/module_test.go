...
func TestEndpointDescriptorJSONShape(t *testing.T) {
	descriptor := module.EndpointDescriptor{
		...
		Description: "Creates a content artifact",
		Category:    "artifacts",
		...
		Examples: []module.Example{{
			Name: "Create",
			Curl: "curl http://localhost:${API_PORT}/api/v1/artifacts",
		}},
	}
	...
	require.Equal(t, "artifacts_create", got["id"])
	require.Equal(t, "/api/v1/artifacts", got["path"])
