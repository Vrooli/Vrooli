...
// `packages/proto/gen/go/business-health/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/business-health/v1/shared/health.proto`
