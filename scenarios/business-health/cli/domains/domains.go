...
import (
	...
	"business-health/cli/domains/contract"
	"business-health/cli/domains/fix"
	"business-health/cli/domains/fleet"
	"business-health/cli/domains/reindex"
	"business-health/cli/domains/search"
	"business-health/cli/domains/wizard"
)
...
func SubcommandGroups(core *cliapp.ScenarioApp, manifest []byte) ([]cliapp.SubcommandGroup, error) {
	...
	contractGroups, err := contract.Register(core, manifest)
	if err != nil {
		return nil, err
	}
	groups = append(groups, contractGroups...)
	...
	wizardGroup, err := wizard.Register(core, manifest)
	if err != nil {
		return nil, err
	}
	groups = append(groups, wizardGroup)
	...
	groups = append(groups, reindexGroup)
	return groups, nil
}
