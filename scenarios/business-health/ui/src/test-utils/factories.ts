 ...
 * `packages/proto/gen/typescript/js/business-health/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/business-health/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/business-health/v1/shared/health_pb";
