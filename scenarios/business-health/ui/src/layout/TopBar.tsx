...
// Literal per-choice label lookup. Referencing each leaf key directly (rather
// than the dynamic `strings.theme.choice[c]` form) keeps the no-unused-keys
// audit — which cannot see bracket access — satisfied for every variant.
