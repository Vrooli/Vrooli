...
> **Source of Truth**: Business Health (the PRD/requirements contract provider)
...
Key principles:
- **Minimal + Machine-Readable** – short and scannable, simple heading hierarchy, deterministic parsing
...
Under it, define the priority subsections (even if some lists are empty):
...
- Referenced by `scenarios/swarm-manager/prompts/templates/scenario-generator.md`
