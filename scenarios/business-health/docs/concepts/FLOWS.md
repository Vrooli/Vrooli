...
Flow files sit at the top of the feature folder (Go flows are leaner than
UI flows), plus one `generated/` sibling. Everything in `generated/` is codegen output.
