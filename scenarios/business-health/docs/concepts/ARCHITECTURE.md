...
| Contracts (`packages/proto/schemas/business-health/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/business-health/`.
...
packages/proto/schemas/business-health/v1/<domain>/<file>.proto
       ...
       make generate
       │
       ├──▶ packages/proto/gen/go/business-health/v1/...              (api, cli)
       ├──▶ packages/proto/gen/go/business-health/v1/...connect       (Connect-Go)
       ├──▶ packages/proto/gen/typescript/js/business-health/v1/...   (ui)
       └──▶ packages/proto/gen/python/business_health/v1/...    (future tools)
```
...
REST is allowed only for the enumerated reasons, defined as
...
1. Add proto messages and service methods under
   `packages/proto/schemas/business-health/v1/<domain>/`.
