 ...
 * `packages/proto/gen/typescript/js/scenario-completeness-scoring/v1/notes/...`.
...
} from "@vrooli/proto-types/scenario-completeness-scoring/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/scenario-completeness-scoring/v1/notes/attachments_pb";
