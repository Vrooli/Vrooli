 ...
 * (e.g. `features/scoring/mocks/factories.ts`); only truly cross-domain
 ...
 * `packages/proto/gen/typescript/js/scenario-completeness-scoring/v1/health/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/scenario-completeness-scoring/v1/health/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/scenario-completeness-scoring/v1/health/health_pb";
