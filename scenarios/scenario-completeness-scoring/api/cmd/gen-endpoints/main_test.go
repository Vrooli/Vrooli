	...
	endpoints := []module.EndpointDescriptor{
		{
			...
			CLIMapping: &module.CLIMapping{
				Command: "scenario-completeness-scoring lonely subcommand",
			},
		},
	}
...
func TestCrossCheck_PassesWhenRegistered(t *testing.T) {
	endpoints := []module.EndpointDescriptor{
		{ID: "x", CLIMapping: &module.CLIMapping{Command: "scenario-completeness-scoring x"}},
		{ID: "y_alias", CLIMapping: &module.CLIMapping{Command: "scenario-completeness-scoring notes ll"}},
...
func TestBuildCLICommands_ResolvesEndpointIDs(t *testing.T) {
	endpoints := []module.EndpointDescriptor{
		{ID: "health", CLIMapping: &module.CLIMapping{Command: "scenario-completeness-scoring status"}},
		{ID: "notes_list", CLIMapping: &module.CLIMapping{Command: "scenario-completeness-scoring notes list"}},
	}
	registered := []registeredCommand{
		{Name: "configure"},
		{Name: "notes list"},
