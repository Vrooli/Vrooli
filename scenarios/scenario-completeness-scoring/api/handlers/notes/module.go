...
import (
	...
	notesconnect "github.com/vrooli/vrooli/packages/proto/gen/go/scenario-completeness-scoring/v1/notes/notes_v1connect"

	internalnotes "scenario-completeness-scoring/internal/notes"
)
...
var Endpoints = []module.EndpointDescriptor{
	{
		...
		Examples: []module.Example{
			{Name: "List notes", Curl: "curl http://localhost:${API_PORT}/vrooli.scenario_completeness_scoring.v1.notes.NotesService/ListNotes -H 'Content-Type: application/json' -d '{}'"},
		},
		CLIMapping: &module.CLIMapping{
			Command: "scenario-completeness-scoring notes list",
		},
	},
	{
		ID:          "notes_create",
		...
		Examples: []module.Example{
			{Name: "Create note", Curl: "curl http://localhost:${API_PORT}/vrooli.scenario_completeness_scoring.v1.notes.NotesService/CreateNote -H 'Content-Type: application/json' -d '{\"title\":\"first\",\"body\":\"hello\"}'"},
		},
		CLIMapping: &module.CLIMapping{
			Command: "scenario-completeness-scoring notes create",
	...
	},
	{
		...
		Examples: []module.Example{
			{Name: "Get note", Curl: "curl http://localhost:${API_PORT}/vrooli.scenario_completeness_scoring.v1.notes.NotesService/GetNote -H 'Content-Type: application/json' -d '{\"id\":\"abc123\"}'"},
		},
		CLIMapping: &module.CLIMapping{
			Command: "scenario-completeness-scoring notes get",
			Args:    []string{"<id>"},
		},
	},
	{
		...
		Examples: []module.Example{
			{Name: "Count this week", Curl: "curl http://localhost:${API_PORT}/vrooli.scenario_completeness_scoring.v1.notes.NotesService/CountNotes -H 'Content-Type: application/json' -d '{\"window\":{\"token\":\"TIME_WINDOW_TOKEN_THIS_WEEK\"}}'"},
		},
		CLIMapping: &module.CLIMapping{
			Command: "scenario-completeness-scoring notes count",
	...
	},
	{
		...
		CLIMapping: &module.CLIMapping{
			Command: "scenario-completeness-scoring notes attach",
