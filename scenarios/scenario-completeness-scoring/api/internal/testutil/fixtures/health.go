...
// `packages/proto/gen/go/scenario-completeness-scoring/v1/health/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/scenario-completeness-scoring/v1/health/health.proto`
