...
//
//	type FakeRepository = repokit.SliceRepo[tasks.Task]
//
//	func NewFakeRepository() *FakeRepository {
//	    return &FakeRepository{
//	        GetID:    func(n tasks.Task) string { return n.ID },
//	        SetID:    func(n *tasks.Task, id string) { n.ID = id },
//	        NotFound: func(id string) error { return tasks.ErrTaskNotFound{ID: id} },
//	    }
//	}
//
...
// → []T" shape. Other domain-specific repository shapes stay hand-written
