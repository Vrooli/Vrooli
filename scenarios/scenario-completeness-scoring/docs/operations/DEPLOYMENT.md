# Deployment — Scenario Completeness Scoring
...
| Proto | Schemas live under `packages/proto/schemas/scenario-completeness-scoring/`; generated clients are shared artifacts. |
