...
`vrooli scenario orient scenario-completeness-scoring`, which reads the temporary
`.vrooli/orientation.json` manifest generated by the template. After
all required gates pass, run `vrooli scenario orient scenario-completeness-scoring
...
```bash
prd-control-tower prd generate scenario-completeness-scoring \
...
```bash
prd-control-tower prd validate scenario-completeness-scoring --json
```
...
```bash
prd-control-tower requirements generate scenario-completeness-scoring \
...
```bash
prd-control-tower requirements validate scenario-completeness-scoring --json
```
