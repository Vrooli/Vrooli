 ...
 * `packages/proto/gen/typescript/js/architecture-cartographer/v1/health/...`.
...
import type { Response as HealthResponse } from "@vrooli/proto-types/architecture-cartographer/v1/health/health_pb";
