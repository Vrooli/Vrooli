...
const literalSelectors = {
  ...
  pages: {
    ...
    targetCampaign: "page-target-campaign",
    targetCampaignDetail: "page-target-campaign-detail",
  ...
  features: {
    ...
    campaign: {
      list: {
        root: "feature-campaign-list",
        loading: "feature-campaign-list-loading",
        error: "feature-campaign-list-error",
        empty: "feature-campaign-list-empty",
        newButton: "feature-campaign-list-new",
      },
      create: {
        root: "feature-campaign-create",
        nameInput: "feature-campaign-create-name",
        reportInput: "feature-campaign-create-report",
        parsedCount: "feature-campaign-create-parsed-count",
        parseError: "feature-campaign-create-parse-error",
        submit: "feature-campaign-create-submit",
        cancel: "feature-campaign-create-cancel",
      },
      detail: {
        root: "feature-campaign-detail",
        loading: "feature-campaign-detail-loading",
        error: "feature-campaign-detail-error",
        notFound: "feature-campaign-detail-not-found",
        rollup: "feature-campaign-detail-rollup",
        worklist: "feature-campaign-detail-worklist",
        worklistEmpty: "feature-campaign-detail-worklist-empty",
        profileSelect: "feature-campaign-detail-profile",
        reaudit: "feature-campaign-detail-reaudit",
        reauditInput: "feature-campaign-detail-reaudit-input",
        reauditSubmit: "feature-campaign-detail-reaudit-submit",
        reauditResult: "feature-campaign-detail-reaudit-result",
        closeButton: "feature-campaign-detail-close",
        backLink: "feature-campaign-detail-back",
      },
      workbench: {
        root: "feature-campaign-workbench",
        emptyDetail: "feature-campaign-workbench-empty-detail",
      },
    },
    apply: {
      overview: {
...
const dynamicSelectorDefinitions = {
  ...
  layout: {
    ...
    workspaceSubnavLink: defineDynamicSelector({
      ...
      params: {
        key: {
          type: "enum",
          values: ["graph", "domains", "conflicts", "campaign", "apply", "analytics"] as const,
        },
      },
    }),
  },
  ...
  features: {
    ...
    campaign: {
      list: {
        row: defineDynamicSelector({
          description: "Campaign list row by campaign id",
          testIdPattern: "feature-campaign-list-row-${id}",
          params: { id: { type: "string" } },
        }),
        openButton: defineDynamicSelector({
          description: "Campaign list open detail link by campaign id",
          testIdPattern: "feature-campaign-list-open-${id}",
          params: { id: { type: "string" } },
        }),
      },
      detail: {
        itemCard: defineDynamicSelector({
          description: "Campaign worklist item card by stable id",
          testIdPattern: "feature-campaign-item-${stableId}",
          params: { stableId: { type: "string" } },
        }),
        actionButton: defineDynamicSelector({
          description: "Campaign item action button by stable id and action",
          testIdPattern: "feature-campaign-item-${stableId}-${action}",
          params: {
