 ...
 * ArchitectureFinding[] the campaign tracker ingests.
 *
 * This is the browser twin of the CLI's `loadAuditFindings`
 * (cli/domains/campaign/handlers.go): it flattens every phase's `findings`
 ...
 *
 * The campaign domain RECOMPUTES the afid stable id server-side from
