 ...
 * `packages/proto/gen/typescript/js/architecture-cartographer/v1/notes/...`.
...
} from "@vrooli/proto-types/architecture-cartographer/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/architecture-cartographer/v1/notes/attachments_pb";
