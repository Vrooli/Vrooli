...
|---|---|---|
| `SQLITE_PATH` | `${SCENARIO_DATA_DIR}/architecture-cartographer.db` | Override SQLite file location. The default routes through `api-core/storage` and resolves to a writable per-scenario data directory. |
