...
import "architecture-cartographer/internal/module"
		...
		RESTException: &module.RESTException{
			...
			ProtoPayloads: &module.RESTProtoPayloads{
				...
				Response: module.RESTPayload{
					ProtoFullName: "vrooli.architecture_cartographer.v1.health.Response",
					Transport:     "json",
					Conformance:   "protojson",
				},
				Error: module.RESTPayload{
					ProtoFullName: "vrooli.architecture_cartographer.v1.errors.ErrorEnvelope",
					Transport:     "json",
					Conformance:   "protojson",
				},
			},
