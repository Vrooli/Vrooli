...
// added to the contract. architecture-cartographer ships no deterministic autofixer, so both
...
var errNoDeterministicFixer = errors.New("architecture-cartographer has no deterministic fixer")
