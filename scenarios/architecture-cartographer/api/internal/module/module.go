...
// it. Command uses architecture-cartographer as the binary name placeholder, e.g.
// "architecture-cartographer notes list". Args lists positional/flag tokens for
