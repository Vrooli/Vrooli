...
// drives reindex locally supplies it via --control-token or this env var.
const controlTokenEnv = "ARCHITECTURE_CARTOGRAPHER_SEARCH_CONTROL_TOKEN"
...
// run calls the shared SearchControlService.Reindex method.
