...
// `packages/proto/gen/go/compute-manager/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/compute-manager/v1/shared/health.proto`
