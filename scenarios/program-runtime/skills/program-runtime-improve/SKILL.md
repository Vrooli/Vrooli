...
| Filing | promotable-fragments above 0 | Run the fragment-promotion route for each verified candidate; promotion remains a curation decision and must preserve a fixture. | promotable-fragments |
