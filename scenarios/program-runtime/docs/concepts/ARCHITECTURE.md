...
| Contracts (`packages/proto/schemas/program-runtime/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
1. Add proto messages and service methods under
   `packages/proto/schemas/program-runtime/v1/<domain>/`.
...
|---|---|---|---|
| 2026-08-06 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
