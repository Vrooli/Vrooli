...
try:
    ...
    if program.get("validationError"):
        envelope["status"] = "partial"
        envelope["errors"].append({"class": "invalid_contract", "where": "program", "detail": program["validationError"]})
