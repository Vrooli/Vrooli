...
var Endpoints = []module.EndpointDescriptor{
	...
	{ID: "bindings_sweep", Path: "/vrooli.program_runtime.v1.bindings.BindingRegistryService/SweepBindings", Method: "POST", Summary: "Exercise safe reachable read-effect bindings with operator provenance.", Category: "bindings"},
