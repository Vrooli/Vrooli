...
var Endpoints = []module.EndpointDescriptor{
	...
	{ID: "sessions_delegations", Method: "POST", Path: sessionsconnect.SessionServiceListDelegationsProcedure, Summary: "List retained delegated session executions.", Category: "sessions"},
