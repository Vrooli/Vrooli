 ...
 * `packages/proto/gen/typescript/js/program-runtime/v1/notes/...`.
...
} from "@vrooli/proto-types/program-runtime/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/program-runtime/v1/notes/attachments_pb";
