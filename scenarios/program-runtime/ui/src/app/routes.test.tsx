/**
 * Routing smoke — for each canonical path (`/`, `/bindings`, `/settings`) the
...
describe("AppRouter", () => {
  ...
  it("renders the bindings page at /bindings", () => {
    renderWithProviders(<TestAppRouter initialEntries={["/bindings"]} />, { withoutRouter: true });
    expect(screen.getByText("Governed callable registry")).toBeInTheDocument();
  });
