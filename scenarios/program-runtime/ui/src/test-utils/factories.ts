 ...
 * (e.g. `features/example/mocks/factories.ts`); only truly cross-domain
 ...
 * `packages/proto/gen/typescript/js/program-runtime/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/program-runtime/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/program-runtime/v1/shared/health_pb";
