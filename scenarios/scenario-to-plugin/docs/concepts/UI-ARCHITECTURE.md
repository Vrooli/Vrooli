...
react-component-library adoptions resolve-path <component-id> scenario-to-plugin
react-component-library adoptions apply <component-id> scenario-to-plugin <adopted-path>
```
...
Run `experience-manager spec validate scenario-to-plugin --json` after route or
selector changes. The generated notes page spec is example-domain content and
is removed by `template-manager detemplate scenario-to-plugin`.
