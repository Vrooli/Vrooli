# Architecture — Scenario to Plugin
...
| Contracts (`packages/proto/schemas/scenario-to-plugin/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/scenario-to-plugin/`.
...
packages/proto/schemas/scenario-to-plugin/v1/<domain>/<file>.proto
       ...
       make generate
       │
       ├──▶ packages/proto/gen/go/scenario-to-plugin/v1/...              (api, cli)
       ├──▶ packages/proto/gen/go/scenario-to-plugin/v1/...connect       (Connect-Go)
       ├──▶ packages/proto/gen/typescript/js/scenario-to-plugin/v1/...   (ui)
       └──▶ packages/proto/gen/python/scenario_to_plugin/v1/...    (future tools)
```
...
|---|---|---|---|
| 2026-08-19 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
