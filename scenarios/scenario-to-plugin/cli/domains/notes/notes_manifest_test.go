...
import (
	...
	notesv1 "github.com/vrooli/vrooli/packages/proto/gen/go/scenario-to-plugin/v1/notes"
...
// the template itself does not build because of scenario-to-plugin placeholders.
func TestNotesManifestCoversNotesService(t *testing.T) {
	manifest := readNotesManifest(t)
	cliapp.RequireProtoServiceCoverage(t, manifest, notesv1.File_scenario_to_plugin_v1_notes_notes_proto, "NotesService")
}
