 ...
 * `packages/proto/gen/typescript/js/scenario-to-plugin/v1/notes/...`.
...
} from "@vrooli/proto-types/scenario-to-plugin/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/scenario-to-plugin/v1/notes/attachments_pb";
