...
import { ResponseSchema } from "@vrooli/proto-types/scenario-to-plugin/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/scenario-to-plugin/v1/shared/health_pb";
