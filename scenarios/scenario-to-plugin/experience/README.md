...
Use `experience-manager spec validate scenario-to-plugin --json` after edits.
...
`template-manager detemplate scenario-to-plugin` removes its page spec and registry
