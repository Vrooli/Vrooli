  ...
  return (
    <LibraryAppShell
      ...
      items={NAV_ITEMS.map(item => ({
        ...
        icon: item.key === "settings" ? <Settings aria-hidden className="h-5 w-5" /> : item.key === "signals" ? <Radio aria-hidden className="h-5 w-5" /> : <Home aria-hidden className="h-5 w-5" />,
      ...
      sidebarStorageKey="signal-inbox.sidebar-width"
