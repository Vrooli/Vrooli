...
export const strings = {
  ...
  categories: {
    ...
    descriptionInput: "categories.descriptionInput",
    newName: "categories.newName",
    newDescription: "categories.newDescription",
    create: "categories.create",
    creating: "categories.creating",
    save: "categories.save",
    retire: "categories.retire",
    reserved: "categories.reserved",
    fallback: "categories.fallback",
    load: "categories.load",
    loadError: "categories.loadError",
    createError: "categories.createError",
    changeError: "categories.changeError",
    activeList: "categories.activeList",
    nameFor: "categories.nameFor",
    descriptionFor: "categories.descriptionFor",
    classificationLoading: "categories.classificationLoading",
    classificationPending: "categories.classificationPending",
    proposed: "categories.proposed",
    confirmed: "categories.confirmed",
    confidence: "categories.confidence",
    choose: "categories.choose",
    categoryFor: "categories.categoryFor",
    confirm: "categories.confirm",
    change: "categories.change",
    confirmError: "categories.confirmError",
  },
  notifications: {
