 ...
 * `packages/proto/gen/typescript/js/signal-inbox/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/signal-inbox/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/signal-inbox/v1/shared/health_pb";
