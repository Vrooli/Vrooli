 ...
 * `packages/proto/gen/typescript/js/signal-inbox/v1/notes/...`.
...
} from "@vrooli/proto-types/signal-inbox/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/signal-inbox/v1/notes/attachments_pb";
