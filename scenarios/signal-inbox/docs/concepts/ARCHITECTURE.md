...
| Contracts (`packages/proto/schemas/signal-inbox/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/signal-inbox/`.
...
1. Add proto messages and service methods under
   `packages/proto/schemas/signal-inbox/v1/<domain>/`.
...
|---|---|---|---|
| 2026-07-27 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
