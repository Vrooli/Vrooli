...
describe('[REQ:FAIL-SAFE-001] ErrorDisplay', () => {
  describe('with generic Error', () => {
    it('displays error message', () => {
      renderWithProviders(<ErrorDisplay error={new Error('Something broke')} />);
    ...
    it('displays retry button when onRetry provided', () => {
      const onRetry = vi.fn();
      renderWithProviders(<ErrorDisplay error={new Error('Error')} onRetry={onRetry} />);
    ...
    it('hides retry button when onRetry not provided', () => {
      renderWithProviders(<ErrorDisplay error={new Error('Error')} />);
  ...
  describe('with title prop', () => {
    it('displays custom title', () => {
      renderWithProviders(<ErrorDisplay error={new Error('Err')} title="Connection Failed" />);
  ...
  describe('compact mode', () => {
    it('renders in compact layout', () => {
      renderWithProviders(<ErrorDisplay error={new Error('Error')} compact />);
    ...
    it('shows compact retry link in compact mode', () => {
      const onRetry = vi.fn();
      renderWithProviders(<ErrorDisplay error={new Error('Error')} onRetry={onRetry} compact />);
...
describe('InlineError', () => {
  it('displays error message', () => {
    renderWithProviders(<InlineError message="Something went wrong" />);
  ...
  it('displays retry button when onRetry provided', () => {
    const onRetry = vi.fn();
    renderWithProviders(<InlineError message="Error" onRetry={onRetry} />);
  ...
  it('hides retry when onRetry not provided', () => {
    renderWithProviders(<InlineError message="Error" />);
