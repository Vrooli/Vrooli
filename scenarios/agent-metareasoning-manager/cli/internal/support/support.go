...
const CLIName = "agent-metareasoning-manager"
...
// EnvelopeMessage returns the "message" string if body is a {success, data:
// {message}} envelope, else empty.
...
// path returns nil unless required is true. Errors on missing/invalid JSON.
