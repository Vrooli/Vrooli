...
### 🟢 P2 – Future / expansion
- [ ] OT-P2-001 | Flake And Runtime Diagnostics | Unit Health persists recent run timing, flags runtime growth, and surfaces likely-hang culprits from no-output timeout plus last log lines.
