 ...
 * (e.g. `features/validation/testFactories.ts`); only truly cross-domain
 ...
 * `packages/proto/gen/typescript/js/unit-health/v1/health/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/unit-health/v1/health/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/unit-health/v1/health/health_pb";
