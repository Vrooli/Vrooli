...
//
// Domain-specific factories (ValidateScenarioResponse, etc.) are NOT
// re-exported here — they live next to the feature they double for
// (e.g. `features/validation/testFactories.ts`) so deleting a feature
...
// (e.g. the validation workbench's `vi.mock("../../api/validation")`)
