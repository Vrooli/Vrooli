...
export const makeValidateScenarioResponse = (
  ...
  const base: MessageInitShape<typeof ValidateScenarioResponseSchema> = {
    ...
    projectionChecks: [
      {
        id: "ui:vitest.environment",
        workspaceId: "ui",
        surfaceId: "ui",
        key: "vitest.environment",
        owner: "vite.config.ts test",
        filePath: "scenarios/unit-health/ui/vite.config.ts",
        policyValue: "jsdom",
        nativeValue: "jsdom",
        status: "pass",
        remediation: "",
      ...
      {
        id: "ui:coverage.threshold.lines",
        workspaceId: "ui",
        surfaceId: "ui",
        ...
        nativeValue: "70",
        status: "drift",
        remediation: "Restore the lines threshold to 85.0 or higher.",
