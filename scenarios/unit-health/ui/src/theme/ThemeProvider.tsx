...
// Narrow runtime view of `window`. Typing `matchMedia` as optional lets the
// SSR / non-DOM guards below stay genuine conditionals — the DOM lib declares
// `window.matchMedia` as always-present, so a direct `!window.matchMedia`
// check is flagged as always-falsy under strict eslint.
