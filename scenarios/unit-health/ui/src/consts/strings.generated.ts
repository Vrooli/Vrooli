...
export const strings = {
  ...
  validation: {
    ...
    partialCollectionLimit: "validation.partialCollectionLimit",
    fullReportTitle: "validation.fullReportTitle",
    fullReportLimit: "validation.fullReportLimit",
    suppressedTitle: "validation.suppressedTitle",
    suppressedLimit: "validation.suppressedLimit",
    suppressedDetails: "validation.suppressedDetails",
    suppressedUnknown: "validation.suppressedUnknown",
    noFindings: "validation.noFindings",
    maturitySummaryTitle: "validation.maturitySummaryTitle",
    maturityLimit: "validation.maturityLimit",
    ...
    qualityTitle: "validation.qualityTitle",
    evidenceStagesTitle: "validation.evidenceStagesTitle",
    evidenceStagesLimit: "validation.evidenceStagesLimit",
    traceabilityTitle: "validation.traceabilityTitle",
    traceabilityLimit: "validation.traceabilityLimit",
    traceabilityUnknown: "validation.traceabilityUnknown",
    traceabilityResponsibilities: "validation.traceabilityResponsibilities",
    qualityLimit: "validation.qualityLimit",
    qualityUnknown: "validation.qualityUnknown",
    qualityShowing: "validation.qualityShowing",
    qualityMore: "validation.qualityMore",
    qualityDetails: "validation.qualityDetails",
    diagnosticsEmpty: "validation.diagnosticsEmpty",
    nativeFinalWarning: "validation.nativeFinalWarning",
