...
export const strings = {
  ...
  validation: {
    ...
    artifactsTitle: "validation.artifactsTitle",
    ...
    projectionTitle: "validation.projectionTitle",
    projectionEmpty: "validation.projectionEmpty",
    projectionPolicy: "validation.projectionPolicy",
    projectionNative: "validation.projectionNative",
