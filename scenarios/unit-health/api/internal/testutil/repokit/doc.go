...
//
// Per-domain wiring (in a table-owning domain's mocks/repository.go) is a
// 5–15 line type alias + extractor plumbing:
//
//	type FakeRepository = repokit.SliceRepo[mydomain.Entity]
//
//	func NewFakeRepository() *FakeRepository {
//	    return &FakeRepository{
//	        GetID:    func(e mydomain.Entity) string { return e.ID },
//	        SetID:    func(e *mydomain.Entity, id string) { e.ID = id },
//	        NotFound: func(id string) error { return mydomain.ErrEntityNotFound{ID: id} },
//	    }
//	}
//
...
// → []T" shape. Other domain-specific repository shapes with bespoke methods
// stay hand-written for now; lift to repokit only when a second consumer
// surfaces.
//
