...
// validation call so Validate can open profiling stages without changing its
// signature (and the Service's many test constructions). When no collector is
// present, every stage call is a nil no-op.
