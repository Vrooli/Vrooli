...
func TestRun_ProducesValidJSON(t *testing.T) {
	...
	writeSeed(t, seed, []CLICommand{
		...
		{Name: "validate scenario", Description: "Validate scenario test maturity", EndpointID: "validation_validate_scenario"},
	})
...
func TestStripBinaryPrefix(t *testing.T) {
	cases := []struct {
		...
		{in: "unit-health validate scenario", want: "validate scenario"},
