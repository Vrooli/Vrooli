...
export const literalSelectors = {
  ...
  initiativeDetails: {
    ...
    memberItemStrategyPanel: "initiative-mode-member-item-strategy-panel",
    memberItemStrategyPanelSwitchButton: "initiative-mode-member-item-strategy-panel-switch",
    operationBindingsSection: "initiative-operation-bindings-section",
    modePickerStrategyGroup: "initiative-mode-picker-strategy-group",
    memberItemStrategyNotice: "member-item-strategy-notice",
    ...
    flowPresetSelect: "operating-mode-flow-preset-select",
    flowPresetScenario: "operating-mode-flow-preset-scenario",
    flowTraceReads: "operating-mode-flow-trace-reads",
    flowTraceEmits: "operating-mode-flow-trace-emits",
    flowTraceTransition: "operating-mode-flow-trace-transition",
    flowTraceRawToggle: "operating-mode-flow-trace-raw-toggle",
    // Shared source-agnostic phase viewer (Instructions/Reads/Emits/Transition)
    // reused by the Flow and Phases tabs.
    phaseViewer: "operating-mode-phase-viewer",
    phaseViewerTabInstructions: "operating-mode-phase-viewer-tab-instructions",
    phaseViewerTabReads: "operating-mode-phase-viewer-tab-reads",
    phaseViewerTabEmits: "operating-mode-phase-viewer-tab-emits",
    phaseViewerTabTransition: "operating-mode-phase-viewer-tab-transition",
    ...
    flowSourceContract: "operating-mode-flow-source-contract",
    flowSourceSimulation: "operating-mode-flow-source-simulation",
    flowSourceLive: "operating-mode-flow-source-live",
  ...
  // Workflow binding override controls (agent-operations operator surface)
  workflowBindings: {
    panel: "workflow-bindings-panel",
    row: "workflow-bindings-row",
    rowSource: "workflow-bindings-row-source",
    rowError: "workflow-bindings-row-error",
    layerChip: "workflow-bindings-layer-chip",
    staleRevision: "workflow-bindings-stale-revision",
    overrideProvenance: "workflow-bindings-override-provenance",
    overrideButton: "workflow-bindings-override-button",
    resetButton: "workflow-bindings-reset-button",
    resetConfirmDialog: "workflow-bindings-reset-confirm",
    resetConfirmButton: "workflow-bindings-reset-confirm-button",
    overrideDialog: "workflow-bindings-override-dialog",
    overrideDialogModeOption: "workflow-bindings-override-mode-option",
    overrideDialogConfirm: "workflow-bindings-override-confirm",
    overrideDialogCancel: "workflow-bindings-override-cancel",
    overrideDialogEmpty: "workflow-bindings-override-empty",
    advancedToggle: "workflow-bindings-advanced-toggle",
  },
