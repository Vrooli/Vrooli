...
export type ProposalOp = "add_item" | "update_item" | "change_status" | "change_priority" | "add_edge" | "remove_edge" | "move_initiative" | "archive_item" | "interrupt_in_progress" | "split_item" | "merge_items" | "recreate_item" | "reset_artifacts" | "recreate_initiative";
export type ResetArtifactScope = "workshop" | "clarifications" | "review" | "handoff_executions" | "plan_unbind";
export interface ProposalItemSpec { kind: string; name: string; title: string; description?: string; priority?: number; tags?: string[]; depends_on?: string[]; effort?: string; initiative?: string; acceptance_allow?: string[]; acceptance_deny?: string[]; note?: string; spawned_from?: string; }
...
export interface ProposalMutation { id: string; op: ProposalOp; rationale?: string; target?: string; item?: ProposalItemSpec; patch?: ProposalItemPatch; status?: string; priority?: number; from?: string; to?: string; initiative?: string; into?: ProposalItemSpec[]; sources?: string[]; reset_scope?: ResetArtifactScope[]; }
