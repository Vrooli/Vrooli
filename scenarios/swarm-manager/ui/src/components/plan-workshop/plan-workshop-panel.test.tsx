...
const { service } = vi.hoisted(() => ({
  service: (() => {
    const session = {
      id: "pw-1", subject: { kind: "initiative", ref: "initiative-a" }, subject_version: "v1", plan_id: "plan-1", packet: {},
...
describe("PlanWorkshopPanel", () => {
  it("renders the structured candidate review and lets the operator ignore it", async () => {
    renderWithProviders(<PlanWorkshopPanel subject={{ kind: "initiative", ref: "initiative-a" }} />);
