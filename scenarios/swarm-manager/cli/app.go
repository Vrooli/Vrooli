...
func (a *App) dependencies() support.Dependencies {
	return support.Dependencies{
		...
		AgentOpsResolveBinding:          a.cmdAgentOpsResolveBinding,
		AgentOpsValidateInvocation:      a.cmdAgentOpsValidate,
		AgentOpsInspectWorkflow:         a.cmdAgentOpsInspectWorkflow,
		AgentOpsInspectExecution:        a.cmdAgentOpsInspectExecution,
		AgentOpsCatalog:                 a.cmdAgentOpsCatalog,
		AgentOpsCompatibleModes:         a.cmdAgentOpsCompatibleModes,
		AgentOpsBindings:                a.cmdAgentOpsBindings,
		AgentOpsOverrides:               a.cmdAgentOpsOverrides,
		AgentOpsWorkflow:                a.cmdAgentOpsWorkflow,
		AgentOpsHistory:                 a.cmdAgentOpsHistory,
		AgentOpsMigrationStatus:         a.cmdAgentOpsMigrationStatus,
		AgentOpsReconcile:               a.cmdAgentOpsReconcile,
