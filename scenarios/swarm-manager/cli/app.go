...
func (a *App) dependencies() support.Dependencies {
	return support.Dependencies{
		...
		IntegrationStatus:           a.cmdIntegrationStatus,
		...
		BacklogPlanWorkshop:         a.cmdBacklogPlanWorkshop,
		BacklogRecreate:             a.cmdBacklogRecreate,
		BacklogResetArtifacts:       a.cmdBacklogResetArtifacts,
		...
		EffortGet:                   a.cmdEffortGet,
		EffortAdmit:                 a.cmdEffortAdmit,
		EffortAmend:                 a.cmdEffortAmend,
		EffortEvidenceComplete:      a.cmdEffortEvidenceComplete,
		EffortAccept:                a.cmdEffortAccept,
		...
		GoalsList:                   a.cmdGoalsList,
		GoalsGet:                    a.cmdGoalsGet,
		GoalsCreate:                 a.cmdGoalsCreate,
		GoalsUpdate:                 a.cmdGoalsUpdate,
		GoalsDelete:                 a.cmdGoalsDelete,
		GoalsArchive:                a.cmdGoalsArchive,
		GoalsUnarchive:              a.cmdGoalsUnarchive,
		GoalsContext:                a.cmdGoalsContext,
		GoalsTargetsAdd:             a.cmdGoalsTargetsAdd,
		GoalsTargetsRemove:          a.cmdGoalsTargetsRemove,
		GoalsMilestoneCreate:        a.cmdGoalsMilestoneCreate,
		GoalsMilestoneUpdate:        a.cmdGoalsMilestoneUpdate,
		GoalsMilestoneAssign:        a.cmdGoalsMilestoneAssign,
		GoalsMilestoneUnassign:      a.cmdGoalsMilestoneUnassign,
		GoalsMilestoneArchive:       a.cmdGoalsMilestoneArchive,
		GoalsPlanRun:                a.cmdGoalsPlanRun,
		GoalsDiscoverRun:            a.cmdGoalsDiscoverRun,
		GoalsMilestoneReviewRun:     a.cmdGoalsMilestoneReviewRun,
		GoalsCloseOut:               a.cmdGoalsCloseOut,
		GoalsWorkflowPending:        a.cmdGoalsWorkflowPending,
		GoalsWorkflowApply:          a.cmdGoalsWorkflowApply,
		ProposalsList:               a.cmdProposalsList,
		ProposalsGet:                a.cmdProposalsGet,
		ProposalsDecide:             a.cmdProposalsDecide,
		ProposalsAcceptKeep:         a.cmdProposalsAcceptKeep,
		ProposalsRevise:             a.cmdProposalsRevise,
		...
		SessionsCreate:              a.cmdSessionsCreate,
		SessionsCreateBatch:         a.cmdSessionsCreateBatch,
		SessionsAttach:              a.cmdSessionsAttach,
		SessionsStart:               a.cmdSessionsStart,
		SessionsContinue:            a.cmdSessionsContinue,
		SessionsComplete:            a.cmdSessionsComplete,
		SessionsReap:                a.cmdSessionsReap,
		SessionsEvents:              a.cmdSessionsEvents,
		SessionsProposalApply:       a.cmdSessionsProposalApply,
		SessionsProposalRevise:      a.cmdSessionsProposalRevise,
		SessionsProposalWait:        a.cmdSessionsProposalWait,
		SessionsProposalAcceptKeep:  a.cmdSessionsProposalAcceptKeep,
