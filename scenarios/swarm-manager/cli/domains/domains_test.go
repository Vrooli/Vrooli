...
func TestSubcommandGroups(t *testing.T) {
	...
	wantNames := []string{
		"backlog", "scenarios", "settings", "queue", "execution", "prompts",
		"initiatives", "operating-mode", "captures", "records", "agent-manager",
		"operations", "portfolio", "sessions", "stats", "ai-search",
	}
