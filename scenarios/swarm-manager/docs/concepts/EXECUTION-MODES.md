...
- [`docs/plans/swarm-manager-initiative-operating-mode-implementation.md`](../plans/swarm-manager-initiative-operating-mode-implementation.md) — Original implementation plan for initiative-level operating modes.
