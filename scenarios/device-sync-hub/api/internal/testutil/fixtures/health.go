...
// `packages/proto/gen/go/device-sync-hub/v1/health/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/device-sync-hub/v1/health/health.proto`
