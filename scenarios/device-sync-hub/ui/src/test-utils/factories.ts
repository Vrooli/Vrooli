 ...
 * `packages/proto/gen/typescript/js/device-sync-hub/v1/health/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/device-sync-hub/v1/health/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/device-sync-hub/v1/health/health_pb";
