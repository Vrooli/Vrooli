...
const ParentDashboard = ({ onClose }) => {
  ...
  const calculateStats = () => {
    ...
    const totalReadingTime = stories.reduce(
      (acc, story) => acc + story.times_read * story.reading_time_minutes,
      0,
    );
    const favoriteCount = stories.filter((s) => s.is_favorite).length;
    const mostReadStory = stories.reduce(
      (max, story) => (!max || story.times_read > max.times_read ? story : max),
      null,
    );
      ...
      <div className="dashboard-stats">
        ...
        <div className="stat-card">
          <div className="stat-value">
            {stats.mostReadStory?.title || "None"}
          </div>
        ...
        {selectedStory && (
          <div className="story-preview">
            ...
            <div className="story-details">
              <p>
                <strong>Age Group:</strong> {selectedStory.age_group}
              </p>
              <p>
              ...
              <p>
                ...
                {selectedStory.reading_time_minutes} minutes
              </p>
              <p>
              ...
              <p>
                <strong>Times Read:</strong> {selectedStory.times_read}
              </p>
            </div>
