...
CREATE INDEX IF NOT EXISTS idx_stories_times_read ON stories(times_read DESC);
...
DROP TRIGGER IF EXISTS trigger_update_story_stats ON reading_sessions;
...
DROP TRIGGER IF EXISTS trigger_calculate_duration ON reading_sessions;
