...
// `packages/proto/gen/go/storage-manager/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/storage-manager/v1/shared/health.proto`
