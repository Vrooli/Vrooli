...
Storage Manager's product architecture is intentionally policy-first:
...
| Contracts (`packages/proto/schemas/storage-manager/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/storage-manager/`.
