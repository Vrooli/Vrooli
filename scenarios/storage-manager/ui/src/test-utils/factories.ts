 ...
 * `packages/proto/gen/typescript/js/storage-manager/v1/shared/...`.
...
import type { Response as HealthResponse } from "@vrooli/proto-types/storage-manager/v1/shared/health_pb";
