      ...
      <div id="storage-overview" className="scroll-mt-20 space-y-4">
        ...
        {snapshot ? (
          <div data-testid={selectors.console.summary} className="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
            ...
            <Metric label="Undeclared" value={formatBytes(snapshot.unattributed_bytes)} detail={snapshot.unattributed_bytes ? "Requires adoption review" : "Nothing outstanding"} tone={snapshot.unattributed_bytes ? "warning" : "success"} />
