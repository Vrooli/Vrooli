...
CREATE INDEX IF NOT EXISTS idx_text_documents_name ON text_documents USING gin(to_tsvector('english', name));
CREATE INDEX IF NOT EXISTS idx_text_documents_format ON text_documents(format);
CREATE INDEX IF NOT EXISTS idx_text_documents_language ON text_documents(language);
CREATE INDEX IF NOT EXISTS idx_text_documents_tags ON text_documents USING gin(tags);
CREATE INDEX IF NOT EXISTS idx_text_documents_metadata ON text_documents USING gin(metadata);
CREATE INDEX IF NOT EXISTS idx_text_documents_created_at ON text_documents(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_text_documents_content_hash ON text_documents(content_hash);
...
CREATE INDEX IF NOT EXISTS idx_text_operations_document_id ON text_operations(document_id);
CREATE INDEX IF NOT EXISTS idx_text_operations_type ON text_operations(operation_type);
CREATE INDEX IF NOT EXISTS idx_text_operations_status ON text_operations(status);
CREATE INDEX IF NOT EXISTS idx_text_operations_created_at ON text_operations(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_text_operations_cache_key ON text_operations(result_cache_key);
...
CREATE INDEX IF NOT EXISTS idx_text_templates_name ON text_templates(name);
CREATE INDEX IF NOT EXISTS idx_text_templates_category ON text_templates(category);
CREATE INDEX IF NOT EXISTS idx_text_templates_tags ON text_templates USING gin(tags);
CREATE INDEX IF NOT EXISTS idx_text_templates_usage_count ON text_templates(usage_count DESC);
...
CREATE INDEX IF NOT EXISTS idx_text_comparisons_doc1 ON text_comparisons(document1_id);
CREATE INDEX IF NOT EXISTS idx_text_comparisons_doc2 ON text_comparisons(document2_id);
CREATE INDEX IF NOT EXISTS idx_text_comparisons_operation ON text_comparisons(operation_id);
CREATE INDEX IF NOT EXISTS idx_text_comparisons_similarity ON text_comparisons(similarity_score DESC);
...
CREATE INDEX IF NOT EXISTS idx_text_embeddings_document ON text_embeddings(document_id);
CREATE INDEX IF NOT EXISTS idx_text_embeddings_vector ON text_embeddings USING ivfflat (embedding vector_cosine_ops);
...
CREATE INDEX IF NOT EXISTS idx_text_pipelines_name ON text_pipelines(name);
CREATE INDEX IF NOT EXISTS idx_text_pipelines_usage ON text_pipelines(usage_count DESC);
...
CREATE INDEX IF NOT EXISTS idx_text_extraction_rules_format ON text_extraction_rules(source_format);
CREATE INDEX IF NOT EXISTS idx_text_extraction_rules_type ON text_extraction_rules(rule_type);
CREATE INDEX IF NOT EXISTS idx_text_extraction_rules_active ON text_extraction_rules(is_active);
...
CREATE INDEX IF NOT EXISTS idx_api_usage_stats_scenario ON api_usage_stats(scenario_name);
...
DROP TRIGGER IF EXISTS update_text_documents_modified ON text_documents;
CREATE TRIGGER update_text_documents_modified
    BEFORE UPDATE ON text_documents
    FOR EACH ROW
    EXECUTE FUNCTION update_modified_at();

DROP TRIGGER IF EXISTS update_text_templates_modified ON text_templates;
CREATE TRIGGER update_text_templates_modified
    BEFORE UPDATE ON text_templates
    FOR EACH ROW
    EXECUTE FUNCTION update_modified_at();

DROP TRIGGER IF EXISTS update_text_pipelines_modified ON text_pipelines;
CREATE TRIGGER update_text_pipelines_modified
    BEFORE UPDATE ON text_pipelines
    FOR EACH ROW
    EXECUTE FUNCTION update_modified_at();

DROP TRIGGER IF EXISTS update_text_extraction_rules_modified ON text_extraction_rules;
...
CREATE INDEX IF NOT EXISTS idx_operation_statistics_day ON operation_statistics(day DESC);
