...
SCENARIO_NAME="email-outreach-manager"
LOG_DIR="$TEST_DIR/artifacts"

mkdir -p "$LOG_DIR"

# Initialise shared phased test runner
# Runtime management stays opt-in so integration/business phases can skip cleanly
# unless the caller supplies --manage-runtime.
testing::runner::init \
