...
// `packages/proto/gen/go/quality-health/v1/health/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/quality-health/v1/health/health.proto`
