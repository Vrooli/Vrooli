...
// (health and future product domains) returns a Module from its handlers package, and main.go
...
//
//   - Name is for diagnostics ("health", "audit", "tasks"). Free-form;
...
// errors) and future product domains round-trip the same way.
...
const (
	...
	// Multipart endpoints can declare transport-only request payloads.
...
// it. Command uses quality-health as the binary name placeholder, e.g.
// "quality-health audit run". Args lists positional/flag tokens for
