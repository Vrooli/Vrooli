...
| Contracts (`packages/proto/schemas/notification-hub/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/notification-hub/`.
...
packages/proto/schemas/notification-hub/v1/<domain>/<file>.proto
       ...
       make generate
       │
       ├──▶ packages/proto/gen/go/notification-hub/v1/...              (api, cli)
       ├──▶ packages/proto/gen/go/notification-hub/v1/...connect       (Connect-Go)
       ├──▶ packages/proto/gen/typescript/js/notification-hub/v1/...   (ui)
       └──▶ packages/proto/gen/python/notification_hub/v1/...    (future tools)
```
...
1. Add proto messages and service methods under
   `packages/proto/schemas/notification-hub/v1/<domain>/`.
...
|---|---|---|---|
| 2026-08-17 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
