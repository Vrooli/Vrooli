 ...
 * `packages/proto/gen/typescript/js/notification-hub/v1/notes/...`.
...
} from "@vrooli/proto-types/notification-hub/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/notification-hub/v1/notes/attachments_pb";
