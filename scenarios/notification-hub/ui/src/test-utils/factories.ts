 ...
 * (e.g. a feature-local mock factory); only truly cross-domain
 ...
 * `packages/proto/gen/typescript/js/notification-hub/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/notification-hub/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/notification-hub/v1/shared/health_pb";
