 ...
 * `packages/proto/gen/typescript/js/hello-mobile/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/hello-mobile/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/hello-mobile/v1/shared/health_pb";
