...
const literalSelectors = {
	helloMobile: {
		...
		input: "hello-mobile-input",
		submit: "hello-mobile-submit",
		result: "hello-mobile-result",
		state: "hello-mobile-state",
		connectivity: "hello-mobile-connectivity",
		route: "hello-mobile-route",
		notification: "hello-mobile-notification",
	},
	app: {
    title: "app-title",
    eyebrow: "app-eyebrow",
