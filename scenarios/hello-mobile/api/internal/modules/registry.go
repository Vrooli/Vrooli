...
import (
	...
	notesv1 "github.com/vrooli/vrooli/packages/proto/gen/go/hello-mobile/v1/notes" // EXAMPLE-DOMAIN:notes
)
...
func AllProtoFiles() []ProtoFileEntry {
	return []ProtoFileEntry{
		{Module: "notes", File: notesv1.File_hello_mobile_v1_notes_notes_proto}, // EXAMPLE-DOMAIN:notes
	}
}
