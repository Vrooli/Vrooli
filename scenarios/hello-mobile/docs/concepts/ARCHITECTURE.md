...
| Contracts (`packages/proto/schemas/hello-mobile/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/hello-mobile/`.
...
1. Add proto messages and service methods under
   `packages/proto/schemas/hello-mobile/v1/<domain>/`.
