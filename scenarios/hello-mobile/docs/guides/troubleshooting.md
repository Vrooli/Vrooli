...
```bash
export SQLITE_PATH=/tmp/hello-mobile.db
make start
```
...
```bash
fuser "$(echo "${SQLITE_PATH:-${SCENARIO_DATA_DIR}/hello-mobile.db}")"
```
...
`packages/proto/gen/typescript/js/hello-mobile/v1/`, and Python under
