...
| Contracts (`packages/proto/schemas/flow-verifier/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/flow-verifier/`.
