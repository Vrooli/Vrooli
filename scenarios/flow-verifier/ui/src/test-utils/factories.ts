 ...
 * `packages/proto/gen/typescript/js/flow-verifier/v1/health/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/flow-verifier/v1/health/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/flow-verifier/v1/health/health_pb";
