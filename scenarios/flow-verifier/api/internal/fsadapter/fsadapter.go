// Package fsadapter centralises filesystem path + hash helpers used by
// the flows discovery, verification artifact, and pipeline domains.
// It is the only shared cross-domain utility in api/internal/ that wraps
// raw filesystem walks; everything else owns its own I/O.
package fsadapter
