...
// `packages/proto/gen/go/flow-verifier/v1/health/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/flow-verifier/v1/health/health.proto`
