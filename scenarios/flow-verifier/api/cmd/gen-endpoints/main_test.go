...
func TestRun_ProducesValidJSON(t *testing.T) {
	...
	writeSeed(t, seed, []CLICommand{
		...
		{Name: "flows codegen", Description: "Codegen flow", EndpointID: "flows.codegen"},
		{Name: "flows reconcile", Description: "Reconcile flow", EndpointID: "flows.reconcile"},
		{Name: "flows studio", Description: "Navigation studio descriptor", EndpointID: "flows.navigationStudio"},
