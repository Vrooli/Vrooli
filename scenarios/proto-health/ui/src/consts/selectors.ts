...
const literalSelectors = {
  ...
  protoHealth: {
    panel: "proto-health-panel",
    scenarioInput: "proto-health-scenario-input",
    runButton: "proto-health-run-button",
    loading: "proto-health-loading",
    error: "proto-health-error",
    empty: "proto-health-empty",
  ...
  layout: {
    shell: "layout-shell",
    topBar: "layout-shell-header",
    sidebar: "layout-shell-sidebar",
    bottomNav: "layout-shell-tabs",
...
const dynamicSelectorDefinitions = {
  ...
  layout: {
    ...
    bottomNavLink: defineDynamicSelector({
      ...
      testIdPattern: "layout-sidebar-link-${key}-tab",
      params: { key: { type: "enum", values: ["dashboard", "settings"] as const } },
    }),
  },
  protoHealth: {
    quickTarget: defineDynamicSelector({
      description: "Quick target scenario button",
      testIdPattern: "proto-health-quick-target-${scenario}",
      params: { scenario: { type: "enum", values: ["proto-health", "cli-health", "measures-health", "agent-manager"] as const } },
    }),
  },
  settingsPage: {
