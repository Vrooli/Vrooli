...
// added to the contract. proto-health ships no deterministic autofixer, so both
...
var errNoDeterministicFixer = errors.New("proto-health has no deterministic fixer")
