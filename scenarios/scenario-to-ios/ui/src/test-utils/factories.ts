 ...
 * `packages/proto/gen/typescript/js/scenario-to-ios/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/scenario-to-ios/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/scenario-to-ios/v1/shared/health_pb";
