...
// Decode unmarshals body as the concrete shape expected by the caller. If the
// response is a {success, data} envelope, the data field is unwrapped;
