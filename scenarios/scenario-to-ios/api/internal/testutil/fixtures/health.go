...
// `packages/proto/gen/go/scenario-to-ios/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/scenario-to-ios/v1/shared/health.proto`
