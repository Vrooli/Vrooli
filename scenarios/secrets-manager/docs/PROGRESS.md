...
| Date | Author | % Δ | Summary | Files Changed |
|------|--------|-----|---------|---------------|
| 2025-12-01 11:45 | Codex (readiness-split-and-export) | +0.3% | **Resource vs Scenario readiness clarity**: Split readiness into Resource vs Scenario tabs, clarified what each measures, added scenario search chips, manifest export CTA, and a full resource list (including healthy items) so users can verify coverage beyond the top issues. Orientation copy now explains the readiness types. | ui/src/App.tsx, ui/src/sections/TierReadiness.tsx, ui/src/sections/OrientationHub.tsx, ui/src/sections/ResourceWorkbench.tsx, ui/src/hooks/useJourneys.ts |
