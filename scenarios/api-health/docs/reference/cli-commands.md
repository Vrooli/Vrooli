...
`~/.vrooli/bin/api-health`, and rebuilt automatically when its
...
- **Error messages must be actionable.** "API unreachable" is bad;
  ...
  `vrooli scenario start api-health`" is good.
