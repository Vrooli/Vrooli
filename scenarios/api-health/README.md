...
Validates Vrooli scenario API lifecycle, health, HTTP semantics, and runtime hygiene as a delegated Test Genie health provider.
...
`test-genie execute api-health --preset comprehensive` directly for
