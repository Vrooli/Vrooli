...
const CLIName = "prompt-injection-arena"
...
// EnvelopeMessage returns the "message" string from either a {success,data:{message}}
// envelope or a top-level {"message": "..."} payload.
