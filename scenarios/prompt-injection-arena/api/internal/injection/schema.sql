...
CREATE TABLE IF NOT EXISTS injection_techniques (
...
CREATE INDEX IF NOT EXISTS idx_injection_techniques_category ON injection_techniques(category);
CREATE INDEX IF NOT EXISTS idx_injection_techniques_difficulty ON injection_techniques(difficulty_score);
CREATE INDEX IF NOT EXISTS idx_injection_techniques_success_rate ON injection_techniques(success_rate);
CREATE INDEX IF NOT EXISTS idx_injection_techniques_active ON injection_techniques(is_active) WHERE is_active = true;

CREATE INDEX IF NOT EXISTS idx_agent_configurations_model ON agent_configurations(model_name);
CREATE INDEX IF NOT EXISTS idx_agent_configurations_robustness ON agent_configurations(robustness_score DESC);
CREATE INDEX IF NOT EXISTS idx_agent_configurations_active ON agent_configurations(is_active) WHERE is_active = true;

CREATE INDEX IF NOT EXISTS idx_test_results_injection_id ON test_results(injection_id);
...
CREATE INDEX IF NOT EXISTS idx_leaderboard_snapshots_type_created ON leaderboard_snapshots(snapshot_type, created_at DESC);
...
DROP TRIGGER IF EXISTS update_injection_techniques_updated_at ON injection_techniques;
...
DROP TRIGGER IF EXISTS trigger_update_scores_on_test_result ON test_results;
...
CREATE INDEX IF NOT EXISTS idx_tournament_results_agent_id ON tournament_results(agent_id);
CREATE INDEX IF NOT EXISTS idx_tournament_results_score ON tournament_results(score DESC);
