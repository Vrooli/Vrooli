...
// `packages/proto/gen/go/cleanup-manager/v1/shared/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/cleanup-manager/v1/shared/health.proto`
