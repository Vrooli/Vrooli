...
// one cleanup-manager could not service.
//
...
// PressureAction is what cleanup-manager did about a report.
...
//
// Two safeguards reach cleanup-manager independently by design, so duplicate
