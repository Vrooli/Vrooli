...
Cleanup Manager is Vrooli's durable cleanup policy and orchestration
...
Ecosystem fit: Cleanup Manager is a meta-scenario and interface-enabler.
...
private deletion logic behind provider hooks; Cleanup Manager owns policy,
...
`test-genie execute cleanup-manager --preset comprehensive` directly for
