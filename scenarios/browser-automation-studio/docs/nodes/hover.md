...
2. The Playwright driver issues `Input.dispatchMouseEvent` events to simulate moving from the current pointer position to the target element in the requested number of steps/duration.
