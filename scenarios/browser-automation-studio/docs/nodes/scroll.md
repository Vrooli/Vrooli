...
2. The Playwright driver dispatches either window-level `Page.scroll` commands or executes frame-aware `scrollIntoView`/`scrollTo` scripts, depending on the mode.
