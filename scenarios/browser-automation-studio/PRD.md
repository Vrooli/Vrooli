...
- **Requirements Tracking**: `requirements/index.yaml` (v0.2.0 modular registry) plus `scripts/requirements/report.js` reflect telemetry/replay progress. Automated integration with CI dashboards is still pending.
