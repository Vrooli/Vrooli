    ...
    >
      ...
      <div className="px-4 py-3 border-t border-gray-200 dark:border-gray-700">
        {isNavigating ? (
          <button
            onClick={onAbort}
            className="w-full px-4 py-2 text-sm font-medium text-red-700 bg-red-100 hover:bg-red-200 dark:bg-red-900/30 dark:text-red-300 dark:hover:bg-red-900/50 rounded-lg transition-colors"
          >
