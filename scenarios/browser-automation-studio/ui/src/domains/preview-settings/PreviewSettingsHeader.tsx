 ...
 *
 * Header for the Preview Settings dialog. Includes:
 * - Title
 * - Replay presets dropdown (always visible, applies to replay tabs)
 * - Randomize button
 * - Save preset button
 * - Close button
 */
    ...
    <>
      <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div>
            <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Preview Settings</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400">Configure stream quality and replay styling</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 text-sm bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-700 dark:text-gray-200 hover:border-gray-300 dark:hover:border-gray-600 transition-colors"
            >
              <Bookmark size={14} className={activePreset ? 'text-flow-accent' : 'text-gray-500'} />
              <span className="max-w-[120px] truncate">{activePreset ? activePreset.name : 'Presets'}</span>
            ...
            {showPresetDropdown && (
              <>
                ...
                <div className="absolute right-0 top-full mt-2 z-30 w-64 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl overflow-hidden max-h-80 overflow-y-auto">
