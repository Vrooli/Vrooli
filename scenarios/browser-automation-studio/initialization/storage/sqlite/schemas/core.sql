...
-- ============================================================================
-- PROJECT ASSETS: Index of non-workflow files within a project
-- ============================================================================
-- Asset bytes remain on disk; this table supports file-tree, import, and
-- workflow-sync lookups. It belongs with projects/workflows because routed
-- test pools must initialize the whole project catalog atomically.
