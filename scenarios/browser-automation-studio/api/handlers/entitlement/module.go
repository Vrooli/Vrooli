...
// state, identity, and credit usage. Paid decisions come from the signed LPBS
// lease; local plan and API-source controls are intentionally not exposed.
package entitlement
...
// SettingsStore is the narrow seam used for persistent consumer identity. The concrete implementation is the SQLite-backed
...
// Settings is optional — when nil, identity endpoints that touch persistent
// state return FailedPrecondition.
type Deps struct {
	Provider Provider
