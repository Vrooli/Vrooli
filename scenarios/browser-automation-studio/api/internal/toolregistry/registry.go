// Package toolregistry provides the tool discovery service for browser-automation-studio.
//
...
// - ToolDefinitions: Static tool definitions (workflow execution, recording, AI, etc.)
//
// TESTING SEAMS:
