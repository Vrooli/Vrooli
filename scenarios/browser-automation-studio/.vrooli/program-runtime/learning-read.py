try:
    ...
    inputs = {}
envelope={"program":"browser-automation-studio.learning-read","version":"1","status":"failed","phase":"validate","inputs":{},
...
def step_collect():
    ...
    try:
        handles["learning"]=vrooli_memory.learning.measure(scope="bas-usage",rows="cohorts",**inputs)
