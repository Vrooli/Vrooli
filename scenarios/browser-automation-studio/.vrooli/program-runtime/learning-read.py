...
envelope={"program":"browser-automation-studio.learning-read","version":"1","status":"failed","phase":"validate",
...
try:
    ...
    result=lib.vrooli_memory.compare_outcomes(scope="bas-usage",cohort_limit=1,**inputs).head(1)
    if not result:
