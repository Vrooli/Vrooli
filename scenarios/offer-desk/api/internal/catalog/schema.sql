CREATE TABLE IF NOT EXISTS nodes (id TEXT PRIMARY KEY, kind INTEGER NOT NULL, name TEXT NOT NULL, status INTEGER NOT NULL, trigger_id TEXT NOT NULL DEFAULT '', created_at TEXT NOT NULL, actual_account_id TEXT NOT NULL DEFAULT '', release_rank INTEGER NOT NULL DEFAULT 0, deliverable_class INTEGER NOT NULL DEFAULT 0, finish_bar INTEGER NOT NULL DEFAULT 0);
