...
| Contracts (`packages/proto/schemas/offer-desk/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/offer-desk/`.
...
```
packages/proto/schemas/offer-desk/v1/<domain>/<file>.proto
       │
       ▼
       make generate
       │
       ├──▶ packages/proto/gen/go/offer-desk/v1/...              (api, cli)
       ├──▶ packages/proto/gen/go/offer-desk/v1/...connect       (Connect-Go)
       ├──▶ packages/proto/gen/typescript/js/offer-desk/v1/...   (ui)
       └──▶ packages/proto/gen/python/offer_desk/v1/...    (future tools)
```
...
1. Add proto messages and service methods under
   `packages/proto/schemas/offer-desk/v1/<domain>/`.
...
|---|---|---|---|
| 2026-08-13 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
