...
react-component-library adoptions resolve-path <component-id> offer-desk
react-component-library adoptions apply <component-id> offer-desk <adopted-path>
```
...
Run `experience-manager spec validate offer-desk --json` after route or
selector changes. The generated notes page spec is example-domain content and
is removed by `template-manager detemplate offer-desk`.
