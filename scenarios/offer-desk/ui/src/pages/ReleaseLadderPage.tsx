...
type EntryLike = { deliverable?: NodeLike; unlockedRamps?: NodeLike[]; unlockedStreams?: NodeLike[]; audiences?: NodeLike[]; cumulativeRamps?: NodeLike[]; goalImpacts?: GoalImpactLike[] };
