...
describe("AppRouter", () => {
  ...
  it("renders the offers page at /offers", () => {
    renderWithProviders(<TestAppRouter initialEntries={["/offers"]} />, { withoutRouter: true });
    expect(screen.getByTestId(selectors.pages.offers)).toBeInTheDocument();
  });
