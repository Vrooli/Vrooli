...
export function AppShell() {
  ...
  return <LibraryAppShell density="sidebar" mobileNav="tabs" mainMode="scroll"
    ...
    utility={<span className="text-xs text-app-muted-foreground">{t(strings.app.description)}</span>}
    ...
    onNavigate={(item) => navigate(item.href)} navigationLabel={t(strings.layout.sidebarLabel)} mobileNavigationLabel={t(strings.layout.bottomNavLabel)} sidebarStorageKey="offer-desk.sidebar-width" testId={selectors.layout.shell}>
    <Outlet />
  </LibraryAppShell>;
}
