...
import (
	...
	capsH "hello-python/handlers/capabilities"

	apidb "github.com/vrooli/api-core/database"
	"google.golang.org/protobuf/reflect/protoreflect"

	healthH "hello-python/handlers/health"
	notesH "hello-python/handlers/notes" // EXAMPLE-DOMAIN:notes
	localdb "hello-python/internal/database"

	notesv1 "github.com/vrooli/vrooli/packages/proto/gen/go/hello-python/v1/notes" // EXAMPLE-DOMAIN:notes
)
...
func AllProtoFiles() []ProtoFileEntry {
	return []ProtoFileEntry{
		{Module: "notes", File: notesv1.File_hello_python_v1_notes_notes_proto}, // EXAMPLE-DOMAIN:notes
	}
}
