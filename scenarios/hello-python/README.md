...
Python builder lifecycle proof scenario

This scenario was generated from the `python-uv-react-vite` template and packages
...
- Python uv API (`api/`), Go CLI (`cli/`), and React/Vite UI (`ui/`)
...
`test-genie execute hello-python --preset comprehensive` directly for
