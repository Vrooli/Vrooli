...
| Contracts (`packages/proto/schemas/hello-python/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/hello-python/`.
...
packages/proto/schemas/hello-python/v1/<domain>/<file>.proto
       ...
       make generate
       │
       ├──▶ packages/proto/gen/go/hello-python/v1/...              (api, cli)
       ├──▶ packages/proto/gen/go/hello-python/v1/...connect       (Connect-Go)
       ├──▶ packages/proto/gen/typescript/hello-python/v1/...   (ui)
       └──▶ packages/proto/gen/python/hello_python/v1/...    (future tools)
```
...
1. Add proto messages and service methods under
   `packages/proto/schemas/hello-python/v1/<domain>/`.
...
|---|---|---|---|
| 2026-09-02 | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
