...
```bash
react-component-library adoptions eject navigation.app-shell hello-python --reason "..."
```
...
react-component-library adoptions preflight <component-id> hello-python
...
```bash
react-component-library components ingest hello-python ui/src/features/<name>/<Component>.tsx <Component>
```
