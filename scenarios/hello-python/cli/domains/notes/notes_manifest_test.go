...
import (
	...
	notesv1 "github.com/vrooli/vrooli/packages/proto/gen/go/hello-python/v1/notes"
...
// the template itself does not build because of hello-python placeholders.
func TestNotesManifestCoversNotesService(t *testing.T) {
	manifest := readNotesManifest(t)
	cliapp.RequireProtoServiceCoverage(t, manifest, notesv1.File_hello_python_v1_notes_notes_proto, "NotesService")
}
