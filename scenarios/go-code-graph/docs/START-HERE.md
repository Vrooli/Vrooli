...
all required gates pass, run `vrooli scenario orient go-code-graph
...
```bash
prd-control-tower prd generate go-code-graph \
...
```bash
prd-control-tower prd validate go-code-graph --json
```
...
```bash
prd-control-tower requirements generate go-code-graph \
...
```bash
prd-control-tower requirements validate go-code-graph --json
```
