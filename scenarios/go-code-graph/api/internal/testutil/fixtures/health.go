...
// `packages/proto/gen/go/go-code-graph/v1/health/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/go-code-graph/v1/health/health.proto`
