...
var Endpoints = []module.EndpointDescriptor{
	{
		...
		Description: "Loads the Go module rooted at module_path and returns the normalized graph, warnings, phase timings, and graph hash. Full extraction remains the default; callers can opt into lighter profiles or narrower package patterns.",
		Category:    "graph",
		Request: &module.Schema{
			...
			Properties: map[string]string{
				...
				"profile":          "enum {full, semantic, structural} (default full)",
				"package_patterns": "array<string> (optional, module-relative Go patterns; empty means ./...)",
			},
		},
