...
import (
	...
	notesconnect "github.com/vrooli/vrooli/packages/proto/gen/go/go-code-graph/v1/notes/notes_v1connect"

	"go-code-graph/handlers/notes"
	"go-code-graph/internal/clock"
	localdb "go-code-graph/internal/database"
	internalnotes "go-code-graph/internal/notes"
