...
import "go-code-graph/internal/module"
		...
		RESTException: &module.RESTException{
			...
			ProtoPayloads: module.RESTProtoPayloads{
				...
				Response: module.RESTPayload{
					ProtoFullName: "vrooli.go_code_graph.v1.health.Response",
					Transport:     "json",
					Conformance:   "protojson",
				},
				Error: module.RESTPayload{
					ProtoFullName: "vrooli.go_code_graph.v1.errors.ErrorEnvelope",
					Transport:     "json",
					Conformance:   "protojson",
				},
			},
