 ...
 * `packages/proto/gen/typescript/js/go-code-graph/v1/health/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/go-code-graph/v1/health/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/go-code-graph/v1/health/health_pb";
