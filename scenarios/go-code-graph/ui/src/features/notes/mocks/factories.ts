 ...
 * `packages/proto/gen/typescript/js/go-code-graph/v1/notes/...`.
...
} from "@vrooli/proto-types/go-code-graph/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/go-code-graph/v1/notes/attachments_pb";
