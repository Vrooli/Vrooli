...
export const strings = {
  ...
  explorer: {
    ...
    kind: {
      go_type: "explorer.kind.go_type",
      go_func: "explorer.kind.go_func",
      go_var: "explorer.kind.go_var",
      go_const: "explorer.kind.go_const",
      go_interface: "explorer.kind.go_interface",
      go_method: "explorer.kind.go_method",
  ...
  warnings: {
    ...
    vendorToggle: "warnings.vendorToggle",
    vendorHint: "warnings.vendorHint",
