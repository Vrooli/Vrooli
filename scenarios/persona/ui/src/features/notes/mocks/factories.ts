 ...
 * `packages/proto/gen/typescript/js/persona/v1/notes/...`.
...
} from "@vrooli/proto-types/persona/v1/notes/notes_pb";
import {
  AttachmentSchema,
  type Attachment,
} from "@vrooli/proto-types/persona/v1/notes/attachments_pb";
