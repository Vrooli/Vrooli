...
envelope (`packages/proto/schemas/persona/v1/shared/errors.proto`):
...
The proto type lives at `packages/proto/schemas/persona/v1/shared/health.proto`
...
`POST /vrooli.persona.v1.<domain>.<Domain>Service/<Method>`
