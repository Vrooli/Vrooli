...
| Contracts (`packages/proto/schemas/persona/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
- scenario proto schemas relocated to
  `packages/proto/schemas/persona/`.
...
```
packages/proto/schemas/persona/v1/<domain>/<file>.proto
       │
       ▼
       make generate
       │
