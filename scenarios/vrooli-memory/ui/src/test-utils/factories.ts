 ...
 * (e.g. `features/journal/mocks/factories.ts`); only truly cross-domain
 ...
 * `packages/proto/gen/typescript/js/vrooli-memory/v1/shared/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/vrooli-memory/v1/shared/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/vrooli-memory/v1/shared/health_pb";
