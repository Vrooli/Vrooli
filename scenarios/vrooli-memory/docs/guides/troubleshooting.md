...
make stop
vrooli scenario start vrooli-memory --clean-stale
```
...
```bash
fuser "${SCENARIO_DATA_DIR}/vrooli-memory.db"
```
...
`packages/proto/gen/typescript/vrooli-memory/v1/`, and Python under
