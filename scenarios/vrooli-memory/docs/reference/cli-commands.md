...
```bash
vrooli-memory notes list
vrooli-memory notes list --json
```

#### `vrooli-memory notes create --title <title> [--body <body>]`
...
```bash
vrooli-memory notes create --title "First note" --body "Hello world"
```
...
```bash
vrooli-memory notes attach abc123 --file ./example.png
```
