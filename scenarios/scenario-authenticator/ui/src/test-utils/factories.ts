 ...
 * `packages/proto/gen/typescript/js/scenario-authenticator/v1/health/...`.
...
import { ResponseSchema } from "@vrooli/proto-types/scenario-authenticator/v1/health/health_pb";
import type { Response as HealthResponse } from "@vrooli/proto-types/scenario-authenticator/v1/health/health_pb";
