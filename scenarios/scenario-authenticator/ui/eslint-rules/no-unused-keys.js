...
// looks like an i18next key (`"feature.key"`, `"a.b.c"`). Catalogs may use
// hyphenated RCL namespaces such as `feedback.permission-state`, so the
// segment grammar mirrors the catalog rather than JavaScript identifiers.
// The string must contain at least one `.` so we don't match every plain
// identifier string.
