...
func RegisterHandler(w http.ResponseWriter, r *http.Request) {
	...
	if valid, message := utils.ValidatePassword(req.Password, utils.DefaultPasswordRequirements()); !valid {
		utils.SendError(w, message, http.StatusBadRequest)
		return
	}
...
func LogoutHandler(w http.ResponseWriter, r *http.Request) {
	...
	auth.BlacklistToken(token, expiresAt)
...
func CompleteResetHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Validate password complexity
	if valid, message := utils.ValidatePassword(req.NewPassword, utils.DefaultPasswordRequirements()); !valid {
		utils.SendError(w, message, http.StatusBadRequest)
		return
	}
