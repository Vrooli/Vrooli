...
// `packages/proto/gen/go/scenario-authenticator/v1/health/health.pb.go`. The
...
// the wire shape itself live in `packages/proto/schemas/scenario-authenticator/v1/health/health.proto`
