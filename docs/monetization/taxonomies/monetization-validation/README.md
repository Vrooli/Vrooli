...
Cross-team-readable canon for how monetization validation requests are partitioned, classified, dispatched, and shaped. This file is the human-readable view of [`taxonomy.json`](taxonomy.json).
