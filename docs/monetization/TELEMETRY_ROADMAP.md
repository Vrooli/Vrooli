...
- **Downstream effect:** Collapses ~4 `pending-telemetry` flags in [FUNNEL.md](FUNNEL.md) and the retention portion of [FINANCIAL_MODEL.md](FINANCIAL_MODEL.md).
...
- **Most likely host:** The API gateway itself — could be part of LPBS, scenario-to-cloud, or its own resource. Directly tied to Tier 2 activation prereqs (see [TIERS.md](TIERS.md)).
...
- **Downstream effect:** Collapses the Acquisition `pending-telemetry` in [FUNNEL.md](FUNNEL.md).
