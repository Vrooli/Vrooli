...
Comparable SaaS bundles are cataloged in [BENCHMARKS.md](../evidence/BENCHMARKS.md). Market-validator populates that file and references it when proposing pricing updates.

## Related documents

- [TIERS.md](TIERS.md) — why each tier exists and what it costs us
- [FINANCIAL_MODEL.md](../evidence/FINANCIAL_MODEL.md) — COGS per tier, LTV formulas, default-alive math
- [CATALOG.md](../catalogs/CATALOG.md) — SKU index
