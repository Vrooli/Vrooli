...
Cited by:
- `topics.json` for any member whose `intake[].taxonomy = "notebook-debt"` — currently `literal:marketing-crew/brand-manager` (`marketing/notebook/*`) and `literal:meta-optimization/debt-curator` (`meta-optimization/notebook/*`).
