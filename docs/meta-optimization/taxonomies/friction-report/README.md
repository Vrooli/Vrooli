...
Cross-team-readable canon for how the `literal:meta-optimization/friction-curator` member classifies and routes entries written to `friction-inbox/*`. Human-readable view of [`taxonomy.json`](taxonomy.json).
...
- [`docs/meta-optimization/README.md`](../../README.md) — meta-optimization team's friction-related canon overview.
