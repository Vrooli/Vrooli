...
- **Not** an iteration of the template-fitness program. The fitness harness program is tracked separately at `~/.claude/plans/thanks-for-the-postgres-wise-hearth.md` and at `path:scenarios/prompt-manager/store/teams/meta-optimization/notebook/template-fitness/react-vite-template/2026-05-04/`. After this plan lands, the fitness program runs iteration 3 against the new convention.
...
- [`path:scenarios/prompt-manager/store/teams/meta-optimization/notebook/template-fitness/react-vite-template/2026-05-04/RESULTS.md`](../../scenarios/prompt-manager/store/teams/meta-optimization/notebook/template-fitness/react-vite-template/2026-05-04/RESULTS.md) "Iteration 2 — Results" section — the cost composition that motivates this plan.
