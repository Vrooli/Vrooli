...
- **`palette`** — object:
  ...
  - `accent`: array of hex colors describing accent tones (often pulls from brand palette per [`../../IMAGE_STYLE.md`](../../IMAGE_STYLE.md))
...
- [`../../IMAGE_STYLE.md`](../../IMAGE_STYLE.md) — brand canon for palette and aesthetic.
