...
They do **not** answer: *how does any specific post type apply this technique end-to-end.* That belongs in the per-type file under [`../../catalogs/post-types/`](../../catalogs/post-types/) which references the technique here.
