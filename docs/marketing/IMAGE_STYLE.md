...
- [`docs/marketing/ASSETS.md`](ASSETS.md) — canonical brand assets (logos, fonts, etc.)
- [`docs/marketing/BRAND.md`](BRAND.md) — visual identity overview
- [`docs/marketing/STRATEGY.md`](STRATEGY.md) — voice canon (the linguistic counterpart to this file's visual canon)
