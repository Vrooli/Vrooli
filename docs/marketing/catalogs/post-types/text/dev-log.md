...
Primary: the **OSS / contributor** persona (see [`AUDIENCES.md`](../../../strategy/AUDIENCES.md) for the full definition). Specifically:
...
Apply the cross-cutting [essay-shape technique](../../../methods/post-techniques/essay-shape.md) — hook → introduction → body → conclusion. With the cross-cutting [hook-vs-body-asymmetry technique](../../../methods/post-techniques/hook-vs-body-asymmetry.md) on length distribution.
...
The general voice canon lives in [`STRATEGY.md`](../../../strategy/STRATEGY.md). Dev-logs apply it with an additional discipline:
...
Dev-logs are **text-led**, not asset-led (in contrast to `scenario-spotlight.md`'s asset-led shape). When an asset appears, it is supporting evidence for the narrative — a diff fragment, a screenshot of a graph view, an ASCII tree of the new package layout. Brand consistency with [`ASSETS.md`](../../../strategy/ASSETS.md) and [`IMAGE_STYLE.md`](../../../strategy/IMAGE_STYLE.md) still applies; sanitization per [`x-dev-log`](../../../../../scenarios/prompt-manager/store/skills/packs/core/x-dev-log/SKILL.md) guardrails is non-negotiable.
...
(All have canonical homes under [`../../../methods/post-techniques/`](../../../methods/post-techniques/).)
