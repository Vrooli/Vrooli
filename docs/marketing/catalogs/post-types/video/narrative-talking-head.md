...
- [Hook-vs-body length asymmetry](../../../methods/post-techniques/hook-vs-body-asymmetry.md) — first 1.5s carries massive weight; rest is body.
- [Recommendation framing](../../../methods/post-techniques/recommendation-framing.md) (with AI-UGC scope per `ai-ugc-personas.md`).

## Cross-references

- [`../../../strategy/patterns/ai-ugc-personas.md`](../../../strategy/patterns/ai-ugc-personas.md) — persona discipline, disclosure protocol.
...
- [`../../../strategy/patterns/hook-library.md`](../../../strategy/patterns/hook-library.md) — narrative talking-head openers.
