...
**Craft observation topic:** `marketing-craft-observation/slideshow-tips-then-plug/<slug>`
...
- **Brand assets in the closer frame.** Logo, scenario name, tier-aligned CTA per [`../../../strategy/ASSETS.md`](../../../strategy/ASSETS.md).
- **Disclosure label** — substantial AI-generated persona content carries the platform's native AI-content label per [`../../../strategy/patterns/ai-ugc-personas.md`](../../../strategy/patterns/ai-ugc-personas.md).

## Voice

Persona voice is the default. Persona voice is **not the brand voice** — see [`../../../strategy/patterns/ai-ugc-personas.md`](../../../strategy/patterns/ai-ugc-personas.md) for the rules. Persona voice can sound like a normal person on TikTok, including informal language banned in brand voice. But:
...
- [Hook-vs-body length asymmetry](../../../methods/post-techniques/hook-vs-body-asymmetry.md) — cover hook is short; tips frames are the body.
- [Recommendation framing](../../../methods/post-techniques/recommendation-framing.md) — *with the AI-UGC scope clarification* — persona voice is allowed when persona is labeled-AI; not a third-party-attribution fabrication.

## Cross-references

- [`../../../strategy/patterns/ai-ugc-personas.md`](../../../strategy/patterns/ai-ugc-personas.md) — persona-actor account discipline, disclosure protocol, persona voice rules.
...
- [`../../../strategy/patterns/hook-library.md`](../../../strategy/patterns/hook-library.md) — tips-then-plug cover hooks.
