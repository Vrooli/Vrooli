...
- **Brand assets** per [`../../../strategy/ASSETS.md`](../../../strategy/ASSETS.md) and [`../../../strategy/IMAGE_STYLE.md`](../../../strategy/IMAGE_STYLE.md).

## Voice

Listicles can be brand-voice or persona-voice. Brand-voice listicles follow `STRATEGY.md` voice canon. Persona-voice listicles follow [`../../../strategy/patterns/ai-ugc-personas.md`](../../../strategy/patterns/ai-ugc-personas.md) — including disclosure rules per channel.
...
- [Hook-vs-body length asymmetry](../../../methods/post-techniques/hook-vs-body-asymmetry.md) — cover frame is the hook; item frames are the body.
...
- [`../../../strategy/patterns/ai-ugc-personas.md`](../../../strategy/patterns/ai-ugc-personas.md) — when persona-voice is used.
- [`../../rich-media/`](../../rich-media/) — multi-frame consistency substrate.
- [`../../../strategy/patterns/hook-library.md`](../../../strategy/patterns/hook-library.md) — listicle cover hooks are a populated category.
