...
- **Brand consistency** with [`../../../strategy/ASSETS.md`](../../../strategy/ASSETS.md) and [`../../../strategy/IMAGE_STYLE.md`](../../../strategy/IMAGE_STYLE.md) is mandatory. Logos, palette, OG-image style.
...
- [Hook-vs-body length asymmetry](../../../methods/post-techniques/hook-vs-body-asymmetry.md) — image is the hook (extreme asymmetry); caption is the body.
- [No internal numbering externally](../../../methods/post-techniques/no-internal-numbering-externally.md) — no `p8` / `round-002` in image or caption.
- [Recommendation framing](../../../methods/post-techniques/recommendation-framing.md) — when applicable.

## Cross-references

- [`../../../strategy/patterns/ai-ugc-personas.md`](../../../strategy/patterns/ai-ugc-personas.md) — disclosure rules for AI-generated images.
...
- [`../../../strategy/CHANNELS.md`](../../../strategy/CHANNELS.md) — per-channel size targets and disclosure expectations.
