...
- **`core_traits`** — immutable across renders. Object containing:
  ...
  - `audience_target`: the audience persona this character speaks to (mapped to entries in [`../../../strategy/AUDIENCES.md`](../../../strategy/AUDIENCES.md))
...
- **`disclosure_required`** — boolean. `true` for persona-actor characters subject to platform AI-content disclosure per [`../../../strategy/patterns/ai-ugc-personas.md`](../../../strategy/patterns/ai-ugc-personas.md).
...
- [`../../../strategy/patterns/ai-ugc-personas.md`](../../../strategy/patterns/ai-ugc-personas.md) — persona-actor discipline; characters are the visual substrate for personas.
