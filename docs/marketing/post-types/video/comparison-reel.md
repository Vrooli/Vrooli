...
The video application of [`../../post-techniques/competitive-comparison.md`](../../post-techniques/competitive-comparison.md) — that technique's rules apply throughout.
...
Inherits all the failure modes from [`../../post-techniques/competitive-comparison.md`](../../post-techniques/competitive-comparison.md) — uncited multiplier, unfair comparison, comparison without genuine differentiator, strawman alternative, hostile tone, stale comparison. Reapplied at video specifically:
...
- [Competitive comparison](../../post-techniques/competitive-comparison.md) — the canonical home; this video format applies its rules.
- [Hook-vs-body length asymmetry](../../post-techniques/hook-vs-body-asymmetry.md).
- [Recommendation framing](../../post-techniques/recommendation-framing.md) — when comparison is third-party-attributed.

## Cross-references

- [`../../post-techniques/competitive-comparison.md`](../../post-techniques/competitive-comparison.md) — required reading.
