...
- **Brand assets** per [`../../ASSETS.md`](../../ASSETS.md), [`../../IMAGE_STYLE.md`](../../IMAGE_STYLE.md). Infographics often deviate slightly from `IMAGE_STYLE.md` because data-viz palettes need additional non-brand colors for clarity; the deviation must be intentional and documented in the draft.
...
| **Comparison-without-genuine-differentiator** | Comparison chart is a strawman. | mode 17 (recommendation-framing-without-basis) generalized + see [`../../post-techniques/competitive-comparison.md`](../../post-techniques/competitive-comparison.md). |
...
- [Competitive comparison](../../post-techniques/competitive-comparison.md) — when the infographic compares.
- [Hook-vs-body length asymmetry](../../post-techniques/hook-vs-body-asymmetry.md) — title is hook; visual is body.
...
- [`../../post-techniques/competitive-comparison.md`](../../post-techniques/competitive-comparison.md) — applies when the infographic is comparison-shaped.
