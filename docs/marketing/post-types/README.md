...
- [`../strategies/ai-ugc-personas.md`](../strategies/ai-ugc-personas.md) — disclosure rules and persona-actor account discipline.
- [`../rich-media/`](../rich-media/) — character / scene / product schemas that drive consistent multi-frame generation.
- [`../strategies/hook-library.md`](../strategies/hook-library.md) — proven hook patterns by platform/audience/outcome.
...
- [`../STRATEGY.md`](../STRATEGY.md) — voice canon, dual-audience framing, anti-patterns (now eighteen named modes).
- [`../post-techniques/`](../post-techniques/) — cross-cutting voice and structure techniques.
- [`../strategies/`](../strategies/) — strategies that span multiple post-types (AI-UGC personas, hook library, funnel patterns).
- [`../rich-media/`](../rich-media/) — character / scene / product / prompt-template schemas for image and video generation.
- [`../CHANNELS.md`](../CHANNELS.md) — channel × format matrix showing which post-types map to which platforms.
