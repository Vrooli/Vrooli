...
*"X-times faster / cheaper / smaller than Y." Subject to the [hyperbolic-but-verifiable-multipliers sub-pattern](../../methods/post-techniques/competitive-comparison.md#sub-pattern-hyperbolic-but-verifiable-multipliers). Strong on comparison-reel and competitive scenario-spotlight.*
