...
The character JSON for a persona-actor lives in [`docs/marketing/catalogs/rich-media/characters/<persona-slug>.json`](../../catalogs/rich-media/characters/) per the rich-media schema. The persona's `profile.json` (in marketing-crew shared/) references that character.
...
- [`../../methods/post-techniques/recommendation-framing.md`](../../methods/post-techniques/recommendation-framing.md) — distinguishes labeled AI-persona-actor (allowed under this doc's rules) from fabricated-real-customer-testimonial (banned).
...
- [`../../catalogs/post-types/video/`](../../catalogs/post-types/video/) — short-video formats where AI-UGC is the dominant production mode.
- [`../../catalogs/rich-media/characters/`](../../catalogs/rich-media/characters/) — schema for the character JSON each persona-actor depends on.
