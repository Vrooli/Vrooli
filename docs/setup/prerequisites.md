...
1. *Windows only*: [Windows Terminal](https://www.microsoft.com/store/productId/9N0DX20HK701) if using Windows Subsystem for Linux (WSL)
2. *Windows only*: [Ubuntu (version 22 or higher)](https://apps.microsoft.com/detail/9PN20MSR04DW?hl=en-us&gl=US) if using Windows Subsystem for Linux (WSL)
3. *Windows only*: [Git Bash](https://git-scm.com/downloads/win) if running in Windows directly
