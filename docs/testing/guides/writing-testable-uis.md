...
### Related Guides
- **[BAS Workflow Authoring](ui-automation-with-bas.md)** - Write JSON workflows that use these selectors
- **[End-to-End Example](end-to-end-example.md)** - Complete flow from UI design to BAS workflow
- **[Requirement Tracking](requirement-tracking.md)** - Link UI tests to requirements

### Reference Implementation
- **[browser-automation-studio UI](../../../scenarios/browser-automation-studio/ui/)** - See `data-testid` usage in production
- **[Example Workflows](../../../scenarios/browser-automation-studio/test/playbooks/)** - BAS workflows testing BAS itself
