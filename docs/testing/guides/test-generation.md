...
1. **First test run**: vitest-requirement-reporter extracts tags
2. **Phase results**: `testing::phase::add_requirement()` records status
3. **Auto-sync**: `report.js --mode sync` updates requirement registry
4. **Validation entries**: Added automatically to requirements
...
```bash
# Validate requirement registry
node scripts/requirements/validate.js --scenario my-scenario

# Generate report to see current coverage
node scripts/requirements/report.js --scenario my-scenario
```
...
4. Tests now execute via `testing::phase::run_bas_automation_validations()`
...
### Related Guides
- [Requirement Tracking Guide](requirement-tracking.md) - How requirement tracking works
- [Scenario Testing Guide](scenario-testing.md) - Complete testing workflow
- [Requirement Flow](../architecture/REQUIREMENT_FLOW.md) - End-to-end requirement flow

### Reference Implementation
- [test-genie scenario](/scenarios/test-genie/) - Complete test-genie implementation
- [test-genie README](/scenarios/test-genie/README.md) - Detailed feature documentation

### Related Tools
- [@vrooli/vitest-requirement-reporter](../../../packages/vitest-requirement-reporter/README.md) - Vitest integration
- [UI Automation with BAS](ui-automation-with-bas.md) - BAS workflow testing
...
node /path/to/scripts/requirements/report.js --scenario my-scenario
...
# 6. Requirements auto-sync
node /path/to/scripts/requirements/report.js --scenario my-scenario --mode sync

# 7. Check updated coverage
node /path/to/scripts/requirements/report.js --scenario my-scenario
```
