...
./resources/storage/vault/manage.sh --action put-secret \
...
curl -X POST http://localhost:5678/api/v1/workflows/import \
  ...
  -d @${VROOLI_ROOT}/resources/storage/vault/examples/n8n-vault-integration.json
```
...
./resources/storage/vault/manage.sh --action test-functional
```
...
./resources/storage/vault/manage.sh --action auth-info
./resources/storage/vault/manage.sh --action test-functional
```
...
- **Individual Resource READMEs**: `/resources/README.md`
