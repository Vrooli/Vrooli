...
Checklist item: `declared-features-reachable`.

## What this checks

Whether the release satisfies the acceptance criterion for **Declared features are reachable** in the deployment-manager readiness checklist.
