...
Checklist item: `update-policy-set`.

## What this checks

Whether the release satisfies the acceptance criterion for **Update policy is declared** in the deployment-manager readiness checklist.
