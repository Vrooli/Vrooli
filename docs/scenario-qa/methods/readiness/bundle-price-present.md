...
Checklist item: `bundle-price-present`.

## What this checks

Whether the release satisfies the acceptance criterion for **A current bundle price exists** in the deployment-manager readiness checklist.
