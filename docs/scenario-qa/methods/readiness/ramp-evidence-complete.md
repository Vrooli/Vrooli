...
Checklist item: `ramp-evidence-complete`.

## What this checks

Whether the release satisfies the acceptance criterion for **Ramp evidence exists for every target** in the deployment-manager readiness checklist.
