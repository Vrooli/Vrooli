...
Checklist item: `non-subscriber-gate-honest`.

## What this checks

Whether the release satisfies the acceptance criterion for **The gate is honest to a paying customer** in the deployment-manager readiness checklist.
