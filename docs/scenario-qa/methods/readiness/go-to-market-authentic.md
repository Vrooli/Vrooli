...
Checklist item: `go-to-market-authentic`.

## What this checks

Whether the release satisfies the acceptance criterion for **Go-to-market documents have substance** in the deployment-manager readiness checklist.
