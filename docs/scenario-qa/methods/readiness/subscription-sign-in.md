...
Checklist item: `subscription-sign-in`.

## What this checks

Whether the release satisfies the acceptance criterion for **Subscription sign-in works end to end** in the deployment-manager readiness checklist.
