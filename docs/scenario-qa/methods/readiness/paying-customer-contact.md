...
Checklist item: `paying-customer-contact`.

## What this checks

Whether the release satisfies the acceptance criterion for **A paying customer has a contact path** in the deployment-manager readiness checklist.
