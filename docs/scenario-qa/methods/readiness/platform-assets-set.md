...
Checklist item: `platform-assets-set`.

## What this checks

Whether the release satisfies the acceptance criterion for **Per-platform assets are set** in the deployment-manager readiness checklist.
