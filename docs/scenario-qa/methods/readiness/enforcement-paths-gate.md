...
Checklist item: `enforcement-paths-gate`.

## What this checks

Whether the release satisfies the acceptance criterion for **Enforcement paths actually gate** in the deployment-manager readiness checklist.
