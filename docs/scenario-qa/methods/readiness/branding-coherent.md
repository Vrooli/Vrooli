...
Checklist item: `branding-coherent`.

## What this checks

Whether the release satisfies the acceptance criterion for **Branding is applied and coherent** in the deployment-manager readiness checklist.
