...
Checklist item: `suite-state-known`.

## What this checks

Whether the release satisfies the acceptance criterion for **Suite state is known** in the deployment-manager readiness checklist.
