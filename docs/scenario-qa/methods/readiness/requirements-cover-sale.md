...
Checklist item: `requirements-cover-sale`.

## What this checks

Whether the release satisfies the acceptance criterion for **Requirements cover what is sold** in the deployment-manager readiness checklist.
