...
Checklist item: `paying-customer-onboarding`.

## What this checks

Whether the release satisfies the acceptance criterion for **Onboarding is usable by a paying customer** in the deployment-manager readiness checklist.
