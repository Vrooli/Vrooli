...
| **Signal-inbox ideation-extraction** *(future)* | Signal-inbox-derived idea candidates from operator's bookmark stream | When signal-inbox ships, its extraction agent proposes promotions via decision |
