...
| Document | Purpose |
|---|---|
| [`OPERATING_MODEL.md`](OPERATING_MODEL.md) | Team-level operating contract: mission, scope, loops, graph, topic catalog, decisions, external inputs, outputs, feedback loop, gaps, and adoption commands. |
