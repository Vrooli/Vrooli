...
| Supporting backlog work under existing goals | `goal-supplement` |
| Backlog or goal readiness judgment | `goal-readiness` |
| Command Center metric gaps or missing data pipelines | `outcome-gap` |
...
Direct edits are limited to operator migration work, mechanical link repair, and explicitly approved canon updates. Live goal state belongs in Swarm Manager, not in this plan of record.
