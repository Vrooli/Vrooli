...
| Contracts (`packages/proto/schemas/{{SCENARIO_ID}}/`) | Wire shape | Proto messages/services and generated clients | Hand-written route/type mirrors |
...
|---|---|---|---|
| {{DATE}} | None yet. | Generated from `react-vite`. | Update when the scenario intentionally diverges. |
