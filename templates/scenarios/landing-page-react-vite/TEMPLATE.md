...
| `docs/SEAMS.md` | Architectural responsibility boundaries |
| `docs/EXPERIENCE_AUDIT.md` | UX improvements and future opportunities |
| `PRD.md` | Product requirements and operational targets |
