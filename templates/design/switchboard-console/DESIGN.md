...
## Switchboard expression

Use green-gray surfaces with teal primary actions and amber attention. Archivo owns headings; IBM Plex Sans owns body and controls; IBM Plex Mono owns identifiers and technical values. The adapter bundles font files and their OFL licenses for offline rendering. In-app amber, iMessage blue, Slack purple, and Telegram cyan remain distinguishable.
