...
func RenderStatusReport(w io.Writer, format cliout.Format, resp StatusResponse) error {
	return cliout.RenderJSONOr(w, format, func(w io.Writer) error { return cliout.WriteProtoJSON(w, ProjectStatusResponseMessage(resp.Report)) }, func(w io.Writer) error {
...
func RenderDoctorReport(w io.Writer, format cliout.Format, report project.DoctorReport) error {
	return cliout.RenderJSONOr(w, format, func(w io.Writer) error { return cliout.WriteProtoJSON(w, ProjectDoctorResponseMessage(report.Checks)) }, func(w io.Writer) error {
...
func RenderStopReport(w io.Writer, format cliout.Format, report control.StopReport) error {
	return cliout.RenderJSONOr(w, format, func(w io.Writer) error { return cliout.WriteProtoJSON(w, ProjectStopResponseMessage(report)) }, func(w io.Writer) error {
...
func RenderOrphansResponse(w io.Writer, format cliout.Format, resp OrphansResponse) error {
	return cliout.RenderJSONOr(w, format, func(w io.Writer) error {
		if resp.KillReport != nil {
			return cliout.WriteProtoJSON(w, ProjectStopResponseMessage(*resp.KillReport))
		}
		if resp.DryRun {
			return cliout.WriteProtoJSON(w, ProjectOrphansDryRunResponseMessage(resp.List))
		}
		return cliout.WriteProtoJSON(w, ProjectOrphansResponseMessage(resp.List))
...
func RenderLocksResponse(w io.Writer, format cliout.Format, resp LocksResponse) error {
	return cliout.RenderJSONOr(w, format, func(w io.Writer) error {
		if resp.CleanReport != nil {
			return cliout.WriteProtoJSON(w, ProjectStopResponseMessage(*resp.CleanReport))
		}
		return cliout.WriteProtoJSON(w, ProjectLocksResponseMessage(resp.RuntimeClaims))
	}, func(w io.Writer) error {
		if resp.CleanReport != nil {
...
func RenderPortDiagnostic(w io.Writer, format cliout.Format, diagnostic maintenance.PortDiagnostic) error {
	return cliout.RenderJSONOr(w, format, func(w io.Writer) error {
		return cliout.WriteProtoJSON(w, ProjectPortDiagnosticResponseMessage(diagnostic))
	}, func(w io.Writer) error {
