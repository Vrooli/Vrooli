...
func currentHost() Host {
	...
	return Host{
		...
		Notes: []string{
			"docker-service resources use the container-runtime provider ladder: existing daemon, remote DOCKER_HOST, OrbStack/Rancher/Docker Desktop, or headless Colima",
