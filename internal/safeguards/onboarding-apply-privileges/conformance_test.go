...
func TestConformance(t *testing.T) {
	hostreqkittest.RunSuite(t, hostreqkittest.Case{NewHandler: func() hostreqkit.Handler {
		return NewHandler(hostreqkit.SafeguardManifest{Name: "onboarding_apply_privileges"})
	}, Name: "onboarding_apply_privileges", Kind: hostreqspec.KindSafeguard, Checks: []string{"name_and_kind"}})
}
