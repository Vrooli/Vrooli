...
func TestConformance(t *testing.T) {
	hostreqkittest.RunSuite(t, hostreqkittest.Case{NewHandler: func() hostreqkit.Handler {
		return NewHandler(hostreqkit.SafeguardManifest{Name: "remote_desktop_access"})
	}, Name: "remote_desktop_access", Kind: hostreqspec.KindSafeguard, Checks: []string{"name_and_kind"}})
}
