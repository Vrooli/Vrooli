...
func TestConformance(t *testing.T) {
	hostreqkittest.RunSuite(t, hostreqkittest.Case{NewHandler: func() hostreqkit.Handler {
		return NewHandler(hostreqkit.SafeguardManifest{Name: "workspace_sandbox_userns"})
	}, Name: "workspace_sandbox_userns", Kind: hostreqspec.KindSafeguard, Checks: []string{"name_and_kind"}})
}
