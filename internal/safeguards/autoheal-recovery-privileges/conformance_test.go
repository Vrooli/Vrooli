...
func TestConformance(t *testing.T) {
	hostreqkittest.RunSuite(t, hostreqkittest.Case{NewHandler: func() hostreqkit.Handler {
		return NewHandler(hostreqkit.SafeguardManifest{Name: "autoheal_recovery_privileges"})
	}, Name: "autoheal_recovery_privileges", Kind: hostreqspec.KindSafeguard, Checks: []string{"name_and_kind"}})
}
