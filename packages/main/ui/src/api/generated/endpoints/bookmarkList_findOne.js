...
export const bookmarkListFindOne = gql `${Api_list}
${Api_nav}
${Bookmark_full}
${Comment_list}
${Issue_list}
...
query bookmarkList($input: FindByIdInput!) {
  bookmarkList(input: $input) {
    bookmarks {
        ...Bookmark_full
    }
    id
...
//# sourceMappingURL=bookmarkList_findOne.js.map