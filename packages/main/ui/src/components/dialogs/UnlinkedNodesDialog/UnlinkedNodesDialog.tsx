 ...
 */
import { Node, NodeEnd, NodeRoutineList, NodeType } from "@local/shared/consts";
import { DeleteIcon, ExpandLessIcon, ExpandMoreIcon, UnlinkedNodesIcon } from "@local/shared/icons";
import {
    Box,
    IconButton,
    Stack,
