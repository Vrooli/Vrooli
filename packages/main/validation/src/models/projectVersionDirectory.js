import { description, id, name, req, opt, blankToUndefined, maxStrErr, transRel, bool, yupObj } from "../utils";
import * as yup from "yup";
export const childOrder = yup.string().transform(blankToUndefined).max(4096, maxStrErr);
export const projectVersionDirectoryTranslationValidation = transRel({
    create: {
...
export const projectVersionDirectoryValidation = {
    create: ({ o }) => yupObj({
        id: req(id),
