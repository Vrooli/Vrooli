...
import { blankToUndefined, bool, description, enumToYup, id, jsonVariable, maxStrErr, name, opt, req, transRel, versionLabel, versionNotes, yupObj } from "../utils";
...
export const standardVersionTranslationValidation = transRel({
    create: {
...
export const standardVersionValidation = {
