import { bool, description, id, name, opt, req, transRel, versionLabel, versionNotes, yupObj } from "../utils";
import { projectValidation } from "./project";
import { projectVersionDirectoryValidation } from "./projectVersionDirectory";
export const projectVersionTranslationValidation = transRel({
    create: {
...
export const projectVersionValidation = {
