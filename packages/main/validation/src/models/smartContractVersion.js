...
import { blankToUndefined, bool, description, id, jsonVariable, maxStrErr, name, opt, req, transRel, versionLabel, versionNotes, yupObj } from "../utils";
...
export const smartContractVersionTranslationValidation = transRel({
    create: {
...
export const smartContractVersionValidation = {
