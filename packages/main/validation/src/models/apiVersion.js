import { bool, details, id, name, opt, req, summary, transRel, url, versionLabel, versionNotes, yupObj } from "../utils";
import { apiValidation } from "./api";
import { resourceListValidation } from "./resourceList";
export const apiVersionTranslationValidation = transRel({
    create: {
        name: req(name),
        details: opt(details),
        summary: opt(summary),
...
export const apiVersionValidation = {
