...
import { bool, description, id, opt, req, name, transRel, versionLabel, versionNotes, yupObj, blankToUndefined, maxStrErr } from "../utils";
import { noteValidation } from "./note";
const text = yup.string().transform(blankToUndefined).max(65536, maxStrErr);
export const noteVersionTranslationValidation = transRel({
    create: {
...
export const noteVersionValidation = {
