import { apiCallData, bool, description, id, instructions, name, opt, req, smartContractCallData, transRel, versionLabel, versionNotes, yupObj } from "../utils";
...
export const routineVersionTranslationValidation = transRel({
    create: {
...
export const routineVersionValidation = {
