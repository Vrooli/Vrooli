import { MaxObjects, ResourceListSortBy } from "@local/consts";
...
export const ResourceListModel = ({
    ...
    validate: {
        ...
        owner: (data, userId) => {
            ...
            const { validate } = getLogic(["validate"], uppercaseFirstLetter(resourceOnType), ["en"], "ResourceListModel.validate.owner");
