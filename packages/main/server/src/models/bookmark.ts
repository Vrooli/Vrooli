import { Bookmark, BookmarkCreateInput, BookmarkFor, BookmarkSearchInput, BookmarkSortBy, BookmarkUpdateInput, GqlModelType, MaxObjects, bookmarkValidation, exists, uppercaseFirstLetter } from "@local/shared";
