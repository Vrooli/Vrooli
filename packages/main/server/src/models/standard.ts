import { standardValidation } from "@local/shared";
import { MaxObjects, Standard, StandardCreateInput, StandardSearchInput, StandardSortBy, StandardUpdateInput, StandardYou } from "@local/shared;";
