import { ApiVersionSortBy, MaxObjects } from "@local/consts";
import { apiVersionValidation } from "@local/validation";
import { noNull, shapeHelper } from "../builders";
import { bestLabel, defaultPermissions, postShapeVersion, translationShapeHelper } from "../utils";
import { getSingleTypePermissions, lineBreaksCheck, versionsCheck } from "../validators";
import { ApiModel } from "./api";
const __typename = "ApiVersion";
...
export const ApiVersionModel = ({
    ...
    validate: {
        ...
        isPublic: (data, languages) => data.isPrivate === false &&
            ...
            ApiModel.validate.isPublic(data.root, languages),
        isTransferable: false,
        maxObjects: MaxObjects[__typename],
        owner: (data, userId) => ApiModel.validate.owner(data.root, userId),
        permissionsSelect: () => ({
            id: true,
            isDeleted: true,
            isPrivate: true,
