...
import { nodeValidation } from "@local/validation";
...
export const NodeModel = ({
    ...
    validate: {
        ...
        owner: (data, userId) => RoutineModel.validate.owner(data.routineVersion, userId),
        isDeleted: (data, languages) => RoutineModel.validate.isDeleted(data.routineVersion, languages),
        isPublic: (data, languages) => RoutineModel.validate.isPublic(data.routineVersion, languages),
        visibility: {
