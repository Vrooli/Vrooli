...
import { RunStatus, StatPeriodType, VisibilityType } from "@local/consts";
...
export const resolvers = {
    ...
    Date: new GraphQLScalarType({
        ...
        parseLiteral(ast) {
            return new Date(ast).toDateString();
        },
    }),
    ...
    Mutation: {
        writeAssets: async (_parent, { input }, { req }, info) => {
            ...
            throw new CustomError("0327", "NotImplemented", req.languages);
