...
func TestVisualManifestRequiresOrderedRedactedTimelineAndUsefulRecording(t *testing.T) {
	...
	manifest := Manifest{
		...
		Timeline:   TimelineSummary{Version: JourneyEvidenceVersion, JourneyRef: "capture:journey", ChapterIDs: []string{"launch"}, Ordered: true, RedactionStatus: "verified", ScreenContentSource: "bundled_private"},
