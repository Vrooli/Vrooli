...
export type EndpointsNote = {
    findOne: ApiEndpoint<FindByIdInput, FindOneResult<Note>>;
    findMany: ApiEndpoint<NoteSearchInput, FindManyResult<Note>>;
    createOne: ApiEndpoint<NoteCreateInput, CreateOneResult<Note>>;
    updateOne: ApiEndpoint<NoteUpdateInput, UpdateOneResult<Note>>;
}
