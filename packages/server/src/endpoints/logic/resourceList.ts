...
export type EndpointsResourceList = {
    findOne: ApiEndpoint<FindByIdInput, FindOneResult<ResourceList>>;
    findMany: ApiEndpoint<ResourceListSearchInput, FindManyResult<ResourceList>>;
    createOne: ApiEndpoint<ResourceListCreateInput, CreateOneResult<ResourceList>>;
    updateOne: ApiEndpoint<ResourceListUpdateInput, UpdateOneResult<ResourceList>>;
}
