...
export type EndpointsMemberInvite = {
    findOne: ApiEndpoint<FindByIdInput, FindOneResult<MemberInvite>>;
    findMany: ApiEndpoint<MemberInviteSearchInput, FindManyResult<MemberInvite>>;
    createOne: ApiEndpoint<MemberInviteCreateInput, CreateOneResult<MemberInvite>>;
    createMany: ApiEndpoint<MemberInviteCreateInput[], CreateOneResult<MemberInvite>[]>;
    updateOne: ApiEndpoint<MemberInviteUpdateInput, UpdateOneResult<MemberInvite>>;
    updateMany: ApiEndpoint<MemberInviteUpdateInput[], UpdateOneResult<MemberInvite>[]>;
    acceptOne: ApiEndpoint<FindByIdInput, UpdateOneResult<MemberInvite>>;
    declineOne: ApiEndpoint<FindByIdInput, UpdateOneResult<MemberInvite>>;
}
