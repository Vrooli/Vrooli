...
export type EndpointsBookmark = {
    findOne: ApiEndpoint<FindByIdInput, FindOneResult<Bookmark>>;
    findMany: ApiEndpoint<BookmarkSearchInput, FindManyResult<Bookmark>>;
    createOne: ApiEndpoint<BookmarkCreateInput, CreateOneResult<Bookmark>>;
    updateOne: ApiEndpoint<BookmarkUpdateInput, UpdateOneResult<Bookmark>>;
}
