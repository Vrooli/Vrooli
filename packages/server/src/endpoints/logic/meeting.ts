import { type FindByPublicIdInput, type Meeting, type MeetingCreateInput, type MeetingSearchInput, type MeetingSearchResult, type MeetingUpdateInput } from "@local/shared";
