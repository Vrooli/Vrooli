...
export type EndpointsCodeVersion = {
    findOne: ApiEndpoint<FindVersionInput, FindOneResult<CodeVersion>>;
    findMany: ApiEndpoint<CodeVersionSearchInput, FindManyResult<CodeVersion>>;
    createOne: ApiEndpoint<CodeVersionCreateInput, CreateOneResult<CodeVersion>>;
    updateOne: ApiEndpoint<CodeVersionUpdateInput, UpdateOneResult<CodeVersion>>;
}
