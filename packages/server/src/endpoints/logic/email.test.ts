...
import { EmailDbFactory } from "../../__test/fixtures/db/emailFixtures.js";
    ...
    describe("createOne", () => {
        describe("authentication", () => {
            ...
            it("requires auth write permissions", async () => {
                ...
                const { req, res } = await mockApiSession({
                    ...
                    apiKeyId: generatePK(),
                    permissions: mockWritePrivatePermissions(["Email"]), // Wrong permission type
                });
        ...
        describe("valid", () => {
            it("creates new email for user", async () => {
                ...
                expect(createdEmail?.userId).toEqual(testUser[0].id);
            });
        ...
        describe("invalid", () => {
            it("rejects duplicate email address", async () => {
                ...
                await DbProvider.get().email.create({
                    data: EmailDbFactory.createMinimal({
