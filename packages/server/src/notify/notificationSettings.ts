 ...
 */
export async function getNotificationSettingsAndRecipients(userIds: string[]): Promise<Array<{ settings: NotificationSettings } & NotificationRecipients>> {
 ...
 */
export async function findRecipientsAndLimit(
