...
class BigNum {
    ...
    */
    checked_mul(other) {
        ...
        const ret = wasm.bignum_checked_mul(this.ptr, other.ptr);
        return BigNum.__wrap(ret);
    }
    /**
    * @param {BigNum} other
    ...
    */
    checked_add(other) {
        _assertClass(other, BigNum);
        const ret = wasm.bignum_checked_add(this.ptr, other.ptr);
        return BigNum.__wrap(ret);
    }
    /**
    * @param {BigNum} other
    ...
    */
    checked_sub(other) {
        _assertClass(other, BigNum);
        const ret = wasm.bignum_checked_sub(this.ptr, other.ptr);
        return BigNum.__wrap(ret);
    }
}
    ...
    */
    as_float() {
        try {
            ...
            const r0 = getInt32Memory0()[retptr / 4 + 0];
            const r1 = getFloat64Memory0()[retptr / 8 + 1];
...
class COSEEncrypt {
    ...
    */
    static new(headers, ciphertext, recipients) {
        ...
        const ptr0 = isLikeNone(ciphertext) ? 0 : passArray8ToWasm0(ciphertext, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
...
class COSESign {
    ...
    */
    static new(headers, payload, signatures) {
        _assertClass(headers, Headers);
        const ptr0 = isLikeNone(payload) ? 0 : passArray8ToWasm0(payload, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
...
class COSESign1 {
    ...
    */
    signed_data(external_aad, external_payload) {
        const ptr0 = isLikeNone(external_aad) ? 0 : passArray8ToWasm0(external_aad, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = isLikeNone(external_payload) ? 0 : passArray8ToWasm0(external_payload, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.cosesign1_signed_data(this.ptr, ptr0, len0, ptr1, len1);
