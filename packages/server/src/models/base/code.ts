            ...
            private: function getVisibilityPrivate(...params) {
                return {
                    ...
                    OR: [ // Either the object is private, its owner is private, or the owner has disabled public visibility
                        ...
                        { ownedByUser: { isPrivateCodes: true } },
                        // NOTE: We don't need `{ createdBy: { isPrivateCodesCreated: true } }` because that is only for hiding the creator. The object can still be public.
                    ],
                };
            },
