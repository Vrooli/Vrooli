...
import { QuizQuestion, QuizQuestionCreateInput, QuizQuestionPermission, QuizQuestionSearchInput, QuizQuestionSortBy, QuizQuestionUpdateInput } from '@shared/consts';
