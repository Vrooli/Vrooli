...
export const SearchMap = {
    ...
    maxParticipants: (participants: Maybe<number>) => ({ participantsCount: { lte: participants } }),
    ...
    minParticipants: (participants: Maybe<number>) => ({ participantsCount: { gte: participants } }),
