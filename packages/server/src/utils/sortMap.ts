...
export const SortMap = {
    ...
    DateCreatedAsc: { createdAt: Order.Asc },
    DateCreatedDesc: { createdAt: Order.Desc },
    DateStartedAsc: { startedAt: Order.Asc },
    DateStartedDesc: { startedAt: Order.Desc },
    DateUpdatedAsc: { updatedAt: Order.Asc },
    DateUpdatedDesc: { updatedAt: Order.Desc },
    ...
    MessagesAsc: { messages: { _count: Order.Asc } },
    ...
    ParticipantsDesc: { participants: { _count: Order.Desc } },
    ...
    BookmarksAsc: { bookmarks: Order.Asc },
    BookmarksDesc: { bookmarks: Order.Desc },
    ...
    ViewsAsc: { views: Order.Asc },
    ViewsDesc: { views: Order.Desc },
