...
CREATE TABLE "api_key" (
    ...
    "countBeforeLimit" INTEGER NOT NULL DEFAULT 20000,
...
CREATE TABLE "data_site" (
    ...
    "apiCallsPeriod" INTEGER NOT NULL,
    ...
    "routinesSimplicityAverage" INTEGER NOT NULL,
    "routinesComplexityAverage" INTEGER NOT NULL,
    ...
    CONSTRAINT "data_site_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "data_organization" (
    ...
    CONSTRAINT "data_organization_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "data_quiz" (
    ...
    CONSTRAINT "data_quiz_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "data_routine" (
    "id" UUID NOT NULL,
    ...
    CONSTRAINT "data_routine_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "data_smart_contract" (
    "id" UUID NOT NULL,
    ...
    CONSTRAINT "data_smart_contract_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "data_standard" (
    ...
    "timesUsedInCompletedRoutines" INTEGER NOT NULL,
...
-- CreateTable
CREATE TABLE "organization_schedule" (
    "id" UUID NOT NULL,
    "inviteId" UUID,
    ...
    CONSTRAINT "organization_schedule_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "organization_schedule_attendees" (
    "id" UUID NOT NULL,
    "scheduleId" UUID NOT NULL,
    "userId" UUID NOT NULL,

    CONSTRAINT "organization_schedule_attendees_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "organization_schedule_invites" (
    "id" UUID NOT NULL,
    "status" "MeetingInviteStatus" NOT NULL DEFAULT 'Pending',
    "scheduleId" UUID NOT NULL,
    "userId" UUID NOT NULL,

    CONSTRAINT "organization_schedule_invites_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "organization_schedule_labels" (
    "id" UUID NOT NULL,
    "labelledId" UUID NOT NULL,
    "labelId" UUID NOT NULL,

    CONSTRAINT "organization_schedule_labels_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "organization_schedule_roles" (
    "id" UUID NOT NULL,
    "scheduleId" UUID NOT NULL,
    "roleId" UUID NOT NULL,

    CONSTRAINT "organization_schedule_roles_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "organization_schedule_translation" (
    "id" UUID NOT NULL,
    "scheduleId" UUID NOT NULL,
    "language" VARCHAR(3) NOT NULL,
    "title" VARCHAR(128),
    ...
    CONSTRAINT "organization_schedule_translation_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "run_project" (
    ...
    "isPrivate" BOOLEAN NOT NULL DEFAULT false,
    "scheduleId" UUID,
    "suggestPublicData" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "user_schedule_translation" (
    ...
    CONSTRAINT "user_schedule_translation_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "organization_schedule_attendees_scheduleId_userId_key" ON "organization_schedule_attendees"("scheduleId", "userId");

-- CreateIndex
CREATE UNIQUE INDEX "organization_schedule_invites_scheduleId_userId_key" ON "organization_schedule_invites"("scheduleId", "userId");

-- CreateIndex
CREATE UNIQUE INDEX "organization_schedule_labels_labelledId_labelId_key" ON "organization_schedule_labels"("labelledId", "labelId");

-- CreateIndex
CREATE UNIQUE INDEX "organization_schedule_roles_scheduleId_roleId_key" ON "organization_schedule_roles"("scheduleId", "roleId");

-- CreateIndex
CREATE UNIQUE INDEX "organization_schedule_translation_scheduleId_language_key" ON "organization_schedule_translation"("scheduleId", "language");
...
-- CreateIndex
CREATE UNIQUE INDEX "standard_ownedByUserId_ownedByOrganizationId_name_key" ON "standard"("ownedByUserId", "ownedByOrganizationId", "name");
...
-- CreateIndex
CREATE UNIQUE INDEX "user_schedule_translation_userScheduleId_language_key" ON "user_schedule_translation"("userScheduleId", "language");
...
-- AddForeignKey
ALTER TABLE "api_version" ADD CONSTRAINT "api_version_rootId_fkey" FOREIGN KEY ("rootId") REFERENCES "api"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "data_api" ADD CONSTRAINT "data_api_apiId_fkey" FOREIGN KEY ("apiId") REFERENCES "api"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "data_organization" ADD CONSTRAINT "data_organization_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "data_project" ADD CONSTRAINT "data_project_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "project"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "data_quiz" ADD CONSTRAINT "data_quiz_quizId_fkey" FOREIGN KEY ("quizId") REFERENCES "quiz"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "data_routine" ADD CONSTRAINT "data_routine_routineId_fkey" FOREIGN KEY ("routineId") REFERENCES "routine"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "data_smart_contract" ADD CONSTRAINT "data_smart_contract_smartContractId_fkey" FOREIGN KEY ("smartContractId") REFERENCES "smart_contract"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "data_standard" ADD CONSTRAINT "data_standard_standardId_fkey" FOREIGN KEY ("standardId") REFERENCES "standard"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "data_user" ADD CONSTRAINT "data_user_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "notification_device" ADD CONSTRAINT "notification_device_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "organization_schedule" ADD CONSTRAINT "organization_schedule_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "organization_schedule_attendees" ADD CONSTRAINT "organization_schedule_attendees_scheduleId_fkey" FOREIGN KEY ("scheduleId") REFERENCES "organization_schedule"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "organization_schedule_attendees" ADD CONSTRAINT "organization_schedule_attendees_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "organization_schedule_invites" ADD CONSTRAINT "organization_schedule_invites_scheduleId_fkey" FOREIGN KEY ("scheduleId") REFERENCES "organization_schedule"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "organization_schedule_invites" ADD CONSTRAINT "organization_schedule_invites_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "organization_schedule_labels" ADD CONSTRAINT "organization_schedule_labels_labelledId_fkey" FOREIGN KEY ("labelledId") REFERENCES "organization_schedule"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "organization_schedule_labels" ADD CONSTRAINT "organization_schedule_labels_labelId_fkey" FOREIGN KEY ("labelId") REFERENCES "label"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "organization_schedule_roles" ADD CONSTRAINT "organization_schedule_roles_scheduleId_fkey" FOREIGN KEY ("scheduleId") REFERENCES "organization_schedule"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "organization_schedule_roles" ADD CONSTRAINT "organization_schedule_roles_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "role"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "organization_schedule_translation" ADD CONSTRAINT "organization_schedule_translation_scheduleId_fkey" FOREIGN KEY ("scheduleId") REFERENCES "organization_schedule"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "quiz_attempt_answer" ADD CONSTRAINT "quiz_attempt_answer_questionId_fkey" FOREIGN KEY ("questionId") REFERENCES "quiz_question"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "routine_version" ADD CONSTRAINT "routine_version_apiId_fkey" FOREIGN KEY ("apiId") REFERENCES "api"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "routine_version" ADD CONSTRAINT "routine_version_smartContractId_fkey" FOREIGN KEY ("smartContractId") REFERENCES "smart_contract"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "user_schedule_translation" ADD CONSTRAINT "user_schedule_translation_userScheduleId_fkey" FOREIGN KEY ("userScheduleId") REFERENCES "user_schedule"("id") ON DELETE CASCADE ON UPDATE CASCADE;
