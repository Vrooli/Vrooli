import { CodeLanguage, InputType, RoutineVersionConfig, type FormInputType, type PassableLogger, type ResourceVersion, type StandardVersionConfigObject } from "@local/shared";
import { RelatedResourceLabel, RelatedResourceUtils, type RelatedVersionLink } from "@local/shared/src/utils/relatedResource.js";
