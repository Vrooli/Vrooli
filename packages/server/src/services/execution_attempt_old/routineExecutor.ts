import { InputGenerationStrategy, ResourceSubType, SubroutineExecutionStrategy, type ExecutionContext, type ExecutionResult, type PassableLogger, type ResourceVersion } from "@local/shared";
