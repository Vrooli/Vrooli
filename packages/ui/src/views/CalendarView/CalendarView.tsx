import { Box, Button, Checkbox, DialogContent, Divider, FormControlLabel, FormGroup, IconButton, InputAdornment, List, ListItem, ListItemText, Paper, Tab, Tabs, TextField, Typography, styled, useTheme, type BoxProps } from "@mui/material";
