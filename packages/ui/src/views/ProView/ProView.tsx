...
import { ArrowUpRightIcon, CompleteIcon, ShoppingCartIcon } from "../../icons/common.js";
...
const rows = [
    ...
    ["Run routines automatically with AI", "Credits required", "✔️"],
        ...
        <Box display="flex" flexDirection="column" gap={4} p={2}>
            ...
            <Box display="flex" flexDirection="column" gap={2} justifyContent="center">
                ...
                <SupportOption
                    ...
                    text={t("ProSupport1", { monthlyCredits: `$${(Number(API_CREDITS_PREMIUM / BigInt(1_000_000)) / 100).toFixed(2)}` })}
                />
                <SupportOption
