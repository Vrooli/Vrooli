import { DUMMY_ID, DefinedArrayElement, DeleteOneInput, DeleteType, GraphMessageWithStatus, MultiRoutineStep, NodeShape, NodeTranslationShape, NodeType, RoutineType, RoutineVersion, RoutineVersionCreateInput, RoutineVersionShape, RoutineVersionUpdateInput, RunStepBuilder, RunStepNavigator, RunStepType, RunnableRoutineVersion, Session, StartStep, Status, Success, addToArray, deleteArrayIndex, endpointGetRoutineVersion, endpointPostDeleteOne, endpointPostRoutineVersion, endpointPutRoutineVersion, exists, funcTrue, getTranslation, isEqual, noopSubmit, routineVersionStatusMultiStep, routineVersionTranslationValidation, routineVersionValidation, shapeRoutineVersion, updateArray, uuid } from "@local/shared";
...
import { GraphLink } from "components/graphs/NodeGraph/GraphLink/GraphLink";
import { EndNode, RoutineListNode } from "components/graphs/NodeGraph/Nodes/Nodes";
...
import { AddIcon, CancelIcon, CreateIcon, DragIcon, MinusIcon, SaveIcon } from "icons";
import { useCallback, useContext, useMemo, useState } from "react";
import { DragDropContext, Draggable, DropResult, Droppable } from "react-beautiful-dnd";
import { useTranslation } from "react-i18next";
import { useLocation } from "route";
import { FormContainer, FormSection, ScrollBox, pagePaddingBottom } from "styles";
...
import { ROOT_LOCATION } from "views/runs/RunView/RunView";
import { routineSingleStepInitialValues } from "..";
import { RoutineMultiStepCrudProps } from "../types";
