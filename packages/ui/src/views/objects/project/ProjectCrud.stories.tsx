...
import { DUMMY_ID, type ProjectVersion, type ProjectVersionDirectory, type Resource, ResourceUsedFor, type Tag, type User, endpointsProjectVersion, generatePKString, getObjectUrl } from "@local/shared";
