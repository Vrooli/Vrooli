...
import { dataConverterFormTestConfig } from "../../../__test/fixtures/form-testing/DataConverterFormTest.js";
import {
    createMockSession,
...
vi.mock("../../../hooks/useManagedObject.js", () => ({
    useManagedObject: vi.fn(() => {
        ...
        const mockInitialValues = dataConverterFormTestConfig.initialValuesFunction?.(mockSession) || dataConverterFormTestConfig.formFixtures.minimal;
...
describe("DataConverterUpsert", () => {
    ...
    const formTester = createSimpleFormTester(DataConverterUpsert, defaultProps, mockSession);
    ...
    describe("Basic Functionality", () => {
        ...
        it("handles form submission with valid data", async () => {
            ...
            await user.type(screen.getByTestId("input-name"), "Test Data Converter");
    ...
    describe("Form Field Interactions", () => {
        it("handles name input", async () => {
            await formTester.testElement("name", "Test Data Converter");
        });
    ...
    describe("Fixture Data Integration", () => {
        it("uses fixture data correctly", () => {
            const fixtureData = dataConverterFormTestConfig.formFixtures.minimal;
            expect(fixtureData).toBeDefined();
            expect(fixtureData.translations[0].name).toBe("Test Data Converter");
        });
