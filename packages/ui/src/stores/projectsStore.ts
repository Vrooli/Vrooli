import { ResourceVersionSortBy, endpointsResource, ResourceType, type ResourceVersion, type ResourceVersionSearchInput, type ResourceVersionSearchResult } from "@vrooli/shared";
