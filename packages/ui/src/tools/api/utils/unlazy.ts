 ...
 * Unlazies an object
 */
export const unlazy = async <T extends object>(obj: T | (() => T) | (() => Promise<T>)): Promise<T> => typeof obj === "function" ? await (obj as () => T)() : obj;
 ...
 */
export const unlazyDeep = async <T extends object>(obj: T | (() => T) | (() => Promise<T>)): Promise<T> => {
