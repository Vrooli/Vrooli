...
import { USER_SORT_BY } from "@local/shared";
...
const SORT_OPTIONS: {label: string, value: UserSortBy}[] = Object.values(USER_SORT_BY).map((sortOption) => ({ label: sortOption, value: sortOption as UserSortBy }));
