...
import { getObjectUrlBase, PubSub, parseSearchParams, stringifySearchParams, openObject } from "utils";
...
type BaseParams = {
    ...
    objectType: HistoryTabType | undefined;
    popupTitle: string;
    popupTooltip: string;
    query: any | undefined;
    title: string;
...
const tabOptions: [string, HistoryTabType][] = [
    ['Active', HistoryTabType.ActiveRun],
    ['Completed', HistoryTabType.CompletedRun],
    ['Viewed', HistoryTabType.View],
    ['Starred', HistoryTabType.Star],
];
 ...
 */
const queryMap = {
    [HistoryTabType.ActiveRun]: runsQuery,
    [HistoryTabType.CompletedRun]: runsQuery,
    [HistoryTabType.View]: viewsQuery,
    [HistoryTabType.Star]: starsQuery,
}
 ...
 */
const titleMap = {
    [HistoryTabType.ActiveRun]: 'Active Runs',
    [HistoryTabType.CompletedRun]: 'Completed Runs',
    [HistoryTabType.View]: 'Views',
    [HistoryTabType.Star]: 'Stars',
}
