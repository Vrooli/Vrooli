...
import { $createTableNodeWithDimensions, type TableNode } from "../nodes/TableNode.js";
import { type TableRowNode } from "../nodes/TableRowNode.js";
import { $createPoint, $createRangeSelection, $createRangeSelectionFromDom, $getPreviousSelection, type RangeSelection, getTable } from "../selection.js";
import { type BaseSelection, type CustomDomElement, type ElementFormatType, type InsertTableCommandPayload, type LexicalCommand, type NodeKey, type PointType, type TableDOMCell, type TableDOMTable, type TableMapType, type TableMapValueType, type TableSelectionShape, type TextFormatType } from "../types.js";
