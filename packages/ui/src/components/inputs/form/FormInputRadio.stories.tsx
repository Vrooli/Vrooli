...
import { InputType, type RadioFormInput } from "@vrooli/shared";
import { Formik } from "formik";
import { Switch } from "../Switch/Switch.js";
import { FormInputRadio } from "./FormInputRadio.js";

const meta: Meta<typeof FormInputRadio> = {
    title: "Components/Inputs/Form/FormInputRadio",
...
export const Showcase: Story = {
    render: () => {
        ...
        const [labelText, setLabelText] = useState("Radio Button Options");
        const [helperText, setHelperText] = useState("Select one option");

        const [fieldData, setFieldData] = useState<RadioFormInput>({
            id: "radio-1",
        ...
        const handleConfigUpdate = (newFieldData: RadioFormInput) => {
            setFieldData(newFieldData);
        };

        const handleDelete = () => {
            console.log("FormInputRadio deleted");
        };
            ...
            <Box sx={{ 
                ...
                <Box sx={{ 
                    ...
                    <Box sx={{ 
                        ...
                        <Typography variant="h5" sx={{ mb: 3 }}>FormInputRadio Controls</Typography>
                    ...
                    <Box sx={{ 
                        ...
                        <Typography variant="h5" sx={{ mb: 3 }}>FormInputRadio Component</Typography>
                        
                        <Box sx={{ p: 2, border: "1px dashed #ccc", borderRadius: 1 }}>
                            <Formik
                                initialValues={{ radioField: "optionA" }}
                                onSubmit={() => {}}
                            >
                                <FormInputRadio
                                    disabled={disabled}
