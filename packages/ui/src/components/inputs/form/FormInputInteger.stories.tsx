...
import { InputType, type IntegerFormInput } from "@vrooli/shared";
import { Formik } from "formik";
import { Switch } from "../Switch/Switch.js";
import { FormInputInteger } from "./FormInputInteger.js";

const meta: Meta<typeof FormInputInteger> = {
    title: "Components/Inputs/Form/FormInputInteger",
    component: FormInputInteger,
    parameters: {
        layout: "fullscreen",
    },
};
...
export const Showcase: Story = {
    render: () => {
        ...
        const [labelText, setLabelText] = useState("Integer Input");
        const [helperText, setHelperText] = useState("Enter a whole number");
        const [minValue, setMinValue] = useState("0");
        const [maxValue, setMaxValue] = useState("100");

        const [fieldData, setFieldData] = useState<IntegerFormInput>({
            id: "integer-1",
        ...
        const handleConfigUpdate = (newFieldData: IntegerFormInput) => {
            setFieldData(newFieldData);
        };

        const handleDelete = () => {
            console.log("FormInputInteger deleted");
        };
            ...
            <Box sx={{ 
                ...
                <Box sx={{ 
                    ...
                    <Box sx={{ 
                        ...
                        <Typography variant="h5" sx={{ mb: 3 }}>FormInputInteger Controls</Typography>
                    ...
                    <Box sx={{ 
                        ...
                        <Typography variant="h5" sx={{ mb: 3 }}>FormInputInteger Component</Typography>
                        
                        <Box sx={{ p: 2, border: "1px dashed #ccc", borderRadius: 1 }}>
                            <Formik
                                initialValues={{ integerField: 10 }}
                                onSubmit={() => {}}
                            >
                                <FormInputInteger
                                    disabled={disabled}
