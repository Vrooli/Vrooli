...
import { InputType, type SwitchFormInput } from "@vrooli/shared";
import { Formik } from "formik";
import { Switch } from "../Switch/Switch.js";
import { FormInputSwitch } from "./FormInputSwitch.js";

const meta: Meta<typeof FormInputSwitch> = {
    title: "Components/Inputs/Form/FormInputSwitch",
...
export const Showcase: Story = {
    render: () => {
        ...
        const [labelText, setLabelText] = useState("Toggle Switch");
        const [helperText, setHelperText] = useState("Enable or disable this option");

        const [fieldData, setFieldData] = useState<SwitchFormInput>({
            id: "switch-1",
        ...
        const handleConfigUpdate = (newFieldData: SwitchFormInput) => {
            setFieldData(newFieldData);
        };

        const handleDelete = () => {
            console.log("FormInputSwitch deleted");
        };
            ...
            <Box sx={{ 
                ...
                <Box sx={{ 
                    ...
                    <Box sx={{ 
                        ...
                        <Typography variant="h5" sx={{ mb: 3 }}>FormInputSwitch Controls</Typography>
                    ...
                    <Box sx={{ 
                        ...
                        <Typography variant="h5" sx={{ mb: 3 }}>FormInputSwitch Component</Typography>
