...
import { TailwindTextInput, TailwindTextInputBase, TranslatedTailwindTextInput } from "./TailwindTextInput.js";
...
describe("TailwindTextInputBase", () => {
    describe("Basic rendering", () => {
        it("renders as a basic input field", () => {
            render(<TailwindTextInputBase />);
        ...
        it("renders with provided value", () => {
            render(<TailwindTextInputBase value="test value" onChange={vi.fn()} />);
        ...
        it("renders with placeholder text", () => {
            render(<TailwindTextInputBase placeholder="Enter text here" />);
        ...
        it("renders with custom className", () => {
            render(<TailwindTextInputBase className="custom-class" />);
    ...
    describe("Label behavior", () => {
        it("renders with label", () => {
            render(<TailwindTextInputBase label="Test Label" />);
        ...
        it("shows required asterisk when isRequired is true", () => {
            render(<TailwindTextInputBase label="Required Field" isRequired />);
        ...
        it("does not show asterisk when isRequired is false", () => {
            render(<TailwindTextInputBase label="Optional Field" isRequired={false} />);
    ...
    describe("Helper text behavior", () => {
        it("renders helper text when provided", () => {
            render(<TailwindTextInputBase helperText="This is helper text" />);
        ...
        it("renders error helper text with error styling", () => {
            render(<TailwindTextInputBase helperText="Error message" error />);
        ...
        it("handles boolean helper text", () => {
            render(<TailwindTextInputBase helperText={true} />);
    ...
    describe("Input states", () => {
        it("handles disabled state", () => {
            render(<TailwindTextInputBase disabled />);
        ...
        it("handles error state", () => {
            render(<TailwindTextInputBase error />);
        ...
        it("handles required state", () => {
            render(<TailwindTextInputBase required />);
        ...
        it("handles readonly state", () => {
            render(<TailwindTextInputBase readOnly />);
    ...
    describe("Input variants", () => {
        it("renders outline variant", () => {
            render(<TailwindTextInputBase variant="outline" />);
        ...
        it("renders filled variant", () => {
            render(<TailwindTextInputBase variant="filled" />);
        ...
        it("renders underline variant", () => {
            render(<TailwindTextInputBase variant="underline" />);
    ...
    describe("Input sizes", () => {
        it("renders small size", () => {
            render(<TailwindTextInputBase size="sm" />);
        ...
        it("renders medium size", () => {
            render(<TailwindTextInputBase size="md" />);
        ...
        it("renders large size", () => {
            render(<TailwindTextInputBase size="lg" />);
    ...
    describe("Multiline behavior", () => {
        it("renders as textarea when multiline is true", () => {
            render(<TailwindTextInputBase multiline />);
        ...
        it("renders with specified rows", () => {
            render(<TailwindTextInputBase multiline rows={5} />);
        ...
        it("renders with specified cols", () => {
            render(<TailwindTextInputBase multiline cols={50} />);
    ...
    describe("User interaction", () => {
        it("handles typing input", async () => {
            ...
            render(<TailwindTextInputBase onChange={onChange} />);
        ...
        it("handles focus events", async () => {
            ...
            render(<TailwindTextInputBase onFocus={onFocus} />);
        ...
        it("handles blur events", async () => {
            ...
            render(<TailwindTextInputBase onBlur={onBlur} />);
        ...
        it("handles keydown events", async () => {
            ...
            render(<TailwindTextInputBase onKeyDown={onKeyDown} />);
    ...
    describe("Full width behavior", () => {
        it("applies full width styling when fullWidth is true", () => {
            render(<TailwindTextInputBase fullWidth />);

            const input = screen.getByRole("textbox");
            const container = input.closest("div");

            expect(container?.className).toContain("tw-w-full");
        });

        it("does not apply full width styling when fullWidth is false", () => {
            render(<TailwindTextInputBase fullWidth={false} />);

            const input = screen.getByRole("textbox");
            const container = input.closest("div");

            expect(container?.className).not.toContain("tw-w-full");
        });
    });

    describe("Input type variations", () => {
        it("renders password input type", () => {
            render(<TailwindTextInputBase type="password" />);
        ...
        it("renders email input type", () => {
            render(<TailwindTextInputBase type="email" />);
        ...
        it("renders number input type", () => {
            render(<TailwindTextInputBase type="number" />);
        ...
        it("renders tel input type", () => {
            render(<TailwindTextInputBase type="tel" />);
...
describe("TailwindTextInput (Formik-enabled wrapper)", () => {
    describe("Formik integration using test helpers", () => {
        ...
        it("displays validation errors from Formik", async () => {
            const { user } = renderWithFormik(
                <TailwindTextInput name="email" label="Email" type="email" />,
                {
                    initialValues: { email: "" },
                    formikConfig: {
        ...
        it("shows required field validation", async () => {
            const { user } = renderWithFormik(
                <TailwindTextInput name="name" label="Name" isRequired />,
                {
                    initialValues: { name: "" },
                    formikConfig: {
                        validationSchema: yup.object({
        ...
        it("displays validation errors correctly", async () => {
            const { user } = renderWithFormik(
                <TailwindTextInput name="username" label="Username" />,
                {
                    initialValues: { username: "" },
                    formikConfig: {
                        validationSchema: yup.object({
...
describe("Component state changes", () => {
    it("toggles between normal and error states", () => {
        const { rerender } = render(<TailwindTextInputBase />);

        const input = screen.getByRole("textbox");
        expect(input).toBeDefined();

        // Switch to error state
        rerender(<TailwindTextInputBase error helperText="Error message" />);

        const errorText = screen.getByText("Error message");
        expect(errorText).toBeDefined();

        // Switch back to normal state
        rerender(<TailwindTextInputBase />);
    ...
    it("toggles between enabled and disabled states", () => {
        ...
        rerender(<TailwindTextInputBase disabled />);

        input = screen.getByRole("textbox") as HTMLInputElement;
        expect(input.disabled).toBe(true);

        // Switch back to enabled state
        rerender(<TailwindTextInputBase disabled={false} />);
    ...
    it("toggles between single-line and multiline", () => {
        ...
        // Switch to multiline
        rerender(<TailwindTextInputBase multiline />);

        input = screen.getByRole("textbox");
        expect(input.tagName).toBe("TEXTAREA");

        // Switch back to single-line
        rerender(<TailwindTextInputBase multiline={false} />);
...
describe("TranslatedTailwindTextInput", () => {
