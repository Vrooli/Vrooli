...
export function RunListItem({
    ...
    const { bio, name, percentComplete } = useMemo(() => {
            ...
            >
                <ListItemButton component="div" onClick={handleClick}>
                    ...
                    <Stack direction="column" spacing={1} pl={2} sx={{ width: '-webkit-fill-available' }}>
                        ...
                        {/* Progress bar */}
                        <LinearProgressWithLabel color="secondary" variant={loading ? 'indeterminate' : 'determinate'} value={percentComplete} sx={{ height: '15px' }} />
                    </Stack>
                    {
