...
export const projectVersionFindOne = gql`fragment Api_list on Api {
    versions {
        translations {
            id
            language
...
export const projectVersionCreate = gql`fragment Api_list on Api {
    versions {
        translations {
            id
            language
...
export const projectVersionUpdate = gql`fragment Api_list on Api {
    versions {
        translations {
            id
            language
