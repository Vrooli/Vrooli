...
export const noteVersionFindOne = gql`fragment Api_list on Api {
    versions {
        translations {
            id
            language
...
export const noteVersionCreate = gql`fragment Api_list on Api {
    versions {
        translations {
            id
            language
...
export const noteVersionUpdate = gql`fragment Api_list on Api {
    versions {
        translations {
            id
            language
