...
export const standardVersionFindOne = gql`fragment Api_list on Api {
    versions {
        translations {
            id
            language
...
export const standardVersionCreate = gql`fragment Api_list on Api {
    versions {
        translations {
            id
            language
...
export const standardVersionUpdate = gql`fragment Api_list on Api {
    versions {
        translations {
            id
            language
