...
import { CopyInput, ResourceListUsedFor, ResourceUsedFor, NodeType, RunStatus, RunRoutineStepStatus } from "./globalTypes";
...
export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_inputs_translations {
  __typename: "InputItemTranslation";
  id: string;
  language: string;
  description: string | null;
...
export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_inputs_standard_translations {
  __typename: "StandardTranslation";
  id: string;
  language: string;
  description: string | null;
...
export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_inputs_standard {
  __typename: "Standard";
  id: string;
  default: string | null;
  isDeleted: boolean;
  ...
  props: string;
  yup: string | null;
  translations: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_inputs_standard_translations[];
}

export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_inputs {
  __typename: "InputItem";
  id: string;
  isRequired: boolean | null;
  name: string | null;
  translations: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_inputs_translations[];
  standard: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_inputs_standard | null;
}

export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_outputs_translations {
...
export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_outputs_standard_translations {
  __typename: "StandardTranslation";
  id: string;
  language: string;
  description: string | null;
...
export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_outputs_standard {
  __typename: "Standard";
  id: string;
  default: string | null;
  isDeleted: boolean;
  ...
  props: string;
  yup: string | null;
  translations: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_outputs_standard_translations[];
}

export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_outputs {
  __typename: "OutputItem";
  id: string;
  name: string | null;
  translations: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_outputs_translations[];
  standard: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_outputs_standard | null;
}

export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_owner_Organization_translations {
  __typename: "OrganizationTranslation";
  id: string;
  language: string;
  name: string;
...
export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_owner_Organization {
  __typename: "Organization";
  id: string;
  handle: string | null;
  translations: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_owner_Organization_translations[];
}

export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_owner_User {
  __typename: "User";
  id: string;
  name: string;
  handle: string | null;
...
export type copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_owner = copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_owner_Organization | copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_owner_User;

export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_permissionsRoutine {
...
export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_resourceLists_translations {
  __typename: "ResourceListTranslation";
  id: string;
  language: string;
  description: string | null;
...
export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_resourceLists_resources {
  ...
  updated_at: any;
  usedFor: ResourceUsedFor | null;
  translations: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_resourceLists_resources_translations[];
}

export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_resourceLists {
  __typename: "ResourceList";
  id: string;
  created_at: any;
  index: number | null;
  usedFor: ResourceListUsedFor | null;
  translations: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_resourceLists_translations[];
  resources: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_resourceLists_resources[];
}

export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_tags_translations {
  __typename: "TagTranslation";
  id: string;
  language: string;
  description: string | null;
...
export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_tags {
  __typename: "Tag";
  tag: string;
  translations: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_tags_translations[];
}

export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_translations {
...
export interface copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion {
  __typename: "Routine";
  id: string;
  complexity: number;
  isComplete: boolean;
  ...
  isPrivate: boolean;
  inputs: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_inputs[];
  nodesCount: number | null;
  outputs: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_outputs[];
  owner: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_owner | null;
  permissionsRoutine: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_permissionsRoutine;
  resourceLists: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_resourceLists[];
  simplicity: number;
  tags: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_tags[];
  translations: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion_translations[];
}
...
export interface copy_copy_routine_nodes_data_NodeRoutineList_routines {
  ...
  index: number;
  isOptional: boolean;
  routineVersion: copy_copy_routine_nodes_data_NodeRoutineList_routines_routineVersion;
