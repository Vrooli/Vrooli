...
export interface projectCreate_projectCreate_owner_Organization_permissionsOrganization {
...
export interface projectCreate_projectCreate_owner_Organization {
  ...
  permissionsOrganization: projectCreate_projectCreate_owner_Organization_permissionsOrganization | null;
}
