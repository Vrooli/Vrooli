# Compute Manager proto sources

This folder contains the canonical wire contracts for Compute Manager.

The generated bindings under `packages/proto/gen/` are derived artifacts and
must not be hand-edited. Domain messages and services belong in this folder.
