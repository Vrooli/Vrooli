...
import (
	...
	context "context"
	errors "errors"
	validation "github.com/vrooli/vrooli/packages/proto/gen/go/ui-health/v1/validation"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ValidationServiceName = "vrooli.ui_health.v1.validation.ValidationService"
)
...
const (
	...
	ValidationServiceValidateScenarioProcedure = "/vrooli.ui_health.v1.validation.ValidationService/ValidateScenario"
)

// ValidationServiceClient is a client for the vrooli.ui_health.v1.validation.ValidationService
// service.
...
// vrooli.ui_health.v1.validation.ValidationService service. By default, it uses the Connect
...
func NewValidationServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ValidationServiceClient {
	...
	validationServiceMethods := validation.File_ui_health_v1_validation_validation_proto.Services().ByName("ValidationService").Methods()
...
// ValidateScenario calls vrooli.ui_health.v1.validation.ValidationService.ValidateScenario.
...
// vrooli.ui_health.v1.validation.ValidationService service.
...
func NewValidationServiceHandler(svc ValidationServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/vrooli.ui_health.v1.validation.ValidationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedValidationServiceHandler) ValidateScenario(context.Context, *connect.Request[validation.ValidateScenarioRequest]) (*connect.Response[validation.ValidateScenarioResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vrooli.ui_health.v1.validation.ValidationService.ValidateScenario is not implemented"))
}
