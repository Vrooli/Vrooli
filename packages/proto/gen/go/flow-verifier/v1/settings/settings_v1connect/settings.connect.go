...
import (
	...
	context "context"
	errors "errors"
	settings "github.com/vrooli/vrooli/packages/proto/gen/go/flow-verifier/v1/settings"
	http "net/http"
	strings "strings"
)
...
const (
	...
	SettingsServiceName = "vrooli.flow_verifier.v1.settings.SettingsService"
)
...
const (
	...
	// GetSettings RPC.
	SettingsServiceGetSettingsProcedure = "/vrooli.flow_verifier.v1.settings.SettingsService/GetSettings"
	// SettingsServiceUpdateSettingsProcedure is the fully-qualified name of the SettingsService's
	// UpdateSettings RPC.
	SettingsServiceUpdateSettingsProcedure = "/vrooli.flow_verifier.v1.settings.SettingsService/UpdateSettings"
)

// SettingsServiceClient is a client for the vrooli.flow_verifier.v1.settings.SettingsService
// service.
...
// vrooli.flow_verifier.v1.settings.SettingsService service. By default, it uses the Connect
...
func NewSettingsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SettingsServiceClient {
	...
	settingsServiceMethods := settings.File_flow_verifier_v1_settings_settings_proto.Services().ByName("SettingsService").Methods()
...
// GetSettings calls vrooli.flow_verifier.v1.settings.SettingsService.GetSettings.
...
// UpdateSettings calls vrooli.flow_verifier.v1.settings.SettingsService.UpdateSettings.
...
// vrooli.flow_verifier.v1.settings.SettingsService service.
...
func NewSettingsServiceHandler(svc SettingsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/vrooli.flow_verifier.v1.settings.SettingsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSettingsServiceHandler) GetSettings(context.Context, *connect.Request[settings.GetSettingsRequest]) (*connect.Response[settings.GetSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vrooli.flow_verifier.v1.settings.SettingsService.GetSettings is not implemented"))
}
...
func (UnimplementedSettingsServiceHandler) UpdateSettings(context.Context, *connect.Request[settings.UpdateSettingsRequest]) (*connect.Response[settings.UpdateSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vrooli.flow_verifier.v1.settings.SettingsService.UpdateSettings is not implemented"))
}
