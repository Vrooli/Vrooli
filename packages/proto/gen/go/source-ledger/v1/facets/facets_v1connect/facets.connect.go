...
import (
	...
	context "context"
	errors "errors"
	facets "github.com/vrooli/vrooli/packages/proto/gen/go/source-ledger/v1/facets"
	http "net/http"
	strings "strings"
)
...
const (
	...
	FacetsServiceName = "vrooli.source_ledger.v1.facets.FacetsService"
)
...
const (
	...
	FacetsServiceSetPinProcedure = "/vrooli.source_ledger.v1.facets.FacetsService/SetPin"
	// FacetsServiceListPinProposalsProcedure is the fully-qualified name of the FacetsService's
	// ListPinProposals RPC.
	FacetsServiceListPinProposalsProcedure = "/vrooli.source_ledger.v1.facets.FacetsService/ListPinProposals"
	// FacetsServiceListPinCandidatesProcedure is the fully-qualified name of the FacetsService's
	// ListPinCandidates RPC.
	FacetsServiceListPinCandidatesProcedure = "/vrooli.source_ledger.v1.facets.FacetsService/ListPinCandidates"
	// FacetsServiceResolvePinProposalProcedure is the fully-qualified name of the FacetsService's
	// ResolvePinProposal RPC.
	FacetsServiceResolvePinProposalProcedure = "/vrooli.source_ledger.v1.facets.FacetsService/ResolvePinProposal"
	// FacetsServiceMarkSupersededProcedure is the fully-qualified name of the FacetsService's
	// MarkSuperseded RPC.
	FacetsServiceMarkSupersededProcedure = "/vrooli.source_ledger.v1.facets.FacetsService/MarkSuperseded"
	// FacetsServiceResolveThreadProcedure is the fully-qualified name of the FacetsService's
	// ResolveThread RPC.
	FacetsServiceResolveThreadProcedure = "/vrooli.source_ledger.v1.facets.FacetsService/ResolveThread"
)
...
// NewFacetsServiceClient constructs a client for the vrooli.source_ledger.v1.facets.FacetsService
...
func NewFacetsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FacetsServiceClient {
	...
	facetsServiceMethods := facets.File_source_ledger_v1_facets_facets_proto.Services().ByName("FacetsService").Methods()
...
// SetPin calls vrooli.source_ledger.v1.facets.FacetsService.SetPin.
...
// ListPinProposals calls vrooli.source_ledger.v1.facets.FacetsService.ListPinProposals.
...
// ListPinCandidates calls vrooli.source_ledger.v1.facets.FacetsService.ListPinCandidates.
...
// ResolvePinProposal calls vrooli.source_ledger.v1.facets.FacetsService.ResolvePinProposal.
...
// MarkSuperseded calls vrooli.source_ledger.v1.facets.FacetsService.MarkSuperseded.
...
// ResolveThread calls vrooli.source_ledger.v1.facets.FacetsService.ResolveThread.
...
// FacetsServiceHandler is an implementation of the vrooli.source_ledger.v1.facets.FacetsService
// service.
...
func NewFacetsServiceHandler(svc FacetsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/vrooli.source_ledger.v1.facets.FacetsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedFacetsServiceHandler) AssignFacet(context.Context, *connect.Request[facets.AssignFacetRequest]) (*connect.Response[facets.AssignFacetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vrooli.source_ledger.v1.facets.FacetsService.AssignFacet is not implemented"))
}
...
func (UnimplementedFacetsServiceHandler) SetPin(context.Context, *connect.Request[facets.SetPinRequest]) (*connect.Response[facets.SetPinResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vrooli.source_ledger.v1.facets.FacetsService.SetPin is not implemented"))
}
...
func (UnimplementedFacetsServiceHandler) ListPinProposals(context.Context, *connect.Request[facets.ListPinProposalsRequest]) (*connect.Response[facets.ListPinProposalsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vrooli.source_ledger.v1.facets.FacetsService.ListPinProposals is not implemented"))
}
...
func (UnimplementedFacetsServiceHandler) ListPinCandidates(context.Context, *connect.Request[facets.ListPinCandidatesRequest]) (*connect.Response[facets.ListPinCandidatesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vrooli.source_ledger.v1.facets.FacetsService.ListPinCandidates is not implemented"))
}
...
func (UnimplementedFacetsServiceHandler) ResolvePinProposal(context.Context, *connect.Request[facets.ResolvePinProposalRequest]) (*connect.Response[facets.ResolvePinProposalResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vrooli.source_ledger.v1.facets.FacetsService.ResolvePinProposal is not implemented"))
}
...
func (UnimplementedFacetsServiceHandler) MarkSuperseded(context.Context, *connect.Request[facets.MarkSupersededRequest]) (*connect.Response[facets.MarkSupersededResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vrooli.source_ledger.v1.facets.FacetsService.MarkSuperseded is not implemented"))
}
...
func (UnimplementedFacetsServiceHandler) ResolveThread(context.Context, *connect.Request[facets.ResolveThreadRequest]) (*connect.Response[facets.ResolveThreadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vrooli.source_ledger.v1.facets.FacetsService.ResolveThread is not implemented"))
}
