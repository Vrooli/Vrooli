...
func (x *AppendEntryResponse) GetExisting() bool {
	if x != nil {
		return x.Existing
	}
	return false
...
var File_source_ledger_v1_journal_journal_proto protoreflect.FileDescriptor
...
const file_source_ledger_v1_journal_journal_proto_rawDesc = "" +
	...
	"\vattribution\x18\x04 \x01(\v2,.vrooli.source_ledger.v1.journal.AttributionR\vattribution\x12N\n" +
	"\vcorrelation\x18\x05 \x01(\v2,.vrooli.source_ledger.v1.journal.CorrelationR\vcorrelation\x12^\n" +
	"\x11import_provenance\x18\x06 \x01(\v21.vrooli.source_ledger.v1.journal.ImportProvenanceR\x10importProvenance\x12K\n" +
	"\vfacet_texts\x18\a \x03(\v2*.vrooli.source_ledger.v1.journal.FacetTextR\n" +
	"facetTexts\x129\n" +
	"\n" +
	...
	"\vattribution\x18\x04 \x01(\v2,.vrooli.source_ledger.v1.journal.AttributionR\vattribution\x12N\n" +
	"\vcorrelation\x18\x05 \x01(\v2,.vrooli.source_ledger.v1.journal.CorrelationR\vcorrelation\x12^\n" +
	"\x11import_provenance\x18\x06 \x01(\v21.vrooli.source_ledger.v1.journal.ImportProvenanceR\x10importProvenance\x12\x18\n" +
...
var (
	...
	file_source_ledger_v1_journal_journal_proto_rawDescData []byte
)

func file_source_ledger_v1_journal_journal_proto_rawDescGZIP() []byte {
	file_source_ledger_v1_journal_journal_proto_rawDescOnce.Do(func() {
		file_source_ledger_v1_journal_journal_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_source_ledger_v1_journal_journal_proto_rawDesc), len(file_source_ledger_v1_journal_journal_proto_rawDesc)))
	})
...
func file_source_ledger_v1_journal_journal_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_source_ledger_v1_journal_journal_proto_goTypes,
		DependencyIndexes: file_source_ledger_v1_journal_journal_proto_depIdxs,
		MessageInfos:      file_source_ledger_v1_journal_journal_proto_msgTypes,
	}.Build()
	File_source_ledger_v1_journal_journal_proto = out.File
	file_source_ledger_v1_journal_journal_proto_goTypes = nil
	file_source_ledger_v1_journal_journal_proto_depIdxs = nil
}
