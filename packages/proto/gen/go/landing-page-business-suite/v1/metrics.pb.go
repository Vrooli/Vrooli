...
const file_landing_page_business_suite_v1_metrics_proto_rawDesc = "" +
	...
	"\x05stats\x18\x03 \x03(\v2,.landing_page_business_suite.v1.VariantStatsR\x05stats2\x90\x03\n" +
	...
	"\x0fGetVariantStats\x126.landing_page_business_suite.v1.GetVariantStatsRequest\x1a7.landing_page_business_suite.v1.GetVariantStatsResponseBnZlgithub.com/vrooli/vrooli/packages/proto/gen/go/landing-page-business-suite/v1;landing_page_business_suite_v1b\x06proto3"
...
var file_landing_page_business_suite_v1_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_landing_page_business_suite_v1_metrics_proto_goTypes = []any{
	(*TrackEventRequest)(nil),          // 0: landing_page_business_suite.v1.TrackEventRequest
	(*TrackEventResponse)(nil),         // 1: landing_page_business_suite.v1.TrackEventResponse
	(*VariantStats)(nil),               // 2: landing_page_business_suite.v1.VariantStats
	(*AnalyticsSummary)(nil),           // 3: landing_page_business_suite.v1.AnalyticsSummary
	(*GetAnalyticsSummaryRequest)(nil), // 4: landing_page_business_suite.v1.GetAnalyticsSummaryRequest
...
func file_landing_page_business_suite_v1_metrics_proto_init() {
	...
	file_landing_page_business_suite_v1_metrics_proto_msgTypes[2].OneofWrappers = []any{}
	file_landing_page_business_suite_v1_metrics_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
