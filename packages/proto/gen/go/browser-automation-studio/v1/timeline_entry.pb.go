...
// 	protoc        (unknown)
// source: browser-automation-studio/v1/timeline_entry.proto
...
type TimelineEntry struct {
	...
	Context *EventContext `protobuf:"bytes,12,opt,name=context,proto3" json:"context,omitempty"`
...
func (x *TimelineEntry) GetAction() *ActionDefinition {
	if x != nil {
		return x.Action
	}
	return nil
...
func (x *TimelineEntry) GetTelemetry() *ActionTelemetry {
	if x != nil {
		return x.Telemetry
	}
	return nil
...
func (x *TimelineEntry) GetContext() *EventContext {
	if x != nil {
		return x.Context
	}
	return nil
...
type TimelineEntryAggregates struct {
	...
	Status StepStatus `protobuf:"varint,1,opt,name=status,proto3,enum=browser_automation_studio.v1.StepStatus" json:"status,omitempty"`
...
func (x *TimelineEntryAggregates) GetStatus() StepStatus {
	if x != nil {
		return x.Status
	}
...
const file_browser_automation_studio_v1_timeline_entry_proto_rawDesc = "" +
	"\n" +
	"1browser-automation-studio/v1/timeline_entry.proto\x12\x1cbrowser_automation_studio.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x15common/v1/types.proto\x1a)browser-automation-studio/v1/shared.proto\x1a+browser-automation-studio/v1/geometry.proto\x1a)browser-automation-studio/v1/action.proto\x1a,browser-automation-studio/v1/telemetry.proto\"\x88\x06\n" +
	...
	"\x19TIMELINE_MESSAGE_TYPE_LOG\x10\x04BjZhgithub.com/vrooli/vrooli/packages/proto/gen/go/browser-automation-studio/v1;browser_automation_studio_v1b\x06proto3"
...
var file_browser_automation_studio_v1_timeline_entry_proto_goTypes = []any{
	...
	(*ActionDefinition)(nil),        // 11: browser_automation_studio.v1.ActionDefinition
	(*ActionTelemetry)(nil),         // 12: browser_automation_studio.v1.ActionTelemetry
	(*EventContext)(nil),            // 13: browser_automation_studio.v1.EventContext
	(StepStatus)(0),                 // 14: browser_automation_studio.v1.StepStatus
	(*v1.JsonValue)(nil),            // 15: common.v1.JsonValue
	(ArtifactType)(0),               // 16: browser_automation_studio.v1.ArtifactType
	(*BoundingBox)(nil),             // 17: browser_automation_studio.v1.BoundingBox
	(LogLevel)(0),                   // 18: browser_automation_studio.v1.LogLevel
	(ExecutionStatus)(0),            // 19: browser_automation_studio.v1.ExecutionStatus
}
