...
func (x *Project) Reset() {
	*x = Project{}
	mi := &file_browser_automation_studio_v1_project_proto_msgTypes[0]
...
func (*Project) Descriptor() ([]byte, []int) {
	return file_browser_automation_studio_v1_project_proto_rawDescGZIP(), []int{0}
}
...
func (x *ProjectStats) Reset() {
	*x = ProjectStats{}
	mi := &file_browser_automation_studio_v1_project_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProjectStats) Descriptor() ([]byte, []int) {
	return file_browser_automation_studio_v1_project_proto_rawDescGZIP(), []int{1}
}
...
func (x *ProjectWithStats) Reset() {
	*x = ProjectWithStats{}
	mi := &file_browser_automation_studio_v1_project_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProjectWithStats) Descriptor() ([]byte, []int) {
	return file_browser_automation_studio_v1_project_proto_rawDescGZIP(), []int{2}
}
...
func (x *ProjectList) Reset() {
	*x = ProjectList{}
	mi := &file_browser_automation_studio_v1_project_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProjectList) Descriptor() ([]byte, []int) {
	return file_browser_automation_studio_v1_project_proto_rawDescGZIP(), []int{3}
}
...
var File_browser_automation_studio_v1_project_proto protoreflect.FileDescriptor

const file_browser_automation_studio_v1_project_proto_rawDesc = "" +
	"\n" +
	"*browser-automation-studio/v1/project.proto\x12\x1cbrowser_automation_studio.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe6\x01\n" +
	"\aProject\x12\x0e\n" +
	...
	"\vProjectList\x12J\n" +
	"\bprojects\x18\x01 \x03(\v2..browser_automation_studio.v1.ProjectWithStatsR\bprojectsBjZhgithub.com/vrooli/vrooli/packages/proto/gen/go/browser-automation-studio/v1;browser_automation_studio_v1b\x06proto3"

var (
	file_browser_automation_studio_v1_project_proto_rawDescOnce sync.Once
	file_browser_automation_studio_v1_project_proto_rawDescData []byte
)

func file_browser_automation_studio_v1_project_proto_rawDescGZIP() []byte {
	file_browser_automation_studio_v1_project_proto_rawDescOnce.Do(func() {
		file_browser_automation_studio_v1_project_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_browser_automation_studio_v1_project_proto_rawDesc), len(file_browser_automation_studio_v1_project_proto_rawDesc)))
	})
	return file_browser_automation_studio_v1_project_proto_rawDescData
}

var file_browser_automation_studio_v1_project_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_browser_automation_studio_v1_project_proto_goTypes = []any{
...
var file_browser_automation_studio_v1_project_proto_depIdxs = []int32{
...
func init() { file_browser_automation_studio_v1_project_proto_init() }
func file_browser_automation_studio_v1_project_proto_init() {
	if File_browser_automation_studio_v1_project_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_browser_automation_studio_v1_project_proto_rawDesc), len(file_browser_automation_studio_v1_project_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_browser_automation_studio_v1_project_proto_goTypes,
		DependencyIndexes: file_browser_automation_studio_v1_project_proto_depIdxs,
		MessageInfos:      file_browser_automation_studio_v1_project_proto_msgTypes,
	}.Build()
	File_browser_automation_studio_v1_project_proto = out.File
	file_browser_automation_studio_v1_project_proto_goTypes = nil
	file_browser_automation_studio_v1_project_proto_depIdxs = nil
}
