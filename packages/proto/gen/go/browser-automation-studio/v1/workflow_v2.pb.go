...
// 	protoc        (unknown)
// source: browser-automation-studio/v1/workflow_v2.proto
...
func (x *WorkflowDefinitionV2) Reset() {
	*x = WorkflowDefinitionV2{}
	mi := &file_browser_automation_studio_v1_workflow_v2_proto_msgTypes[0]
...
func (*WorkflowDefinitionV2) Descriptor() ([]byte, []int) {
	return file_browser_automation_studio_v1_workflow_v2_proto_rawDescGZIP(), []int{0}
}
...
func (x *WorkflowMetadataV2) Reset() {
	*x = WorkflowMetadataV2{}
	mi := &file_browser_automation_studio_v1_workflow_v2_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WorkflowMetadataV2) Descriptor() ([]byte, []int) {
	return file_browser_automation_studio_v1_workflow_v2_proto_rawDescGZIP(), []int{1}
}
...
func (x *WorkflowSettingsV2) Reset() {
	*x = WorkflowSettingsV2{}
	mi := &file_browser_automation_studio_v1_workflow_v2_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WorkflowSettingsV2) Descriptor() ([]byte, []int) {
	return file_browser_automation_studio_v1_workflow_v2_proto_rawDescGZIP(), []int{2}
}
...
func (x *WorkflowNodeV2) Reset() {
	*x = WorkflowNodeV2{}
	mi := &file_browser_automation_studio_v1_workflow_v2_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WorkflowNodeV2) Descriptor() ([]byte, []int) {
	return file_browser_automation_studio_v1_workflow_v2_proto_rawDescGZIP(), []int{3}
}
...
func (x *NodeExecutionSettings) Reset() {
	*x = NodeExecutionSettings{}
	mi := &file_browser_automation_studio_v1_workflow_v2_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NodeExecutionSettings) Descriptor() ([]byte, []int) {
	return file_browser_automation_studio_v1_workflow_v2_proto_rawDescGZIP(), []int{4}
}
...
func (x *ResilienceConfig) Reset() {
	*x = ResilienceConfig{}
	mi := &file_browser_automation_studio_v1_workflow_v2_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResilienceConfig) Descriptor() ([]byte, []int) {
	return file_browser_automation_studio_v1_workflow_v2_proto_rawDescGZIP(), []int{5}
}
...
type WorkflowEdgeV2 struct {
	...
	Type *WorkflowEdgeType `protobuf:"varint,4,opt,name=type,proto3,enum=browser_automation_studio.v1.WorkflowEdgeType,oneof" json:"type,omitempty"`
...
func (x *WorkflowEdgeV2) Reset() {
	*x = WorkflowEdgeV2{}
	mi := &file_browser_automation_studio_v1_workflow_v2_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WorkflowEdgeV2) Descriptor() ([]byte, []int) {
	return file_browser_automation_studio_v1_workflow_v2_proto_rawDescGZIP(), []int{6}
}
...
func (x *WorkflowEdgeV2) GetType() WorkflowEdgeType {
	if x != nil && x.Type != nil {
		return *x.Type
	}
	return WorkflowEdgeType_WORKFLOW_EDGE_TYPE_UNSPECIFIED
}
...
var File_browser_automation_studio_v1_workflow_v2_proto protoreflect.FileDescriptor

const file_browser_automation_studio_v1_workflow_v2_proto_rawDesc = "" +
	"\n" +
	".browser-automation-studio/v1/workflow_v2.proto\x12\x1cbrowser_automation_studio.v1\x1a)browser-automation-studio/v1/shared.proto\x1a+browser-automation-studio/v1/geometry.proto\x1a)browser-automation-studio/v1/action.proto\"\xba\x02\n" +
	...
	"\x0e_target_handleBjZhgithub.com/vrooli/vrooli/packages/proto/gen/go/browser-automation-studio/v1;browser_automation_studio_v1b\x06proto3"

var (
	file_browser_automation_studio_v1_workflow_v2_proto_rawDescOnce sync.Once
	file_browser_automation_studio_v1_workflow_v2_proto_rawDescData []byte
)

func file_browser_automation_studio_v1_workflow_v2_proto_rawDescGZIP() []byte {
	file_browser_automation_studio_v1_workflow_v2_proto_rawDescOnce.Do(func() {
		file_browser_automation_studio_v1_workflow_v2_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_browser_automation_studio_v1_workflow_v2_proto_rawDesc), len(file_browser_automation_studio_v1_workflow_v2_proto_rawDesc)))
	})
	return file_browser_automation_studio_v1_workflow_v2_proto_rawDescData
}

var file_browser_automation_studio_v1_workflow_v2_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_browser_automation_studio_v1_workflow_v2_proto_goTypes = []any{
	...
	(*ActionDefinition)(nil),      // 8: browser_automation_studio.v1.ActionDefinition
	(*NodePosition)(nil),          // 9: browser_automation_studio.v1.NodePosition
	(WorkflowEdgeType)(0),         // 10: browser_automation_studio.v1.WorkflowEdgeType
}
var file_browser_automation_studio_v1_workflow_v2_proto_depIdxs = []int32{
...
func init() { file_browser_automation_studio_v1_workflow_v2_proto_init() }
func file_browser_automation_studio_v1_workflow_v2_proto_init() {
	if File_browser_automation_studio_v1_workflow_v2_proto != nil {
		return
	}
	...
	file_browser_automation_studio_v1_workflow_v2_proto_msgTypes[1].OneofWrappers = []any{}
	file_browser_automation_studio_v1_workflow_v2_proto_msgTypes[2].OneofWrappers = []any{}
	file_browser_automation_studio_v1_workflow_v2_proto_msgTypes[3].OneofWrappers = []any{}
	file_browser_automation_studio_v1_workflow_v2_proto_msgTypes[4].OneofWrappers = []any{}
	file_browser_automation_studio_v1_workflow_v2_proto_msgTypes[5].OneofWrappers = []any{}
	file_browser_automation_studio_v1_workflow_v2_proto_msgTypes[6].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_browser_automation_studio_v1_workflow_v2_proto_rawDesc), len(file_browser_automation_studio_v1_workflow_v2_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_browser_automation_studio_v1_workflow_v2_proto_goTypes,
		DependencyIndexes: file_browser_automation_studio_v1_workflow_v2_proto_depIdxs,
		MessageInfos:      file_browser_automation_studio_v1_workflow_v2_proto_msgTypes,
	}.Build()
	File_browser_automation_studio_v1_workflow_v2_proto = out.File
	file_browser_automation_studio_v1_workflow_v2_proto_goTypes = nil
	file_browser_automation_studio_v1_workflow_v2_proto_depIdxs = nil
}
