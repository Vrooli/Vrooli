...
type SelectorCandidate struct {
	...
	Type SelectorType `protobuf:"varint,1,opt,name=type,proto3,enum=browser_automation_studio.v1.SelectorType" json:"type,omitempty"`
...
func (x *SelectorCandidate) Reset() {
	*x = SelectorCandidate{}
	mi := &file_browser_automation_studio_v1_selectors_proto_msgTypes[0]
...
func (*SelectorCandidate) Descriptor() ([]byte, []int) {
	return file_browser_automation_studio_v1_selectors_proto_rawDescGZIP(), []int{0}
}

func (x *SelectorCandidate) GetType() SelectorType {
	if x != nil {
		return x.Type
	}
...
var File_browser_automation_studio_v1_selectors_proto protoreflect.FileDescriptor

const file_browser_automation_studio_v1_selectors_proto_rawDesc = "" +
	"\n" +
	",browser-automation-studio/v1/selectors.proto\x12\x1cbrowser_automation_studio.v1\x1a)browser-automation-studio/v1/shared.proto\x1a+browser-automation-studio/v1/geometry.proto\"\xab\x01\n" +
	...
	"\bselector\x18\x01 \x01(\tR\bselector\x12L\n" +
	"\fbounding_box\x18\x02 \x01(\v2).browser_automation_studio.v1.BoundingBoxR\vboundingBox\x12\x18\n" +
	"\aopacity\x18\x03 \x01(\x01R\aopacityBjZhgithub.com/vrooli/vrooli/packages/proto/gen/go/browser-automation-studio/v1;browser_automation_studio_v1b\x06proto3"

var (
	file_browser_automation_studio_v1_selectors_proto_rawDescOnce sync.Once
	file_browser_automation_studio_v1_selectors_proto_rawDescData []byte
)

func file_browser_automation_studio_v1_selectors_proto_rawDescGZIP() []byte {
	file_browser_automation_studio_v1_selectors_proto_rawDescOnce.Do(func() {
		file_browser_automation_studio_v1_selectors_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_browser_automation_studio_v1_selectors_proto_rawDesc), len(file_browser_automation_studio_v1_selectors_proto_rawDesc)))
	})
...
func file_browser_automation_studio_v1_selectors_proto_init() {
	if File_browser_automation_studio_v1_selectors_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_browser_automation_studio_v1_selectors_proto_goTypes,
		DependencyIndexes: file_browser_automation_studio_v1_selectors_proto_depIdxs,
		MessageInfos:      file_browser_automation_studio_v1_selectors_proto_msgTypes,
	}.Build()
	File_browser_automation_studio_v1_selectors_proto = out.File
	file_browser_automation_studio_v1_selectors_proto_goTypes = nil
	file_browser_automation_studio_v1_selectors_proto_depIdxs = nil
}
