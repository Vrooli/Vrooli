...
func (x *GetActionsResponse) GetEntries() []*timeline.TimelineEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
type GenerateWorkflowRequest struct {
	...
	Entries       []*timeline.TimelineEntry `protobuf:"bytes,6,rep,name=entries,proto3" json:"entries,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GenerateWorkflowRequest) GetEntries() []*timeline.TimelineEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
func (x *ReplayPreviewRequest) GetEntries() []*timeline.TimelineEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
type ReplayEntryResult struct {
	...
	Action        *actions.ActionDefinition `protobuf:"bytes,7,opt,name=action,proto3" json:"action,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ReplayEntryResult) GetAction() *actions.ActionDefinition {
	if x != nil {
		return x.Action
	}
	return nil
...
const file_browser_automation_studio_v1_recording_session_proto_rawDesc = "" +
	"\n" +
	"4browser-automation-studio/v1/recording/session.proto\x12\x1cbrowser_automation_studio.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a1browser-automation-studio/v1/actions/action.proto\x1a1browser-automation-studio/v1/timeline/entry.proto\"\xd3\x01\n" +
	...
	"\x05error\x18\x04 \x01(\tR\x05errorBaZ_github.com/vrooli/vrooli/packages/proto/gen/go/browser-automation-studio/v1/recording;recordingb\x06proto3"
...
var file_browser_automation_studio_v1_recording_session_proto_goTypes = []any{
	...
	(*timeline.TimelineEntry)(nil),             // 17: browser_automation_studio.v1.TimelineEntry
	(*actions.ActionDefinition)(nil),           // 18: browser_automation_studio.v1.ActionDefinition
}
