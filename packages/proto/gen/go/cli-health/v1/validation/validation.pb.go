...
func (Severity) Descriptor() protoreflect.EnumDescriptor {
	return file_cli_health_v1_validation_validation_proto_enumTypes[0].Descriptor()
}

func (Severity) Type() protoreflect.EnumType {
	return &file_cli_health_v1_validation_validation_proto_enumTypes[0]
}
...
func (Severity) EnumDescriptor() ([]byte, []int) {
	return file_cli_health_v1_validation_validation_proto_rawDescGZIP(), []int{0}
}
...
type Finding struct {
	...
	Severity Severity               `protobuf:"varint,1,opt,name=severity,proto3,enum=vrooli.cli_health.v1.validation.Severity" json:"severity,omitempty"`
...
func (x *Finding) Reset() {
	*x = Finding{}
	mi := &file_cli_health_v1_validation_validation_proto_msgTypes[0]
...
func (x *Summary) Reset() {
	*x = Summary{}
	mi := &file_cli_health_v1_validation_validation_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Summary) Descriptor() ([]byte, []int) {
	return file_cli_health_v1_validation_validation_proto_rawDescGZIP(), []int{1}
}
...
func (x *ValidateScenarioRequest) Reset() {
	*x = ValidateScenarioRequest{}
	mi := &file_cli_health_v1_validation_validation_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ValidateScenarioRequest) Descriptor() ([]byte, []int) {
	return file_cli_health_v1_validation_validation_proto_rawDescGZIP(), []int{2}
}
...
func (x *ValidateScenarioResponse) Reset() {
	*x = ValidateScenarioResponse{}
	mi := &file_cli_health_v1_validation_validation_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ValidateScenarioResponse) Descriptor() ([]byte, []int) {
	return file_cli_health_v1_validation_validation_proto_rawDescGZIP(), []int{3}
}
...
const file_cli_health_v1_validation_validation_proto_rawDesc = "" +
	...
	"\rSEVERITY_INFO\x10\x032\x9d\x01\n" +
	"\x11ValidationService\x12\x87\x01\n" +
	"\x10ValidateScenario\x128.vrooli.cli_health.v1.validation.ValidateScenarioRequest\x1a9.vrooli.cli_health.v1.validation.ValidateScenarioResponseBWZUgithub.com/vrooli/vrooli/packages/proto/gen/go/cli-health/v1/validation;validation_v1b\x06proto3"

var (
	file_cli_health_v1_validation_validation_proto_rawDescOnce sync.Once
	file_cli_health_v1_validation_validation_proto_rawDescData []byte
)

func file_cli_health_v1_validation_validation_proto_rawDescGZIP() []byte {
	file_cli_health_v1_validation_validation_proto_rawDescOnce.Do(func() {
		file_cli_health_v1_validation_validation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cli_health_v1_validation_validation_proto_rawDesc), len(file_cli_health_v1_validation_validation_proto_rawDesc)))
	})
	return file_cli_health_v1_validation_validation_proto_rawDescData
}

var file_cli_health_v1_validation_validation_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_cli_health_v1_validation_validation_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_cli_health_v1_validation_validation_proto_goTypes = []any{
	(Severity)(0),                    // 0: vrooli.cli_health.v1.validation.Severity
	(*Finding)(nil),                  // 1: vrooli.cli_health.v1.validation.Finding
...
func file_cli_health_v1_validation_validation_proto_init() {
	if File_cli_health_v1_validation_validation_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cli_health_v1_validation_validation_proto_rawDesc), len(file_cli_health_v1_validation_validation_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_cli_health_v1_validation_validation_proto_goTypes,
		DependencyIndexes: file_cli_health_v1_validation_validation_proto_depIdxs,
		EnumInfos:         file_cli_health_v1_validation_validation_proto_enumTypes,
		MessageInfos:      file_cli_health_v1_validation_validation_proto_msgTypes,
	}.Build()
	File_cli_health_v1_validation_validation_proto = out.File
	file_cli_health_v1_validation_validation_proto_goTypes = nil
	file_cli_health_v1_validation_validation_proto_depIdxs = nil
}
