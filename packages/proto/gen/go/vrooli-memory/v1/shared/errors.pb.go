...
func (x *ErrorEnvelope) Reset() {
	*x = ErrorEnvelope{}
	mi := &file_vrooli_memory_v1_shared_errors_proto_msgTypes[0]
...
var File_vrooli_memory_v1_shared_errors_proto protoreflect.FileDescriptor

const file_vrooli_memory_v1_shared_errors_proto_rawDesc = "" +
	"\n" +
...
var (
	...
	file_vrooli_memory_v1_shared_errors_proto_rawDescData []byte
)

func file_vrooli_memory_v1_shared_errors_proto_rawDescGZIP() []byte {
	file_vrooli_memory_v1_shared_errors_proto_rawDescOnce.Do(func() {
		file_vrooli_memory_v1_shared_errors_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_vrooli_memory_v1_shared_errors_proto_rawDesc), len(file_vrooli_memory_v1_shared_errors_proto_rawDesc)))
	})
...
func init() { file_vrooli_memory_v1_shared_errors_proto_init() }
func file_vrooli_memory_v1_shared_errors_proto_init() {
	if File_vrooli_memory_v1_shared_errors_proto != nil {
		return
	}
	type x struct{}
	...
	file_vrooli_memory_v1_shared_errors_proto_goTypes = nil
	file_vrooli_memory_v1_shared_errors_proto_depIdxs = nil
}
