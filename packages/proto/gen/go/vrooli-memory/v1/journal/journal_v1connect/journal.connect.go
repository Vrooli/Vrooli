...
import (
	...
	context "context"
	errors "errors"
	journal "github.com/vrooli/vrooli/packages/proto/gen/go/vrooli-memory/v1/journal"
	http "net/http"
	strings "strings"
)
...
const (
	...
	JournalServiceName = "vrooli.vrooli_memory.v1.journal.JournalService"
)
...
const (
	...
	// AppendEntry RPC.
	JournalServiceAppendEntryProcedure = "/vrooli.vrooli_memory.v1.journal.JournalService/AppendEntry"
	// JournalServiceGetEntryProcedure is the fully-qualified name of the JournalService's GetEntry RPC.
	JournalServiceGetEntryProcedure = "/vrooli.vrooli_memory.v1.journal.JournalService/GetEntry"
...
// vrooli.vrooli_memory.v1.journal.JournalService service. By default, it uses the Connect protocol
...
func NewJournalServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) JournalServiceClient {
	...
	journalServiceMethods := journal.File_vrooli_memory_v1_journal_journal_proto.Services().ByName("JournalService").Methods()
...
// GetEntry calls vrooli.vrooli_memory.v1.journal.JournalService.GetEntry.
...
// ListEntries calls vrooli.vrooli_memory.v1.journal.JournalService.ListEntries.
...
func (UnimplementedJournalServiceHandler) AppendEntry(context.Context, *connect.Request[journal.AppendEntryRequest]) (*connect.Response[journal.AppendEntryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vrooli.vrooli_memory.v1.journal.JournalService.AppendEntry is not implemented"))
}
...
func (UnimplementedJournalServiceHandler) GetEntry(context.Context, *connect.Request[journal.GetEntryRequest]) (*connect.Response[journal.GetEntryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vrooli.vrooli_memory.v1.journal.JournalService.GetEntry is not implemented"))
}
