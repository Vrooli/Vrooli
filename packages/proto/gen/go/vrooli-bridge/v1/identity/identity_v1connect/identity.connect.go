...
import (
	...
	context "context"
	errors "errors"
	identity "github.com/vrooli/vrooli/packages/proto/gen/go/vrooli-bridge/v1/identity"
	http "net/http"
	strings "strings"
)
...
const (
	...
	IdentityServiceName = "vrooli.vrooli_bridge.v1.identity.IdentityService"
)
...
const (
	...
	IdentityServiceLoginProcedure = "/vrooli.vrooli_bridge.v1.identity.IdentityService/Login"
...
// vrooli.vrooli_bridge.v1.identity.IdentityService service. By default, it uses the Connect
...
func NewIdentityServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) IdentityServiceClient {
	...
	identityServiceMethods := identity.File_vrooli_bridge_v1_identity_identity_proto.Services().ByName("IdentityService").Methods()
...
func (UnimplementedIdentityServiceHandler) Login(context.Context, *connect.Request[identity.LoginRequest]) (*connect.Response[identity.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vrooli.vrooli_bridge.v1.identity.IdentityService.Login is not implemented"))
}
