...
func (x *DependencyStatus) Reset() {
	*x = DependencyStatus{}
	mi := &file_portal_v1_shared_health_proto_msgTypes[0]
...
func (*DependencyStatus) Descriptor() ([]byte, []int) {
	return file_portal_v1_shared_health_proto_rawDescGZIP(), []int{0}
}
...
func (x *Response) Reset() {
	*x = Response{}
	mi := &file_portal_v1_shared_health_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return file_portal_v1_shared_health_proto_rawDescGZIP(), []int{1}
}
...
const file_portal_v1_shared_health_proto_rawDesc = "" +
	"\n" +
	"\x1dportal/v1/shared/health.proto\x12\x17vrooli.portal.v1.shared\"\x81\x01\n" +
	...
	"\bdatabase\x18\x04 \x01(\tR\bdatabase\"\xfe\x02\n" +
	"\bResponse\x12\x16\n" +
	...
	"\x0euptime_seconds\x18\x06 \x01(\x01R\ruptimeSeconds\x12W\n" +
...
var (
	...
	file_portal_v1_shared_health_proto_rawDescData []byte
)

func file_portal_v1_shared_health_proto_rawDescGZIP() []byte {
	file_portal_v1_shared_health_proto_rawDescOnce.Do(func() {
		file_portal_v1_shared_health_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_portal_v1_shared_health_proto_rawDesc), len(file_portal_v1_shared_health_proto_rawDesc)))
	})
...
func init() { file_portal_v1_shared_health_proto_init() }
func file_portal_v1_shared_health_proto_init() {
	if File_portal_v1_shared_health_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		MessageInfos:      file_portal_v1_shared_health_proto_msgTypes,
	}.Build()
	File_portal_v1_shared_health_proto = out.File
	file_portal_v1_shared_health_proto_goTypes = nil
	file_portal_v1_shared_health_proto_depIdxs = nil
}
