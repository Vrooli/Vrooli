...
// 	protoc        (unknown)
// source: proto-health/v1/health/health.proto
...
func (x *DependencyStatus) Reset() {
	*x = DependencyStatus{}
	mi := &file_proto_health_v1_health_health_proto_msgTypes[0]
...
func (*DependencyStatus) Descriptor() ([]byte, []int) {
	return file_proto_health_v1_health_health_proto_rawDescGZIP(), []int{0}
}
...
func (x *Response) Reset() {
	*x = Response{}
	mi := &file_proto_health_v1_health_health_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return file_proto_health_v1_health_health_proto_rawDescGZIP(), []int{1}
}
...
var (
	file_proto_health_v1_health_health_proto_rawDescOnce sync.Once
	file_proto_health_v1_health_health_proto_rawDescData []byte
)

func file_proto_health_v1_health_health_proto_rawDescGZIP() []byte {
	file_proto_health_v1_health_health_proto_rawDescOnce.Do(func() {
		file_proto_health_v1_health_health_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_health_v1_health_health_proto_rawDesc), len(file_proto_health_v1_health_health_proto_rawDesc)))
	})
	return file_proto_health_v1_health_health_proto_rawDescData
}

var file_proto_health_v1_health_health_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_health_v1_health_health_proto_goTypes = []any{
	(*DependencyStatus)(nil), // 0: vrooli.proto_health.v1.health.DependencyStatus
	(*Response)(nil),         // 1: vrooli.proto_health.v1.health.Response
	nil,                      // 2: vrooli.proto_health.v1.health.Response.DependenciesEntry
}
var file_proto_health_v1_health_health_proto_depIdxs = []int32{
	2, // 0: vrooli.proto_health.v1.health.Response.dependencies:type_name -> vrooli.proto_health.v1.health.Response.DependenciesEntry
	0, // 1: vrooli.proto_health.v1.health.Response.DependenciesEntry.value:type_name -> vrooli.proto_health.v1.health.DependencyStatus
...
func init() { file_proto_health_v1_health_health_proto_init() }
func file_proto_health_v1_health_health_proto_init() {
	if File_proto_health_v1_health_health_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_health_v1_health_health_proto_rawDesc), len(file_proto_health_v1_health_health_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_health_v1_health_health_proto_goTypes,
		DependencyIndexes: file_proto_health_v1_health_health_proto_depIdxs,
		MessageInfos:      file_proto_health_v1_health_health_proto_msgTypes,
	}.Build()
	File_proto_health_v1_health_health_proto = out.File
	file_proto_health_v1_health_health_proto_goTypes = nil
	file_proto_health_v1_health_health_proto_depIdxs = nil
}
