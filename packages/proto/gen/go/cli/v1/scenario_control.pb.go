...
func (x *RestartScenarioRequest) GetForceLifecycle() bool {
	if x != nil {
		return x.ForceLifecycle
	}
	return false
}

func (x *RestartScenarioRequest) GetLifecycleOverrideReason() string {
	if x != nil {
		return x.LifecycleOverrideReason
	}
	return ""
}
