...
class ScenarioListResponse(_message.Message):
    ...
    def __init__(self, success: _Optional[bool] = ..., summary: _Optional[_Union[ScenarioListSummary, _Mapping]] = ..., scenarios: _Optional[_Iterable[_Union[Scenario, _Mapping]]] = ..., discovery_failures: _Optional[_Iterable[_Union[_common_pb2.DiscoveryFailure, _Mapping]]] = ...) -> None: ...
...
class Scenario(_message.Message):
    __slots__ = ("name", "description", "version", "status", "tags", "path", "ports")
    ...
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., version: _Optional[str] = ..., status: _Optional[str] = ..., tags: _Optional[_Iterable[str]] = ..., path: _Optional[str] = ..., ports: _Optional[_Iterable[_Union[ScenarioPort, _Mapping]]] = ...) -> None: ...
