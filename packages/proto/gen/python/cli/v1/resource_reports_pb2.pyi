...
class ResourceTemplateListResponse(_message.Message):
    __slots__ = ("success", "templates")
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    TEMPLATES_FIELD_NUMBER: _ClassVar[int]
    success: bool
    templates: _containers.RepeatedCompositeFieldContainer[ResourceTemplateInfo]
    def __init__(self, success: _Optional[bool] = ..., templates: _Optional[_Iterable[_Union[ResourceTemplateInfo, _Mapping]]] = ...) -> None: ...

class ResourceTemplateShowResponse(_message.Message):
    __slots__ = ("success", "template")
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    TEMPLATE_FIELD_NUMBER: _ClassVar[int]
    success: bool
    template: ResourceTemplateInfo
    def __init__(self, success: _Optional[bool] = ..., template: _Optional[_Union[ResourceTemplateInfo, _Mapping]] = ...) -> None: ...

class ResourceTemplateValidationResponse(_message.Message):
    __slots__ = ("success", "report")
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    REPORT_FIELD_NUMBER: _ClassVar[int]
    success: bool
    report: ResourceTemplateValidationReport
    def __init__(self, success: _Optional[bool] = ..., report: _Optional[_Union[ResourceTemplateValidationReport, _Mapping]] = ...) -> None: ...

class ResourceTemplateValidationReport(_message.Message):
    __slots__ = ("templates", "count")
    TEMPLATES_FIELD_NUMBER: _ClassVar[int]
    COUNT_FIELD_NUMBER: _ClassVar[int]
    templates: _containers.RepeatedCompositeFieldContainer[ResourceTemplateSummary]
    count: int
    def __init__(self, templates: _Optional[_Iterable[_Union[ResourceTemplateSummary, _Mapping]]] = ..., count: _Optional[int] = ...) -> None: ...

class ResourceTemplateGenerateResponse(_message.Message):
    __slots__ = ("success", "report")
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    REPORT_FIELD_NUMBER: _ClassVar[int]
    success: bool
    report: ResourceTemplateGenerateReport
    def __init__(self, success: _Optional[bool] = ..., report: _Optional[_Union[ResourceTemplateGenerateReport, _Mapping]] = ...) -> None: ...

class ResourceTemplateGenerateReport(_message.Message):
