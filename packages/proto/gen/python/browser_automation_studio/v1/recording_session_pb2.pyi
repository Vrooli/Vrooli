...
class GetActionsResponse(_message.Message):
    ...
    session_id: str
    entries: _containers.RepeatedCompositeFieldContainer[_timeline_entry_pb2.TimelineEntry]
    count: int
    def __init__(self, session_id: _Optional[str] = ..., entries: _Optional[_Iterable[_Union[_timeline_entry_pb2.TimelineEntry, _Mapping]]] = ..., count: _Optional[int] = ...) -> None: ...
...
class GenerateWorkflowRequest(_message.Message):
    ...
    entries: _containers.RepeatedCompositeFieldContainer[_timeline_entry_pb2.TimelineEntry]
    def __init__(self, session_id: _Optional[str] = ..., name: _Optional[str] = ..., project_id: _Optional[str] = ..., project_name: _Optional[str] = ..., entry_range: _Optional[_Union[GenerateWorkflowRequest.EntryRange, _Mapping]] = ..., entries: _Optional[_Iterable[_Union[_timeline_entry_pb2.TimelineEntry, _Mapping]]] = ...) -> None: ...
...
class ReplayPreviewRequest(_message.Message):
    ...
    def __init__(self, session_id: _Optional[str] = ..., entries: _Optional[_Iterable[_Union[_timeline_entry_pb2.TimelineEntry, _Mapping]]] = ..., limit: _Optional[int] = ..., stop_on_failure: _Optional[bool] = ..., action_timeout_ms: _Optional[int] = ...) -> None: ...
