...
class ExecutionTimeline(_message.Message):
    ...
    logs: _containers.RepeatedCompositeFieldContainer[_timeline_entry_pb2.TimelineLog]
    def __init__(self, execution_id: _Optional[str] = ..., workflow_id: _Optional[str] = ..., status: _Optional[_Union[_shared_pb2.ExecutionStatus, str]] = ..., progress: _Optional[int] = ..., started_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., completed_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., entries: _Optional[_Iterable[_Union[_timeline_entry_pb2.TimelineEntry, _Mapping]]] = ..., logs: _Optional[_Iterable[_Union[_timeline_entry_pb2.TimelineLog, _Mapping]]] = ...) -> None: ...
