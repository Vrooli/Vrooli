...
class Node(_message.Message):
    __slots__ = ("id", "entry_id", "facet_id", "depth", "child_ids")
    ...
    def __init__(self, id: _Optional[str] = ..., entry_id: _Optional[str] = ..., facet_id: _Optional[str] = ..., depth: _Optional[int] = ..., child_ids: _Optional[_Iterable[str]] = ...) -> None: ...
