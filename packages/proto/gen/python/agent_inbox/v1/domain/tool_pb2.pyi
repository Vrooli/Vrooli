...
class ToolDefinition(_message.Message):
    __slots__ = ("name", "description", "category", "parameters", "metadata")
...
class ToolParameters(_message.Message):
    __slots__ = ("type", "properties", "required", "additional_properties")
...
class ParameterSchema(_message.Message):
    __slots__ = ("type", "description", "enum", "default", "items", "properties", "required", "format", "minimum", "maximum", "min_length", "max_length", "pattern")
    class PropertiesEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class ToolMetadata(_message.Message):
    __slots__ = ("enabled_by_default", "requires_approval", "timeout_seconds", "rate_limit_per_minute", "cost_estimate", "long_running", "idempotent", "tags", "examples", "async_behavior", "modifies_state", "sensitive_output", "internal_only")
    ...
    INTERNAL_ONLY_FIELD_NUMBER: _ClassVar[int]
...
class AsyncBehavior(_message.Message):
    __slots__ = ("status_polling", "completion_conditions", "progress_tracking", "cancellation")
...
class StatusPolling(_message.Message):
    __slots__ = ("status_tool", "operation_id_field", "status_tool_id_param", "poll_interval_seconds", "max_poll_duration_seconds", "backoff")
...
class PollingBackoff(_message.Message):
    __slots__ = ("initial_interval_seconds", "max_interval_seconds", "multiplier")
...
class CompletionConditions(_message.Message):
    __slots__ = ("status_field", "success_values", "failure_values", "pending_values", "error_field", "error_details_field", "result_field")
...
class ProgressTracking(_message.Message):
    __slots__ = ("progress_field", "message_field", "phase_field", "current_step_field", "total_steps_field", "estimated_remaining_field")
...
class CancellationBehavior(_message.Message):
    __slots__ = ("cancel_tool", "cancel_tool_id_param", "graceful", "cancel_timeout_seconds")
...
class ToolCategory(_message.Message):
    __slots__ = ("id", "name", "description", "icon", "display_order")
