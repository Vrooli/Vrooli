...
class Message(_message.Message):
    __slots__ = ("id", "chat_id", "parent_message_id", "sibling_index", "role", "content", "model", "created_at", "updated_at", "search_attachments", "context_document_ids", "brief_id")
