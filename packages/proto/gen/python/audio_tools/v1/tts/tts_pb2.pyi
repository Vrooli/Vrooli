...
class SynthesizeRequest(_message.Message):
    ...
    version: str
    chunk_index: int
    def __init__(self, text: _Optional[str] = ..., voice: _Optional[str] = ..., voice_overrides: _Optional[_Iterable[_Union[AdapterMapping, _Mapping]]] = ..., speed: _Optional[float] = ..., response_format: _Optional[_Union[_common_pb2.ResponseFormat, str]] = ..., event_id: _Optional[str] = ..., version: _Optional[str] = ..., chunk_index: _Optional[int] = ...) -> None: ...
...
class GetCacheRequest(_message.Message):
    ...
    response_format: _common_pb2.ResponseFormat
    chunk_index: int
    def __init__(self, event_id: _Optional[str] = ..., voice: _Optional[str] = ..., speed: _Optional[float] = ..., version: _Optional[str] = ..., content_hash: _Optional[str] = ..., response_format: _Optional[_Union[_common_pb2.ResponseFormat, str]] = ..., chunk_index: _Optional[int] = ...) -> None: ...
