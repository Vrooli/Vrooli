...
class ProgramEvent(_message.Message):
    __slots__ = ("event_id", "occurred_at", "kind", "program_id", "session_id", "binding_id", "effect", "provenance", "failure_shape", "context_bytes", "reason", "failure_location", "sequence", "shape_key", "shape_binding_ids", "shape_occurrences", "shape_sessions", "dominant_scenario", "covering_contract_id", "program_name", "program_digest", "caller_run_id", "caller_agent_profile", "caller_skill_id", "caller_harness")
