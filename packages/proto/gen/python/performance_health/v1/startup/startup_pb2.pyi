...
class BenchmarkStartupResponse(_message.Message):
    ...
    def __init__(self, measurement: _Optional[_Union[StartupMeasurement, _Mapping]] = ...) -> None: ...

class GetStartupTrendRequest(_message.Message):
...
class GetStartupTrendResponse(_message.Message):
    __slots__ = ("scenario", "measurements")
    SCENARIO_FIELD_NUMBER: _ClassVar[int]
    MEASUREMENTS_FIELD_NUMBER: _ClassVar[int]
    scenario: str
    measurements: _containers.RepeatedCompositeFieldContainer[StartupMeasurement]
    def __init__(self, scenario: _Optional[str] = ..., measurements: _Optional[_Iterable[_Union[StartupMeasurement, _Mapping]]] = ...) -> None: ...

class StartupMeasurement(_message.Message):
