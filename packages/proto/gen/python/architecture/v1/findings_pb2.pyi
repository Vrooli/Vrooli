...
class ArchitectureFinding(_message.Message):
    __slots__ = ("scenario", "source", "code", "severity", "locations", "domains", "message", "suggestion", "stable_id", "evidence", "suggested_fixes")
    ...
    def __init__(self, scenario: _Optional[str] = ..., source: _Optional[_Union[FindingSource, str]] = ..., code: _Optional[str] = ..., severity: _Optional[_Union[FindingSeverity, str]] = ..., locations: _Optional[_Iterable[str]] = ..., domains: _Optional[_Iterable[str]] = ..., message: _Optional[str] = ..., suggestion: _Optional[str] = ..., stable_id: _Optional[str] = ..., evidence: _Optional[_Iterable[_Union[Evidence, _Mapping]]] = ..., suggested_fixes: _Optional[_Iterable[_Union[SuggestedFix, _Mapping]]] = ...) -> None: ...
