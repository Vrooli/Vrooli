...
class AgentProfile(_message.Message):
    __slots__ = ("id", "name", "profile_key", "description", "runner_type", "model", "model_preset", "max_turns", "timeout", "fallback_runner_types", "allowed_tools", "denied_tools", "skip_permission_prompt", "features", "extra_flags", "requires_sandbox", "requires_approval", "sandbox_config", "allowed_paths", "denied_paths", "created_by", "created_at", "updated_at")
    ...
    FALLBACK_RUNNER_TYPES_FIELD_NUMBER: _ClassVar[int]
    ...
    model: str
    model_preset: _types_pb2.ModelPreset
    max_turns: int
    timeout: _duration_pb2.Duration
    fallback_runner_types: _containers.RepeatedScalarFieldContainer[_types_pb2.RunnerType]
...
class RunConfigOverrides(_message.Message):
    ...
    CLEAR_FALLBACK_RUNNER_TYPES_FIELD_NUMBER: _ClassVar[int]
    runner_type: _types_pb2.RunnerType
    model: str
    model_preset: _types_pb2.ModelPreset
    max_turns: int
