...
class LadderCell(_message.Message):
    __slots__ = ("device_class", "rung", "host_os", "key", "cell_ref", "question", "status", "status_source", "observation", "reason", "mechanism", "remediation", "blocked_by", "trust", "unavailable_reason", "device_count", "blind_devices", "bar_id", "graded", "ungraded_reason", "band", "provisional", "capability", "capability_status", "capability_reason", "observed_at")
...
class SourceState(_message.Message):
    __slots__ = ("id", "available", "reason", "checked_at")
    ...
    def __init__(self, id: _Optional[str] = ..., available: _Optional[bool] = ..., reason: _Optional[str] = ..., checked_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class Ladder(_message.Message):
    __slots__ = ("cells", "sources", "findings", "host_os", "coverage_available", "coverage_reason", "check_platforms", "computed_at")
    ...
    def __init__(self, cells: _Optional[_Iterable[_Union[LadderCell, _Mapping]]] = ..., sources: _Optional[_Iterable[_Union[SourceState, _Mapping]]] = ..., findings: _Optional[_Iterable[_Union[RankedFinding, _Mapping]]] = ..., host_os: _Optional[str] = ..., coverage_available: _Optional[bool] = ..., coverage_reason: _Optional[str] = ..., check_platforms: _Optional[_Iterable[_Union[CheckPlatformCoverage, _Mapping]]] = ..., computed_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class ListSourcesResponse(_message.Message):
    __slots__ = ("sources", "check_platforms", "computed_at")
    SOURCES_FIELD_NUMBER: _ClassVar[int]
    CHECK_PLATFORMS_FIELD_NUMBER: _ClassVar[int]
    COMPUTED_AT_FIELD_NUMBER: _ClassVar[int]
    sources: _containers.RepeatedCompositeFieldContainer[SourceState]
    check_platforms: _containers.RepeatedCompositeFieldContainer[CheckPlatformCoverage]
    computed_at: _timestamp_pb2.Timestamp
    def __init__(self, sources: _Optional[_Iterable[_Union[SourceState, _Mapping]]] = ..., check_platforms: _Optional[_Iterable[_Union[CheckPlatformCoverage, _Mapping]]] = ..., computed_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
