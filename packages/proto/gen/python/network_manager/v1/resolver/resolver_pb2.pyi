...
class ResolverStatus(_message.Message):
    __slots__ = ("backend", "status", "base_url", "upstreams", "filtering_enabled", "warnings")
    ...
    def __init__(self, backend: _Optional[str] = ..., status: _Optional[str] = ..., base_url: _Optional[str] = ..., upstreams: _Optional[_Iterable[str]] = ..., filtering_enabled: _Optional[bool] = ..., warnings: _Optional[_Iterable[str]] = ...) -> None: ...
