...
class GenerateReportResponse(_message.Message):
    ...
    def __init__(self, report: _Optional[_Union[EnhancedSystemReport, _Mapping]] = ...) -> None: ...
...
class ListReportsResponse(_message.Message):
    ...
    reports: _containers.RepeatedCompositeFieldContainer[EnhancedSystemReport]
    count: int
    def __init__(self, reports: _Optional[_Iterable[_Union[EnhancedSystemReport, _Mapping]]] = ..., count: _Optional[int] = ...) -> None: ...
