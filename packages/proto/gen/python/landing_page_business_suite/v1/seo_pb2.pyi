...
class UpdateVariantSEORequest(_message.Message):
    ...
    slug: str
    config: _presentation_pb2.VariantSEOConfig
    def __init__(self, slug: _Optional[str] = ..., config: _Optional[_Union[_presentation_pb2.VariantSEOConfig, _Mapping]] = ...) -> None: ...
