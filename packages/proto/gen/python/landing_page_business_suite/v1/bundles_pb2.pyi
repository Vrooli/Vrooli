...
class BundleCatalogEntry(_message.Message):
    ...
    bundle: _commerce_pb2.Bundle
    prices: _containers.RepeatedCompositeFieldContainer[_commerce_pb2.PlanOption]
    def __init__(self, bundle: _Optional[_Union[_commerce_pb2.Bundle, _Mapping]] = ..., prices: _Optional[_Iterable[_Union[_commerce_pb2.PlanOption, _Mapping]]] = ...) -> None: ...
...
class UpdateBundlePriceResponse(_message.Message):
    ...
    price: _commerce_pb2.PlanOption
    def __init__(self, price: _Optional[_Union[_commerce_pb2.PlanOption, _Mapping]] = ...) -> None: ...
