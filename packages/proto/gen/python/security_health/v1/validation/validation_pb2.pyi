...
class ValidateScenarioResponse(_message.Message):
    __slots__ = ("scenario", "passed", "findings", "summary", "skipped_scanners")
    SCENARIO_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, scenario: _Optional[str] = ..., passed: _Optional[bool] = ..., findings: _Optional[_Iterable[_Union[Finding, _Mapping]]] = ..., summary: _Optional[_Union[Summary, _Mapping]] = ..., skipped_scanners: _Optional[_Iterable[str]] = ...) -> None: ...
