...
class AuthorizeDownloadResponse(_message.Message):
    ...
    asset: DownloadAsset
    def __init__(self, asset: _Optional[_Union[DownloadAsset, _Mapping]] = ...) -> None: ...
...
class ListDownloadAppsResponse(_message.Message):
    ...
    apps: _containers.RepeatedCompositeFieldContainer[DownloadApp]
    def __init__(self, apps: _Optional[_Iterable[_Union[DownloadApp, _Mapping]]] = ...) -> None: ...
...
class SaveDownloadAppRequest(_message.Message):
    ...
    app_key: str
    app: DownloadApp
    def __init__(self, app_key: _Optional[str] = ..., app: _Optional[_Union[DownloadApp, _Mapping]] = ...) -> None: ...

class CreateDownloadAppRequest(_message.Message):
    __slots__ = ("app",)
    APP_FIELD_NUMBER: _ClassVar[int]
    app: DownloadApp
    def __init__(self, app: _Optional[_Union[DownloadApp, _Mapping]] = ...) -> None: ...
