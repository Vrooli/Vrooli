...
from landing_page_react_vite.v1 import download_pb2 as _download_pb2
...
class LandingConfigResponse(_message.Message):
    ...
    pricing: _pricing_pb2.PricingOverview
    downloads: _containers.RepeatedCompositeFieldContainer[_download_pb2.DownloadApp]
    header: _variant_pb2.LandingHeaderConfig
    branding: LandingBranding
    fallback: bool
    def __init__(self, variant: _Optional[_Union[LandingVariantSummary, _Mapping]] = ..., sections: _Optional[_Iterable[_Union[LandingSection, _Mapping]]] = ..., pricing: _Optional[_Union[_pricing_pb2.PricingOverview, _Mapping]] = ..., downloads: _Optional[_Iterable[_Union[_download_pb2.DownloadApp, _Mapping]]] = ..., header: _Optional[_Union[_variant_pb2.LandingHeaderConfig, _Mapping]] = ..., branding: _Optional[_Union[LandingBranding, _Mapping]] = ..., fallback: _Optional[bool] = ...) -> None: ...
