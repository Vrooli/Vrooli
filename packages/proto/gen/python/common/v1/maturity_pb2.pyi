...
class MaturityAssessment(_message.Message):
    __slots__ = ("scenario", "provider", "phase", "version", "local", "findings", "findings_by_global_impact", "findings_by_severity", "recommended_skill_ids", "findings_by_clean_requirement", "autofixable_count", "autofixable_total", "capabilities", "highest_priority_capability")
    class FindingsByGlobalImpactEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
