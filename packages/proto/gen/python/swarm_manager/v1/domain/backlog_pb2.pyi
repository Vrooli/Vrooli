...
class BacklogItem(_message.Message):
    __slots__ = ("name", "title", "description", "status", "priority", "tags", "created", "updated", "kind", "research_target", "depends_on", "initiative", "effort", "acceptance_allow", "acceptance_deny")
