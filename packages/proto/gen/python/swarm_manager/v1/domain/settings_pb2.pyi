...
class RecommendationSources(_message.Message):
...
class RecommendationAutoSync(_message.Message):
...
class Settings(_message.Message):
    ...
    recommendation_auto_sync: RecommendationAutoSync
    def __init__(self, theme: _Optional[str] = ..., recommendation_mode: _Optional[str] = ..., custom_focus: _Optional[str] = ..., insights_enabled: _Optional[bool] = ..., insights_auto_analyze: _Optional[bool] = ..., recommendation_sources: _Optional[_Union[RecommendationSources, _Mapping]] = ..., recommendation_auto_sync: _Optional[_Union[RecommendationAutoSync, _Mapping]] = ...) -> None: ...
