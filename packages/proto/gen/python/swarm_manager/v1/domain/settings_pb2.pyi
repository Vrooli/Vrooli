...
class Settings(_message.Message):
    ...
    class DeleteConfirmationLevelsEntry(_message.Message):
        ...
        key: str
        value: DeleteConfirmLevel
        def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[DeleteConfirmLevel, str]] = ...) -> None: ...
    ...
    delete_confirmation_levels: _containers.ScalarMap[str, DeleteConfirmLevel]
