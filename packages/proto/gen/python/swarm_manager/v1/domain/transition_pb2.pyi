...
class ExecutionMode(_message.Message):
...
class Transition(_message.Message):
    __slots__ = ("key", "subject", "kind", "workflow", "requires", "input_contract", "terminal_outcomes", "apply_action", "execution_modes", "human_gates", "human_wait")
    KEY_FIELD_NUMBER: _ClassVar[int]
    ...
    apply_action: str
    execution_modes: _containers.RepeatedCompositeFieldContainer[ExecutionMode]
    human_gates: _containers.RepeatedCompositeFieldContainer[HumanGate]
    human_wait: bool
    def __init__(self, key: _Optional[str] = ..., subject: _Optional[str] = ..., kind: _Optional[_Union[TransitionKind, str]] = ..., workflow: _Optional[_Union[WorkflowLocator, _Mapping]] = ..., requires: _Optional[_Iterable[str]] = ..., input_contract: _Optional[str] = ..., terminal_outcomes: _Optional[_Iterable[str]] = ..., apply_action: _Optional[str] = ..., execution_modes: _Optional[_Iterable[_Union[ExecutionMode, _Mapping]]] = ..., human_gates: _Optional[_Iterable[_Union[HumanGate, _Mapping]]] = ..., human_wait: _Optional[bool] = ...) -> None: ...
