...
class AgentSessionMessage(_message.Message):
    __slots__ = ("id", "role", "content", "created_at", "attachment_ids")
    ...
    def __init__(self, id: _Optional[str] = ..., role: _Optional[str] = ..., content: _Optional[str] = ..., created_at: _Optional[str] = ..., attachment_ids: _Optional[_Iterable[str]] = ...) -> None: ...
...
class AgentSession(_message.Message):
    __slots__ = ("id", "title", "kind", "status", "skill_id", "task_id", "run_id", "profile_key", "failure_reason", "created_at", "updated_at", "messages", "proposals", "artifacts", "created_by")
    ID_FIELD_NUMBER: _ClassVar[int]
    TITLE_FIELD_NUMBER: _ClassVar[int]
    KIND_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
