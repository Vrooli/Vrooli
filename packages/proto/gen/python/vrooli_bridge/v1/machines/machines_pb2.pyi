...
class Machine(_message.Message):
    __slots__ = ("id", "lifecycle", "version", "desired_profile_id", "desired_profile_version", "locators", "node_lineage", "created_at", "updated_at", "archived_at", "removed_at")
...
class GetMachineResponse(_message.Message):
    __slots__ = ("machine", "enrollment_attempts", "current_node", "audit_events", "readiness", "cleanup_tombstones")
    MACHINE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, machine: _Optional[_Union[Machine, _Mapping]] = ..., enrollment_attempts: _Optional[_Iterable[_Union[EnrollmentAttempt, _Mapping]]] = ..., current_node: _Optional[_Union[CurrentNodeProjection, _Mapping]] = ..., audit_events: _Optional[_Iterable[_Union[MachineAuditEvent, _Mapping]]] = ..., readiness: _Optional[_Union[MachineReadiness, _Mapping]] = ..., cleanup_tombstones: _Optional[_Iterable[_Union[MachineCleanup, _Mapping]]] = ...) -> None: ...
...
class EffectivePolicy(_message.Message):
    __slots__ = ("profile_id", "profile_version", "setup_environment", "suggested_scopes", "required_capabilities", "snapshot_json")
    ...
    snapshot_json: str
    def __init__(self, profile_id: _Optional[str] = ..., profile_version: _Optional[str] = ..., setup_environment: _Optional[str] = ..., suggested_scopes: _Optional[_Iterable[str]] = ..., required_capabilities: _Optional[_Iterable[str]] = ..., snapshot_json: _Optional[str] = ...) -> None: ...
