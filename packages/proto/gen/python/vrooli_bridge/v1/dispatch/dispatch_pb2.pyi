...
class DispatchJobRequest(_message.Message):
    __slots__ = ("node_id", "scenario", "verb", "args", "timeout_seconds", "device_id", "lease_token")
    ...
    device_id: str
    lease_token: str
    def __init__(self, node_id: _Optional[str] = ..., scenario: _Optional[str] = ..., verb: _Optional[str] = ..., args: _Optional[_Iterable[str]] = ..., timeout_seconds: _Optional[int] = ..., device_id: _Optional[str] = ..., lease_token: _Optional[str] = ...) -> None: ...
