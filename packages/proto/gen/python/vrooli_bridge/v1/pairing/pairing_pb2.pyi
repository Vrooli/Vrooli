...
class RedeemPairingCodeRequest(_message.Message):
    __slots__ = ("code", "node_public_key", "name", "os", "arch", "endpoint", "capabilities", "machine_arch", "binary_arch")
    CODE_FIELD_NUMBER: _ClassVar[int]
    ...
    machine_arch: str
    binary_arch: str
    def __init__(self, code: _Optional[str] = ..., node_public_key: _Optional[str] = ..., name: _Optional[str] = ..., os: _Optional[str] = ..., arch: _Optional[str] = ..., endpoint: _Optional[str] = ..., capabilities: _Optional[_Iterable[str]] = ..., machine_arch: _Optional[str] = ..., binary_arch: _Optional[str] = ...) -> None: ...
...
class RequestPairingRequest(_message.Message):
    __slots__ = ("node_public_key", "name", "os", "arch", "endpoint", "capabilities", "machine_arch", "binary_arch")
    NODE_PUBLIC_KEY_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    OS_FIELD_NUMBER: _ClassVar[int]
    ARCH_FIELD_NUMBER: _ClassVar[int]
    ...
    machine_arch: str
    binary_arch: str
    def __init__(self, node_public_key: _Optional[str] = ..., name: _Optional[str] = ..., os: _Optional[str] = ..., arch: _Optional[str] = ..., endpoint: _Optional[str] = ..., capabilities: _Optional[_Iterable[str]] = ..., machine_arch: _Optional[str] = ..., binary_arch: _Optional[str] = ...) -> None: ...
...
class PairingRequest(_message.Message):
    __slots__ = ("id", "name", "os", "arch", "endpoint", "capabilities", "status", "created_at", "decided_at", "node_id", "confirmation_words", "key_fingerprint", "machine_arch", "binary_arch")
