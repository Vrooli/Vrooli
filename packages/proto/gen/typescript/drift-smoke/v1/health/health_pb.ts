...
// @generated from file drift-smoke/v1/health/health.proto (package vrooli.drift_smoke.v1.health, syntax proto3)
/* eslint-disable */
...
/**
 * Describes the file drift-smoke/v1/health/health.proto.
 */
export const file_drift_smoke_v1_health_health: GenFile = /*@__PURE__*/
  fileDesc("");

/**
 * DependencyStatus mirrors api-core/health.DependencyStatus. Reported
 * per-dependency from the /health endpoint.
 *
 * @generated from message vrooli.drift_smoke.v1.health.DependencyStatus
 */
export type DependencyStatus = Message<"vrooli.drift_smoke.v1.health.DependencyStatus"> & {
  /**
...
/**
 * Describes the message vrooli.drift_smoke.v1.health.DependencyStatus.
...
export const DependencyStatusSchema: GenMessage<DependencyStatus> = /*@__PURE__*/
  messageDesc(file_drift_smoke_v1_health_health, 0);
 ...
 *
 * @generated from message vrooli.drift_smoke.v1.health.Response
 */
export type Response = Message<"vrooli.drift_smoke.v1.health.Response"> & {
  /**
   ...
   *
   * @generated from field: map<string, vrooli.drift_smoke.v1.health.DependencyStatus> dependencies = 7;
   */
  dependencies: { [key: string]: DependencyStatus };
};

/**
 * Describes the message vrooli.drift_smoke.v1.health.Response.
 * Use `create(ResponseSchema)` to create a new message.
 */
export const ResponseSchema: GenMessage<Response> = /*@__PURE__*/
  messageDesc(file_drift_smoke_v1_health_health, 1);
