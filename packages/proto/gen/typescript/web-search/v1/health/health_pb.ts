 ...
 */
export const file_web_search_v1_health_health: GenFile = /*@__PURE__*/
 ...
 *
 * @generated from message vrooli.web_search.v1.health.DependencyStatus
 */
export type DependencyStatus = Message<"vrooli.web_search.v1.health.DependencyStatus"> & {
  /**
 ...
 *
 * @generated from message vrooli.web_search.v1.health.Response
 */
export type Response = Message<"vrooli.web_search.v1.health.Response"> & {
  /**
   ...
   *
   * @generated from field: map<string, vrooli.web_search.v1.health.DependencyStatus> dependencies = 7;
   */
