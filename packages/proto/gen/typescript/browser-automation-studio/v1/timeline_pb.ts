...
import type { ArtifactType, ExecutionStatus, JsonValue, LogLevel, StepStatus, StepType } from "./shared_pb";
...
export type TimelineFrame = Message<"browser_automation_studio.v1.TimelineFrame"> & {
   ...
   *
   * @generated from field: browser_automation_studio.v1.JsonValue extracted_data_preview_typed = 34;
   */
...
export type TimelineArtifact = Message<"browser_automation_studio.v1.TimelineArtifact"> & {
   ...
   *
   * @generated from field: map<string, browser_automation_studio.v1.JsonValue> payload_typed = 10;
   */
