 ...
 */
export const file_ui_health_v1_health_health: GenFile = /*@__PURE__*/
 ...
 *
 * @generated from message vrooli.ui_health.v1.health.DependencyStatus
 */
export type DependencyStatus = Message<"vrooli.ui_health.v1.health.DependencyStatus"> & {
  /**
 ...
 *
 * @generated from message vrooli.ui_health.v1.health.Response
 */
export type Response = Message<"vrooli.ui_health.v1.health.Response"> & {
  /**
   ...
   *
   * @generated from field: map<string, vrooli.ui_health.v1.health.DependencyStatus> dependencies = 7;
   */
