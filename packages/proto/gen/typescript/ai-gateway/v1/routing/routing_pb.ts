...
import type { AppliedSettings, GatewayRequest, Modality, PrivacyClass, Profile, RequestKind, SamplingSupport, ValidationIssue } from "../shared/gateway_pb";
...
export type RouteEvidence = Message<"vrooli.ai_gateway.v1.routing.RouteEvidence"> & {
   ...
   *
   * @generated from field: optional double sampling_temperature = 35;
   */
  samplingTemperature?: number | undefined;

  /**
   * @generated from field: vrooli.ai_gateway.v1.shared.SamplingSupport sampling_temperature_support = 36;
   */
  samplingTemperatureSupport: SamplingSupport;
};
...
export type ExecuteRouteResponse = Message<"vrooli.ai_gateway.v1.routing.ExecuteRouteResponse"> & {
   ...
   *
   * @generated from field: vrooli.ai_gateway.v1.shared.AppliedSettings applied = 6;
   */
