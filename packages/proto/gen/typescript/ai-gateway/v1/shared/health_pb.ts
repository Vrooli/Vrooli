 ...
 */
export const file_ai_gateway_v1_shared_health: GenFile = /*@__PURE__*/
 ...
 *
 * @generated from message vrooli.ai_gateway.v1.shared.DependencyStatus
 */
export type DependencyStatus = Message<"vrooli.ai_gateway.v1.shared.DependencyStatus"> & {
  /**
 ...
 *
 * @generated from message vrooli.ai_gateway.v1.shared.Response
 */
export type Response = Message<"vrooli.ai_gateway.v1.shared.Response"> & {
  /**
   ...
   *
   * @generated from field: map<string, vrooli.ai_gateway.v1.shared.DependencyStatus> dependencies = 7;
   */
