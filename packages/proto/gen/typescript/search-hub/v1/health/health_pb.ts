 ...
 */
export const file_search_hub_v1_health_health: GenFile = /*@__PURE__*/
 ...
 *
 * @generated from message vrooli.search_hub.v1.health.DependencyStatus
 */
export type DependencyStatus = Message<"vrooli.search_hub.v1.health.DependencyStatus"> & {
  /**
 ...
 *
 * @generated from message vrooli.search_hub.v1.health.Response
 */
export type Response = Message<"vrooli.search_hub.v1.health.Response"> & {
  /**
   ...
   *
   * @generated from field: map<string, vrooli.search_hub.v1.health.DependencyStatus> dependencies = 7;
   */
