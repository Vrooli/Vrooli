 ...
 */
export const file_cli_health_v1_health_health: GenFile = /*@__PURE__*/
 ...
 *
 * @generated from message vrooli.cli_health.v1.health.DependencyStatus
 */
export type DependencyStatus = Message<"vrooli.cli_health.v1.health.DependencyStatus"> & {
  /**
 ...
 *
 * @generated from message vrooli.cli_health.v1.health.Response
 */
export type Response = Message<"vrooli.cli_health.v1.health.Response"> & {
  /**
   ...
   *
   * @generated from field: map<string, vrooli.cli_health.v1.health.DependencyStatus> dependencies = 7;
   */
