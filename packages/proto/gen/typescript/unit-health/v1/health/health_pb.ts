 ...
 */
export const file_unit_health_v1_health_health: GenFile = /*@__PURE__*/
 ...
 *
 * @generated from message vrooli.unit_health.v1.health.DependencyStatus
 */
export type DependencyStatus = Message<"vrooli.unit_health.v1.health.DependencyStatus"> & {
  /**
 ...
 *
 * @generated from message vrooli.unit_health.v1.health.Response
 */
export type Response = Message<"vrooli.unit_health.v1.health.Response"> & {
  /**
   ...
   *
   * @generated from field: map<string, vrooli.unit_health.v1.health.DependencyStatus> dependencies = 7;
   */
