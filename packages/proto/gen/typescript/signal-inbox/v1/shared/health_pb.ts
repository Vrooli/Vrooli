 ...
 */
export const file_signal_inbox_v1_shared_health: GenFile = /*@__PURE__*/
 ...
 *
 * @generated from message vrooli.signal_inbox.v1.shared.DependencyStatus
 */
export type DependencyStatus = Message<"vrooli.signal_inbox.v1.shared.DependencyStatus"> & {
  /**
 ...
 *
 * @generated from message vrooli.signal_inbox.v1.shared.Response
 */
export type Response = Message<"vrooli.signal_inbox.v1.shared.Response"> & {
  /**
   ...
   *
   * @generated from field: map<string, vrooli.signal_inbox.v1.shared.DependencyStatus> dependencies = 7;
   */
