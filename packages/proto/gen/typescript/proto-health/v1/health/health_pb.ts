 ...
 */
export type DependencyStatus = Message<"vrooli.proto_health.v1.health.DependencyStatus"> & {
  /**
 ...
 */
export type Response = Message<"vrooli.proto_health.v1.health.Response"> & {
  /**
