 ...
 */
export const file_plan_manager_v1_shared_health: GenFile = /*@__PURE__*/
 ...
 *
 * @generated from message vrooli.plan_manager.v1.shared.DependencyStatus
 */
export type DependencyStatus = Message<"vrooli.plan_manager.v1.shared.DependencyStatus"> & {
  /**
 ...
 *
 * @generated from message vrooli.plan_manager.v1.shared.Response
 */
export type Response = Message<"vrooli.plan_manager.v1.shared.Response"> & {
  /**
   ...
   *
   * @generated from field: map<string, vrooli.plan_manager.v1.shared.DependencyStatus> dependencies = 7;
   */
