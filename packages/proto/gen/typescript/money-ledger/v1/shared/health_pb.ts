...
// @generated from file money-ledger/v1/shared/health.proto (package vrooli.money_ledger.v1.shared, syntax proto3)
/* eslint-disable */
...
/**
 * Describes the file money-ledger/v1/shared/health.proto.
 */
export const file_money_ledger_v1_shared_health: GenFile = /*@__PURE__*/
  fileDesc("");

/**
 * DependencyStatus mirrors api-core/health.DependencyStatus. Reported
 * per-dependency from the /health endpoint.
 *
 * @generated from message vrooli.money_ledger.v1.shared.DependencyStatus
 */
export type DependencyStatus = Message<"vrooli.money_ledger.v1.shared.DependencyStatus"> & {
  /**
...
/**
 * Describes the message vrooli.money_ledger.v1.shared.DependencyStatus.
...
export const DependencyStatusSchema: GenMessage<DependencyStatus> = /*@__PURE__*/
  messageDesc(file_money_ledger_v1_shared_health, 0);
 ...
 *
 * @generated from message vrooli.money_ledger.v1.shared.Response
 */
export type Response = Message<"vrooli.money_ledger.v1.shared.Response"> & {
  /**
   ...
   *
   * @generated from field: map<string, vrooli.money_ledger.v1.shared.DependencyStatus> dependencies = 7;
   */
  dependencies: { [key: string]: DependencyStatus };
};

/**
 * Describes the message vrooli.money_ledger.v1.shared.Response.
 * Use `create(ResponseSchema)` to create a new message.
 */
export const ResponseSchema: GenMessage<Response> = /*@__PURE__*/
  messageDesc(file_money_ledger_v1_shared_health, 1);
