 ...
 */
export const file_image_tools_v1_health_health: GenFile = /*@__PURE__*/
 ...
 *
 * @generated from message vrooli.image_tools.v1.health.DependencyStatus
 */
export type DependencyStatus = Message<"vrooli.image_tools.v1.health.DependencyStatus"> & {
  /**
 ...
 *
 * @generated from message vrooli.image_tools.v1.health.Response
 */
export type Response = Message<"vrooli.image_tools.v1.health.Response"> & {
  /**
   ...
   *
   * @generated from field: map<string, vrooli.image_tools.v1.health.DependencyStatus> dependencies = 7;
   */
