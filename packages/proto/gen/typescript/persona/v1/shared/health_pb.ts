 ...
 */
export const file_persona_v1_shared_health: GenFile = /*@__PURE__*/
 ...
 *
 * @generated from message vrooli.persona.v1.shared.DependencyStatus
 */
export type DependencyStatus = Message<"vrooli.persona.v1.shared.DependencyStatus"> & {
  /**
 ...
 *
 * @generated from message vrooli.persona.v1.shared.Response
 */
export type Response = Message<"vrooli.persona.v1.shared.Response"> & {
  /**
   ...
   *
   * @generated from field: map<string, vrooli.persona.v1.shared.DependencyStatus> dependencies = 7;
   */
