...
func TestTimelineSerialization(t *testing.T) {
	...
	var parsed browser_automation_studio_v1.ExecutionTimeline
	...
	if len(parsed.Frames) != 1 || parsed.Frames[0].Status != browser_automation_studio_v1.StepStatus_STEP_STATUS_COMPLETED {
