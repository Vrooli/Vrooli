...
export const tagHiddensCreate = yup.array().of(tagHiddenCreate.required(requiredErrorMessage))
export const tagHiddensUpdate = yup.array().of(tagHiddenUpdate.required(requiredErrorMessage))
