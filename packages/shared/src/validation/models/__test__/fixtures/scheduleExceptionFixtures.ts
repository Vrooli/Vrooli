...
export const scheduleExceptionFixtures: ModelTestFixtures = {
    minimal: {
        create: {
            id: validIds.id1,
    ...
    invalid: {
        missingRequired: {
            create: {
                id: validIds.id1,
                // Missing required newEndTime and scheduleConnect
...
export const scheduleExceptionTestDataFactory = new TestDataFactory(scheduleExceptionFixtures, customizers);