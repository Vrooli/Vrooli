...
describe("orDefault", () => {
    it("should return the default array if the existing array is empty", () => {
        ...
        expect(orDefault([], defaultArray)).toEqual(defaultArray);
    });

    it("should return the existing array if it is non-empty", () => {
        const existingArray = [4, 5, 6];
        expect(orDefault(existingArray, [1, 2, 3])).toEqual(existingArray);
    });

    it("should return the default object if the existing object is empty", () => {
        const defaultObj = { a: 1, b: 2 };
        expect(orDefault({}, defaultObj)).toEqual(defaultObj);
    });

    it("should return the existing object merged with defaults", () => {
        const existingObj = { a: 10, y: 20 };
        expect(orDefault(existingObj, { a: 1, b: 2 })).toEqual({ a: 10, y: 20, b: 2 });
    });
    ...
    it("should fill in missing nested properties from the default object", () => {
        ...
        expect(orDefault(existingObj, defaultObj)).toEqual(expectedObj);
    });
    ...
    it("should handle objects within arrays", () => {
        ...
        expect(orDefault(existingArray, defaultArray)).toEqual(expectedArray);
    });
    ...
    it("should return the existing array of primitives if non-empty", () => {
        ...
        expect(orDefault(existingArray, defaultArray)).toEqual(existingArray);
    });
    ...
    it("should return the default array of objects if the existing array is empty", () => {
        ...
        expect(orDefault(existingArray, defaultArray)).toEqual(defaultArray);
    });
});
