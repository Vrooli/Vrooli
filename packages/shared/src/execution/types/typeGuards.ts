 ...
 */
export type TierInput = SwarmCoordinationInput | RoutineExecutionInput | StepExecutionInput;

/**
 * Type guard for SwarmCoordinationInput
 * 
 ...
 */
export function isSwarmCoordinationInput(input: unknown): input is SwarmCoordinationInput {
