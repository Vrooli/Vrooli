...
describe("SwarmCoordinationInput Type Guard", () => {
    const validSwarmInput: SwarmCoordinationInput = {
    ...
    it("should validate correct SwarmCoordinationInput", () => {
    ...
    it("should reject input without availableAgents array", () => {
        const invalidInput = { ...validSwarmInput };
        delete (invalidInput as any).availableAgents;
        expect(isSwarmCoordinationInput(invalidInput)).toBe(false);
    });

    it("should reject input with invalid agents", () => {
        const invalidInput = {
            ...validSwarmInput,
            availableAgents: [
                {
...
describe("Discriminated Union Type Guard", () => {
    ...
    it("should discriminate SwarmCoordinationInput", () => {
...
describe("Edge Cases and Error Conditions", () => {
            ...
            availableAgents: [
                {
                    id: "agent-1",
                    name: "Test Agent",
                    capabilities: [123], // Invalid: should be strings
                    currentLoad: 0,
                    maxConcurrentTasks: 1,
                },
            ],
    ...
    it("should handle very large objects efficiently", () => {
        ...
        const largeInput = {
            goal: "test",
            availableAgents: largeAgentList,
        };
