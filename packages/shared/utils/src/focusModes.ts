import { ActiveFocusMode, FocusMode, FocusModeStopCondition, Schedule } from "@shared/consts";
...
export const getFocusModesFromOccurrences = (
    ...
    const occurrences = schedules.map((schedule) => calculateOccurrences(schedule as any, startDate, endDate));
