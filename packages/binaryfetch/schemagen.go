						...
						"compose": map[string]any{
							...
							"items": map[string]any{
								...
								"properties": map[string]any{
									...
									"index_url":       map[string]any{"type": "string", "format": "uri"},
									"extra_index_url": map[string]any{"type": "array", "items": map[string]any{"type": "string", "format": "uri"}},
									"allow_sdists":    map[string]any{"type": "boolean"},
								},
							},
						},
					},
