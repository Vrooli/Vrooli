...
// Compatibility names for hosts that used the pre-extraction lifecycle seam.
// They preserve the old call shape while keeping the implementation here.
...
export function ensureAudioContextOnGesture(): void {
  ...
  try {
    ...
    // AudioContext is unavailable outside a browser gesture-capable runtime.
  }
}
