...
import { comment } from "@vrooli/server";
...
class CommentEndpointFixtures {
    async processCreate(apiInput: CommentCreateInput, context: CommentTestContext): Promise<unknown> {
    ...
    async processUpdate(apiInput: CommentUpdateInput, context: CommentTestContext): Promise<unknown> {
...
describe("Comment Round-Trip Tests", () => {
    ...
    let _context: CommentTestContext;
    let testUser: any;
    ...
    const _endpointFixtures = new CommentEndpointFixtures();
