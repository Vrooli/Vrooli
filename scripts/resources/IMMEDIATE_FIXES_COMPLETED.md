...
**Problem**: `resources.local.json` was completely overwritten, losing all API keys
**Solution**: 
- Restored from backup: `resources.local.json.backup.2025-07-27T04-05-29-600Z`
...
**Before**: Direct file overwrite with `cat > resources.local.json`
...
# Check configuration
cat ~/.vrooli/resources.local.json | jq '.services | keys'
