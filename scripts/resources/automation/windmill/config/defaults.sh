...
readonly WINDMILL_COMPOSE_FILE="${SCRIPT_DIR}/docker/docker-compose.yml"
readonly WINDMILL_ENV_FILE="${SCRIPT_DIR}/docker/.env"
...
# Service names
readonly WINDMILL_SERVER_CONTAINER="${WINDMILL_PROJECT_NAME}-server"
