...
unstructured_io::export_messages() {
    ...
    export MSG_UNSTRUCTURED_IO_NOT_FOUND MSG_UNSTRUCTURED_IO_UNHEALTHY MSG_CHECKING_STATUS
    export MSG_WAITING_FOR_API MSG_API_READY MSG_API_NOT_READY MSG_CHECK_LOGS
    export MSG_VIEW_LOGS
    
    # Processing messages
    export MSG_PROCESSING_FILE MSG_PROCESS_SUCCESS MSG_PROCESS_FAILED MSG_INVALID_FILE
    export MSG_UNSUPPORTED_FORMAT MSG_FILE_NOT_FOUND MSG_FILE_TOO_LARGE MSG_API_ERROR
    export MSG_SUPPORTED_FORMATS MSG_PROCESS_TIME MSG_ELEMENTS_EXTRACTED MSG_OUTPUT_SAVED
    
    # Docker messages
    export MSG_CONTAINER_EXISTS MSG_CONTAINER_STOP_FAILED MSG_CONTAINER_REMOVE_FAILED
    export MSG_IMAGE_REMOVE_FAILED MSG_DOCKER_NOT_FOUND MSG_DOCKER_NOT_RUNNING
    export MSG_DOCKER_PERMISSION_ERROR MSG_LOGS_CONTAINER_NOT_FOUND MSG_LOGS_PERMISSION_ERROR
    export MSG_NO_LOGS_AVAILABLE
