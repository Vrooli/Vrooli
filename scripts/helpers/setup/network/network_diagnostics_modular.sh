...
# shellcheck disable=SC1091
source "${NETWORK_DIR}/network_diagnostics_core.sh"
# shellcheck disable=SC1091
source "${NETWORK_DIR}/network_diagnostics_tcp.sh"
# shellcheck disable=SC1091
source "${NETWORK_DIR}/network_diagnostics_analysis.sh"
# shellcheck disable=SC1091
source "${NETWORK_DIR}/network_diagnostics_fixes.sh"
