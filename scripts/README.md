...
- UI package scripts should use the hidden native `vrooli lifecycle protect -- ...` entrypoint; the legacy `scripts/lib/ui-guard.sh` helper and `vrooli-ui-run` package bin are retired.
