...
# Main test function
test_vault_secrets_integration_workflow() {
    print_custom_info "Testing vault secrets integration business workflow"
...
# Export functions
export -f test_vault_secrets_integration_workflow
