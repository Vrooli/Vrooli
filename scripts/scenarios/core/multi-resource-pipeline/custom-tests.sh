...
# Main test function
test_multi_resource_pipeline_workflow() {
    print_custom_info "Testing multi resource pipeline business workflow"
...
# Export functions
export -f test_multi_resource_pipeline_workflow
