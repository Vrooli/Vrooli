...
# Main test function
test_podcast_transcription_assistant_workflow() {
    print_custom_info "Testing podcast transcription assistant business workflow"
...
# Export functions
export -f test_podcast_transcription_assistant_workflow
