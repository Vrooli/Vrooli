...
EOF
    ...
    log_info "✅ Sandbox environment created"
    return 0
}
...
EOF
        ...
        log_info "✅ Resource analysis completed"
        return 0
    else
...
generate_provider_script() {
    ...
    log_info "✅ Provider script generated"
    return 0
}
...
EOF
    ...
    if [[ ${test_results} -eq 0 ]]; then
        ...
        log_error "❌ Experiment failed with ${test_results} test failures"
        return 1
    fi
}
...
# Main function
main() {
    log_info "🧪 Starting Resource Experiment"
