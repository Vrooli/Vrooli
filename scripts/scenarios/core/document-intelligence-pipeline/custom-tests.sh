...
# Main test function
test_document_intelligence_pipeline_workflow() {
    print_custom_info "Testing document intelligence pipeline business workflow"
...
# Export functions
export -f test_document_intelligence_pipeline_workflow
