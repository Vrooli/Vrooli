...
# Main test function
test_image_generation_pipeline_workflow() {
    print_custom_info "Testing image generation pipeline business workflow"
...
# Export functions
export -f test_image_generation_pipeline_workflow
