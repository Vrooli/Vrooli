...
./scripts/scenarios/tools/validate-scenario.sh <scenario-name>

# Alternative: scenario-to-app.sh includes basic validation before generation
./scripts/scenarios/tools/scenario-to-app.sh <scenario-name>
```
...
./scripts/scenarios/framework/scenario-test-runner.sh --scenario ./core/<scenario-name>

# Proposed automated approach
./scripts/scenarios/tools/run-integration-test.sh <scenario-name>
```
...
2. **Vrooli framework files** (copied during generation):
   ...
   - `scripts/resources/injection/engine.sh`
   - `scripts/manage.sh`
...
./scripts/scenarios/tools/validate-scenario.sh agent-metareasoning-manager

# Full integration test (generates app, runs lifecycle, tests)
./scripts/scenarios/tools/run-integration-test.sh agent-metareasoning-manager

# Manual testing of generated app
./scripts/scenarios/tools/scenario-to-app.sh agent-metareasoning-manager
