...
(1, 'hero', '{"headline": "Launch Vrooli Ascension", "subheadline": "Ship automation bundles with analytics, downloads, and admin rails on day one.", "cta_text": "Get Started", "cta_url": "/checkout?plan=pro", "background_color": "#0f172a"}', 1, TRUE),
...
(1, 'downloads', '{"title": "Download Vrooli Ascension", "subtitle": "macOS, Windows, Linux, and store links inherit entitlement gating by default."}', 6, TRUE),
...
VALUES
('business_suite', 'Vrooli Business Suite', 'prod_business_suite', 1000000, 0.001, 'credits', 'production', '{"description":"Vrooli Ascension bundle"}')
