...
EOF
    ...
    echo ""
    echo "Next steps:"
    echo "1. Make sure your VPS has Docker and Docker Compose installed"
    echo "   - If not already installed, run: 'curl -sSL https://github.com/Vrooli/NginxSSLReverseProxy/raw/main/setup.sh | sudo bash'"
    echo "2. Update the .env-prod and .env-dev files in $DEPLOY_DIR with your actual values"
    echo "3. Set up your GitHub repository with the required secrets:"
    ...
    echo ""
    echo "4. Your repository should already have workflow files (.github/workflows/deploy-prod.yml and deploy-dev.yml)"
    echo "5. To manually deploy:"
