...
for util in log exit_codes flow; do
    # shellcheck disable=SC1091
    source "${var_LIB_UTILS_DIR}/${util}.sh"
done

# Source system_commands from lib/system
# shellcheck disable=SC1091
source "${var_LIB_SYSTEM_DIR}/system_commands.sh"

# Source Vrooli-specific vault utility
# shellcheck disable=SC1091
source "${var_LIB_DEPS_DIR}/vault.sh"
