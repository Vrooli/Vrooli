...
readonly COMFYUI_DATA_DIR="${RESOURCE_DATA_DIR:-${XDG_DATA_HOME:-${HOME}/.local/share}/vrooli/resources/comfyui}"
readonly COMFYUI_MODELS_DIR="${COMFYUI_DATA_DIR}/models"
readonly COMFYUI_OUTPUT_DIR="${COMFYUI_DATA_DIR}/outputs"
