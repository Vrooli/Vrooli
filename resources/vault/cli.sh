...
for lib in common docker api status install secrets-manager; do
...
# Register the resource secrets command group
...
cli::register_command "status" "Show detailed vault status" "cli::delegate_status"
