...
`codex` is organized as an `external-cli` resource.
...
- `cli/internal/` owns Codex-specific Go logic that cannot be expressed through the manifest or shared control-plane packages.
