...
test_integration() {
    ...
    echo -n "  [2/8] Create tunnel config... "
    ...
    echo -n "  [3/8] List tunnel configs... "
    ...
    # Test 5: Remove tunnel configuration
    echo -n "  [5/8] Remove tunnel config... "
    ...
    # Test 8: Network capabilities
    echo -n "  [8/8] Network capabilities... "
