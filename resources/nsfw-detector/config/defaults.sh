...
export NSFW_DETECTOR_MODEL_PATH="${NSFW_DETECTOR_MODEL_PATH:-${VROOLI_DATA_DIR:-${HOME}/.vrooli/data}/nsfw-detector/models}"
...
export NSFW_DETECTOR_LOG_DIR="${NSFW_DETECTOR_LOG_DIR:-${VROOLI_DATA_DIR:-${HOME}/.vrooli/data}/nsfw-detector/logs}"
...
# Data paths
export NSFW_DETECTOR_DATA_DIR="${NSFW_DETECTOR_DATA_DIR:-${VROOLI_DATA_DIR:-${HOME}/.vrooli/data}/nsfw-detector}"
