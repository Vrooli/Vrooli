...
# Adapter system (e.g., Vault UI automation)
cli::register_command "for" "Use adapters for other resources (e.g., for vault add-secret <path>)" "browserless::adapter_dispatch"
...
cli::register_command "cache" "Manage browserless cache" "browserless::cache"
...
browserless::content::add() { echo "Add browser automation script"; }
browserless::content::list() { session::list "$@"; }
browserless::content::get() { echo "Get browser session details"; }
browserless::content::remove() { echo "Remove browser session"; }
