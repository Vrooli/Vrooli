...
// settings.json (typically ~/.claude/.vrooli-permissions-state.json) and
// is authoritative for drift detection: if the live settings.json
// fingerprint diverges from State.Fingerprint, the user (or some other
// tool) hand-edited the file.
type State struct {
