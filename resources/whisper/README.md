...
- Models: `${WHISPER_MODELS_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/vrooli/resources/whisper/models}`
- Uploads: `${WHISPER_UPLOADS_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/vrooli/resources/whisper/uploads}`
...
- Audio files are temporarily stored in `${WHISPER_UPLOADS_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/vrooli/resources/whisper/uploads}`
