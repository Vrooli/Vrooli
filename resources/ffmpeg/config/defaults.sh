...
ffmpeg::export_config() {
    ...
    export FFMPEG_SCREEN_CAPTURES_DIR="${FFMPEG_SCREEN_CAPTURES_DIR:-${FFMPEG_DATA_DIR}/screen-captures}"
    export FFMPEG_SCREEN_DEFAULT_FRAMERATE="${FFMPEG_SCREEN_DEFAULT_FRAMERATE:-30}"
    export FFMPEG_SCREEN_DEFAULT_RESOLUTION="${FFMPEG_SCREEN_DEFAULT_RESOLUTION:-1920x1080}"
    export FFMPEG_SCREEN_DEFAULT_COLOR_DEPTH="${FFMPEG_SCREEN_DEFAULT_COLOR_DEPTH:-24}"
    export FFMPEG_SCREEN_DEFAULT_CODEC="${FFMPEG_SCREEN_DEFAULT_CODEC:-libx264}"
}