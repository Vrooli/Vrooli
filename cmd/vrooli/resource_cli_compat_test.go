...
func TestMigratedResourceCLIsDelegateStandardCommandsToNativeControlPlane(t *testing.T) {
	...
	cases := []struct {
		...
		{resource: "comfyui", args: []string{"status"}, want: "resource status comfyui"},
		{resource: "home-assistant", args: []string{"manage", "start"}, want: "resource start home-assistant"},
		...
		{resource: "postgis", args: []string{"logs"}, want: "resource logs postgis"},
