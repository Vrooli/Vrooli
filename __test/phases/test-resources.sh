...
# 
# Tests all resources in resources/ directory:
...
WHAT THIS PHASE TESTS:
  1. Validates all resources in resources/ are properly constructed
...
main() {
    if is_dry_run; then
        ...
        log_info "Would validate all resource files in: $PROJECT_ROOT/resources"
